...
Pod::Spec.new do |s|
  ...
  s.subspec 'Implementation' do |ss|
    ...
    ss.source_files = 'src/core/channelz/channel_trace.h',
                      ...
                      'src/core/util/promise/activity.h',
                      'src/core/util/promise/all_ok.h',
                      'src/core/util/promise/arena_promise.h',
                      'src/core/util/promise/cancel_callback.h',
                      'src/core/util/promise/context.h',
                      'src/core/util/promise/detail/basic_seq.h',
                      'src/core/util/promise/detail/join_state.h',
                      'src/core/util/promise/detail/promise_factory.h',
                      'src/core/util/promise/detail/promise_like.h',
                      'src/core/util/promise/detail/seq_state.h',
                      'src/core/util/promise/detail/status.h',
                      'src/core/util/promise/exec_ctx_wakeup_scheduler.h',
                      'src/core/util/promise/for_each.h',
                      'src/core/util/promise/if.h',
                      'src/core/util/promise/interceptor_list.h',
                      'src/core/util/promise/latch.h',
                      'src/core/util/promise/loop.h',
                      'src/core/util/promise/map.h',
                      'src/core/util/promise/observable.h',
                      'src/core/util/promise/party.h',
                      'src/core/util/promise/pipe.h',
                      'src/core/util/promise/poll.h',
                      'src/core/util/promise/prioritized_race.h',
                      'src/core/util/promise/promise.h',
                      'src/core/util/promise/race.h',
                      'src/core/util/promise/seq.h',
                      'src/core/util/promise/sleep.h',
                      'src/core/util/promise/status_flag.h',
                      'src/core/util/promise/try_join.h',
                      'src/core/util/promise/try_seq.h',
