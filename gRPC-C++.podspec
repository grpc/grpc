...
Pod::Spec.new do |s|
  ...
  s.prepare_command = <<-END_OF_COMMAND
    ...
    find third_party/xxhash/cli/ -maxdepth 1 -type f \\( -name '*.h' -or -name '*.c' \\) -print0 | xargs -0 -L1 sed -E -i'.grpc_back' 's;#include "(.*).h";#if COCOAPODS==1\\\n  #include  "third_party/xxhash/cli/\\1.h"\\\n#else\\\n  #include  "\\1.h"\\\n#endif;g'
    find third_party/xxhash/ -maxdepth 1 -type f \\( -name '*.h' -or -name '*.c' \\) -print0 | xargs -0 -L1 sed -E -i'.grpc_back' 's;#include "(.*).h";#if COCOAPODS==1\\\n  #include  "third_party/xxhash/\\1.h"\\\n#else\\\n  #include  "\\1.h"\\\n#endif;g'
