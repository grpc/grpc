...
_LIBS_EXTRA_PROPERTIES = {
    ...
    'grpc': { 'language': 'c', 'build': 'all', 'generate_plugin_registry': True},  # TODO: get list of plugins
    'grpc++': { 'language': 'c++', 'build': 'all' },
    'grpc++_alts': { 'language': 'c++', 'build': 'all' },
    'grpc++_error_details': { 'language': 'c++', 'build': 'all' },
    'grpc++_reflection': { 'language': 'c++', 'build': 'all' },
    'grpc++_unsecure': { 'language': 'c++', 'build': 'all' },
    'grpc_csharp_ext': { 'language': 'c', 'build': 'all' },
    'grpc_unsecure': { 'language': 'c', 'build': 'all', 'generate_plugin_registry': True},  # TODO: get list of plugins
...
# convert preprocessed_builds.yaml
