...
if test "$PHP_GRPC" != "no"; then
  ...
  PHP_ADD_INCLUDE(PHP_EXT_SRCDIR()/third_party/boringssl/src/include)
  ...
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/bn_extra)
  ...
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/cipher_extra)
  ...
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/digest_extra)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/dsa)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/ec_extra)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/ecdh_extra)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/ecdsa_extra)
  ...
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/fipsmodule)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/hkdf)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/hrss)
  ...
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/pkcs7)
  ...
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/pool)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/rand_extra)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/rc4)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/rsa_extra)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/crypto/siphash)
  ...
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/boringssl/src/third_party/fiat)
