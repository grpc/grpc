...
if test "$PHP_GRPC" != "no"; then
  ...
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/base)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/hash)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/json)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/lex)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/mem)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/message)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/mini_descriptor)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/mini_descriptor/internal)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/mini_table)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/mini_table/internal)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/reflection)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/reflection/internal)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/text)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/protobuf/upb/wire)
