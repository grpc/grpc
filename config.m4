...
if test "$PHP_GRPC" != "no"; then
  ...
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/s2a_core/src/crypto)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/s2a_core/src/frame_protector)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/s2a_core/src/handshaker)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/s2a_core/src/options)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/s2a_core/src/proto/upb-generated/proto)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/s2a_core/src/record_protocol)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/s2a_core/src/test_util)
  PHP_ADD_BUILD_DIR($ext_builddir/third_party/s2a_core/src/token_manager)
