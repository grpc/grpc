...
// This benchmark file evaluates the performance of different XdsMatcher
// implementations. It uses helper classes similar to those in the unit tests
// to create a realistic execution context.
...
static void BM_XdsMatcherList(benchmark::State& state, TestMatchContext context) {
