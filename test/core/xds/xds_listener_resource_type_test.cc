...
using envoy::config::cluster::v3::Listener;
...
TEST_F(XdsListenerTest, MinimumValidConfig) {
  Listener listener;
...
using ClusterTypeTest = XdsListenerTest;
...
using LbPolicyTest = XdsListenerTest;
...
using TlsConfigTest = XdsListenerTest;
...
using CircuitBreakingTest = XdsListenerTest;
...
using OutlierDetectionTest = XdsListenerTest;
