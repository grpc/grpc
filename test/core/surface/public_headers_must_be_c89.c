...
int main(int argc, char **argv) {
  ...
  printf("%lx", (unsigned long) gprc_tls_certificate_provider_data_watcher_set_root_cert);
  printf("%lx", (unsigned long) gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs);
