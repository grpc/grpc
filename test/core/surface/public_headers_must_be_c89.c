...
int main(int argc, char **argv) {
  if (argc == 12345678) {
    ...
    ;
    printf("%lx",
           (unsigned long)grpc_completion_queue_thread_local_cache_flush);
    ;
    ...
    ;
    printf("%lx",
           (unsigned long)grpc_channel_num_external_connectivity_watchers);
    ;
    ...
    ;
    printf("%lx",
           (unsigned long)grpc_auth_context_set_peer_identity_property_name);
    ;
    ...
    ;
    printf("%lx",
           (unsigned long)grpc_service_account_jwt_access_credentials_create);
    ;
    ...
    printf(
        "%lx",
        (unsigned long)grpc_ssl_server_credentials_create_options_using_config);
    ;
    printf("%lx",
           (unsigned long)
    ...
    ;
    printf("%lx",
           (unsigned long)grpc_ssl_server_credentials_create_with_options);
    ;
    ...
    ;
    printf("%lx",
           (unsigned long)grpc_server_credentials_set_auth_metadata_processor);
    ;
