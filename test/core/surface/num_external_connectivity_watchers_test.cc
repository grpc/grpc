...
static void
channel_idle_start_watch (grpc_channel * channel, grpc_completion_queue * cq)
{
...
static void
channel_idle_poll_for_timeout (grpc_channel * channel,
...
static void
run_timeouts_test (const test_fixture * fixture)
{
  ...
  GPR_ASSERT (grpc_completion_queue_next
	      (cq, gpr_inf_future (GPR_CLOCK_REALTIME),
 ...
 * of a polling call. */
static void
run_channel_shutdown_before_timeout_test (const test_fixture * fixture)
{
  gpr_log (GPR_INFO, "TEST: %s", fixture->name);
...
static grpc_channel *
insecure_test_create_channel (const char *addr)
{
...
static grpc_channel *
secure_test_create_channel (const char *addr)
{
