...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  ...
  grpc_init();
  auto* context = grpc_stream_compression_context_create(GRPC_STREAM_COMPRESSION_GZIP_COMPRESS);
  ...
  grpc_stream_compress(context, &input_buffer, &output_buffer, nullptr, SIZE_MAX,
