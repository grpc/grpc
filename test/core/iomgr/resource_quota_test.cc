...
static void
inc_int_cb (void *a, grpc_error * error)
{
  gpr_mu_lock (&g_mu);
  ++*(int *) a;
  gpr_cv_signal (&g_cv);
...
static void
assert_counter_becomes (int *ctr, int value)
{
  gpr_mu_lock (&g_mu);
...
static void
set_event_cb (void *a, grpc_error * error)
{
  gpr_event_set ((gpr_event *) a, (void *) 1);
}

grpc_closure *
set_event (gpr_event * ev)
{
...
static void
reclaimer_cb (void *args, grpc_error * error)
{
...
grpc_closure *
make_reclaimer (grpc_resource_user * resource_user, size_t size,
		grpc_closure * then)
{
  reclaimer_args *a =
...
static void
unused_reclaimer_cb (void *arg, grpc_error * error)
{
...
grpc_closure *
make_unused_reclaimer (grpc_closure * then)
{
...
static void
destroy_user (grpc_resource_user * usr)
{
...
static void
test_instant_alloc_then_free (void)
{
...
static void
test_instant_alloc_free_pair (void)
{
...
static void
test_async_alloc_blocked_by_size (void)
{
...
static void
test_blocked_until_scheduled_reclaim (void)
{
...
static void
test_blocked_until_scheduled_reclaim_and_scavenge (void)
{
  gpr_log (GPR_INFO,
...
static void
test_blocked_until_scheduled_destructive_reclaim (void)
{
  gpr_log (GPR_INFO,
...
static void
test_unused_reclaim_is_cancelled (void)
{
  ...
  gpr_event_init (&destructive_done);
  {
    grpc_core::ExecCtx exec_ctx;
    grpc_resource_user_post_reclaimer (usr, false,
				       make_unused_reclaimer (set_event
							      (&benign_done)));
    grpc_resource_user_post_reclaimer (usr, true,
				       make_unused_reclaimer (set_event
							      (&destructive_done)));
...
static void
test_benign_reclaim_is_preferred (void)
{
...
static void
test_multiple_reclaims_can_be_triggered (void)
{
...
static void
test_resource_user_stays_allocated_until_memory_released (void)
{
  gpr_log (GPR_INFO,
...
static void
test_reclaimers_can_be_posted_repeatedly (void)
{
...
static void
test_one_slice_deleted_late (void)
{
...
static void
test_negative_rq_free_pool (void)
{
