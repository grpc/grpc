...
static grpc_resolved_address
make_addr4 (const uint8_t * data, size_t data_len)
{
...
static grpc_resolved_address
make_addr6 (const uint8_t * data, size_t data_len)
{
...
static void
set_addr6_scope_id (grpc_resolved_address * addr, uint32_t scope_id)
{
...
static void
expect_sockaddr_str (const char *expected,
...
static void
expect_sockaddr_uri (const char *expected, grpc_resolved_address * addr)
{
  char *str;
...
static void
test_sockaddr_set_get_port (void)
{
  grpc_resolved_address input4;
  grpc_resolved_address input6;
  grpc_resolved_address dummy;
