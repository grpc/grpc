...
TEST(TlsCredentialsOptionsComparatorTest, DifferentMinTlsVersion) {
  auto* options_1 = grpc_tls_credentials_options_create();
  auto* options_2 = grpc_tls_credentials_options_create();
  grpc_tls_credentials_options_set_min_tls_version(options_1, grpc_tls_version::TLS1_2);
  grpc_tls_credentials_options_set_min_tls_version(options_2, grpc_tls_version::TLS1_3);
  EXPECT_FALSE(*options_1 == *options_2);
  EXPECT_FALSE(*options_2 == *options_1);
  delete options_1;
  delete options_2;
...
TEST(TlsCredentialsOptionsComparatorTest, DifferentMaxTlsVersion) {
  auto* options_1 = grpc_tls_credentials_options_create();
  auto* options_2 = grpc_tls_credentials_options_create();
  grpc_tls_credentials_options_set_max_tls_version(options_1, grpc_tls_version::TLS1_2);
  grpc_tls_credentials_options_set_max_tls_version(options_2, grpc_tls_version::TLS1_3);
  EXPECT_FALSE(*options_1 == *options_2);
  EXPECT_FALSE(*options_2 == *options_1);
  delete options_1;
  delete options_2;
