...
namespace {
// Test cases of Aws endpoints that the aws-sourced credentials will
// depend on.
...
const char* kAmzTestToken =
    ...
    "KJHBPCp8Qi6i99uy7qh76FQAqgVTsnDuU6fGpHDcsDSGoCls2HgZjZFPeOj8mmRhFk"
    "1Xqvkb"
    "juz8V1cJk54d3gIJvQt8gD2D6yJQZecnuGWd5K2e2HohvCc8Fc9kBl1300nUJPV+"
    "k4tr/"
    "A5R/0QfEKOZL1/"
    "k5lf1g9CREnrM8LVkGxCgdYMxLQow1uTL+QU67AHRRSp5PhhGX4Rek+"
    "01vdYSnJCMaPhSEgcLqDlQkhk6MPsyT91QMXcWmyO+"
    "cAZwUPwnRamFepuP4K8k2KVXs/"
    "LIJHLELwAZ0ekyaS7CptgOqS7uaSTFG3U+vzFZLEnGvWQ7y9IPNQZ+"
    "Dffgh4p3vF4J68y9049sI6Sr5d5wbKkcbm8hdCDHZcv4lnqohquPirLiFQ3q7B17V9"
    "krMPu3"
    "mz1cg4Ekgcrn/"
    "E09NTsxAqD8NcZ7C7ECom9r+"
    "X3zkDOxaajW6hu3Az8hGlyylDaMiFfRbBJpTIlxp7jfa7CxikNgNtEKLH9iCzvuSg2"
    "vhA==";
...
TEST(GrpcAwsRequestSignerTest, GetDescribeRegions) {
  grpc_error_handle error = GRPC_ERROR_NONE;
  grpc_core::AwsRequestSigner signer(
      kAmzTestAccessKeyId, kAmzTestSecretAccessKey, kAmzTestToken,
      "GET",
      "https://"
      "ec2.us-east-2.amazonaws.com?Action=DescribeRegions&Version=2013-"
      "10-15",
      "us-east-2", "", {{"x-amz-date", kAmzTestDate}}, &error);
  EXPECT_EQ(error, GRPC_ERROR_NONE);
  EXPECT_EQ(signer.GetSignedRequestHeaders()["Authorization"],
            "AWS4-HMAC-SHA256 "
            "Credential=ASIARD4OQDT6A77FR3CL/20200811/us-east-2/ec2/"
            "aws4_request, "
            "SignedHeaders=host;x-amz-date;x-amz-security-token, "
            "Signature="
            "631ea80cddfaa545fdadb120dc92c9f18166e38a5c47b50fab9fce476e"
            "022855");
}
...
TEST(GrpcAwsRequestSignerTest, PostGetCallerIdentity) {
  ...
  grpc_core::AwsRequestSigner signer(
      ...
      "POST",
      "https://"
      "sts.us-east-2.amazonaws.com?Action=GetCallerIdentity&Version="
      "2011-06-15",
      "us-east-2", "", {{"x-amz-date", kAmzTestDate}}, &error);
  EXPECT_EQ(error, GRPC_ERROR_NONE);
  EXPECT_EQ(signer.GetSignedRequestHeaders()["Authorization"],
            "AWS4-HMAC-SHA256 "
            "Credential=ASIARD4OQDT6A77FR3CL/20200811/us-east-2/sts/"
            "aws4_request, "
            "SignedHeaders=host;x-amz-date;x-amz-security-token, "
            "Signature="
            "73452984e4a880ffdc5c392355733ec3f5ba310d5e0609a89244440cad"
            "fe7a7a");
}
...
TEST(GrpcAwsRequestSignerTest, PostGetCallerIdentityNoToken) {
  ...
  EXPECT_EQ(signer.GetSignedRequestHeaders()["Authorization"],
            ...
            "Signature="
            "d095ba304919cd0d5570ba8a3787884ee78b860f268ed040ba23831d55"
            "536d56");
}
...
TEST(GrpcAwsRequestSignerTest, GetHost) {
  grpc_error_handle error = GRPC_ERROR_NONE;
  grpc_core::AwsRequestSigner signer(
      kBotoTestAccessKeyId, kBotoTestSecretAccessKey, kBotoTestToken,
  ...
  EXPECT_EQ(
      ...
      "Signature="
      "b27ccfbfa7df52a200ff74193ca6e32d4b48b8856fab7ebf1c595d0670a7e47"
      "0");
}
...
TEST(GrpcAwsRequestSignerTest, GetHostDuplicateQueryParam) {
  ...
  EXPECT_EQ(
      ...
      "SignedHeaders=date;host, "
      "Signature="
      "be7148d34ebccdc6423b19085378aa0bee970bdc61d144bd1a8c48c33079ab0"
      "9");
}
...
TEST(GrpcAwsRequestSignerTest, PostWithUpperCaseHeaderKey) {
  ...
  EXPECT_EQ(
      ...
      "Signature="
      "b7a95a52518abbca0964a999a880429ab734f35ebbf1235bd79a5de87756dc4"
      "a");
}
...
TEST(GrpcAwsRequestSignerTest, PostWithUpperCaseHeaderValue) {
  ...
  EXPECT_EQ(
      ...
      "SignedHeaders=date;host;zoo, "
      "Signature="
      "273313af9d0c265c531e11db70bbd653f3ba074c1009239e8559d3987039cad"
      "7");
}
...
TEST(GrpcAwsRequestSignerTest, SignPostWithHeader) {
  ...
  EXPECT_EQ(
      ...
      "Signature="
      "debf546796015d6f6ded8626f5ce98597c33b47b9164cf6b17b4642036fcb59"
      "2");
}
...
TEST(GrpcAwsRequestSignerTest, PostWithBodyNoCustomHeaders) {
  ...
  grpc_core::AwsRequestSigner signer(
      kBotoTestAccessKeyId, kBotoTestSecretAccessKey, kBotoTestToken,
      "POST", "https://host.foo.com/", "us-east-1", "foo=bar",
      {{"date", kBotoTestDate},
  ...
  EXPECT_EQ(
      ...
      "Signature="
      "5a15b22cf462f047318703b92e6f4f38884e4a7ab7b1d6426ca46a8bd1c26cb"
      "c");
}
...
TEST(GrpcAwsRequestSignerTest, SignPostWithQueryString) {
  ...
  EXPECT_EQ(
      ...
      "SignedHeaders=date;host, "
      "Signature="
      "b6e3b79003ce0743a491606ba1035a804593b0efb1e20a11cba83f8c25a57a9"
      "2");
}
