...
static void test_aws_request_signer(void) {
  ...
  auto sign = grpc_core::AwsRequestSigner(
  ...
  GPR_ASSERT(
      sign.GetSignedRequestHeaders(&error)["Authorization"] ==
      "AWS4-HMAC-SHA256 "
  ...
  auto sign_get_describe_regions = grpc_core::AwsRequestSigner(
  ...
  GPR_ASSERT(
      sign_get_describe_regions.GetSignedRequestHeaders(
          &error)["Authorization"] ==
      "AWS4-HMAC-SHA256 "
  ...
  auto sign_post_get_caller_identity = grpc_core::AwsRequestSigner(
      ...
      "us-east-2", "", {{"x-amz-date", kAmzTestDate}});
  GPR_ASSERT(
      sign_post_get_caller_identity.GetSignedRequestHeaders(
          &error)["Authorization"] ==
      "AWS4-HMAC-SHA256 "
  ...
  auto sign_post_get_caller_identity_no_token = grpc_core::AwsRequestSigner(
      kAmzTestAccessKeyId, kAmzTestSecretAccessKey, "", "POST",
      "https://"
      "sts.us-east-2.amazonaws.com?Action=GetCallerIdentity&Version=2011-06-15",
      "us-east-2", "", {{"x-amz-date", kAmzTestDate}});
  GPR_ASSERT(
      sign_post_get_caller_identity_no_token.GetSignedRequestHeaders(
          &error)["Authorization"] ==
      "AWS4-HMAC-SHA256 "
      "Credential=ASIARD4OQDT6A77FR3CL/20200811/us-east-2/sts/aws4_request, "
  ...
  auto sign_get_host_duplicate_query_param = grpc_core::AwsRequestSigner(
      kBotoTestAccessKeyId, kBotoTestSecretAccessKey, kBotoTestToken, "GET",
      "https://host.foo.com/?foo=Zoo&foo=aha", "us-east-1", "",
      {{"date", kBotoTestDate}});
  GPR_ASSERT(
      sign_get_host_duplicate_query_param.GetSignedRequestHeaders(
          &error)["Authorization"] ==
      "AWS4-HMAC-SHA256 "
      "Credential=AKIDEXAMPLE/20110909/us-east-1/host/aws4_request, "
      "SignedHeaders=date;host, "
  ...
  auto sign_post_with_upper_case_header_key = grpc_core::AwsRequestSigner(
  ...
  GPR_ASSERT(
      sign_post_with_upper_case_header_key.GetSignedRequestHeaders(
          &error)["Authorization"] ==
      "AWS4-HMAC-SHA256 "
      "Credential=AKIDEXAMPLE/20110909/us-east-1/host/aws4_request, "
  ...
  auto sign_post_with_upper_case_header_value = grpc_core::AwsRequestSigner(
      kBotoTestAccessKeyId, kBotoTestSecretAccessKey, kBotoTestToken, "POST",
      "https://host.foo.com/", "us-east-1", "",
      {{"date", kBotoTestDate}, {"zoo", "ZOOBAR"}});
  GPR_ASSERT(
      sign_post_with_upper_case_header_value.GetSignedRequestHeaders(
          &error)["Authorization"] ==
      "AWS4-HMAC-SHA256 "
      "Credential=AKIDEXAMPLE/20110909/us-east-1/host/aws4_request, "
      "SignedHeaders=date;host;zoo, "
  ...
  auto sign_post_with_header = grpc_core::AwsRequestSigner(
      kBotoTestAccessKeyId, kBotoTestSecretAccessKey, kBotoTestToken, "POST",
      "https://host.foo.com/", "us-east-1", "",
      {{"date", kBotoTestDate}, {"p", "phfft"}});
  GPR_ASSERT(
      sign_post_with_header.GetSignedRequestHeaders(&error)["Authorization"] ==
      "AWS4-HMAC-SHA256 "
      "Credential=AKIDEXAMPLE/20110909/us-east-1/host/aws4_request, "
  ...
  auto sign_post_with_body_no_custom_headers = grpc_core::AwsRequestSigner(
      kBotoTestAccessKeyId, kBotoTestSecretAccessKey, kBotoTestToken, "POST",
      "https://host.foo.com/", "us-east-1", "foo=bar",
      {{"date", kBotoTestDate},
       {"Content-Type", "application/x-www-form-urlencoded"}});
  GPR_ASSERT(
      sign_post_with_body_no_custom_headers.GetSignedRequestHeaders(
          &error)["Authorization"] ==
      "AWS4-HMAC-SHA256 "
      "Credential=AKIDEXAMPLE/20110909/us-east-1/host/aws4_request, "
  ...
  auto sign_post_with_query_string = grpc_core::AwsRequestSigner(
      kBotoTestAccessKeyId, kBotoTestSecretAccessKey, kBotoTestToken, "POST",
      "https://host.foo.com/?foo=bar", "us-east-1", "",
      {{"date", kBotoTestDate}});
  GPR_ASSERT(
      sign_post_with_query_string.GetSignedRequestHeaders(
          &error)["Authorization"] ==
      "AWS4-HMAC-SHA256 "
      "Credential=AKIDEXAMPLE/20110909/us-east-1/host/aws4_request, "
      "SignedHeaders=date;host, "
