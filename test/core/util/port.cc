...
static int
grpc_pick_unused_port_impl (void)
{
...
static int
grpc_pick_unused_port_or_die_impl (void)
{
...
static void
grpc_recycle_unused_port_impl (int port)
{
...
void
grpc_set_pick_port_functions (grpc_pick_port_functions functions)
{
