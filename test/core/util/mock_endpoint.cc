...
static void
me_read (grpc_endpoint * ep, grpc_slice_buffer * slices, grpc_closure * cb)
{
...
static void
me_write (grpc_endpoint * ep, grpc_slice_buffer * slices, grpc_closure * cb)
{
  grpc_mock_endpoint *m = (grpc_mock_endpoint *) ep;
...
static void
me_add_to_pollset (grpc_endpoint * ep, grpc_pollset * pollset)
{
}

static void
me_add_to_pollset_set (grpc_endpoint * ep, grpc_pollset_set * pollset)
{
}

static void
me_delete_from_pollset_set (grpc_endpoint * ep, grpc_pollset_set * pollset)
{
}

static void
me_shutdown (grpc_endpoint * ep, grpc_error * why)
{
  grpc_mock_endpoint *m = (grpc_mock_endpoint *) ep;
  gpr_mu_lock (&m->mu);
  if (m->on_read)
...
static char *
me_get_peer (grpc_endpoint * ep)
{
  return gpr_strdup ("fake:mock_endpoint");
}

static grpc_resource_user *
me_get_resource_user (grpc_endpoint * ep)
{
  grpc_mock_endpoint *m = (grpc_mock_endpoint *) ep;
...
grpc_endpoint *
grpc_mock_endpoint_create (void (*on_write) (grpc_slice slice),
...
void
grpc_mock_endpoint_put_read (grpc_endpoint * ep, grpc_slice slice)
{
  grpc_mock_endpoint *m = (grpc_mock_endpoint *) ep;
  gpr_mu_lock (&m->mu);
