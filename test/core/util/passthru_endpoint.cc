...
struct passthru_endpoint
{
  ...
  grpc_passthru_endpoint_stats *stats;
    grpc_passthru_endpoint_stats dummy_stats;	// used if constructor stats == nullptr
  bool shutdown;
  half client;
  half server;
};
...
me_get_peer (grpc_endpoint * ep)
{
  ...
  return ((half *) ep) ==
    &p->
    client ? gpr_strdup ("fake:mock_client_endpoint") :
...
static void
half_init (half * m, passthru_endpoint * parent,
...
void
grpc_passthru_endpoint_create (grpc_endpoint ** client,
