...
#ifndef GRPC_TEST_CORE_UTIL_AUTHORIZATION_ARGS_H
#define GRPC_TEST_CORE_UTIL_AUTHORIZATION_ARGS_H
...
class AuthorizationArgs {
 public:
  AuthorizationArgs() { grpc_metadata_batch_init(&metadata_); }
...
#endif  // GRPC_TEST_CORE_UTIL_AUTHORIZATION_ARGS_H
