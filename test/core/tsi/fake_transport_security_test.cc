...
static void
fake_test_setup_handshakers (tsi_test_fixture * fixture)
{
...
static void
validate_handshaker_peers (tsi_handshaker_result * result)
{
...
static void
fake_test_check_handshaker_peers (tsi_test_fixture * fixture)
{
...
static void
fake_test_destruct (tsi_test_fixture * fixture)
{
}
...
fake_tsi_test_fixture_create ()
{
  fake_tsi_test_fixture *fake_fixture =
    static_cast <
    fake_tsi_test_fixture * >(gpr_zalloc (sizeof (*fake_fixture)));
