...
tsi_test_frame_protector_config *tsi_test_frame_protector_config_create (bool
...
void tsi_test_frame_protector_config_destroy (tsi_test_frame_protector_config
					      * config);
