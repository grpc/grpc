...
static void validate_handshaker_result(tsi_handshaker_result *result) {
...
static void fake_test_check_handshake_results(tsi_test_fixture *fixture) {
  validate_handshaker_result(fixture->client_result);
  validate_handshaker_result(fixture->server_result);
}
