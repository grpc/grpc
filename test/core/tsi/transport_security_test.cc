...
static parsed_names
parse_names (const char *names_str)
{
  parsed_names result;
...
static void
destruct_parsed_names (parsed_names * pdn)
{
  name_list *nl = pdn->names;
  if (pdn->buffer != nullptr)
    gpr_free (pdn->buffer);
  while (nl != nullptr)
    {
...
static char *
processed_name (const char *name)
{
...
static void
test_protector_invalid_args (void)
{
  ...
  GPR_ASSERT (tsi_frame_protector_unprotect
	      (nullptr, nullptr, nullptr, nullptr,
	       nullptr) == TSI_INVALID_ARGUMENT);
}

static void
test_handshaker_invalid_args (void)
{
...
static void
test_handshaker_invalid_state (void)
{
