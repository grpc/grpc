...
TEST(SslTransportSecurityTest, MapSslErrorToTlsTelemetryHandshakeResultTest) {
  // Test SUCCESS
  EXPECT_EQ(tsi::MapSslErrorToTlsTelemetryHandshakeResult(SSL_ERROR_NONE, 0,
                                                          X509_V_OK),
            tsi::TlsTelemetryHandshakeResult::SUCCESS);

  // Test Peer certificate verification failures
  EXPECT_EQ(tsi::MapSslErrorToTlsTelemetryHandshakeResult(
                SSL_ERROR_NONE, 0, X509_V_ERR_CERT_REVOKED),
  ...
  EXPECT_EQ(tsi::MapSslErrorToTlsTelemetryHandshakeResult(
                SSL_ERROR_NONE, 0, X509_V_ERR_CERT_REJECTED),
  ...
  EXPECT_EQ(tsi::MapSslErrorToTlsTelemetryHandshakeResult(SSL_ERROR_ZERO_RETURN,
                                                          0, X509_V_OK),
            tsi::TlsTelemetryHandshakeResult::PEER_CONNECTION_CLOSED);
  EXPECT_EQ(tsi::MapSslErrorToTlsTelemetryHandshakeResult(SSL_ERROR_SYSCALL, 0,
                                                          X509_V_OK),
            tsi::TlsTelemetryHandshakeResult::PEER_CONNECTION_CLOSED);
  ...
  EXPECT_EQ(
      tsi::MapSslErrorToTlsTelemetryHandshakeResult(
