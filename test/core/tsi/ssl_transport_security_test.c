...
static tsi_ssl_handshaker_factory_destructor original_destructor;
...
static void ssl_tsi_test_handshaker_factory_destructor(
  ...
  if (original_destructor != NULL) original_destructor(factory);
}
...
void test_tsi_ssl_client_handshaker_factory_refcounting() {
  ...
  original_destructor = tsi_ssl_handshaker_factory_swap_destructor(
...
void ssl_tsi_test_handshaker_factory_reference_counting() {
...
int main(int argc, char **argv) {
  ...
  ssl_tsi_test_handshaker_factory_reference_counting();
  grpc_shutdown();
  return 0;
}
