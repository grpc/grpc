...
static void alts_test_do_round_trip_check_frames(
  ...
  GPR_ASSERT(alts_create_frame_protector(
                 key, key_size, /*is_client=*/true, rekey,
  ...
  GPR_ASSERT(alts_create_frame_protector(
                 key, key_size, /*is_client=*/false, rekey,
  ...
  GPR_ASSERT(channel->bytes_written_to_server_channel ==
             client_frame_size);
  ...
  GPR_ASSERT(config->client_message_size ==
  ...
  tsi_test_frame_protector_send_message_to_peer(config, channel,
                                                ...
                                                /*is_client=*/false);
  /* Verify if the generated frame is the same as the expected. */
  GPR_ASSERT(channel->bytes_written_to_client_channel ==
             server_frame_size);
  ...
  tsi_test_frame_protector_receive_message_from_peer(
      ...
      /*is_client=*/true);
  GPR_ASSERT(config->server_message_size ==
             client_received_message_size);
...
static void alts_test_do_round_trip_vector_tests() {
  const uint8_t key[] = {0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65,
  ...
  const uint8_t large_message[] = {
      ...
      0x57, 0xba, 0x63, 0x7b, 0x39, 0x1a, 0xaf, 0xd2, 0x55, 0xd6, 0x09,
      0xb1, 0xf0, 0x56, 0x63, 0x7a, 0x0d, 0x46, 0xdf, 0x99, 0x8d, 0x88,
      0xe5, 0x22, 0x2a, 0xb2, 0xc2, 0x84, 0x65, 0x12, 0x15, 0x35, 0x24,
      0xc0, 0x89, 0x5e, 0x81, 0x08, 0x06, 0x0f, 0x10, 0x11, 0x12, 0x13,
  ...
  const size_t small_message_size =
      sizeof(small_message) / sizeof(uint8_t);
  const size_t large_message_size =
      sizeof(large_message) / sizeof(uint8_t);
  /* Test small client message and large server message. */
  const uint8_t client_expected_frame1[] = {
      0x1f, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x09,
  ...
  const uint8_t server_expected_frame1[] = {
      };
  ...
  alts_test_do_round_trip_check_frames(
      ...
      small_message_size, client_expected_frame1, client_frame_size1,
      large_message, large_message_size, server_expected_frame1,
      server_frame_size1);
  ...
  const uint8_t client_expected_frame2[] = {
      };
  const uint8_t server_expected_frame2[] = {
      0x1f, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x33,
  ...
  alts_test_do_round_trip_check_frames(
      fixture, key, kAes128GcmKeyLength, /*rekey=*/false,
      reinterpret_cast<const uint8_t*>(small_message),
      small_message_size, client_expected_frame6, client_frame_size6,
      large_message, large_message_size, server_expected_frame6,
      server_frame_size6);
  tsi_test_frame_protector_fixture_destroy(fixture);
}

static void alts_test_do_round_trip(
    tsi_test_frame_protector_fixture* fixture, bool rekey) {
  GPR_ASSERT(fixture != nullptr);
  GPR_ASSERT(fixture->config != nullptr);
  tsi_frame_protector* client_frame_protector = nullptr;
  tsi_frame_protector* server_frame_protector = nullptr;
  ...
  size_t client_max_output_protected_frame_size =
      config->client_max_output_protected_frame_size;
  GPR_ASSERT(alts_create_frame_protector(
                 key, key_length, /*is_client=*/true, rekey,
                 client_max_output_protected_frame_size == 0
                     ? nullptr
                     : &client_max_output_protected_frame_size,
                 &client_frame_protector) == TSI_OK);
