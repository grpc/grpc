...
// If max_expected_concurrent_rpcs is non-zero, the fake handshake
// service will track the number of concurrent RPCs that it handles and
// abort if if ever exceeds that number.
