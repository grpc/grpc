...
const size_t kTestNumCrypters = 6;
...
static void gsec_test_get_crypter_from_test_vector(
    gsec_aead_crypter** crypter, gsec_aead_test_vector* test_vector,
    bool copy_key, bool rekey = false) {
  ...
  gsec_aes_gcm_aead_crypter_create(test_vector->key, key_length, copy_key,
                                   nonce_length, tag_length, rekey, crypter,
                                   nullptr);
}

static void gsec_test_verify_crypter_on_test_vector(
    gsec_aead_test_vector* test_vector, bool copy_key, bool rekey = false) {
  gsec_aead_crypter* crypter;
  gsec_test_get_crypter_from_test_vector(&crypter, test_vector, copy_key,
                                         rekey);
...
static void gsec_test_create_random_aes_gcm_crypter(
    gsec_aead_crypter** crypter, uint8_t** key, size_t key_length,
    size_t nonce_length, size_t tag_length, bool rekey, bool copy_key) {
  gsec_test_random_array(key, key_length);
  gsec_aes_gcm_aead_crypter_create(*key, key_length, copy_key, nonce_length,
...
static void gsec_test_get_random_aes_gcm_crypters(gsec_aead_crypter*** crypters,
  ...
  *keys =
      static_cast<uint8_t**>(gpr_malloc(sizeof(uint8_t*) * kTestNumCrypters));
  gsec_test_create_random_aes_gcm_crypter(
      &((*crypters)[0]), &((*keys)[0]), kAes128GcmKeyLength, kAesGcmNonceLength,
      kAesGcmTagLength, /*rekey=*/false, /*copy_key=*/true);
  gsec_test_create_random_aes_gcm_crypter(
      &((*crypters)[1]), &((*keys)[1]), kAes256GcmKeyLength, kAesGcmNonceLength,
      kAesGcmTagLength, /*rekey=*/false, /*copy_key=*/true);
  gsec_test_create_random_aes_gcm_crypter(
      &((*crypters)[2]), &((*keys)[2]), kAes128GcmRekeyKeyLength,
      kAesGcmNonceLength, kAesGcmTagLength, /*rekey=*/true,
      /*copy_key=*/true);
  gsec_test_create_random_aes_gcm_crypter(
      &((*crypters)[3]), &((*keys)[3]), kAes128GcmKeyLength, kAesGcmNonceLength,
      kAesGcmTagLength, /*rekey=*/false,
      /*copy_key=*/false);
  gsec_test_create_random_aes_gcm_crypter(
      &((*crypters)[4]), &((*keys)[4]), kAes256GcmKeyLength, kAesGcmNonceLength,
      kAesGcmTagLength, /*rekey=*/false,
      /*copy_key=*/false);
  gsec_test_create_random_aes_gcm_crypter(
      &((*crypters)[5]), &((*keys)[5]), kAes128GcmRekeyKeyLength,
      kAesGcmNonceLength, kAesGcmTagLength, /*rekey=*/true,
      /*copy_key=*/false);
}
...
TEST(AltsCryptTest, GsecTestDoGenericCrypterTests) {
  ...
  uint8_t** keys;
  gsec_test_get_random_aes_gcm_crypters(&crypters, &keys);
  for (size_t ind = 0; ind < kTestNumCrypters; ind++) {
...
TEST(AltsCryptTest, GsecTestDoVectorTestsRekeyNistCopyKey) {
  // NIST vectors from:
  ...
  gsec_test_verify_crypter_on_test_vector(&vec, copy_key, rekey);
...
TEST(AltsCryptTest, GsecTestDoVectorTestsRekeyNistNotCopyKey) {
  // NIST vectors from:
  // http://csrc.nist.gov/groups/ST/toolkit/BCM/documents/proposedmodes/gcm/gcm-revised-spec.pdf
  //
  // IEEE vectors from:
...
TEST(AltsCryptTest, GsecTestDoVectorTestsRekeyIeeeCopyKey) {
  // IEEE vectors from:
  // http://www.ieee802.org/1/files/public/docs2011/bn-randall-test-vectors-0511-v1.pdf
  //
  // Key expanded by setting expandedKey = (key||(key ^ {0x01, .., 0x01})||key ^
...
TEST(AltsCryptTest, GsecTestDoVectorTestsRekeyIeeeNotCopyKey) {
  // IEEE vectors from:
  // http://www.ieee802.org/1/files/public/docs2011/bn-randall-test-vectors-0511-v1.pdf
  //
  // Key expanded by setting expandedKey = (key||(key ^ {0x01, .., 0x01})||key ^
...
TEST(AltsCryptTest, GsecTestDoVectorTestsNistCopyKey) {
  ///
  /// From:
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_1, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_2, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_3, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_4, copy_key);
  gsec_aead_free_test_vector(test_vector_4);
}

TEST(AltsCryptTest, GsecTestDoVectorTestsNistNotCopyKey) {
  ///
  /// From:
  /// http://csrc.nist.gov/groups/ST/toolkit/BCM/documents/proposedmodes/gcm/
  /// gcm-revised-spec.pdf
...
TEST(AltsCryptTest, GsecTestDoVectorTestsIeeeCopyKey) {
  ///
  /// From:
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_5, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_6, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_7, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_8, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_9, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_10, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_11, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_12, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_13, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_14, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_15, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_16, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_17, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_18, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_19, copy_key);
  ...
  gsec_test_verify_crypter_on_test_vector(test_vector_20, copy_key);
  gsec_aead_free_test_vector(test_vector_20);
}

TEST(AltsCryptTest, GsecTestDoVectorTestsIeeeNotCopyKey) {
  ///
  /// From:
  /// http://www.ieee802.org/1/files/public/docs2011/
  /// bn-randall-test-vectors-0511-v1.pdf
