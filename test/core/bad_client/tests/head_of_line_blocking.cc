...
static const char prefix[] = "PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n"
  // settings frame
  ...
  // fulfill)
  "\x00\x00\x05\x00\x00\x00\x00\x00\x01" "\x01\x00\x00\x27\x10"
  ...
  // fulfill)
  "\x00\x00\x05\x00\x00\x00\x00\x00\x03" "\x01\x00\x00\x27\x10" "";
...
static void
addbuf (const void *data, size_t len)
{
