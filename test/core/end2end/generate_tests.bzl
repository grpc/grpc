...
def _fixture_options(fullstack=True,
...
END2END_FIXTURES = {
    ...
    "h2_full":
        _fixture_options(),
    "h2_full+pipe":
        _fixture_options(_platforms=["linux"]),
    "h2_full+trace":
        _fixture_options(tracing=True),
    "h2_http_proxy":
        _fixture_options(supports_proxy_auth=True),
    "h2_insecure":
        _fixture_options(secure=True),
    "h2_oauth2":
        _fixture_options(),
    "h2_proxy":
        _fixture_options(includes_proxy=True),
    "h2_sockpair_1byte":
        _fixture_options(
            fullstack=False,
            dns_resolver=False,
    ...
    "h2_tls":
        _fixture_options(secure=True),
    "h2_local_abstract_uds_percent_encoded":
        _fixture_options(
            secure=True,
            dns_resolver=False,
    ...
    "h2_local_ipv6":
        _fixture_options(secure=True,
                         ...
                         _platforms=["linux", "mac", "posix"]),
    "h2_ssl_proxy":
        _fixture_options(includes_proxy=True, secure=True),
    "h2_uds":
        _fixture_options(
            dns_resolver=False,
            _platforms=["linux", "mac", "posix"],
...
END2END_NOSEC_FIXTURES = {
    ...
    "h2_full+pipe":
        _fixture_options(secure=False,
                         ...
                         supports_msvc=False),
    "h2_full+trace":
        _fixture_options(secure=False, tracing=True, supports_msvc=False),
    "h2_http_proxy":
        _fixture_options(secure=False, supports_proxy_auth=True),
    "h2_proxy":
        _fixture_options(secure=False, includes_proxy=True),
    "h2_sockpair_1byte":
        _fixture_options(
            fullstack=False,
            dns_resolver=False,
    ...
    "h2_ssl_cred_reload":
        _fixture_options(secure=False),
    "h2_ssl_proxy":
        _fixture_options(includes_proxy=True, secure=False),
    "h2_uds":
        _fixture_options(
            dns_resolver=False,
            _platforms=["linux", "mac", "posix"],
...
def _test_options(needs_fullstack=False,
                  needs_dns=False,
                  needs_names=False,
                  proxyable=True,
                  secure=False,
...
END2END_TESTS = {
    "bad_hostname":
        _test_options(needs_names=True),
    "bad_ping":
        _test_options(needs_fullstack=True, proxyable=False),
    "binary_metadata":
        _test_options(),
    ...
    "client_streaming":
        _test_options(),
    "compressed_payload":
        _test_options(proxyable=False, exclude_inproc=True),
    "connectivity":
        _test_options(
            needs_fullstack=True,
            needs_names=True,
    ...
    "disappearing_server":
        _test_options(needs_fullstack=True, needs_names=True),
    "empty_batch":
        _test_options(),
    "filter_causes_close":
        _test_options(),
    ...
    "graceful_server_shutdown":
        _test_options(exclude_inproc=True),
    "hpack_size":
        _test_options(
            proxyable=False,
            traceable=False,
    ...
    "invoke_large_request":
        _test_options(exclude_1byte=True),
    "keepalive_timeout":
        _test_options(proxyable=False, needs_http2=True),
    "large_metadata":
        _test_options(exclude_1byte=True),
    ...
    "negative_deadline":
        _test_options(),
    "no_error_on_hotpath":
        _test_options(proxyable=False),
    "no_logging":
        _test_options(traceable=False),
    "no_op":
        _test_options(),
    "payload":
        _test_options(exclude_1byte=True),
    ...
    "ping":
        _test_options(needs_fullstack=True, proxyable=False),
    "proxy_auth":
        _test_options(needs_proxy_auth=True),
    "registered_call":
        _test_options(),
    "request_with_flags":
        _test_options(proxyable=False),
    "request_with_payload":
        _test_options(),
    "retry":
        _test_options(needs_client_channel=True),
    "retry_cancellation":
        _test_options(needs_client_channel=True),
    ...
    "server_finishes_request":
        _test_options(),
    "server_streaming":
        _test_options(needs_http2=True),
    ...
    "simple_delayed_request":
        _test_options(needs_fullstack=True),
    "simple_metadata":
        _test_options(),
    "simple_request":
        _test_options(),
    ...
    "filter_status_code":
        _test_options(),
    "write_buffering":
        _test_options(needs_write_buffering=True),
...
def grpc_end2end_tests():
    ...
    for f, fopt in END2END_FIXTURES.items():
        grpc_cc_binary(
            ...
            deps=[
                ":end2end_tests", "//test/core/util:grpc_test_util", "//:grpc",
                "//:gpr", "//test/core/compression:args_utils"
            ],
