...
namespace grpc
{
  namespace testing
  {
    ...
    static void chttp2_init_client_secure_fullstack (grpc_end2end_test_fixture
						     * f,
						     grpc_channel_args *
						     client_args,
	...
	static_cast < fullstack_secure_fixture_data * >(f->fixture_data);
      f->client =
	grpc_secure_channel_create (creds, ffd->localaddr, client_args,
				    nullptr);
      GPR_ASSERT (f->client != nullptr);
      grpc_channel_credentials_release (creds);
    }

    static void chttp2_init_server_secure_fullstack (grpc_end2end_test_fixture
						     * f,
						     grpc_channel_args *
						     server_args,
      ...
      if (f->server)
	{
      ...
      GPR_ASSERT (grpc_server_add_secure_http2_port
		  (f->server, ffd->localaddr, server_creds));
...
#define CLIENT_INIT_NAME(cert_type) \
  chttp2_init_client_simple_ssl_secure_fullstack_##cert_type
      typedef enum
    { NONE, SELF_SIGNED, SIGNED, BAD_CERT_PAIR } certtype;
...
/* All test configurations */
    ...
    static grpc_end2end_test_config_wrapper configs[] = {
      ...
      SSL_TEST (GRPC_SSL_DONT_REQUEST_CLIENT_CERTIFICATE, SELF_SIGNED,
		SUCCESS),
      SSL_TEST (GRPC_SSL_DONT_REQUEST_CLIENT_CERTIFICATE, SIGNED, SUCCESS),
      SSL_TEST (GRPC_SSL_DONT_REQUEST_CLIENT_CERTIFICATE, BAD_CERT_PAIR,
		FAIL),
      ...
      SSL_TEST (GRPC_SSL_REQUEST_CLIENT_CERTIFICATE_AND_VERIFY, NONE,
		SUCCESS),
      SSL_TEST (GRPC_SSL_REQUEST_CLIENT_CERTIFICATE_AND_VERIFY, SELF_SIGNED,
		FAIL),
      SSL_TEST (GRPC_SSL_REQUEST_CLIENT_CERTIFICATE_AND_VERIFY, SIGNED,
		SUCCESS),
    ...
    class H2SslCertTest:public::testing::TestWithParam <
      grpc_end2end_test_config_wrapper >
    {
    protected:
      H2SslCertTest ()
    ...
    INSTANTIATE_TEST_CASE_P (H2SslCert,
			     H2SslCertTest,::testing::ValuesIn (configs));
