...
static grpc_end2end_test_config configs[] = {
    {"chttp2/fullstack_local_ipv4",
     ...
     nullptr, chttp2_create_fixture_fullstack_ipv4, chttp2_init_client_fullstack_ipv4,
     chttp2_init_server_fullstack_ipv4, grpc_end2end_local_chttp2_tear_down_fullstack}};
