...
chttp2_create_fixture_static_data_tls1_2(
...
static grpc_end2end_test_fixture
chttp2_create_fixture_static_data_tls1_3(
    grpc_channel_args* client_args, grpc_channel_args* server_args) {
  return chttp2_create_fixture_static_data(client_args, server_args,
...
static grpc_end2end_test_fixture
chttp2_create_fixture_cert_watcher_tls1_2(
    grpc_channel_args* client_args, grpc_channel_args* server_args) {
...
static grpc_end2end_test_fixture
chttp2_create_fixture_cert_watcher_tls1_3(
    grpc_channel_args* client_args, grpc_channel_args* server_args) {
  return chttp2_create_fixture_cert_watcher(client_args, server_args,
                                            grpc_tls_version::TLS1_3);
}
...
int main(int argc, char** argv) {
  ...
  grpc_init();
  for (size_t ind = 0; ind < sizeof(configs) / sizeof(*configs);
       ind++) {
