...
inproc_create_fixture (grpc_channel_args * client_args,
		       grpc_channel_args * server_args)
{
  grpc_end2end_test_fixture f;
  inproc_fixture_data *ffd =
    static_cast <
    inproc_fixture_data * >(gpr_malloc (sizeof (inproc_fixture_data)));
  memset (&f, 0, sizeof (f));
...
void
inproc_init_client (grpc_end2end_test_fixture * f,
...
void
inproc_init_server (grpc_end2end_test_fixture * f,
		    grpc_channel_args * server_args)
{
  if (f->server)
    {
...
void
inproc_tear_down (grpc_end2end_test_fixture * f)
{
  inproc_fixture_data *ffd =
