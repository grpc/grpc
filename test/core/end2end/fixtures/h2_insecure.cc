...
grpc_end2end_test_fixture Chttp2CreateFixtureInsecureFullstack(grpc_channel_args* /*client_args*/,
...
void ProcessAuthFailure(void* state, grpc_auth_context* /*ctx*/, const grpc_metadata* /*md*/,
...
void Chttp2InitServerInsecureFullstack(grpc_end2end_test_fixture* f,
  ...
  if (grpc_channel_args_find(server_args, FAIL_AUTH_CHECK_SERVER_ARG_NAME) != nullptr) {
    grpc_auth_metadata_processor processor = {ProcessAuthFailure, nullptr, nullptr};
    grpc_server_credentials_set_auth_metadata_processor(server_creds, processor);
  }
...
grpc_end2end_test_config configs[] = {
    {"chttp2/insecure_fullstack",
     ...
     nullptr, Chttp2CreateFixtureInsecureFullstack, Chttp2InitClientInsecureFullstack,
