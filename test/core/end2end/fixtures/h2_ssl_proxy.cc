...
static grpc_channel* create_proxy_client(const char* target, grpc_channel_args* client_args) {
  ...
  channel = grpc_secure_channel_create(ssl_creds, target, new_client_args, nullptr);
...
static void chttp2_init_client_secure_fullstack(grpc_end2end_test_fixture* f,
  ...
  f->client = grpc_secure_channel_create(creds, grpc_end2end_proxy_get_client_target(ffd->proxy),
                                         client_args, nullptr);
