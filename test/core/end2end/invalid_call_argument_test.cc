...
static void test_non_null_reserved_on_start_batch() {
  ABSL_LOG(INFO) << "test_non_null_reserved_on_start_batch";

  prepare_test(1);
  ABSL_CHECK(GRPC_CALL_ERROR ==
...
static void test_non_null_reserved_on_op() {
  ABSL_LOG(INFO) << "test_non_null_reserved_on_op";
  ...
  op++;
  ABSL_CHECK(GRPC_CALL_ERROR == grpc_call_start_batch(g_state.call, g_state.ops,
                                                 (size_t)(op - g_state.ops),
                                                 grpc_core::CqVerifier::tag(1),
                                                 nullptr));
  cleanup_test();
...
static void test_send_initial_metadata_more_than_once() {
  ABSL_LOG(INFO) << "test_send_initial_metadata_more_than_once";
  ...
  op->reserved = nullptr;
  op++;
  ABSL_CHECK(GRPC_CALL_ERROR_TOO_MANY_OPERATIONS ==
        grpc_call_start_batch(g_state.call, g_state.ops,
                              (size_t)(op - g_state.ops),
                              grpc_core::CqVerifier::tag(1), nullptr));
  cleanup_test();
...
static void test_too_many_metadata() {
  ABSL_LOG(INFO) << "test_too_many_metadata";
  ...
  op->reserved = nullptr;
  op++;
  ABSL_CHECK(GRPC_CALL_ERROR_INVALID_METADATA ==
        grpc_call_start_batch(g_state.call, g_state.ops,
                              (size_t)(op - g_state.ops),
                              grpc_core::CqVerifier::tag(1), nullptr));
  cleanup_test();
...
static void test_send_null_message() {
  ABSL_LOG(INFO) << "test_send_null_message";
  ...
  op->reserved = nullptr;
  op++;
  ABSL_CHECK(GRPC_CALL_ERROR_INVALID_MESSAGE ==
        grpc_call_start_batch(g_state.call, g_state.ops,
                              (size_t)(op - g_state.ops),
                              grpc_core::CqVerifier::tag(1), nullptr));
  cleanup_test();
...
static void test_send_messages_at_the_same_time() {
  ABSL_LOG(INFO) << "test_send_messages_at_the_same_time";
...
static void test_send_server_status_from_client() {
  ABSL_LOG(INFO) << "test_send_server_status_from_client";
  ...
  op->reserved = nullptr;
  op++;
  ABSL_CHECK(GRPC_CALL_ERROR_NOT_ON_CLIENT ==
        grpc_call_start_batch(g_state.call, g_state.ops,
                              (size_t)(op - g_state.ops),
                              grpc_core::CqVerifier::tag(1), nullptr));
  cleanup_test();
...
static void test_receive_initial_metadata_twice_at_client() {
  ABSL_LOG(INFO) << "test_receive_initial_metadata_twice_at_client";
...
static void test_receive_message_with_invalid_flags() {
  ABSL_LOG(INFO) << "test_receive_message_with_invalid_flags";
  ...
  op->reserved = nullptr;
  op++;
  ABSL_CHECK(GRPC_CALL_ERROR_INVALID_FLAGS ==
        grpc_call_start_batch(g_state.call, g_state.ops,
                              (size_t)(op - g_state.ops),
                              grpc_core::CqVerifier::tag(1), nullptr));
  cleanup_test();
...
static void test_receive_two_messages_at_the_same_time() {
  ABSL_LOG(INFO) << "test_receive_two_messages_at_the_same_time";
...
static void test_recv_close_on_server_from_client() {
  ABSL_LOG(INFO) << "test_recv_close_on_server_from_client";
...
static void test_recv_status_on_client_twice() {
  ABSL_LOG(INFO) << "test_recv_status_on_client_twice";
...
static void test_send_close_from_client_on_server() {
  ABSL_LOG(INFO) << "test_send_close_from_client_on_server";
  ...
  op->reserved = nullptr;
  op++;
  ABSL_CHECK(GRPC_CALL_ERROR_NOT_ON_SERVER ==
...
static void test_recv_status_on_client_from_server() {
  ABSL_LOG(INFO) << "test_recv_status_on_client_from_server";
...
static void test_send_status_from_server_with_invalid_flags() {
  ABSL_LOG(INFO) << "test_send_status_from_server_with_invalid_flags";
...
static void test_too_many_trailing_metadata() {
  ABSL_LOG(INFO) << "test_too_many_trailing_metadata";
...
static void test_send_server_status_twice() {
  ABSL_LOG(INFO) << "test_send_server_status_twice";
...
static void test_recv_close_on_server_with_invalid_flags() {
  ABSL_LOG(INFO) << "test_recv_close_on_server_with_invalid_flags";
...
static void test_recv_close_on_server_twice() {
  ABSL_LOG(INFO) << "test_recv_close_on_server_twice";
...
static void test_invalid_initial_metadata_reserved_key() {
  ABSL_LOG(INFO) << "test_invalid_initial_metadata_reserved_key";
...
static void test_multiple_ops_in_a_single_batch() {
  ABSL_LOG(INFO) << "test_multiple_ops_in_a_single_batch";
