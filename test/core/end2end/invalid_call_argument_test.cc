...
prepare_test (int is_client)
{
  ...
  if (is_client)
	...
	grpc_insecure_channel_create ("nonexistant:54321", nullptr, nullptr);
      ...
      g_state.call =
	grpc_channel_create_call (g_state.chan, nullptr,
				  GRPC_PROPAGATE_DEFAULTS, g_state.cq,
	...
	grpc_channel_create_call (g_state.chan, nullptr,
      ...
      GPR_ASSERT (GRPC_CALL_OK ==
		  grpc_call_start_batch (g_state.call, g_state.ops,
					 ...
					 nullptr));
      GPR_ASSERT (GRPC_CALL_OK ==
		  grpc_server_request_call (g_state.server,
					    &g_state.server_call,
					    &g_state.call_details,
					    &g_state.
					    server_initial_metadata_recv,
