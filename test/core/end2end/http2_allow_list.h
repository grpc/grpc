...
#define GRPC_HTTP2_HTTP_2_FULLSTACK_SINGLE_HOP_TESTS

#define GRPC_HTTP2_HTTP_2_SINGLE_HOP_TESTS

#define GRPC_HTTP2_HTTP_2_TESTS
...
#define GRPC_HTTP2_RETRY_HTTP_2_TESTS
