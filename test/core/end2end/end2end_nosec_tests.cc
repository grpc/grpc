...
extern void stream_compression_compressed_payload (grpc_end2end_test_config
						   config);
...
extern void stream_compression_ping_pong_streaming (grpc_end2end_test_config
						    config);
...
void
grpc_end2end_tests_pre_init (void)
{
...
void
grpc_end2end_tests (int argc, char **argv, grpc_end2end_test_config config)
{
  int i;
