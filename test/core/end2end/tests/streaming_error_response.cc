...
begin_test (grpc_end2end_test_config config,
	    ...
	    grpc_channel_args * server_args, bool request_status_early)
{
...
static void
test (grpc_end2end_test_config config, bool request_status_early)
{
  grpc_call *c;
  grpc_call *s;
...
void
streaming_error_response (grpc_end2end_test_config config)
{
  test (config, false);
  test (config, true);
}
...
void
streaming_error_response_pre_init (void)
{
}
