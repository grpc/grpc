...
static void
simple_request_body (grpc_end2end_test_config config,
		     grpc_end2end_test_fixture f, void *rc)
{
  ...
  c =
    grpc_channel_create_registered_call (f.client, nullptr,
...
test_invoke_simple_request (grpc_end2end_test_config config)
{
  ...
  void *rc = grpc_channel_register_call (f.client, "/foo",
					 ...
					 ("foo.test.google.fr:1234", config),
					 nullptr);
...
void
registered_call (grpc_end2end_test_config config)
{
