...
static void simple_request_body(grpc_end2end_test_config /*config*/, grpc_end2end_test_fixture f,
  ...
  c = grpc_channel_create_registered_call(f.client, nullptr, GRPC_PROPAGATE_DEFAULTS, f.cq, rc,
                                          deadline, nullptr);
  GPR_ASSERT(c);
...
static void test_invoke_simple_request(grpc_end2end_test_config config) {
  grpc_end2end_test_fixture f = begin_test(config, "test_invoke_simple_request", nullptr, nullptr);
