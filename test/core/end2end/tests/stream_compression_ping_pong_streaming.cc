...
test_pingpong_streaming (grpc_end2end_test_config config, int messages)
{
  grpc_channel_args *client_args =
    grpc_channel_args_set_stream_compression_algorithm (nullptr,
...
void
stream_compression_ping_pong_streaming (grpc_end2end_test_config config)
{
  int i;
...
void
stream_compression_ping_pong_streaming_pre_init (void)
{
}
