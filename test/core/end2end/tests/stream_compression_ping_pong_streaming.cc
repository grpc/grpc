...
/* Client pings and server pongs. Repeat messages rounds before
 * finishing. */
static void test_pingpong_streaming(grpc_end2end_test_config config,
  ...
  grpc_end2end_test_fixture f = begin_test(
      config, "test_pingpong_streaming", client_args, server_args);
  grpc_call* c;
  grpc_call* s;
...
void stream_compression_ping_pong_streaming(
