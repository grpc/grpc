...
static void test_request_response_with_metadata_and_payload(
  ...
  GPR_ASSERT(contains_metadata(request_metadata_recv,
                               request_metadata_recv_count, "key1", "val1"));
  GPR_ASSERT(contains_metadata(request_metadata_recv,
                               request_metadata_recv_count, "key2", "val2"));
  GPR_ASSERT(contains_metadata(initial_metadata_recv,
                               initial_metadata_recv_count, "key3", "val3"));
  GPR_ASSERT(contains_metadata(initial_metadata_recv,
                               initial_metadata_recv_count, "key4", "val4"));
