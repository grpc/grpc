...
static void
test_cancel_after_round_trip (grpc_end2end_test_config config,
...
void
cancel_after_round_trip (grpc_end2end_test_config config)
{
  unsigned i;
...
void
cancel_after_round_trip_pre_init (void)
{
}
