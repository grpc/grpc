...
// initialize the call.
static void
test_server_channel_filter (grpc_end2end_test_config config)
{
  grpc_call *c;
  grpc_call *s;
...
static void
test_client_channel_filter (grpc_end2end_test_config config)
{
  grpc_call *c;
  grpc_slice request_payload_slice =
    grpc_slice_from_copied_string ("hello world");
...
// initialize the call.
static void
test_client_subchannel_filter (grpc_end2end_test_config config)
{
  grpc_call *c;
  grpc_slice request_payload_slice =
    grpc_slice_from_copied_string ("hello world");
...
init_call_elem (grpc_call_element * elem, const grpc_call_element_args * args)
{
  return
    grpc_error_set_int (GRPC_ERROR_CREATE_FROM_STATIC_STRING
			("access denied"), GRPC_ERROR_INT_GRPC_STATUS,
...
static bool
maybe_add_server_channel_filter (grpc_channel_stack_builder * builder,
				 void *arg)
{
  if (g_enable_server_channel_filter)
	...
	grpc_channel_stack_builder_create_iterator_at_last (builder);
      ...
      const bool retval =
	grpc_channel_stack_builder_add_filter_before (it, &test_filter,
						      nullptr, nullptr);
...
static bool
maybe_add_client_channel_filter (grpc_channel_stack_builder * builder,
				 void *arg)
{
...
static bool
maybe_add_client_subchannel_filter (grpc_channel_stack_builder * builder,
				    void *arg)
{
...
void
filter_call_init_fails (grpc_end2end_test_config config)
{
...
void
filter_call_init_fails_pre_init (void)
{
