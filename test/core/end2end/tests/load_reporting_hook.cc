...
extern void (*g_load_reporting_fn) (const grpc_load_reporting_call_data *
				    call_data);

static void
test_load_reporting_hook (grpc_end2end_test_config config)
{
...
void
load_reporting_hook (grpc_end2end_test_config config)
{
  test_load_reporting_hook (config);
}

void
load_reporting_hook_pre_init (void)
{
}
