...
static void
test_invoke_network_status_change (grpc_end2end_test_config config)
{
  grpc_call *c;
  grpc_call *s;
...
void
network_status_change (grpc_end2end_test_config config)
{
...
void
network_status_change_pre_init (void)
{
}
