				...
				grpc_metadata * client_metadata)
{
							...
							GRPC_STREAM_COMPRESS_NONE);
  {
    ...
    server_args =
      grpc_channel_args_stream_compression_algorithm_set_state (&server_args,
								algorithm_to_disable,
								false);
  }
  ...
  GPR_ASSERT (grpc_stream_compression_algorithm_name
...
request_with_payload_template (grpc_end2end_test_config config,
			       ...
			       grpc_stream_compression_algorithm
			       expected_client_compression_algorithm,
			       grpc_stream_compression_algorithm
			       expected_server_compression_algorithm,
			       ...
			       bool
			       set_default_server_message_compression_algorithm,
			       grpc_compression_algorithm
			       default_server_message_compression_algorithm)
{
  grpc_call *c;
  grpc_call *s;
  grpc_slice request_payload_slice;
  ...
  GPR_ASSERT (GPR_BITCOUNT
	      (grpc_call_test_only_get_stream_encodings_accepted_by_peer (s))
...
{
  request_with_payload_template (config, "test_invoke_request_with_compressed_payload", 0, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, nullptr, false,	/* ignored */
				 GRPC_STREAM_COMPRESS_LEVEL_NONE, false,
...
{
  request_with_payload_template (config, "test_invoke_request_with_send_message_before_initial_metadata", 0, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, nullptr, false,	/* ignored */
				 GRPC_STREAM_COMPRESS_LEVEL_NONE, true, false,
				 GRPC_COMPRESS_NONE);
}
  ...
  (grpc_end2end_test_config config)
{
  ...
  request_with_payload_template (config,
				 ...
				 0, GRPC_STREAM_COMPRESS_NONE,
				 GRPC_STREAM_COMPRESS_NONE,
				 GRPC_STREAM_COMPRESS_GZIP,
				 GRPC_STREAM_COMPRESS_NONE,
				 &gzip_compression_override, false,
				 /*ignored */ GRPC_STREAM_COMPRESS_LEVEL_NONE,
				 false, false,
				 GRPC_COMPRESS_NONE);
...
static void
test_stream_compression_override_message_compression (grpc_end2end_test_config
						      config)
{
  grpc_stream_compression_level level = GRPC_STREAM_COMPRESS_LEVEL_MED;
  request_with_payload_template (config,
				 "test_stream_compression_override_message_compression",
				 0, GRPC_STREAM_COMPRESS_NONE,
				 GRPC_STREAM_COMPRESS_NONE,
				 GRPC_STREAM_COMPRESS_NONE,
				 ...
				 (level,
				  (1u <<
				   GRPC_STREAM_COMPRESS_ALGORITHMS_COUNT) -
				  1),
				 /* ignored */ nullptr, true, level, false,
				 true, GRPC_COMPRESS_GZIP);
}

void
stream_compression_compressed_payload (grpc_end2end_test_config config)
{
...
void
stream_compression_compressed_payload_pre_init (void)
{
}
