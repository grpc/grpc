...
static void test_early_server_shutdown_finishes_inflight_calls(
  ...
  /* Make sure we don't shutdown the server while HTTP/2 PING frames are
   * still being exchanged on the newly established connection. It can
   * lead to failures when testing with HTTP proxy. See
