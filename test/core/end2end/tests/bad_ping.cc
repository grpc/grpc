...
static void
test_bad_ping (grpc_end2end_test_config config)
{
  ...
  server_a[0].key =
    const_cast <
    char *>(GRPC_ARG_HTTP2_MIN_RECV_PING_INTERVAL_WITHOUT_DATA_MS);
...
void
bad_ping (grpc_end2end_test_config config)
{
