...
#define SERVER_END_BASE_TAG 0x4000
  ...
  grpc_call** client_calls =
      reinterpret_cast<grpc_call**>(malloc(sizeof(grpc_call*) * NUM_CALLS));
  grpc_call** server_calls =
      reinterpret_cast<grpc_call**>(malloc(sizeof(grpc_call*) * NUM_CALLS));
  grpc_metadata_array* initial_metadata_recv =
      reinterpret_cast<grpc_metadata_array*>(
  ...
  grpc_metadata_array* request_metadata_recv =
      reinterpret_cast<grpc_metadata_array*>(
          malloc(sizeof(grpc_metadata_array) * NUM_CALLS));
  grpc_call_details* call_details = reinterpret_cast<grpc_call_details*>(
      malloc(sizeof(grpc_call_details) * NUM_CALLS));
  grpc_status_code* status = reinterpret_cast<grpc_status_code*>(
      malloc(sizeof(grpc_status_code) * NUM_CALLS));
  grpc_slice* details =
      reinterpret_cast<grpc_slice*>(malloc(sizeof(grpc_slice) * NUM_CALLS));
  grpc_byte_buffer** request_payload = reinterpret_cast<grpc_byte_buffer**>(
      malloc(sizeof(grpc_byte_buffer*) * NUM_CALLS));
  grpc_byte_buffer** request_payload_recv =
      reinterpret_cast<grpc_byte_buffer**>(
          malloc(sizeof(grpc_byte_buffer*) * NUM_CALLS));
  int* was_cancelled = reinterpret_cast<int*>(malloc(sizeof(int) * NUM_CALLS));
