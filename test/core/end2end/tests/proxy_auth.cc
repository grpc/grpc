...
static void
test_invoke_proxy_auth (grpc_end2end_test_config config)
{
  ...
  client_arg.value.string =
    const_cast < char *>(GRPC_TEST_HTTP_PROXY_AUTH_CREDS);
...
void
proxy_auth (grpc_end2end_test_config config)
{
  test_invoke_proxy_auth (config);
}

void
proxy_auth_pre_init (void)
{
}
