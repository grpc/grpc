...
TEST_P(HpackSizeTest, Encode0Decode0) { HpackSize(*this, 0, 0); }
TEST_P(HpackSizeTest, Encode0Decode100) { HpackSize(*this, 0, 100); }
TEST_P(HpackSizeTest, Encode0Decode1000) { HpackSize(*this, 0, 1000); }
TEST_P(HpackSizeTest, Encode0Decode4096) { HpackSize(*this, 0, 4096); }
TEST_P(HpackSizeTest, Encode0Decode32768) { HpackSize(*this, 0, 32768); }
TEST_P(HpackSizeTest, Encode0Decode4194304) { HpackSize(*this, 0, 4194304); }
TEST_P(HpackSizeTest, Encode100Decode0) { HpackSize(*this, 100, 0); }
TEST_P(HpackSizeTest, Encode100Decode100) { HpackSize(*this, 100, 100); }
TEST_P(HpackSizeTest, Encode100Decode1000) { HpackSize(*this, 100, 1000); }
TEST_P(HpackSizeTest, Encode100Decode4096) { HpackSize(*this, 100, 4096); }
TEST_P(HpackSizeTest, Encode100Decode32768) { HpackSize(*this, 100, 32768); }
TEST_P(HpackSizeTest, Encode100Decode4194304) {
  HpackSize(*this, 100, 4194304);
}
TEST_P(HpackSizeTest, Encode1000Decode0) { HpackSize(*this, 1000, 0); }
TEST_P(HpackSizeTest, Encode1000Decode100) { HpackSize(*this, 1000, 100); }
TEST_P(HpackSizeTest, Encode1000Decode1000) { HpackSize(*this, 1000, 1000); }
TEST_P(HpackSizeTest, Encode1000Decode4096) { HpackSize(*this, 1000, 4096); }
TEST_P(HpackSizeTest, Encode1000Decode32768) { HpackSize(*this, 1000, 32768); }
TEST_P(HpackSizeTest, Encode1000Decode4194304) {
  HpackSize(*this, 1000, 4194304);
}
TEST_P(HpackSizeTest, Encode4096Decode0) { HpackSize(*this, 4096, 0); }
TEST_P(HpackSizeTest, Encode4096Decode100) { HpackSize(*this, 4096, 100); }
TEST_P(HpackSizeTest, Encode4096Decode1000) { HpackSize(*this, 4096, 1000); }
TEST_P(HpackSizeTest, Encode4096Decode4096) { HpackSize(*this, 4096, 4096); }
TEST_P(HpackSizeTest, Encode4096Decode32768) { HpackSize(*this, 4096, 32768); }
TEST_P(HpackSizeTest, Encode4096Decode4194304) {
  HpackSize(*this, 4096, 4194304);
}
TEST_P(HpackSizeTest, Encode32768Decode0) { HpackSize(*this, 32768, 0); }
TEST_P(HpackSizeTest, Encode32768Decode100) { HpackSize(*this, 32768, 100); }
TEST_P(HpackSizeTest, Encode32768Decode1000) { HpackSize(*this, 32768, 1000); }
TEST_P(HpackSizeTest, Encode32768Decode4096) { HpackSize(*this, 32768, 4096); }
TEST_P(HpackSizeTest, Encode32768Decode32768) {
  HpackSize(*this, 32768, 32768);
}
TEST_P(HpackSizeTest, Encode32768Decode4194304) {
  HpackSize(*this, 32768, 4194304);
}
TEST_P(HpackSizeTest, Encode4194304Decode0) { HpackSize(*this, 4194304, 0); }
TEST_P(HpackSizeTest, Encode4194304Decode100) {
  HpackSize(*this, 4194304, 100);
}
TEST_P(HpackSizeTest, Encode4194304Decode1000) {
  HpackSize(*this, 4194304, 1000);
}
TEST_P(HpackSizeTest, Encode4194304Decode4096) {
  HpackSize(*this, 4194304, 4096);
}
TEST_P(HpackSizeTest, Encode4194304Decode32768) {
  HpackSize(*this, 4194304, 32768);
}
TEST_P(HpackSizeTest, Encode4194304Decode4194304) {
