...
// Client streaming test where the client sends a bunch of messages and
// the server reads them. After reading some messages, the server sends
// the status. Client writes fail after that due to the end of stream
// and the client subsequently requests and receives the status.
