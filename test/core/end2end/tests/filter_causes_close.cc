...
static void
recv_im_ready (void *arg, grpc_error * error)
{
  grpc_call_element *elem = (grpc_call_element *) arg;
  call_data *calld = (call_data *) elem->call_data;
  GRPC_CLOSURE_RUN (calld->recv_im_ready,
		    grpc_error_set_int
...
void
filter_causes_close (grpc_end2end_test_config config)
{
...
void
filter_causes_close_pre_init (void)
{
