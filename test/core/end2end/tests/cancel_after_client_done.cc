...
static void test_cancel_after_accept_and_writes_closed(grpc_end2end_test_config config,
  ...
  grpc_call* s;
  grpc_end2end_test_fixture f =
      begin_test(config, "test_cancel_after_accept_and_writes_closed", mode, nullptr, nullptr);
