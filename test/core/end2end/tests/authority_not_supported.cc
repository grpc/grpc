...
static void
test_with_authority_header (grpc_end2end_test_config config)
{
  grpc_call *c;
...
void
authority_not_supported (grpc_end2end_test_config config)
{
...
void
authority_not_supported_pre_init (void)
{
}
