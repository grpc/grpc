...
TEST_F(PartyTest, Test17SpawnedPromises) {
  ...
  party->Spawn("p16_initial", Immediate(Empty{}),
               [&p16_initial_completed](const Empty) {
  ...
  party->Spawn(
      ...
      [&p16_completed](const Empty) { p16_completed.Notify(); });
  ...
  party->Spawn("p17", Immediate(Empty{}),
               [&p17_completed](const Empty) { p17_completed.Notify(); });
