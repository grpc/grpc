...
TEST(StatusConversionTest, TestHttp2ErrorToGrpcStatus) {
  ...
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kNoError, before_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kProtocolError, before_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kInternalError, before_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kFlowControlError,
                              before_deadline, GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kSettingsTimeout, before_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kStreamClosed, before_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kFrameSizeError, before_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kRefusedStream, before_deadline,
                              GRPC_STATUS_UNAVAILABLE);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kCancel, before_deadline,
                              GRPC_STATUS_CANCELLED);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kCompressionError,
                              before_deadline, GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kConnectError, before_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kEnhanceYourCalm, before_deadline,
                              GRPC_STATUS_RESOURCE_EXHAUSTED);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kInadequateSecurity,
                              before_deadline, GRPC_STATUS_PERMISSION_DENIED);

  const grpc_core::Timestamp after_deadline;
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kNoError, after_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kProtocolError, after_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kInternalError, after_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kFlowControlError, after_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kSettingsTimeout, after_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kStreamClosed, after_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kFrameSizeError, after_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kRefusedStream, after_deadline,
                              GRPC_STATUS_UNAVAILABLE);
  ...
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kCancel, after_deadline,
                              GRPC_STATUS_DEADLINE_EXCEEDED);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kCompressionError, after_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kConnectError, after_deadline,
                              GRPC_STATUS_INTERNAL);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kEnhanceYourCalm, after_deadline,
                              GRPC_STATUS_RESOURCE_EXHAUSTED);
  http2_status_TO_GRPC_STATUS(Http2ErrorCode::kInadequateSecurity,
