...
class NoOpWritableParcel implements WritableParcel {
 public:
...
class BinderForFuzzing implements Binder {
 public:
...
class ReadableParcelForFuzzing implements ReadableParcel {
 public:
...
class TransactionReceiverForFuzzing implements TransactionReceiver {
 public:
