...
/* verify that the output generated by encoding the stream matches the
   hexstring passed in */
static void
verify (const verify_params params, const char *expected,
	size_t nheaders, ...)
{
...
test_basic_headers ()
{
  ...
  verify (params, "000001 0104 deadbeef be", 1, "a", "a");
  verify (params, "000006 0104 deadbeef be 40 0162 0163", 2, "a", "a", "b",
	  "c");
  ...
  for (i = 0; i < 350; i++)
    {
      verify (params, "000003 0104 deadbeef c0 bf be", 3, "a", "a", "b", "c",
	      "a", "d");
    }

  verify (params, "000006 0104 deadbeef c0 00 016b 0176", 2, "a", "a", "k",
	  "v");
...
test_decode_table_overflow ()
{
  ...
  for (i = 0; i < 114; i++)
	...
	{
	  gpr_asprintf (&expect,
			"000007 0104 deadbeef 40 02%02x%02x 02%02x%02x",
...
static void
verify_table_size_change_match_elem_size (const char *key,
					  const char *value,
  ...
  grpc_mdelem elem =
    grpc_mdelem_from_slices (grpc_slice_intern
			     ...
			     grpc_slice_intern (grpc_slice_from_static_string
						(value)));
  size_t elem_size =
    grpc_mdelem_get_size_in_hpack_table (elem, use_true_binary);
...
test_interned_key_indexed ()
{
  ...
  for (i = 0; i < 10; i++)
    {
      verify (params, "000008 0104 deadbeef 0f2f 0162 0f2f 0163", 2, "a", "b",
	      "a", "c");
    }
}
