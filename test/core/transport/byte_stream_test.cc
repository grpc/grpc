...
static void
not_called_closure (void *arg, grpc_error * error)
{
  GPR_ASSERT (false);
}

static void
test_slice_buffer_stream_basic (void)
{
...
static void
test_slice_buffer_stream_shutdown (void)
{
...
static void
test_caching_byte_stream_basic (void)
{
...
static void
test_caching_byte_stream_reset (void)
{
...
static void
test_caching_byte_stream_shared_cache (void)
{
