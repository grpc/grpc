...
void
set_arg_once_fn (grpc_channel_stack * channel_stack,
...
static void
test_channel_stack_builder_filter_replace (void)
{
...
static bool
add_replacement_filter (grpc_channel_stack_builder * builder, void *arg)
{
  const grpc_channel_filter *filter =
    static_cast < const grpc_channel_filter * >(arg);
  // Get rid of any other version of the filter, as determined by having the
  // same name.
  GPR_ASSERT (grpc_channel_stack_builder_remove_filter
	      (builder, filter->name));
...
static bool
add_original_filter (grpc_channel_stack_builder * builder, void *arg)
{
