...
static grpc_error *
channel_init_func (grpc_channel_element * elem,
...
static grpc_error *
call_init_func (grpc_call_element * elem, const grpc_call_element_args * args)
{
...
static void
channel_destroy_func (grpc_channel_element * elem)
{
}

static void
call_destroy_func (grpc_call_element * elem,
...
static void
call_func (grpc_call_element * elem, grpc_transport_stream_op_batch * op)
{
  ++*(int *) (elem->call_data);
}

static void
channel_func (grpc_channel_element * elem, grpc_transport_op * op)
{
  ++*(int *) (elem->channel_data);
}

static void
free_channel (void *arg, grpc_error * error)
{
...
static void
free_call (void *arg, grpc_error * error)
{
...
test_create_channel_stack (void)
{
  ...
  call_stack =
    static_cast <
    grpc_call_stack * >(gpr_malloc (channel_stack->call_stack_size));
