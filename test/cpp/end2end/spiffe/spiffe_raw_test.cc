...
class SpiffeRawEnd2EndTest : public ::testing::Test {
 protected:
  SpiffeRawEnd2EndTest() {}
...
TEST_F(SpiffeRawEnd2EndTest, PureAsyncService) {
...
TEST_F(SpiffeRawEnd2EndTest, RawServerUnary) {
...
TEST_F(SpiffeRawEnd2EndTest, RawServerClientStreaming) {
...
TEST_F(SpiffeRawEnd2EndTest, RawServerServerStreaming) {
...
TEST_F(SpiffeRawEnd2EndTest, RawServerBidiStreaming) {
...
TEST_F(SpiffeRawEnd2EndTest, CompileTest) {
  typedef grpc::testing::EchoTestService::WithRawMethod_Echo<
