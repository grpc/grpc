  ...
  grpc
{
    ...
    testing
  {
	...
	ChannelData
      ...
      public:
	grpc_error *
	Init (grpc_channel_element * elem, grpc_channel_element_args * args)
	{
	  IncrementConnectionCounter ();
	  return
	    GRPC_ERROR_NONE;
...
// One ping, one pong.
	...
	EXPECT_EQ (1, GetConnectionCounterValue ());
      ...
      RegisterFilter ()
      {
	grpc::RegisterChannelFilter < ChannelDataImpl,
	  CallDataImpl > ("test-filter", GRPC_SERVER_CHANNEL, INT_MAX,
			  nullptr);
      }
