...
TEST_P(RingHashTest, NoHashPolicy) {
  ...
  // optimization.
  WaitForAllBackends(DEBUG_LOCATION, 0, 2, /*check_status=*/nullptr, WaitForBackendOptions(),
...
TEST_P(RingHashTest, TransientFailureSkipToAvailableReady) {
  ...
  WaitForBackend(DEBUG_LOCATION, 1, /*check_status=*/nullptr, WaitForBackendOptions(), rpc_options);
