...
// Client uses proto, server uses generic codegen request, unary
TEST_F(CodegenGenericEnd2EndTest, CodegenGenericRequestServerUnary) {
  typedef grpc::testing::EchoTestService::WithCodegenGenericRequestMethod_Echo<
      grpc::testing::EchoTestService::Service>
      SType;
  ResetStub();
  auto service = BuildAndStartServer<SType>();
...
// Client uses proto, server uses generic codegen request, client streaming
TEST_F(CodegenGenericEnd2EndTest, CodegenGenericRequestServerClientStreaming) {
  typedef grpc::testing::EchoTestService::
      WithCodegenGenericRequestMethod_RequestStream<
          grpc::testing::EchoTestService::Service>
          SType;
  ResetStub();
  auto service = BuildAndStartServer<SType>();

  grpc::ServerAsyncReader<EchoResponse, ByteBuffer> srv_stream(&srv_ctx_);
  ...
  ParseFromByteBuffer(&recv_request_buffer_, &recv_request_);
  send_response_.set_message(recv_request_.message());
  srv_stream.Finish(send_response_, Status::OK, tag(9));
  cli_stream->Finish(&recv_status_, tag(10));
  Verifier().Expect(9, true).Expect(10, true).Verify(cq_.get());
...
// Client uses proto, server uses generic codegen request, server streaming
TEST_F(CodegenGenericEnd2EndTest, CodegenGenericRequestServerServerStreaming) {
  typedef grpc::testing::EchoTestService::
      WithCodegenGenericRequestMethod_ResponseStream<
          grpc::testing::EchoTestService::Service>
          SType;
  ResetStub();
  auto service = BuildAndStartServer<SType>();
  grpc::ServerAsyncWriter<EchoResponse> srv_stream(&srv_ctx_);
  ...
  send_response_.set_message(recv_request_.message());
  srv_stream.Write(send_response_, tag(3));
  cli_stream->Read(&recv_response_, tag(4));
  Verifier().Expect(3, true).Expect(4, true).Verify(cq_.get());
  EXPECT_EQ(send_response_.message(), recv_response_.message());

  srv_stream.Write(send_response_, tag(5));
  cli_stream->Read(&recv_response_, tag(6));
  Verifier().Expect(5, true).Expect(6, true).Verify(cq_.get());
  EXPECT_EQ(send_response_.message(), recv_response_.message());
...
// Client uses proto, server uses generic codegen request, bidi streaming
TEST_F(CodegenGenericEnd2EndTest, CodegenGenericRequestServerBidiStreaming) {
  typedef grpc::testing::EchoTestService::
      WithCodegenGenericRequestMethod_BidiStream<
          grpc::testing::EchoTestService::Service>
          SType;
  ResetStub();
  auto service = BuildAndStartServer<SType>();

  grpc::ServerAsyncReaderWriter<EchoResponse, ByteBuffer> srv_stream(&srv_ctx_);
...
// Client uses proto, server uses generic response codegen, unary
TEST_F(CodegenGenericEnd2EndTest, CodegenGenericReponseServerUnary) {
  typedef grpc::testing::EchoTestService::WithCodegenGenericResponseMethod_Echo<
      grpc::testing::EchoTestService::Service>
      SType;
  ResetStub();
  auto service = BuildAndStartServer<SType>();
...
// Client uses proto, server uses generic response codegen, client streaming
TEST_F(CodegenGenericEnd2EndTest, CodegenGenericResponseServerClientStreaming) {
  typedef grpc::testing::EchoTestService::
      WithCodegenGenericResponseMethod_RequestStream<
          grpc::testing::EchoTestService::Service>
          SType;
  ResetStub();
  auto service = BuildAndStartServer<SType>();

  grpc::ServerAsyncReader<ByteBuffer, EchoRequest> srv_stream(&srv_ctx_);
  ...
  cli_stream->Write(send_request_, tag(3));
  srv_stream.Read(&recv_request_, tag(4));
  Verifier().Expect(3, true).Expect(4, true).Verify(cq_.get());
  EXPECT_EQ(send_request_.message(), recv_request_.message());

  cli_stream->Write(send_request_, tag(5));
  srv_stream.Read(&recv_request_, tag(6));
  Verifier().Expect(5, true).Expect(6, true).Verify(cq_.get());

  EXPECT_EQ(send_request_.message(), recv_request_.message());
  cli_stream->WritesDone(tag(7));
  srv_stream.Read(&recv_request_, tag(8));
  Verifier().Expect(7, true).Expect(8, false).Verify(cq_.get());
...
// Client uses proto, server uses generic response codegen, server streaming
TEST_F(CodegenGenericEnd2EndTest, CodegenGenericResponseServerServerStreaming) {
  typedef grpc::testing::EchoTestService::
      WithCodegenGenericMethod_ResponseStream<
          grpc::testing::EchoTestService::Service>
          SType;
...
// Client uses proto, server uses generic response codegen, bidi streaming
TEST_F(CodegenGenericEnd2EndTest, CodegenGenericResponseServerBidiStreaming) {
  typedef grpc::testing::EchoTestService::
      WithCodegenGenericResponseMethod_BidiStream<
          grpc::testing::EchoTestService::Service>
          SType;
  ResetStub();
  auto service = BuildAndStartServer<SType>();

  grpc::ServerAsyncReaderWriter<ByteBuffer, EchoRequest> srv_stream(&srv_ctx_);
