  ...
  grpc
{
    ...
    testing
  {
    ...
    public:
      ...
      Status
      Echo (ServerContext * context, const EchoRequest * request,
	...
	GPR_ASSERT (shutdown_);
      ...
      {
	string
	  target = "dns:localhost:" + to_string (port_);
	ChannelArguments
	  args;
	auto
	  channel_creds =
				 ...
				 nullptr) != nullptr)
	{
      ...
      auto
	sec_list = GetCredentialsProvider ()->GetSecureCredentialsTypeList ();
    ...
    INSTANTIATE_TEST_CASE_P (End2EndShutdown,
			     ShutdownTest,::testing::
			     ValuesIn (GetAllCredentialsTypeList ()));
