...
inline std::function<void(std::string)> g_print_fn = PrintStdout;

// Returns the print function. Not thread-safe.
inline std::function<void(std::string)> GetPrintFn() { return g_print_fn; }

// Sets the print function. Not thread-safe.
inline void SetPrintFn(std::function<void(std::string)> p) {
  g_print_fn = std::move(p);
}
