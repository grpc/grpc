...
static void
get_resource_usage (double *utime, double *stime)
{
#ifdef __linux__
  struct rusage usage;
...
static void
get_cpu_usage (unsigned long long *total_cpu_time,
...
UsageTimer::Result UsageTimer::Mark () constconst
{
  Result
    s = Sample ();
  Result
