...
// Find method and associated request/response types.
    ...
    public:
      ...
      // used as the argument of Stub::Call()
        ...
        grpc::string GetSerializedProtoFromMethod (const grpc::
						   string & method,
						   const grpc::
						   string & text_format_proto,
						   bool is_request);
        ...
        grpc::string GetSerializedProtoFromMessageType (const grpc::
							string &
							message_type_name,
							const grpc::
							string &
        ...
        grpc::string GetTextFormatFromMessageType (const grpc::
