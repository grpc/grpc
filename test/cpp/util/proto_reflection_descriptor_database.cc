  ...
  grpc
{
  ...
  ProtoReflectionDescriptorDatabase::ProtoReflectionDescriptorDatabase (std::
									unique_ptr
									<
									ServerReflection::
									Stub >
  ...
  bool
  ProtoReflectionDescriptorDatabase::FindFileByName (const string & filename,
						     protobuf::
						     FileDescriptorProto *
						     output)
  {
	...
	gpr_log (GPR_INFO,
		 ...
		 filename.c_str (),
		 ServerReflectionResponse::MessageResponseCase::
		 kFileDescriptorResponse, response.message_response_case ());
      }
  ...
  ProtoReflectionDescriptorDatabase::
    FindFileContainingSymbol (const string & symbol_name,
				 ...
				 protobuf::FileDescriptorProto * output)
  {
    ...
    request.mutable_file_containing_extension ()->
      set_containing_type (containing_type);
    request.mutable_file_containing_extension ()->
    ...
    return cached_db_.FindFileContainingExtension (containing_type,
						   field_number, output);
  }

  bool
  ProtoReflectionDescriptorDatabase::
    FindAllExtensionNumbers (const string & extendee_type,
			     std::vector < int >*output)
  {
	...
	*output = cached_extension_numbers_[extendee_type];
    ...
    if (response.message_response_case () ==
	ServerReflectionResponse::
	MessageResponseCase::kAllExtensionNumbersResponse)
      {
	auto
	  number =
  ...
  bool
  ProtoReflectionDescriptorDatabase::GetServices (std::vector < grpc::string >
						  *output)
  {
    ServerReflectionRequest
      request;
	...
	const ListServiceResponse
	  ls_response = response.list_services_response ();
	...
	gpr_log (GPR_INFO,
		 ...
		 ServerReflectionResponse::MessageResponseCase::
		 kListServicesResponse, response.message_response_case ());
      }
    return false;
  }
  ...
  ProtoReflectionDescriptorDatabase::
    ParseFileDescriptorProtoResponse (const grpc::string & byte_fd_proto)
  {
  ...
  void
  ProtoReflectionDescriptorDatabase::AddFileFromResponse (const grpc::
							  reflection::
							  v1alpha::
  ...
  const
    std::shared_ptr <
    ProtoReflectionDescriptorDatabase::ClientStream >
