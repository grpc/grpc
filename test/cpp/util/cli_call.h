...
// and thread-unsafe methods should not be used together.
    ...
    {
    public:
      typedef std::multimap < grpc::string,
	grpc::string > OutgoingMetadataContainer;
      typedef std::multimap < grpc::string_ref,
	grpc::string_ref > IncomingMetadataContainer;

        CliCall (std::shared_ptr < grpc::Channel > channel,
      ...
      bool ReadAndMaybeNotifyWrite (grpc::string * response,
				    IncomingMetadataContainer *
