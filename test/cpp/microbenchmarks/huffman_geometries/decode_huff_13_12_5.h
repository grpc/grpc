...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit22(size_t, size_t emit) { return emit + 192; }
  static inline uint64_t GetOp23(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit23(size_t, size_t emit) { return emit + 200; }
  ...
  static inline uint64_t GetEmit26(size_t, size_t emit) { return emit + 218; }
  ...
  static inline uint64_t GetEmit28(size_t, size_t emit) { return emit + 242; }
  ...
  static inline uint64_t GetEmit31(size_t, size_t emit) { return emit + 245; }
