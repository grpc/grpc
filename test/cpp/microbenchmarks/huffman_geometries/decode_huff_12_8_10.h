...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetOp44(size_t i) {
    return table44_ops_[i >> 8][i & 0xff];
  }
  static inline uint64_t GetEmit44(size_t i, size_t emit) {
    return table44_emit_[i >> 8][emit];
  }
 ...
 private:
  ...
  static const uint8_t table44_0_ops_[256];
  static const uint8_t table44_1_ops_[256];
  static const uint8_t* const table44_emit_[2];
  static const uint8_t* const table44_ops_[2];
