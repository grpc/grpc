...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_12_8_10_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_12_8_10_H
#include <grpc/support/port_platform.h>

#include <cstddef>
#include <cstdint>
namespace grpc_core {
namespace geometry_12_8_10 {
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit21(size_t, size_t emit) { return emit + 176; }
  ...
  static inline uint64_t GetEmit23(size_t, size_t emit) { return emit + 216; }
  ...
  static inline uint64_t GetOp31(size_t i) { return table31_0_inner_[i]; }
  static inline uint64_t GetEmit31(size_t, size_t emit) {
    return table31_0_emit_[emit];
  }
  static inline uint64_t GetOp32(size_t i) { return table31_0_inner_[i]; }
  static inline uint64_t GetEmit32(size_t, size_t emit) {
    return table32_0_emit_[emit];
  }
  static inline uint64_t GetOp33(size_t i) { return table31_0_inner_[i]; }
  ...
  static inline uint64_t GetOp43(size_t i) {
    return table43_ops_[i >> 7][i & 0x7f];
  }
  static inline uint64_t GetEmit43(size_t i, size_t emit) {
    return table43_emit_[i >> 7][emit];
  }
  static inline uint64_t GetOp44(size_t i) {
    return table44_ops_[i >> 6][i & 0x3f];
  }
  static inline uint64_t GetEmit44(size_t i, size_t emit) {
    return table44_emit_[i >> 6][emit];
  }
 ...
 private:
  ...
  static const uint8_t table12_2_emit_[1];
  static const uint8_t table12_4_emit_[1];
  static const uint16_t table12_4_ops_[32];
  static const uint8_t table12_5_emit_[1];
  static const uint8_t table12_6_emit_[1];
  static const uint8_t table12_7_emit_[11];
  static const uint16_t table12_7_ops_[32];
  ...
  static const uint8_t table31_0_inner_[8];
  static const uint8_t table32_0_emit_[8];
  static const uint8_t table33_0_emit_[8];
  static const uint8_t table37_0_emit_[5];
  static const uint8_t table37_0_inner_[6];
  static const uint8_t table36_0_emit_[11];
  static const uint8_t table36_0_inner_[11];
  static const uint8_t table39_0_emit_[6];
  static const uint8_t table39_0_inner_[8];
  static const uint8_t table40_0_emit_[10];
  static const uint8_t table40_0_ops_[32];
  static const uint8_t table41_0_emit_[25];
  static const uint8_t table41_0_ops_[64];
  static const uint8_t table42_0_emit_[44];
  static const uint8_t table42_0_ops_[128];
  static const uint8_t table43_0_ops_[128];
  static const uint8_t table43_1_emit_[63];
  static const uint8_t table43_1_ops_[128];
  static const uint8_t* const table43_emit_[2];
  static const uint8_t* const table43_ops_[2];
  static const uint8_t table44_0_emit_[40];
  static const uint8_t table44_0_ops_[64];
  static const uint8_t table44_1_emit_[40];
  static const uint8_t table44_2_emit_[40];
  static const uint8_t table44_3_emit_[4];
  static const uint8_t table44_4_emit_[8];
  static const uint8_t table44_5_emit_[9];
  static const uint8_t table44_5_ops_[64];
  static const uint8_t table44_6_emit_[16];
  static const uint8_t table44_6_ops_[64];
  static const uint8_t table44_7_emit_[30];
  static const uint8_t table44_7_ops_[64];
  static const uint8_t* const table44_emit_[8];
  static const uint8_t* const table44_ops_[8];
  static const uint8_t table38_0_emit_[1];
  static const uint16_t table38_0_ops_[64];
  static const uint8_t table38_1_emit_[1];
  static const uint8_t table38_2_emit_[1];
  static const uint8_t table38_3_emit_[1];
  static const uint8_t table38_4_emit_[1];
  static const uint8_t table38_5_emit_[1];
  static const uint8_t table38_6_emit_[2];
  static const uint16_t table38_6_ops_[64];
  static const uint8_t table38_7_emit_[2];
  static const uint8_t table38_8_emit_[4];
  static const uint16_t table38_8_ops_[64];
  static const uint8_t table38_9_emit_[4];
  static const uint8_t table38_10_emit_[4];
  static const uint8_t table38_11_emit_[5];
  static const uint16_t table38_11_ops_[64];
  static const uint8_t table38_12_emit_[8];
  static const uint16_t table38_12_ops_[64];
  static const uint8_t table38_13_emit_[8];
  static const uint8_t table38_14_emit_[15];
  static const uint16_t table38_14_ops_[64];
  static const uint8_t table38_15_emit_[18];
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_12_8_10_H
