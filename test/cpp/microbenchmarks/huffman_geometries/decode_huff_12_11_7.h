...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_12_11_7_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_12_11_7_H
#include <grpc/support/port_platform.h>

#include <cstddef>
#include <cstdint>
namespace grpc_core {
namespace geometry_12_11_7 {
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit23(size_t, size_t emit) { return emit + 144; }
  ...
  static inline uint64_t GetEmit27(size_t, size_t emit) { return emit + 236; }
  ...
  static inline uint64_t GetOp35(size_t i) {
    return table35_0_inner_[(i < 13 ? (i / 2 + 0) : ((i - 13) + 6))];
  }
 ...
 private:
  ...
  static const uint16_t table12_8_ops_[128];
  static const uint8_t table12_14_emit_[15];
  static const uint16_t table12_14_ops_[128];
  static const uint8_t table12_15_emit_[64];
  static const uint16_t table12_15_ops_[128];
  ...
  static const uint8_t table30_0_emit_[16];
  static const uint8_t table30_0_inner_[16];
  static const uint8_t table33_0_emit_[30];
  static const uint8_t table33_0_ops_[32];
  static const uint8_t table34_0_ops_[64];
  static const uint8_t table31_0_emit_[7];
  static const uint8_t table31_0_ops_[32];
  static const uint8_t table31_1_emit_[8];
  static const uint8_t table31_1_ops_[32];
  static const uint8_t table31_2_emit_[8];
  static const uint8_t table31_3_emit_[10];
  static const uint8_t table31_3_ops_[32];
  static const uint8_t* const table31_emit_[4];
  static const uint8_t* const table31_ops_[4];
  static const uint8_t table36_0_emit_[7];
  static const uint8_t table36_0_inner_[8];
  static const uint8_t table35_0_emit_[9];
  static const uint8_t table35_0_inner_[9];
};
template <typename F>
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_12_11_7_H
