...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_9_14_7_H
...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit24(size_t, size_t emit) { return emit + 144; }
  ...
  static inline uint64_t GetEmit28(size_t, size_t emit) { return emit + 236; }
  ...
  static inline uint64_t GetOp36(size_t i) {
    return table36_0_inner_[(i < 13 ? (i / 2 + 0) : ((i - 13) + 6))];
  }
 ...
 private:
  ...
  static const uint16_t table10_16_ops_[256];
  static const uint16_t table10_32_ops_[256];
  static const uint16_t table10_56_ops_[256];
  static const uint8_t table10_60_emit_[1];
  static const uint16_t table10_60_ops_[256];
  static const uint8_t table10_61_emit_[1];
  static const uint8_t table10_62_emit_[1];
  static const uint8_t table10_63_emit_[79];
  static const uint16_t table10_63_ops_[256];
  ...
  static const uint8_t table31_0_emit_[16];
  static const uint8_t table31_0_inner_[16];
  static const uint8_t table34_0_emit_[30];
  static const uint8_t table34_0_ops_[32];
  static const uint8_t table35_0_ops_[64];
  static const uint8_t table32_0_emit_[7];
  static const uint8_t table32_0_ops_[32];
  static const uint8_t table32_1_emit_[8];
  static const uint8_t table32_1_ops_[32];
  static const uint8_t table32_2_emit_[8];
  static const uint8_t table32_3_emit_[10];
  static const uint8_t table32_3_ops_[32];
  static const uint8_t* const table32_emit_[4];
  static const uint8_t* const table32_ops_[4];
  static const uint8_t table37_0_emit_[7];
  static const uint8_t table37_0_inner_[8];
  static const uint8_t table36_0_emit_[9];
  static const uint8_t table36_0_inner_[9];
};
template <typename F>
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_9_14_7_H
