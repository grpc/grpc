...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit20(size_t, size_t emit) { return emit + 203; }
  static inline uint64_t GetOp21(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit21(size_t, size_t emit) { return emit + 211; }
  ...
  static inline uint64_t GetEmit23(size_t, size_t emit) { return emit + 222; }
  ...
  static inline uint64_t GetEmit25(size_t, size_t emit) { return emit + 245; }
  static inline uint64_t GetOp26(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit26(size_t, size_t emit) { return emit + 247; }
  static inline uint64_t GetOp27(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit27(size_t, size_t emit) { return emit + 250; }
  static inline uint64_t GetOp28(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit28(size_t, size_t emit) { return emit + 252; }
  static inline uint64_t GetOp29(size_t i) {
    return (i < 2 ? (i ? 6 : 2) : ((i - 2) ? 14 : 10));
  }
  static inline uint64_t GetEmit29(size_t, size_t emit) { return emit + 4; }
  ...
  static inline uint64_t GetEmit34(size_t, size_t emit) { return emit + 28; }
  static inline uint64_t GetOp36(size_t i) { return i ? 1 : 2; }
