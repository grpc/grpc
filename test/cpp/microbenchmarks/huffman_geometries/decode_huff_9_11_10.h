...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit22(size_t, size_t emit) { return emit + 176; }
  ...
  static inline uint64_t GetEmit24(size_t, size_t emit) { return emit + 216; }
  ...
  static inline uint64_t GetOp45(size_t i) {
    return table45_ops_[i >> 8][i & 0xff];
  }
  static inline uint64_t GetEmit45(size_t i, size_t emit) {
    return table45_emit_[i >> 8][emit];
  }
 ...
 private:
  ...
  static const uint8_t table45_1_ops_[256];
  static const uint8_t* const table45_emit_[2];
  static const uint8_t* const table45_ops_[2];
