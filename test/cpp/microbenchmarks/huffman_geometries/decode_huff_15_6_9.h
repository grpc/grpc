...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_15_6_9_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_15_6_9_H
#include <grpc/support/port_platform.h>

#include <cstddef>
#include <cstdint>
namespace grpc_core {
namespace geometry_15_6_9 {
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit16(size_t, size_t emit) { return emit + 133; }
  ...
  static inline uint64_t GetEmit23(size_t, size_t emit) { return emit + 185; }
  ...
  static inline uint64_t GetEmit27(size_t, size_t emit) { return emit + 232; }
  ...
  static inline uint64_t GetOp37(size_t i) {
    return table37_0_inner_[(i < 1 ? (((void)i, 0)) : ((i - 1)))];
  }
  ...
  static inline uint64_t GetOp39(size_t i) {
    return table39_ops_[i >> 5][i & 0x1f];
  }
  static inline uint64_t GetEmit39(size_t i, size_t emit) {
    return table39_emit_[i >> 5][emit];
  }
 ...
 private:
  ...
  static const uint8_t table12_0_emit_[24];
  static const uint16_t table12_0_inner_[47];
  static const uint8_t table12_0_outer_[64];
  static const uint8_t table36_0_emit_[6];
  static const uint8_t table36_0_inner_[7];
  static const uint8_t table35_0_emit_[10];
  static const uint8_t table35_0_inner_[10];
  static const uint8_t table37_0_emit_[7];
  static const uint8_t table37_0_inner_[7];
  static const uint8_t table40_0_emit_[15];
  static const uint8_t table40_0_ops_[32];
  static const uint8_t table41_0_emit_[34];
  static const uint8_t table41_0_ops_[64];
  static const uint8_t table42_0_emit_[63];
  static const uint8_t table42_0_ops_[128];
  static const uint8_t table43_0_ops_[256];
  static const uint8_t table39_0_emit_[2];
  static const uint16_t table39_0_ops_[32];
  static const uint8_t table39_1_emit_[2];
  static const uint8_t table39_2_emit_[2];
  static const uint8_t table39_3_emit_[2];
  static const uint8_t table39_4_emit_[2];
  static const uint8_t table39_5_emit_[2];
  static const uint8_t table39_6_emit_[2];
  static const uint8_t table39_7_emit_[3];
  static const uint16_t table39_7_ops_[32];
  static const uint8_t table39_8_emit_[4];
  static const uint16_t table39_8_ops_[32];
  static const uint8_t table39_9_emit_[4];
  static const uint8_t table39_10_emit_[4];
  static const uint8_t table39_11_emit_[4];
  static const uint8_t table39_12_emit_[7];
  static const uint16_t table39_12_ops_[32];
  static const uint8_t table39_13_emit_[8];
  static const uint16_t table39_13_ops_[32];
  static const uint8_t table39_14_emit_[8];
  static const uint8_t table39_15_emit_[10];
  static const uint16_t table39_15_ops_[32];
  static const uint8_t* const table39_emit_[16];
  static const uint16_t* const table39_ops_[16];
};
template <typename F>
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_15_6_9_H
