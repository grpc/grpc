...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_9_8_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_9_8_H
...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit20(size_t, size_t emit) { return emit + 137; }
  static inline uint64_t GetOp21(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit21(size_t, size_t emit) { return emit + 139; }
  ...
  static inline uint64_t GetEmit24(size_t, size_t emit) { return emit + 150; }
  ...
  static inline uint64_t GetEmit26(size_t, size_t emit) { return emit + 157; }
  static inline uint64_t GetOp27(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit27(size_t, size_t emit) { return emit + 165; }
  ...
  static inline uint64_t GetEmit30(size_t, size_t emit) { return emit + 182; }
  ...
  static inline uint64_t GetOp38(size_t i) { return i ? 1 : 2; }
  ...
  static inline uint64_t GetEmit40(size_t, size_t emit) { return emit + 236; }
  static inline uint64_t GetOp39(size_t i) {
    return table39_0_inner_[(i < 3 ? (i / 2 + 0) : ((i - 3) + 1))];
  }
 ...
 private:
  ...
  static const uint8_t table11_3_emit_[50];
  static const uint16_t table11_3_ops_[128];
  static const uint8_t* const table11_emit_[4];
  static const uint16_t* const table11_ops_[4];
  ...
  static const uint8_t table39_0_inner_[6];
  static const uint8_t table42_0_emit_[17];
  static const uint8_t table42_0_ops_[32];
  static const uint8_t table43_0_emit_[46];
  static const uint8_t table43_0_ops_[64];
  static const uint8_t table44_0_ops_[128];
  static const uint8_t table41_0_emit_[4];
  static const uint16_t table41_0_ops_[32];
  static const uint8_t table41_1_emit_[4];
  static const uint8_t table41_2_emit_[4];
  static const uint8_t table41_3_emit_[4];
  static const uint8_t table41_4_emit_[7];
  static const uint16_t table41_4_ops_[32];
  static const uint8_t table41_5_emit_[8];
  static const uint16_t table41_5_ops_[32];
  static const uint8_t table41_6_emit_[8];
  static const uint8_t table41_7_emit_[10];
  static const uint16_t table41_7_ops_[32];
  static const uint8_t* const table41_emit_[8];
  static const uint16_t* const table41_ops_[8];
};
template <typename F>
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_9_8_H
