...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit16(size_t, size_t emit) { return emit + 176; }
  ...
  static inline uint64_t GetEmit18(size_t, size_t emit) { return emit + 216; }
  ...
  static inline uint64_t GetOp30(size_t i) { return i ? 1 : 2; }
  ...
  static inline uint64_t GetOp39(size_t i) {
    return table39_ops_[i >> 8][i & 0xff];
  }
  static inline uint64_t GetEmit39(size_t i, size_t emit) {
    return table39_emit_[i >> 8][emit];
  }
 ...
 private:
  ...
  static const uint8_t table39_0_ops_[256];
  static const uint8_t table39_1_ops_[256];
  static const uint8_t* const table39_emit_[2];
  static const uint8_t* const table39_ops_[2];
