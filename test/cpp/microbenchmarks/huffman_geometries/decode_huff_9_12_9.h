...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_9_12_9_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_9_12_9_H
...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetOp10(size_t i) {
    return table10_ops_[i >> 7][i & 0x7f];
  }
  static inline uint64_t GetEmit10(size_t i, size_t emit) {
    return table10_emit_[i >> 7][emit];
  }
  ...
  static inline uint64_t GetEmit22(size_t, size_t emit) { return emit + 133; }
  ...
  static inline uint64_t GetEmit29(size_t, size_t emit) { return emit + 185; }
  ...
  static inline uint64_t GetEmit33(size_t, size_t emit) { return emit + 232; }
  ...
  static inline uint64_t GetOp43(size_t i) {
    return table43_0_inner_[(i < 1 ? (((void)i, 0)) : ((i - 1)))];
  }
  ...
  static inline uint64_t GetEmit47(size_t, size_t emit) {
    return table47_0_emit_[emit];
  }
  static inline uint64_t GetOp48(size_t i) { return table48_0_ops_[i]; }
  static inline uint64_t GetEmit48(size_t, size_t emit) {
    return table48_0_emit_[emit];
  }
  static inline uint64_t GetOp49(size_t i) { return table49_0_ops_[i]; }
  static inline uint64_t GetEmit49(size_t, size_t emit) {
    return table48_0_emit_[emit];
  }
  static inline uint64_t GetOp45(size_t i) {
    return table45_ops_[i >> 5][i & 0x1f];
  }
  static inline uint64_t GetEmit45(size_t i, size_t emit) {
    return table45_emit_[i >> 5][emit];
  }
 ...
 private:
  ...
  static const uint16_t table10_0_ops_[128];
  static const uint8_t table10_8_emit_[1];
  static const uint16_t table10_8_ops_[128];
  static const uint8_t table10_12_emit_[1];
  static const uint8_t table10_16_emit_[1];
  static const uint16_t table10_16_ops_[128];
  static const uint8_t table10_18_emit_[1];
  static const uint8_t table10_20_emit_[1];
  static const uint8_t table10_22_emit_[1];
  static const uint8_t table10_24_emit_[1];
  static const uint8_t table10_26_emit_[1];
  static const uint8_t table10_28_emit_[1];
  static const uint16_t table10_28_ops_[128];
  static const uint8_t table10_29_emit_[1];
  static const uint8_t table10_30_emit_[2];
  static const uint16_t table10_30_ops_[128];
  static const uint8_t table10_31_emit_[25];
  static const uint16_t table10_31_ops_[128];
  static const uint8_t* const table10_emit_[32];
  static const uint16_t* const table10_ops_[32];
  static const uint8_t table42_0_emit_[6];
  static const uint8_t table42_0_inner_[7];
  static const uint8_t table41_0_emit_[10];
  static const uint8_t table41_0_inner_[10];
  static const uint8_t table43_0_emit_[7];
  static const uint8_t table43_0_inner_[7];
  static const uint8_t table46_0_emit_[15];
  static const uint8_t table46_0_ops_[32];
  static const uint8_t table47_0_emit_[34];
  static const uint8_t table47_0_ops_[64];
  static const uint8_t table48_0_emit_[63];
  static const uint8_t table48_0_ops_[128];
  static const uint8_t table49_0_ops_[256];
  static const uint8_t table45_0_emit_[2];
  static const uint16_t table45_0_ops_[32];
  static const uint8_t table45_1_emit_[2];
  static const uint8_t table45_2_emit_[2];
  static const uint8_t table45_3_emit_[2];
  static const uint8_t table45_4_emit_[2];
  static const uint8_t table45_5_emit_[2];
  static const uint8_t table45_6_emit_[2];
  static const uint8_t table45_7_emit_[3];
  static const uint16_t table45_7_ops_[32];
  static const uint8_t table45_8_emit_[4];
  static const uint16_t table45_8_ops_[32];
  static const uint8_t table45_9_emit_[4];
  static const uint8_t table45_10_emit_[4];
  static const uint8_t table45_11_emit_[4];
  static const uint8_t table45_12_emit_[7];
  static const uint16_t table45_12_ops_[32];
  static const uint8_t table45_13_emit_[8];
  static const uint16_t table45_13_ops_[32];
  static const uint8_t table45_14_emit_[8];
  static const uint8_t table45_15_emit_[10];
  static const uint16_t table45_15_ops_[32];
  static const uint8_t* const table45_emit_[16];
  static const uint16_t* const table45_ops_[16];
};
template <typename F>
class HuffDecoder : public HuffDecoderCommon {
 ...
 private:
  ...
  void DecodeStep26() {
    ...
    switch ((op >> 4) & 1) {
      case 0: {
        sink_(GetEmit45(index, emit_ofs + 0));
        break;
      }
      case 1: {
        begin_ = end_;
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_9_12_9_H
