...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_12_9_9_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_12_9_9_H
...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit21(size_t, size_t emit) { return emit + 133; }
  ...
  static inline uint64_t GetEmit28(size_t, size_t emit) { return emit + 185; }
  ...
  static inline uint64_t GetEmit32(size_t, size_t emit) { return emit + 232; }
  ...
  static inline uint64_t GetOp42(size_t i) {
    return table42_0_inner_[(i < 1 ? (((void)i, 0)) : ((i - 1)))];
  }
  ...
  static inline uint64_t GetOp44(size_t i) {
    return table44_ops_[i >> 5][i & 0x1f];
  }
  static inline uint64_t GetEmit44(size_t i, size_t emit) {
    return table44_emit_[i >> 5][emit];
  }
 ...
 private:
  ...
  static const uint16_t table12_4_ops_[64];
  static const uint8_t table12_5_emit_[1];
  static const uint8_t table12_6_emit_[1];
  static const uint8_t table12_7_emit_[24];
  static const uint16_t table12_7_ops_[64];
  ...
  static const uint8_t table40_0_inner_[10];
  static const uint8_t table42_0_emit_[7];
  static const uint8_t table42_0_inner_[7];
  static const uint8_t table45_0_emit_[15];
  static const uint8_t table45_0_ops_[32];
  static const uint8_t table46_0_emit_[34];
  static const uint8_t table46_0_ops_[64];
  static const uint8_t table47_0_emit_[63];
  static const uint8_t table47_0_ops_[128];
  static const uint8_t table48_0_ops_[256];
  static const uint8_t table44_0_emit_[2];
  static const uint16_t table44_0_ops_[32];
  static const uint8_t table44_1_emit_[2];
  static const uint8_t table44_2_emit_[2];
  static const uint8_t table44_3_emit_[2];
  static const uint8_t table44_4_emit_[2];
  static const uint8_t table44_5_emit_[2];
  static const uint8_t table44_6_emit_[2];
  static const uint8_t table44_7_emit_[3];
  static const uint16_t table44_7_ops_[32];
  static const uint8_t table44_8_emit_[4];
  static const uint16_t table44_8_ops_[32];
  static const uint8_t table44_9_emit_[4];
  static const uint8_t table44_10_emit_[4];
  static const uint8_t table44_11_emit_[4];
  static const uint8_t table44_12_emit_[7];
  static const uint16_t table44_12_ops_[32];
  static const uint8_t table44_13_emit_[8];
  static const uint16_t table44_13_ops_[32];
  static const uint8_t table44_14_emit_[8];
  static const uint8_t table44_15_emit_[10];
  static const uint16_t table44_15_ops_[32];
  static const uint8_t* const table44_emit_[16];
  static const uint16_t* const table44_ops_[16];
};
template <typename F>
class HuffDecoder : public HuffDecoderCommon {
 ...
 private:
  ...
  void DecodeStep26() {
    ...
    switch ((op >> 4) & 1) {
      case 0: {
        sink_(GetEmit44(index, emit_ofs + 0));
        break;
      }
      case 1: {
        begin_ = end_;
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_12_9_9_H
