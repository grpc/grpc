...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_6_11_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_13_6_11_H
#include <grpc/support/port_platform.h>

#include <cstddef>
#include <cstdint>
namespace grpc_core {
namespace geometry_13_6_11 {
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetOp11(size_t i) {
    return table11_0_inner_[(i < 47 ? (i / 16 + 0) : ((i - 47) + 2))];
  }
 ...
 private:
  ...
  static const uint8_t table11_0_emit_[6];
  static const uint16_t table11_0_inner_[19];
  ...
  static const uint8_t table36_0_emit_[40];
  static const uint8_t table36_0_ops_[64];
  static const uint8_t table36_1_emit_[40];
  static const uint8_t table36_2_emit_[22];
  ...
  static const uint8_t table37_0_emit_[72];
  static const uint16_t table37_0_ops_[64];
  static const uint8_t table37_1_emit_[72];
  static const uint8_t table37_2_emit_[72];
  static const uint8_t table37_3_emit_[72];
  static const uint8_t table37_4_emit_[72];
  static const uint8_t table37_5_emit_[40];
  static const uint16_t table37_5_ops_[64];
  static const uint8_t table37_6_emit_[40];
  static const uint8_t table37_7_emit_[40];
  static const uint8_t table37_8_emit_[40];
  static const uint8_t table37_9_emit_[40];
  static const uint8_t table37_10_emit_[40];
  ...
  static const uint16_t table37_13_ops_[64];
  ...
  static const uint8_t table30_0_emit_[1];
  static const uint16_t table30_0_ops_[64];
  static const uint8_t table30_2_emit_[1];
  static const uint8_t table30_4_emit_[1];
  static const uint8_t table30_6_emit_[1];
  static const uint8_t table30_8_emit_[1];
