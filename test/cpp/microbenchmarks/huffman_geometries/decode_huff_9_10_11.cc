...
const uint8_t HuffDecoderCommon::table29_0_inner_[7] = {0x02, 0x07, 0x0b, 0x0f,
                                                        0x13, 0x17, 0x1b};
const uint8_t HuffDecoderCommon::table32_0_inner_[5] = {0x02, 0x06, 0x0a, 0x0e,
                                                        0x01};
...
const uint8_t HuffDecoderCommon::table34_0_emit_[5] = {0xbc, 0xbf, 0xc5, 0xe7,
                                                       0xef};
const uint8_t HuffDecoderCommon::table34_0_inner_[7] = {0x02, 0x06, 0x0a, 0x0e,
                                                        0x12, 0x01, 0x00};
...
const uint8_t HuffDecoderCommon::table38_0_ops_[256] = {
    ...
    0x01, 0x01, 0x01, 0x00};
const uint8_t HuffDecoderCommon::table39_0_emit_[2] = {0xbc, 0xbf};
const uint8_t HuffDecoderCommon::table39_1_emit_[2] = {0xc5, 0xe7};
const uint8_t HuffDecoderCommon::table39_2_emit_[3] = {0xef, 0x09, 0x8e};
...
const uint8_t* const HuffDecoderCommon::table39_ops_[8] = {
    table18_4_ops_, table18_4_ops_, table39_2_ops_, table39_3_ops_,
    table39_3_ops_, table39_5_ops_, table39_6_ops_, table39_7_ops_,
};
const uint8_t HuffDecoderCommon::table40_0_emit_[1] = {0xbc};
const uint8_t HuffDecoderCommon::table40_1_emit_[1] = {0xbf};
const uint8_t HuffDecoderCommon::table40_2_emit_[1] = {0xc5};
const uint8_t HuffDecoderCommon::table40_3_emit_[1] = {0xe7};
const uint8_t HuffDecoderCommon::table40_4_emit_[1] = {0xef};
const uint8_t HuffDecoderCommon::table40_5_emit_[2] = {0x09, 0x8e};
const uint8_t HuffDecoderCommon::table40_6_emit_[2] = {0x90, 0x91};
const uint8_t HuffDecoderCommon::table40_7_emit_[2] = {0x94, 0x9f};
const uint8_t HuffDecoderCommon::table40_8_emit_[2] = {0xab, 0xce};
const uint8_t HuffDecoderCommon::table40_9_emit_[2] = {0xd7, 0xe1};
const uint8_t HuffDecoderCommon::table40_10_emit_[2] = {0xec, 0xed};
...
const uint8_t HuffDecoderCommon::table40_12_emit_[8] = {0xc0, 0xc1, 0xc8, 0xc9,
                                                        0xca, 0xcd, 0xd2, 0xd5};
const uint8_t HuffDecoderCommon::table40_12_ops_[64] = {
    0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02, 0x01, 0x01, 0x01,
...
const uint8_t HuffDecoderCommon::table40_13_ops_[64] = {
    0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02, 0x01, 0x01, 0x01,
    0x01, 0x01, 0x01, 0x01, 0x06, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
    0x01, 0x0a, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x0e, 0x01,
    0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x12, 0x01, 0x01, 0x01, 0x01,
...
const uint8_t HuffDecoderCommon::table40_14_ops_[64] = {
    0x01, 0x01, 0x01, 0x02, 0x01, 0x01, 0x01, 0x06, 0x01, 0x01, 0x01,
    0x0a, 0x01, 0x01, 0x01, 0x0e, 0x01, 0x01, 0x01, 0x12, 0x01, 0x01,
    0x01, 0x16, 0x01, 0x01, 0x01, 0x1a, 0x01, 0x01, 0x01, 0x1e, 0x01,
    0x01, 0x01, 0x22, 0x01, 0x01, 0x01, 0x26, 0x01, 0x01, 0x01, 0x2a,
...
const uint8_t HuffDecoderCommon::table40_15_emit_[30] = {
    ...
    0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x7f, 0xdc, 0xf9};
const uint8_t HuffDecoderCommon::table40_15_ops_[64] = {
...
const uint8_t* const HuffDecoderCommon::table40_ops_[16] = {
    table18_1_ops_,  table18_1_ops_,  table18_1_ops_,  table18_1_ops_,
    table18_1_ops_,  table18_4_ops_,  table18_4_ops_,  table18_4_ops_,
    table18_4_ops_,  table18_4_ops_,  table18_4_ops_,  table39_3_ops_,
...
const uint8_t* const HuffDecoderCommon::table33_emit_[32] = {
    table40_0_emit_,  table40_0_emit_,  table40_1_emit_,  table40_1_emit_,
    table40_2_emit_,  table40_2_emit_,  table40_3_emit_,  table40_3_emit_,
    table40_4_emit_,  table40_4_emit_,  table33_10_emit_, table33_11_emit_,
