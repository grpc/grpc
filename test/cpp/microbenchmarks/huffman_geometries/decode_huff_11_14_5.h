...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit23(size_t, size_t emit) { return emit + 192; }
  static inline uint64_t GetOp24(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit24(size_t, size_t emit) { return emit + 200; }
  ...
  static inline uint64_t GetEmit27(size_t, size_t emit) { return emit + 218; }
  ...
  static inline uint64_t GetEmit29(size_t, size_t emit) { return emit + 242; }
  ...
  static inline uint64_t GetEmit32(size_t, size_t emit) { return emit + 245; }
  static inline uint64_t GetOp33(size_t i) {
    return (i < 2 ? (i ? 6 : 2) : ((i - 2) ? 14 : 10));
  }
  static inline uint64_t GetEmit33(size_t, size_t emit) { return emit + 250; }
