...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit21(size_t, size_t emit) { return emit + 2; }
  static inline uint64_t GetOp22(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit22(size_t, size_t emit) { return emit + 4; }
  static inline uint64_t GetOp23(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit23(size_t, size_t emit) { return emit + 6; }
  ...
  static inline uint64_t GetEmit26(size_t, size_t emit) { return emit + 15; }
  static inline uint64_t GetOp27(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit27(size_t, size_t emit) { return emit + 17; }
  static inline uint64_t GetOp28(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit28(size_t, size_t emit) { return emit + 19; }
  ...
  static inline uint64_t GetEmit30(size_t, size_t emit) { return emit + 24; }
  static inline uint64_t GetOp31(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit31(size_t, size_t emit) { return emit + 26; }
  static inline uint64_t GetOp32(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit32(size_t, size_t emit) { return emit + 28; }
  static inline uint64_t GetOp33(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit33(size_t, size_t emit) { return emit + 30; }
  static inline uint64_t GetOp34(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit34(size_t, size_t emit) {
    return emit ? 220 : 127;
  }
  static inline uint64_t GetOp36(size_t i) { return i ? 0 : 2; }
