...
#ifndef GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_16_8_6_H
#define GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_16_8_6_H
#include <grpc/support/port_platform.h>

#include <cstddef>
#include <cstdint>
namespace grpc_core {
namespace geometry_16_8_6 {
class HuffDecoderCommon {
 ...
 private:
  ...
  static const uint8_t table12_0_emit_[0];
  ...
  static const uint8_t table16_0_emit_[76];
  static const uint16_t table16_0_inner_[86];
  static const uint8_t table16_0_outer_[256];
...
#endif  // GRPC_TEST_CPP_MICROBENCHMARKS_HUFFMAN_GEOMETRIES_DECODE_HUFF_16_8_6_H
