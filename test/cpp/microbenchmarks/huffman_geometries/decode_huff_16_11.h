...
class HuffDecoderCommon {
 protected:
  ...
  static inline uint64_t GetEmit23(size_t, size_t emit) { return emit + 2; }
  static inline uint64_t GetOp24(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit24(size_t, size_t emit) { return emit + 4; }
  static inline uint64_t GetOp25(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit25(size_t, size_t emit) { return emit + 6; }
  ...
  static inline uint64_t GetEmit28(size_t, size_t emit) { return emit + 15; }
  static inline uint64_t GetOp29(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit29(size_t, size_t emit) { return emit + 17; }
  static inline uint64_t GetOp30(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit30(size_t, size_t emit) { return emit + 19; }
  ...
  static inline uint64_t GetEmit32(size_t, size_t emit) { return emit + 24; }
  static inline uint64_t GetOp33(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit33(size_t, size_t emit) { return emit + 26; }
  ...
  static inline uint64_t GetEmit35(size_t, size_t emit) { return emit + 30; }
  static inline uint64_t GetOp36(size_t i) { return i ? 3 : 1; }
  static inline uint64_t GetEmit36(size_t, size_t emit) {
    return emit ? 220 : 127;
  }
  static inline uint64_t GetOp38(size_t i) { return i ? 0 : 2; }
