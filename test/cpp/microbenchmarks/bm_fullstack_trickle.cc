 ...
 public:
  TrickledCHTTP2(Service* service, bool streaming, size_t req_size,
    ...
    if (FLAGS_log) {
      ...
      write_csv(log_.get(), "t", "iteration", "cli_backlog", "svr_backlog",
                "cli_t_stall", "cli_s_stall", "svr_t_stall", "svr_s_stall",
                "cli_remote_window", "svr_remote_window", "cli_announced_local",
                "svr_announced_local", "cli_s_remote_delta",
                "svr_s_remote_delta", "cli_s_announced_local_delta",
                "svr_s_annouced_local_delta", "client_remote_iws",
                "client_local_iws", "client_sent_iws", "client_acked_iws",
                "server_remote_iws", "server_local_iws", "server_sent_iws",
  ...
  void Log(int64_t iteration) {
    ...
    write_csv(
        ...
        client->flow_control.announced_local_window,
        server->flow_control.announced_local_window,
        ...
        client_stream ? client_stream->flow_control.announced_local_window_delta
                      : -1,
        server_stream ? server_stream->flow_control.announced_local_window_delta
                      : -1,
