 ...
 public:
  ...
  void Log(int64_t iteration) {
    ...
    write_csv(
        ...
        client->flow_control.local_window, server->flow_control.local_window,
        ...
        client_stream ? client_stream->flow_control.announce_window : -1,
        server_stream ? server_stream->flow_control.announce_window : -1,
