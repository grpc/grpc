...
def targets():
    ...
    return _reorder_targets_for_build_speed(
        [
            ...
            PythonArtifact("manylinux2014", "x64", "cp312-cp312", presubmit=True),
            ...
            PythonArtifact("manylinux2014", "x86", "cp312-cp312", presubmit=True),
            ...
            PythonArtifact("manylinux2014", "aarch64", "cp310-cp310", presubmit=True),
            PythonArtifact("manylinux2014", "aarch64", "cp311-cp311", presubmit=True),
            PythonArtifact("manylinux2014", "aarch64", "cp312-cp312", presubmit=True),
            ...
            PythonArtifact("linux_extra", "armv7", "cp312-cp312", presubmit=True),
            ...
            PythonArtifact("musllinux_1_2", "x64", "cp310-cp310", presubmit=True),
            PythonArtifact("musllinux_1_2", "x64", "cp311-cp311", presubmit=True),
            PythonArtifact("musllinux_1_2", "x64", "cp312-cp312", presubmit=True),
            PythonArtifact("musllinux_1_2", "x64", "cp313-cp313", presubmit=True),
            PythonArtifact(
                "musllinux_1_2", "x64", "cp314-cp314", presubmit=True
            ),
            PythonArtifact("musllinux_1_2", "x86", "cp39-cp39", presubmit=True),
            PythonArtifact("musllinux_1_2", "x86", "cp310-cp310", presubmit=True),
            PythonArtifact("musllinux_1_2", "x86", "cp311-cp311", presubmit=True),
            PythonArtifact("musllinux_1_2", "x86", "cp312-cp312", presubmit=True),
            PythonArtifact("musllinux_1_2", "x86", "cp313-cp313", presubmit=True),
            PythonArtifact(
            ...
            PythonArtifact("musllinux_1_2", "aarch64", "cp310-cp310", presubmit=True),
            PythonArtifact("musllinux_1_2", "aarch64", "cp311-cp311", presubmit=True),
            PythonArtifact("musllinux_1_2", "aarch64", "cp312-cp312", presubmit=True),
            PythonArtifact("musllinux_1_2", "aarch64", "cp313-cp313", presubmit=True),
            PythonArtifact(
