...
cat << EOF | awk '{ print $1 }' | sort > "$want_submodules"
 ...
 6f3e034fe58ce3bca3c1c32be6d603a6206c89af third_party/boringssl (remotes/origin/chromium-stable)
 ff3ed6780a7e520ac4fa5d12a9f442e189d3c305 third_party/boringssl-with-bazel (remotes/origin/chromium-stable-with-bazel)
