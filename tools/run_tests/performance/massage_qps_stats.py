...
def massage_qps_stats(scenario_result):
  for stats in scenario_result["serverStats"] + scenario_result["clientStats"]:
    if "coreStats" in stats:
      ...
      stats["core_tcp_read_alloc_8k"] = massage_qps_stats_helpers.counter(core_stats, "tcp_read_alloc_8k")
      stats["core_tcp_read_alloc_64k"] = massage_qps_stats_helpers.counter(core_stats, "tcp_read_alloc_64k")
      ...
      stats["core_cq_pluck_creates"] = massage_qps_stats_helpers.counter(core_stats, "cq_pluck_creates")
      stats["core_cq_next_creates"] = massage_qps_stats_helpers.counter(core_stats, "cq_next_creates")
      stats["core_cq_callback_creates"] = massage_qps_stats_helpers.counter(core_stats, "cq_callback_creates")
