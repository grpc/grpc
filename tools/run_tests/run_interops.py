...
cleanup_steps = 'tools/run_tests/run_interops_cleanup.sh'
...
cleanup_job = jobset.JobSpec(cmdline=cleanup_steps, shortname='cleanup')
...
jobset.run([cleanup_job], maxjobs=1, xml_report=testsuite)
