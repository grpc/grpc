...
# TODO: Install to a venv.
# TODO
# Generate xds-protos
python3 -m pip install --upgrade --ignore-installed grpcio-tools==1.59.0
echo "Running xds_protos/build.py"
python3 tools/distrib/python/xds_protos/build.py
echo "Ran xds_protos/build.py"
