...
#define GRPC_TRACE_FLAG_ENABLED(tracer) GPR_UNLIKELY((grpc_core::tracer).enabled())
#define GRPC_TRACE_LOG(tracer, level) LOG_IF(level, GRPC_TRACE_FLAG_ENABLED(tracer##_trace))
