...
# set the required docker image
export DOCKERFILE_DIR=tools/dockerfile/test/cxx_buster_x64
...
# NOTE: Some old distros (e.g. debian jessie) might have a gdb version
