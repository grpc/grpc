...
def generate_run_tests_portability_tests(name):
    ...
    for language in ["c", "c++"]:
        compiler_configs = [
            ...
            # TODO(weizheyuan): Remove GCC 8 tests per OSS policy (https://github.com/google/oss-policies-info/blob/main/foundational-cxx-support-matrix.md)
            ...
            # TODO(weizheyuan): Remove Clang 14 tests per OSS policy (https://github.com/google/oss-policies-info/blob/main/foundational-cxx-support-matrix.md)
