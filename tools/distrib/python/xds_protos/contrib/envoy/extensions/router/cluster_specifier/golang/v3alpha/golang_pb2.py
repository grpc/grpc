...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CONFIG'].fields_by_name['default_cluster']._loaded_options = None
  _globals['_CONFIG'].fields_by_name['default_cluster']._serialized_options = b'\372B\004r\002\020\001'
