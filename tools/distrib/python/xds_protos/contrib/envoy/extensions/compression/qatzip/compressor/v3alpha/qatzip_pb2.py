...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_QATZIP'].fields_by_name['compression_level']._loaded_options = None
  _globals['_QATZIP'].fields_by_name['compression_level']._serialized_options = b'\372B\006*\004\030\t(\001'
  _globals['_QATZIP'].fields_by_name['hardware_buffer_size']._loaded_options = None
  _globals['_QATZIP'].fields_by_name['hardware_buffer_size']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_QATZIP'].fields_by_name['input_size_threshold']._loaded_options = None
  _globals['_QATZIP'].fields_by_name['input_size_threshold']._serialized_options = b'\372B\t*\007\030\200\200 (\200\001'
  _globals['_QATZIP'].fields_by_name['stream_buffer_size']._loaded_options = None
  _globals['_QATZIP'].fields_by_name['stream_buffer_size']._serialized_options = b'\372B\t*\007\030\200\330\177(\200\010'
  _globals['_QATZIP'].fields_by_name['chunk_size']._loaded_options = None
  _globals['_QATZIP'].fields_by_name['chunk_size']._serialized_options = b'\372B\t*\007\030\200\200\004(\200 '
