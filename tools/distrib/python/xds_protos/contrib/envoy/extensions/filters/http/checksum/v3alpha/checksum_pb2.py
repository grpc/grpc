...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CHECKSUMCONFIG_CHECKSUM'].fields_by_name['path_matcher']._loaded_options = None
  _globals['_CHECKSUMCONFIG_CHECKSUM'].fields_by_name['path_matcher']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_CHECKSUMCONFIG_CHECKSUM'].fields_by_name['sha256']._loaded_options = None
  _globals['_CHECKSUMCONFIG_CHECKSUM'].fields_by_name['sha256']._serialized_options = b'\372B\024r\0222\020^[a-fA-F0-9]{64}'
