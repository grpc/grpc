...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'contrib/envoy/extensions/filters/http/dynamo/v3/dynamo.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DYNAMO']._loaded_options = None
  _globals['_DYNAMO']._serialized_options = b'\232\305\210\036+\n)envoy.config.filter.http.dynamo.v2.Dynamo'
