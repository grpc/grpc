...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'contrib/envoy/extensions/filters/network/client_ssl_auth/v3/client_ssl_auth.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CLIENTSSLAUTH'].fields_by_name['auth_api_cluster']._serialized_options = b'\372B\nr\010\020\001\300\001\002\310\001\000'
  _globals['_CLIENTSSLAUTH'].fields_by_name['stat_prefix']._loaded_options = None
  _globals['_CLIENTSSLAUTH'].fields_by_name['stat_prefix']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_CLIENTSSLAUTH'].fields_by_name['ip_white_list']._loaded_options = None
  _globals['_CLIENTSSLAUTH'].fields_by_name['ip_white_list']._serialized_options = b'\362\230\376\217\005\016\n\014ip_allowlist'
  _globals['_CLIENTSSLAUTH']._loaded_options = None
  _globals['_CLIENTSSLAUTH']._serialized_options = b'\232\305\210\036>\n<envoy.config.filter.network.client_ssl_auth.v2.ClientSSLAuth'
