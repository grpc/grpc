...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CELEXPRESSION'].oneofs_by_name['expr_specifier']._loaded_options = None
  _globals['_CELEXPRESSION'].oneofs_by_name['expr_specifier']._serialized_options = b'\370B\001'
