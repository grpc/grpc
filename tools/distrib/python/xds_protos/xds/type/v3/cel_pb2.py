...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CELEXPRESSION.fields_by_name['parsed_expr']._options = None
  _CELEXPRESSION.fields_by_name['parsed_expr']._serialized_options = b'\030\001'
  _CELEXPRESSION.fields_by_name['checked_expr']._options = None
  _CELEXPRESSION.fields_by_name['checked_expr']._serialized_options = b'\030\001'
