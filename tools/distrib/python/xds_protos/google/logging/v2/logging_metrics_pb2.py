...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LOGMETRIC_LABELEXTRACTORSENTRY']._serialized_options = b'8\001'
  _globals['_LOGMETRIC'].fields_by_name['name']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['name']._serialized_options = b'\340A\002'
  _globals['_LOGMETRIC'].fields_by_name['description']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['description']._serialized_options = b'\340A\001'
  _globals['_LOGMETRIC'].fields_by_name['filter']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['filter']._serialized_options = b'\340A\002'
  _globals['_LOGMETRIC'].fields_by_name['bucket_name']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['bucket_name']._serialized_options = b'\340A\001'
  _globals['_LOGMETRIC'].fields_by_name['disabled']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['disabled']._serialized_options = b'\340A\001'
  _globals['_LOGMETRIC'].fields_by_name['metric_descriptor']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['metric_descriptor']._serialized_options = b'\340A\001'
  _globals['_LOGMETRIC'].fields_by_name['value_extractor']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['value_extractor']._serialized_options = b'\340A\001'
  _globals['_LOGMETRIC'].fields_by_name['label_extractors']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['label_extractors']._serialized_options = b'\340A\001'
  _globals['_LOGMETRIC'].fields_by_name['bucket_options']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['bucket_options']._serialized_options = b'\340A\001'
  _globals['_LOGMETRIC'].fields_by_name['create_time']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_LOGMETRIC'].fields_by_name['update_time']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_LOGMETRIC'].fields_by_name['version']._loaded_options = None
  _globals['_LOGMETRIC'].fields_by_name['version']._serialized_options = b'\030\001'
  _globals['_LOGMETRIC']._loaded_options = None
  _globals['_LOGMETRIC']._serialized_options = b'\352AG\n logging.googleapis.com/LogMetric\022#projects/{project}/metrics/{metric}'
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A-\n+cloudresourcemanager.googleapis.com/Project'
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_GETLOGMETRICREQUEST'].fields_by_name['metric_name']._loaded_options = None
  _globals['_GETLOGMETRICREQUEST'].fields_by_name['metric_name']._serialized_options = b'\340A\002\372A\"\n logging.googleapis.com/LogMetric'
  _globals['_CREATELOGMETRICREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_CREATELOGMETRICREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A\"\022 logging.googleapis.com/LogMetric'
  _globals['_CREATELOGMETRICREQUEST'].fields_by_name['metric']._loaded_options = None
  _globals['_CREATELOGMETRICREQUEST'].fields_by_name['metric']._serialized_options = b'\340A\002'
  _globals['_UPDATELOGMETRICREQUEST'].fields_by_name['metric_name']._loaded_options = None
  _globals['_UPDATELOGMETRICREQUEST'].fields_by_name['metric_name']._serialized_options = b'\340A\002\372A\"\n logging.googleapis.com/LogMetric'
  _globals['_UPDATELOGMETRICREQUEST'].fields_by_name['metric']._loaded_options = None
  _globals['_UPDATELOGMETRICREQUEST'].fields_by_name['metric']._serialized_options = b'\340A\002'
  _globals['_DELETELOGMETRICREQUEST'].fields_by_name['metric_name']._loaded_options = None
  _globals['_DELETELOGMETRICREQUEST'].fields_by_name['metric_name']._serialized_options = b'\340A\002\372A\"\n logging.googleapis.com/LogMetric'
  _globals['_METRICSSERVICEV2']._loaded_options = None
  _globals['_METRICSSERVICEV2']._serialized_options = b'\312A\026logging.googleapis.com\322A\360\001https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/cloud-platform.read-only,https://www.googleapis.com/auth/logging.admin,https://www.googleapis.com/auth/logging.read,https://www.googleapis.com/auth/logging.write'
  _globals['_METRICSSERVICEV2'].methods_by_name['ListLogMetrics']._loaded_options = None
  _globals['_METRICSSERVICEV2'].methods_by_name['ListLogMetrics']._serialized_options = b'\332A\006parent\202\323\344\223\002!\022\037/v2/{parent=projects/*}/metrics'
  _globals['_METRICSSERVICEV2'].methods_by_name['GetLogMetric']._loaded_options = None
  _globals['_METRICSSERVICEV2'].methods_by_name['GetLogMetric']._serialized_options = b'\332A\013metric_name\202\323\344\223\002(\022&/v2/{metric_name=projects/*/metrics/*}'
  _globals['_METRICSSERVICEV2'].methods_by_name['CreateLogMetric']._loaded_options = None
  _globals['_METRICSSERVICEV2'].methods_by_name['CreateLogMetric']._serialized_options = b'\332A\rparent,metric\202\323\344\223\002)\"\037/v2/{parent=projects/*}/metrics:\006metric'
  _globals['_METRICSSERVICEV2'].methods_by_name['UpdateLogMetric']._loaded_options = None
  _globals['_METRICSSERVICEV2'].methods_by_name['UpdateLogMetric']._serialized_options = b'\332A\022metric_name,metric\202\323\344\223\0020\032&/v2/{metric_name=projects/*/metrics/*}:\006metric'
  _globals['_METRICSSERVICEV2'].methods_by_name['DeleteLogMetric']._loaded_options = None
  _globals['_METRICSSERVICEV2'].methods_by_name['DeleteLogMetric']._serialized_options = b'\332A\013metric_name\202\323\344\223\002(*&/v2/{metric_name=projects/*/metrics/*}'
