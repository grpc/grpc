...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LOGENTRY'].fields_by_name['log_name']._serialized_options = b'\340A\002'
  _globals['_LOGENTRY'].fields_by_name['resource']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['resource']._serialized_options = b'\340A\002'
  _globals['_LOGENTRY'].fields_by_name['timestamp']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['timestamp']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY'].fields_by_name['receive_timestamp']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['receive_timestamp']._serialized_options = b'\340A\003'
  _globals['_LOGENTRY'].fields_by_name['severity']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['severity']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY'].fields_by_name['insert_id']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['insert_id']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY'].fields_by_name['http_request']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['http_request']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY'].fields_by_name['labels']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['labels']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY'].fields_by_name['operation']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['operation']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY'].fields_by_name['trace']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['trace']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY'].fields_by_name['span_id']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['span_id']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY'].fields_by_name['trace_sampled']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['trace_sampled']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY'].fields_by_name['source_location']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['source_location']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY'].fields_by_name['split']._loaded_options = None
  _globals['_LOGENTRY'].fields_by_name['split']._serialized_options = b'\340A\001'
  _globals['_LOGENTRY']._loaded_options = None
  _globals['_LOGENTRY']._serialized_options = b'\352A\271\001\n\032logging.googleapis.com/Log\022\035projects/{project}/logs/{log}\022\'organizations/{organization}/logs/{log}\022\033folders/{folder}/logs/{log}\022,billingAccounts/{billing_account}/logs/{log}\032\010log_name'
  _globals['_LOGENTRYOPERATION'].fields_by_name['id']._loaded_options = None
  _globals['_LOGENTRYOPERATION'].fields_by_name['id']._serialized_options = b'\340A\001'
  _globals['_LOGENTRYOPERATION'].fields_by_name['producer']._loaded_options = None
  _globals['_LOGENTRYOPERATION'].fields_by_name['producer']._serialized_options = b'\340A\001'
  _globals['_LOGENTRYOPERATION'].fields_by_name['first']._loaded_options = None
  _globals['_LOGENTRYOPERATION'].fields_by_name['first']._serialized_options = b'\340A\001'
  _globals['_LOGENTRYOPERATION'].fields_by_name['last']._loaded_options = None
  _globals['_LOGENTRYOPERATION'].fields_by_name['last']._serialized_options = b'\340A\001'
  _globals['_LOGENTRYSOURCELOCATION'].fields_by_name['file']._loaded_options = None
  _globals['_LOGENTRYSOURCELOCATION'].fields_by_name['file']._serialized_options = b'\340A\001'
  _globals['_LOGENTRYSOURCELOCATION'].fields_by_name['line']._loaded_options = None
  _globals['_LOGENTRYSOURCELOCATION'].fields_by_name['line']._serialized_options = b'\340A\001'
  _globals['_LOGENTRYSOURCELOCATION'].fields_by_name['function']._loaded_options = None
  _globals['_LOGENTRYSOURCELOCATION'].fields_by_name['function']._serialized_options = b'\340A\001'
