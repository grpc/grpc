...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LISTENER_CONNECTIONBALANCECONFIG'].oneofs_by_name['balance_type']._loaded_options = None
  _globals['_LISTENER_CONNECTIONBALANCECONFIG'].oneofs_by_name['balance_type']._serialized_options = b'\370B\001'
  _globals['_LISTENER'].fields_by_name['address']._loaded_options = None
  _globals['_LISTENER'].fields_by_name['address']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_LISTENER'].fields_by_name['use_original_dst']._loaded_options = None
  _globals['_LISTENER'].fields_by_name['use_original_dst']._serialized_options = b'\030\001'
