...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FILTER'].fields_by_name['name']._loaded_options = None
  _globals['_FILTER'].fields_by_name['name']._serialized_options = b'\372B\004r\002 \001'
  _globals['_FILTER'].fields_by_name['config']._loaded_options = None
  _globals['_FILTER'].fields_by_name['config']._serialized_options = b'\030\001'
  _globals['_FILTERCHAINMATCH_CONNECTIONSOURCETYPE'].values_by_name["LOCAL"]._loaded_options = None
  _globals['_FILTERCHAINMATCH_CONNECTIONSOURCETYPE'].values_by_name["LOCAL"]._serialized_options = b'\362\230\376\217\005\025\n\023SAME_IP_OR_LOOPBACK'
  _globals['_FILTERCHAINMATCH'].fields_by_name['destination_port']._loaded_options = None
  _globals['_FILTERCHAINMATCH'].fields_by_name['destination_port']._serialized_options = b'\372B\010*\006\030\377\377\003(\001'
  _globals['_FILTERCHAINMATCH'].fields_by_name['source_type']._loaded_options = None
  _globals['_FILTERCHAINMATCH'].fields_by_name['source_type']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_FILTERCHAINMATCH'].fields_by_name['source_ports']._loaded_options = None
  _globals['_FILTERCHAINMATCH'].fields_by_name['source_ports']._serialized_options = b'\372B\r\222\001\n\"\010*\006\030\377\377\003(\001'
  _globals['_FILTERCHAIN'].fields_by_name['tls_context']._loaded_options = None
  _globals['_FILTERCHAIN'].fields_by_name['tls_context']._serialized_options = b'\030\001'
  _globals['_LISTENERFILTERCHAINMATCHPREDICATE_MATCHSET'].fields_by_name['rules']._loaded_options = None
  _globals['_LISTENERFILTERCHAINMATCHPREDICATE_MATCHSET'].fields_by_name['rules']._serialized_options = b'\372B\005\222\001\002\010\002'
  _globals['_LISTENERFILTERCHAINMATCHPREDICATE'].oneofs_by_name['rule']._loaded_options = None
  _globals['_LISTENERFILTERCHAINMATCHPREDICATE'].oneofs_by_name['rule']._serialized_options = b'\370B\001'
  _globals['_LISTENERFILTERCHAINMATCHPREDICATE'].fields_by_name['any_match']._loaded_options = None
  _globals['_LISTENERFILTERCHAINMATCHPREDICATE'].fields_by_name['any_match']._serialized_options = b'\372B\004j\002\010\001'
  _globals['_LISTENERFILTER'].fields_by_name['name']._loaded_options = None
  _globals['_LISTENERFILTER'].fields_by_name['name']._serialized_options = b'\372B\004r\002 \001'
  _globals['_LISTENERFILTER'].fields_by_name['config']._loaded_options = None
  _globals['_LISTENERFILTER'].fields_by_name['config']._serialized_options = b'\030\001'
