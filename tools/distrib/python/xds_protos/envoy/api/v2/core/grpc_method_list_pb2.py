...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GRPCMETHODLIST_SERVICE'].fields_by_name['name']._loaded_options = None
  _globals['_GRPCMETHODLIST_SERVICE'].fields_by_name['name']._serialized_options = b'\372B\004r\002 \001'
  _globals['_GRPCMETHODLIST_SERVICE'].fields_by_name['method_names']._loaded_options = None
  _globals['_GRPCMETHODLIST_SERVICE'].fields_by_name['method_names']._serialized_options = b'\372B\005\222\001\002\010\001'
