...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_HEALTHCHECK_PAYLOAD'].fields_by_name['text']._serialized_options = b'\372B\004r\002 \001'
  _globals['_HEALTHCHECK_HTTPHEALTHCHECK'].fields_by_name['path']._loaded_options = None
  _globals['_HEALTHCHECK_HTTPHEALTHCHECK'].fields_by_name['path']._serialized_options = b'\372B\004r\002 \001'
  _globals['_HEALTHCHECK_HTTPHEALTHCHECK'].fields_by_name['service_name']._loaded_options = None
  _globals['_HEALTHCHECK_HTTPHEALTHCHECK'].fields_by_name['service_name']._serialized_options = b'\030\001'
  ...
  _globals['_HEALTHCHECK_HTTPHEALTHCHECK'].fields_by_name['use_http2']._loaded_options = None
  _globals['_HEALTHCHECK_HTTPHEALTHCHECK'].fields_by_name['use_http2']._serialized_options = b'\030\001\270\356\362\322\005\001'
  ...
  _globals['_HEALTHCHECK_CUSTOMHEALTHCHECK'].fields_by_name['name']._serialized_options = b'\372B\004r\002 \001'
  _globals['_HEALTHCHECK_CUSTOMHEALTHCHECK'].fields_by_name['config']._loaded_options = None
  _globals['_HEALTHCHECK_CUSTOMHEALTHCHECK'].fields_by_name['config']._serialized_options = b'\030\001'
