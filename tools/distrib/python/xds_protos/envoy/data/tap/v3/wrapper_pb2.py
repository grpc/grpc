...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TRACEWRAPPER'].oneofs_by_name['trace']._loaded_options = None
  _globals['_TRACEWRAPPER'].oneofs_by_name['trace']._serialized_options = b'\370B\001'
  _globals['_TRACEWRAPPER']._loaded_options = None
  _globals['_TRACEWRAPPER']._serialized_options = b'\232\305\210\036%\n#envoy.data.tap.v2alpha.TraceWrapper'
