...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DNSTABLE_ADDRESSLIST']._loaded_options = None
  _globals['_DNSTABLE_ADDRESSLIST']._serialized_options = b'\232\305\210\036-\n+envoy.data.dns.v2alpha.DnsTable.AddressList'
  _globals['_DNSTABLE_DNSSERVICEPROTOCOL'].oneofs_by_name['protocol_config']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICEPROTOCOL'].oneofs_by_name['protocol_config']._serialized_options = b'\370B\001'
  _globals['_DNSTABLE_DNSSERVICEPROTOCOL'].fields_by_name['number']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICEPROTOCOL'].fields_by_name['number']._serialized_options = b'\372B\005*\003\020\377\001'
  _globals['_DNSTABLE_DNSSERVICEPROTOCOL'].fields_by_name['name']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICEPROTOCOL'].fields_by_name['name']._serialized_options = b'\372B\007r\005\020\001\300\001\001'
  _globals['_DNSTABLE_DNSSERVICETARGET'].oneofs_by_name['endpoint_type']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICETARGET'].oneofs_by_name['endpoint_type']._serialized_options = b'\370B\001'
  _globals['_DNSTABLE_DNSSERVICETARGET'].fields_by_name['host_name']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICETARGET'].fields_by_name['host_name']._serialized_options = b'\372B\007r\005\020\001\300\001\001'
  _globals['_DNSTABLE_DNSSERVICETARGET'].fields_by_name['cluster_name']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICETARGET'].fields_by_name['cluster_name']._serialized_options = b'\372B\007r\005\020\001\300\001\001'
  _globals['_DNSTABLE_DNSSERVICETARGET'].fields_by_name['priority']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICETARGET'].fields_by_name['priority']._serialized_options = b'\372B\006*\004\020\200\200\004'
  _globals['_DNSTABLE_DNSSERVICETARGET'].fields_by_name['weight']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICETARGET'].fields_by_name['weight']._serialized_options = b'\372B\006*\004\020\200\200\004'
  _globals['_DNSTABLE_DNSSERVICETARGET'].fields_by_name['port']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICETARGET'].fields_by_name['port']._serialized_options = b'\372B\006*\004\020\200\200\004'
  _globals['_DNSTABLE_DNSSERVICE'].fields_by_name['service_name']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICE'].fields_by_name['service_name']._serialized_options = b'\372B\007r\005\020\001\300\001\001'
  _globals['_DNSTABLE_DNSSERVICE'].fields_by_name['ttl']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICE'].fields_by_name['ttl']._serialized_options = b'\372B\007\252\001\0042\002\010\001'
  _globals['_DNSTABLE_DNSSERVICE'].fields_by_name['targets']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICE'].fields_by_name['targets']._serialized_options = b'\372B\005\222\001\002\010\001'
  _globals['_DNSTABLE_DNSSERVICELIST'].fields_by_name['services']._loaded_options = None
  _globals['_DNSTABLE_DNSSERVICELIST'].fields_by_name['services']._serialized_options = b'\372B\005\222\001\002\010\001'
  ...
  _globals['_DNSTABLE_DNSENDPOINT']._loaded_options = None
  _globals['_DNSTABLE_DNSENDPOINT']._serialized_options = b'\232\305\210\036-\n+envoy.data.dns.v2alpha.DnsTable.DnsEndpoint'
  _globals['_DNSTABLE_DNSVIRTUALDOMAIN'].fields_by_name['name']._loaded_options = None
  _globals['_DNSTABLE_DNSVIRTUALDOMAIN'].fields_by_name['name']._serialized_options = b'\372B\007r\005\020\001\300\001\001'
  _globals['_DNSTABLE_DNSVIRTUALDOMAIN'].fields_by_name['answer_ttl']._loaded_options = None
  _globals['_DNSTABLE_DNSVIRTUALDOMAIN'].fields_by_name['answer_ttl']._serialized_options = b'\372B\007\252\001\0042\002\010\036'
  _globals['_DNSTABLE_DNSVIRTUALDOMAIN']._loaded_options = None
  _globals['_DNSTABLE_DNSVIRTUALDOMAIN']._serialized_options = b'\232\305\210\0362\n0envoy.data.dns.v2alpha.DnsTable.DnsVirtualDomain'
  _globals['_DNSTABLE'].fields_by_name['external_retry_count']._loaded_options = None
  _globals['_DNSTABLE'].fields_by_name['external_retry_count']._serialized_options = b'\372B\004*\002\030\003'
  _globals['_DNSTABLE'].fields_by_name['known_suffixes']._loaded_options = None
  _globals['_DNSTABLE'].fields_by_name['known_suffixes']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_DNSTABLE']._loaded_options = None
  _globals['_DNSTABLE']._serialized_options = b'\232\305\210\036!\n\037envoy.data.dns.v2alpha.DnsTable'
