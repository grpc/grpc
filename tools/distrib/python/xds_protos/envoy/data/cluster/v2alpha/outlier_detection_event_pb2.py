...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_OUTLIERDETECTIONEVENT'].oneofs_by_name['event']._loaded_options = None
  _globals['_OUTLIERDETECTIONEVENT'].oneofs_by_name['event']._serialized_options = b'\370B\001'
  _globals['_OUTLIERDETECTIONEVENT'].fields_by_name['type']._loaded_options = None
  _globals['_OUTLIERDETECTIONEVENT'].fields_by_name['type']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_OUTLIERDETECTIONEVENT'].fields_by_name['cluster_name']._loaded_options = None
  _globals['_OUTLIERDETECTIONEVENT'].fields_by_name['cluster_name']._serialized_options = b'\372B\004r\002 \001'
  _globals['_OUTLIERDETECTIONEVENT'].fields_by_name['upstream_url']._loaded_options = None
  _globals['_OUTLIERDETECTIONEVENT'].fields_by_name['upstream_url']._serialized_options = b'\372B\004r\002 \001'
  _globals['_OUTLIERDETECTIONEVENT'].fields_by_name['action']._loaded_options = None
  _globals['_OUTLIERDETECTIONEVENT'].fields_by_name['action']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_OUTLIEREJECTSUCCESSRATE'].fields_by_name['host_success_rate']._loaded_options = None
  _globals['_OUTLIEREJECTSUCCESSRATE'].fields_by_name['host_success_rate']._serialized_options = b'\372B\004*\002\030d'
  _globals['_OUTLIEREJECTSUCCESSRATE'].fields_by_name['cluster_average_success_rate']._loaded_options = None
  _globals['_OUTLIEREJECTSUCCESSRATE'].fields_by_name['cluster_average_success_rate']._serialized_options = b'\372B\004*\002\030d'
  _globals['_OUTLIEREJECTSUCCESSRATE'].fields_by_name['cluster_success_rate_ejection_threshold']._loaded_options = None
  _globals['_OUTLIEREJECTSUCCESSRATE'].fields_by_name['cluster_success_rate_ejection_threshold']._serialized_options = b'\372B\004*\002\030d'
  _globals['_OUTLIEREJECTFAILUREPERCENTAGE'].fields_by_name['host_success_rate']._loaded_options = None
  _globals['_OUTLIEREJECTFAILUREPERCENTAGE'].fields_by_name['host_success_rate']._serialized_options = b'\372B\004*\002\030d'
