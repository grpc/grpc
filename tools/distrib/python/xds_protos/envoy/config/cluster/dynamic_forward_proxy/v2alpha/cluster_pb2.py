...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CLUSTERCONFIG'].fields_by_name['dns_cache_config']._loaded_options = None
  _globals['_CLUSTERCONFIG'].fields_by_name['dns_cache_config']._serialized_options = b'\372B\005\212\001\002\020\001'
