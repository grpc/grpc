...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FAULTDELAY'].oneofs_by_name['fault_delay_secifier']._loaded_options = None
  _globals['_FAULTDELAY'].oneofs_by_name['fault_delay_secifier']._serialized_options = b'\370B\001'
  _globals['_FAULTDELAY'].fields_by_name['type']._loaded_options = None
  _globals['_FAULTDELAY'].fields_by_name['type']._serialized_options = b'\030\001\270\356\362\322\005\001'
  _globals['_FAULTDELAY'].fields_by_name['fixed_delay']._loaded_options = None
  _globals['_FAULTDELAY'].fields_by_name['fixed_delay']._serialized_options = b'\372B\005\252\001\002*\000'
  _globals['_FAULTRATELIMIT_FIXEDLIMIT'].fields_by_name['limit_kbps']._loaded_options = None
  _globals['_FAULTRATELIMIT_FIXEDLIMIT'].fields_by_name['limit_kbps']._serialized_options = b'\372B\0042\002(\001'
  _globals['_FAULTRATELIMIT'].oneofs_by_name['limit_type']._loaded_options = None
  _globals['_FAULTRATELIMIT'].oneofs_by_name['limit_type']._serialized_options = b'\370B\001'
