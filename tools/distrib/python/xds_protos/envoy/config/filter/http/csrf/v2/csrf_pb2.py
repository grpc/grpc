...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CSRFPOLICY'].fields_by_name['filter_enabled']._loaded_options = None
  _globals['_CSRFPOLICY'].fields_by_name['filter_enabled']._serialized_options = b'\372B\005\212\001\002\020\001'
