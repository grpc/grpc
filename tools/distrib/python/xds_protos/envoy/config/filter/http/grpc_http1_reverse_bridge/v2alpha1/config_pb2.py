...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FILTERCONFIG'].fields_by_name['content_type']._loaded_options = None
  _globals['_FILTERCONFIG'].fields_by_name['content_type']._serialized_options = b'\372B\004r\002 \001'
