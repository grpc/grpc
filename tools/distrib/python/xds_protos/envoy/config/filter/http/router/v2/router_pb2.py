...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ROUTER'].fields_by_name['strict_check_headers']._loaded_options = None
  _globals['_ROUTER'].fields_by_name['strict_check_headers']._serialized_options = b'\372B\220\001\222\001\214\001\"\211\001r\206\001R\036x-envoy-upstream-rq-timeout-msR&x-envoy-upstream-rq-per-try-timeout-msR\023x-envoy-max-retriesR\025x-envoy-retry-grpc-onR\020x-envoy-retry-on'
