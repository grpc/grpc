...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_XRAYCONFIG'].fields_by_name['segment_name']._loaded_options = None
  _globals['_XRAYCONFIG'].fields_by_name['segment_name']._serialized_options = b'\372B\004r\002\020\001'
