...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DYNAMICOTCONFIG'].fields_by_name['library']._loaded_options = None
  _globals['_DYNAMICOTCONFIG'].fields_by_name['library']._serialized_options = b'\030\001\372B\004r\002\020\001\222\307\206\330\004\0033.0\270\356\362\322\005\001'
  _globals['_DYNAMICOTCONFIG'].fields_by_name['config']._loaded_options = None
  _globals['_DYNAMICOTCONFIG'].fields_by_name['config']._serialized_options = b'\030\001\222\307\206\330\004\0033.0\270\356\362\322\005\001'
  _globals['_DYNAMICOTCONFIG']._loaded_options = None
  _globals['_DYNAMICOTCONFIG']._serialized_options = b'\232\305\210\036\'\n%envoy.config.trace.v2.DynamicOtConfig'
