...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_HTTPURI'].oneofs_by_name['http_upstream_type']._loaded_options = None
  _globals['_HTTPURI'].oneofs_by_name['http_upstream_type']._serialized_options = b'\370B\001'
  _globals['_HTTPURI'].fields_by_name['uri']._loaded_options = None
  _globals['_HTTPURI'].fields_by_name['uri']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_HTTPURI'].fields_by_name['cluster']._loaded_options = None
  _globals['_HTTPURI'].fields_by_name['cluster']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_HTTPURI'].fields_by_name['timeout']._loaded_options = None
  _globals['_HTTPURI'].fields_by_name['timeout']._serialized_options = b'\372B\017\252\001\014\010\001\032\006\010\200\200\200\200\0202\000'
  _globals['_HTTPURI']._loaded_options = None
  _globals['_HTTPURI']._serialized_options = b'\232\305\210\036\033\n\031envoy.api.v2.core.HttpUri'
