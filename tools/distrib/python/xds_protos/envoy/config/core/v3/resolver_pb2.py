...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DNSRESOLUTIONCONFIG'].fields_by_name['resolvers']._loaded_options = None
  _globals['_DNSRESOLUTIONCONFIG'].fields_by_name['resolvers']._serialized_options = b'\372B\005\222\001\002\010\001'
