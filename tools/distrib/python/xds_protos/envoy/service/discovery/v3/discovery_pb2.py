...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RESOURCELOCATOR_DYNAMICPARAMETERSENTRY']._loaded_options = None
  _globals['_RESOURCELOCATOR_DYNAMICPARAMETERSENTRY']._serialized_options = b'8\001'
  _globals['_DISCOVERYREQUEST']._loaded_options = None
  _globals['_DISCOVERYREQUEST']._serialized_options = b'\232\305\210\036\037\n\035envoy.api.v2.DiscoveryRequest'
  _globals['_DISCOVERYRESPONSE']._loaded_options = None
  _globals['_DISCOVERYRESPONSE']._serialized_options = b'\232\305\210\036 \n\036envoy.api.v2.DiscoveryResponse'
  ...
  _globals['_DELTADISCOVERYREQUEST']._loaded_options = None
  _globals['_DELTADISCOVERYREQUEST']._serialized_options = b'\232\305\210\036$\n\"envoy.api.v2.DeltaDiscoveryRequest'
  _globals['_DELTADISCOVERYRESPONSE']._loaded_options = None
  _globals['_DELTADISCOVERYRESPONSE']._serialized_options = b'\232\305\210\036%\n#envoy.api.v2.DeltaDiscoveryResponse'
  _globals['_DYNAMICPARAMETERCONSTRAINTS_SINGLECONSTRAINT'].oneofs_by_name['constraint_type']._loaded_options = None
  _globals['_DYNAMICPARAMETERCONSTRAINTS_SINGLECONSTRAINT'].oneofs_by_name['constraint_type']._serialized_options = b'\370B\001'
  _globals['_RESOURCE']._loaded_options = None
  _globals['_RESOURCE']._serialized_options = b'\232\305\210\036\027\n\025envoy.api.v2.Resource'
