...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RATELIMITQUOTAUSAGEREPORTS_BUCKETQUOTAUSAGE'].fields_by_name['bucket_id']._loaded_options = None
  ...
  _globals['_RATELIMITQUOTAUSAGEREPORTS_BUCKETQUOTAUSAGE'].fields_by_name['time_elapsed']._loaded_options = None
  ...
  _globals['_RATELIMITQUOTAUSAGEREPORTS'].fields_by_name['domain']._loaded_options = None
  _globals['_RATELIMITQUOTAUSAGEREPORTS'].fields_by_name['domain']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_RATELIMITQUOTAUSAGEREPORTS'].fields_by_name['bucket_quota_usages']._loaded_options = None
  ...
  _globals['_RATELIMITQUOTARESPONSE_BUCKETACTION_QUOTAASSIGNMENTACTION'].fields_by_name['assignment_time_to_live']._loaded_options = None
  ...
  _globals['_RATELIMITQUOTARESPONSE_BUCKETACTION'].oneofs_by_name['bucket_action']._loaded_options = None
  _globals['_RATELIMITQUOTARESPONSE_BUCKETACTION'].oneofs_by_name['bucket_action']._serialized_options = b'\370B\001'
  _globals['_RATELIMITQUOTARESPONSE_BUCKETACTION'].fields_by_name['bucket_id']._loaded_options = None
  ...
  _globals['_RATELIMITQUOTARESPONSE'].fields_by_name['bucket_action']._loaded_options = None
  _globals['_RATELIMITQUOTARESPONSE'].fields_by_name['bucket_action']._serialized_options = b'\372B\005\222\001\002\010\001'
  _globals['_BUCKETID_BUCKETENTRY']._loaded_options = None
  _globals['_BUCKETID_BUCKETENTRY']._serialized_options = b'8\001'
  _globals['_BUCKETID'].fields_by_name['bucket']._loaded_options = None
