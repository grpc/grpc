...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DENIEDHTTPRESPONSE'].fields_by_name['status']._loaded_options = None
  _globals['_DENIEDHTTPRESPONSE'].fields_by_name['status']._serialized_options = b'\372B\005\212\001\002\020\001'
