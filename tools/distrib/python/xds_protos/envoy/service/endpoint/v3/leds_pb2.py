...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'envoy/service/endpoint/v3/leds.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LOCALITYENDPOINTDISCOVERYSERVICE']._loaded_options = None
  _globals['_LOCALITYENDPOINTDISCOVERYSERVICE']._serialized_options = b'\212\244\226\363\007%\n#envoy.config.endpoint.v3.LbEndpoint'
