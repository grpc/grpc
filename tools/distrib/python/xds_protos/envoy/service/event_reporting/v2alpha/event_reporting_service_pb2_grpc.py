...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in envoy/service/event_reporting/v2alpha/event_reporting_service_pb2_grpc.py depends on'
...
def add_EventReportingServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('envoy.service.event_reporting.v2alpha.EventReportingService', rpc_method_handlers)
