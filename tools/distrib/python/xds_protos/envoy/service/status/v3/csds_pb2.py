...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CLIENTSTATUSREQUEST']._loaded_options = None
  _globals['_CLIENTSTATUSREQUEST']._serialized_options = b'\232\305\210\036-\n+envoy.service.status.v2.ClientStatusRequest'
  _globals['_PERXDSCONFIG'].fields_by_name['client_status']._loaded_options = None
  _globals['_PERXDSCONFIG'].fields_by_name['client_status']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_PERXDSCONFIG']._loaded_options = None
  _globals['_PERXDSCONFIG']._serialized_options = b'\232\305\210\036&\n$envoy.service.status.v2.PerXdsConfig'
  _globals['_CLIENTCONFIG'].fields_by_name['xds_config']._loaded_options = None
  _globals['_CLIENTCONFIG'].fields_by_name['xds_config']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_CLIENTCONFIG']._loaded_options = None
  _globals['_CLIENTCONFIG']._serialized_options = b'\232\305\210\036&\n$envoy.service.status.v2.ClientConfig'
  _globals['_CLIENTSTATUSRESPONSE']._loaded_options = None
  _globals['_CLIENTSTATUSRESPONSE']._serialized_options = b'\232\305\210\036.\n,envoy.service.status.v2.ClientStatusResponse'
  _globals['_CLIENTSTATUSDISCOVERYSERVICE'].methods_by_name['FetchClientStatus']._loaded_options = None
  _globals['_CLIENTSTATUSDISCOVERYSERVICE'].methods_by_name['FetchClientStatus']._serialized_options = b'\202\323\344\223\002 \"\033/v3/discovery:client_status:\001*'
