...
class ClientStatusDiscoveryService(object):
    ...
    def StreamClientStatus(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/envoy.service.status.v3.ClientStatusDiscoveryService/StreamClientStatus',
    ...
    def FetchClientStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/envoy.service.status.v3.ClientStatusDiscoveryService/FetchClientStatus',
            envoy_dot_service_dot_status_dot_v3_dot_csds__pb2.ClientStatusRequest.SerializeToString,
            envoy_dot_service_dot_status_dot_v3_dot_csds__pb2.ClientStatusResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
