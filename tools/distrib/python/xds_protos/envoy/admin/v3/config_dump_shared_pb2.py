...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_UPDATEFAILURESTATE']._loaded_options = None
  _globals['_UPDATEFAILURESTATE']._serialized_options = b'\232\305\210\036(\n&envoy.admin.v2alpha.UpdateFailureState'
  _globals['_LISTENERSCONFIGDUMP_STATICLISTENER']._loaded_options = None
  _globals['_LISTENERSCONFIGDUMP_STATICLISTENER']._serialized_options = b'\232\305\210\0368\n6envoy.admin.v2alpha.ListenersConfigDump.StaticListener'
  _globals['_LISTENERSCONFIGDUMP_DYNAMICLISTENERSTATE']._loaded_options = None
  _globals['_LISTENERSCONFIGDUMP_DYNAMICLISTENERSTATE']._serialized_options = b'\232\305\210\036>\n<envoy.admin.v2alpha.ListenersConfigDump.DynamicListenerState'
  _globals['_LISTENERSCONFIGDUMP_DYNAMICLISTENER']._loaded_options = None
  _globals['_LISTENERSCONFIGDUMP_DYNAMICLISTENER']._serialized_options = b'\232\305\210\0369\n7envoy.admin.v2alpha.ListenersConfigDump.DynamicListener'
  _globals['_LISTENERSCONFIGDUMP']._loaded_options = None
  _globals['_LISTENERSCONFIGDUMP']._serialized_options = b'\232\305\210\036)\n\'envoy.admin.v2alpha.ListenersConfigDump'
  _globals['_CLUSTERSCONFIGDUMP_STATICCLUSTER']._loaded_options = None
  _globals['_CLUSTERSCONFIGDUMP_STATICCLUSTER']._serialized_options = b'\232\305\210\0366\n4envoy.admin.v2alpha.ClustersConfigDump.StaticCluster'
  _globals['_CLUSTERSCONFIGDUMP_DYNAMICCLUSTER']._loaded_options = None
  _globals['_CLUSTERSCONFIGDUMP_DYNAMICCLUSTER']._serialized_options = b'\232\305\210\0367\n5envoy.admin.v2alpha.ClustersConfigDump.DynamicCluster'
  _globals['_CLUSTERSCONFIGDUMP']._loaded_options = None
  _globals['_CLUSTERSCONFIGDUMP']._serialized_options = b'\232\305\210\036(\n&envoy.admin.v2alpha.ClustersConfigDump'
  _globals['_ROUTESCONFIGDUMP_STATICROUTECONFIG']._loaded_options = None
  _globals['_ROUTESCONFIGDUMP_STATICROUTECONFIG']._serialized_options = b'\232\305\210\0368\n6envoy.admin.v2alpha.RoutesConfigDump.StaticRouteConfig'
  _globals['_ROUTESCONFIGDUMP_DYNAMICROUTECONFIG']._loaded_options = None
  _globals['_ROUTESCONFIGDUMP_DYNAMICROUTECONFIG']._serialized_options = b'\232\305\210\0369\n7envoy.admin.v2alpha.RoutesConfigDump.DynamicRouteConfig'
  _globals['_ROUTESCONFIGDUMP']._loaded_options = None
  _globals['_ROUTESCONFIGDUMP']._serialized_options = b'\232\305\210\036&\n$envoy.admin.v2alpha.RoutesConfigDump'
  _globals['_SCOPEDROUTESCONFIGDUMP_INLINESCOPEDROUTECONFIGS']._loaded_options = None
  _globals['_SCOPEDROUTESCONFIGDUMP_INLINESCOPEDROUTECONFIGS']._serialized_options = b'\232\305\210\036E\nCenvoy.admin.v2alpha.ScopedRoutesConfigDump.InlineScopedRouteConfigs'
  _globals['_SCOPEDROUTESCONFIGDUMP_DYNAMICSCOPEDROUTECONFIGS']._loaded_options = None
  _globals['_SCOPEDROUTESCONFIGDUMP_DYNAMICSCOPEDROUTECONFIGS']._serialized_options = b'\232\305\210\036F\nDenvoy.admin.v2alpha.ScopedRoutesConfigDump.DynamicScopedRouteConfigs'
  _globals['_SCOPEDROUTESCONFIGDUMP']._loaded_options = None
  _globals['_SCOPEDROUTESCONFIGDUMP']._serialized_options = b'\232\305\210\036,\n*envoy.admin.v2alpha.ScopedRoutesConfigDump'
  _globals['_ECDSCONFIGDUMP_ECDSFILTERCONFIG']._loaded_options = None
  _globals['_ECDSCONFIGDUMP_ECDSFILTERCONFIG']._serialized_options = b'\232\305\210\0365\n3envoy.admin.v2alpha.EcdsConfigDump.EcdsFilterConfig'
  _globals['_ECDSCONFIGDUMP']._loaded_options = None
  _globals['_ECDSCONFIGDUMP']._serialized_options = b'\232\305\210\036$\n\"envoy.admin.v2alpha.EcdsConfigDump'
