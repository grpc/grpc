...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TAPREQUEST'].fields_by_name['config_id']._loaded_options = None
  _globals['_TAPREQUEST'].fields_by_name['config_id']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_TAPREQUEST'].fields_by_name['tap_config']._loaded_options = None
  _globals['_TAPREQUEST'].fields_by_name['tap_config']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_TAPREQUEST']._loaded_options = None
  _globals['_TAPREQUEST']._serialized_options = b'\232\305\210\036 \n\036envoy.admin.v2alpha.TapRequest'
