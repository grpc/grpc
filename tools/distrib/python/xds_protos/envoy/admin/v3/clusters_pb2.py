...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CLUSTERS']._loaded_options = None
  _globals['_CLUSTERS']._serialized_options = b'\232\305\210\036\036\n\034envoy.admin.v2alpha.Clusters'
  _globals['_CLUSTERSTATUS']._loaded_options = None
  _globals['_CLUSTERSTATUS']._serialized_options = b'\232\305\210\036#\n!envoy.admin.v2alpha.ClusterStatus'
  _globals['_HOSTSTATUS']._loaded_options = None
  _globals['_HOSTSTATUS']._serialized_options = b'\232\305\210\036 \n\036envoy.admin.v2alpha.HostStatus'
  _globals['_HOSTHEALTHSTATUS']._loaded_options = None
  _globals['_HOSTHEALTHSTATUS']._serialized_options = b'\232\305\210\036&\n$envoy.admin.v2alpha.HostHealthStatus'
