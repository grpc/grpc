...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RATELIMITSTRATEGY_REQUESTSPERTIMEUNIT'].fields_by_name['time_unit']._loaded_options = None
  _globals['_RATELIMITSTRATEGY_REQUESTSPERTIMEUNIT'].fields_by_name['time_unit']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_RATELIMITSTRATEGY'].oneofs_by_name['strategy']._loaded_options = None
  _globals['_RATELIMITSTRATEGY'].oneofs_by_name['strategy']._serialized_options = b'\370B\001'
  _globals['_RATELIMITSTRATEGY'].fields_by_name['blanket_rule']._loaded_options = None
  _globals['_RATELIMITSTRATEGY'].fields_by_name['blanket_rule']._serialized_options = b'\372B\005\202\001\002\020\001'
