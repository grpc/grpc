...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PATHTRANSFORMATION_OPERATION'].oneofs_by_name['operation_specifier']._loaded_options = None
  _globals['_PATHTRANSFORMATION_OPERATION'].oneofs_by_name['operation_specifier']._serialized_options = b'\370B\001'
