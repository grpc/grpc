...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_VALUEMATCHER_NULLMATCH']._loaded_options = None
  _globals['_VALUEMATCHER_NULLMATCH']._serialized_options = b'\232\305\210\036+\n)envoy.type.matcher.ValueMatcher.NullMatch'
  _globals['_VALUEMATCHER'].oneofs_by_name['match_pattern']._loaded_options = None
  _globals['_VALUEMATCHER'].oneofs_by_name['match_pattern']._serialized_options = b'\370B\001'
  _globals['_VALUEMATCHER']._loaded_options = None
  _globals['_VALUEMATCHER']._serialized_options = b'\232\305\210\036!\n\037envoy.type.matcher.ValueMatcher'
  _globals['_LISTMATCHER'].oneofs_by_name['match_pattern']._loaded_options = None
  _globals['_LISTMATCHER'].oneofs_by_name['match_pattern']._serialized_options = b'\370B\001'
  _globals['_LISTMATCHER']._loaded_options = None
  _globals['_LISTMATCHER']._serialized_options = b'\232\305\210\036 \n\036envoy.type.matcher.ListMatcher'
  _globals['_ORMATCHER'].fields_by_name['value_matchers']._loaded_options = None
  _globals['_ORMATCHER'].fields_by_name['value_matchers']._serialized_options = b'\372B\005\222\001\002\010\002'
