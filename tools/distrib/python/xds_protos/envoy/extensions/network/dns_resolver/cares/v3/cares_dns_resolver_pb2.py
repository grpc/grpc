...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CARESDNSRESOLVERCONFIG'].fields_by_name['query_timeout_seconds']._loaded_options = None
  _globals['_CARESDNSRESOLVERCONFIG'].fields_by_name['query_timeout_seconds']._serialized_options = b'\372B\0042\002(\001'
  _globals['_CARESDNSRESOLVERCONFIG'].fields_by_name['query_tries']._loaded_options = None
  _globals['_CARESDNSRESOLVERCONFIG'].fields_by_name['query_tries']._serialized_options = b'\372B\004*\002(\001'
