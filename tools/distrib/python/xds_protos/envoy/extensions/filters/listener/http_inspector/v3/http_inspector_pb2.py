...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'envoy/extensions/filters/listener/http_inspector/v3/http_inspector.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_HTTPINSPECTOR']._loaded_options = None
  _globals['_HTTPINSPECTOR']._serialized_options = b'\232\305\210\036>\n<envoy.config.filter.listener.http_inspector.v2.HttpInspector'
