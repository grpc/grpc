...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FILTERCONFIG'].fields_by_name['content_type']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_FILTERCONFIG'].fields_by_name['response_size_header']._loaded_options = None
  _globals['_FILTERCONFIG'].fields_by_name['response_size_header']._serialized_options = b'\372B\010r\006\300\001\001\310\001\000'
  _globals['_FILTERCONFIG']._loaded_options = None
  _globals['_FILTERCONFIG']._serialized_options = b'\232\305\210\036J\nHenvoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1.FilterConfig'
  _globals['_FILTERCONFIGPERROUTE']._loaded_options = None
  _globals['_FILTERCONFIGPERROUTE']._serialized_options = b'\232\305\210\036R\nPenvoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1.FilterConfigPerRoute'
