...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GRPCFIELDEXTRACTIONCONFIG_EXTRACTIONSBYMETHODENTRY']._loaded_options = None
  _globals['_GRPCFIELDEXTRACTIONCONFIG_EXTRACTIONSBYMETHODENTRY']._serialized_options = b'8\001'
  _globals['_GRPCFIELDEXTRACTIONCONFIG'].fields_by_name['descriptor_set']._loaded_options = None
  _globals['_GRPCFIELDEXTRACTIONCONFIG'].fields_by_name['descriptor_set']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_FIELDEXTRACTIONS_REQUESTFIELDEXTRACTIONSENTRY']._loaded_options = None
  _globals['_FIELDEXTRACTIONS_REQUESTFIELDEXTRACTIONSENTRY']._serialized_options = b'8\001'
