...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_BUFFERBEHAVIOR'].oneofs_by_name['behavior']._loaded_options = None
  _globals['_BUFFERBEHAVIOR'].oneofs_by_name['behavior']._serialized_options = b'\370B\001'
  _globals['_STREAMCONFIG'].fields_by_name['memory_buffer_bytes_limit']._loaded_options = None
  _globals['_STREAMCONFIG'].fields_by_name['memory_buffer_bytes_limit']._serialized_options = b'\372B\0042\002 \000'
