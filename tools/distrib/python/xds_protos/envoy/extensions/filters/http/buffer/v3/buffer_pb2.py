...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'envoy/extensions/filters/http/buffer/v3/buffer.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_BUFFER'].fields_by_name['max_request_bytes']._loaded_options = None
  _globals['_BUFFER'].fields_by_name['max_request_bytes']._serialized_options = b'\372B\t*\002 \000\212\001\002\020\001'
  _globals['_BUFFER']._loaded_options = None
  _globals['_BUFFER']._serialized_options = b'\232\305\210\036+\n)envoy.config.filter.http.buffer.v2.Buffer'
  _globals['_BUFFERPERROUTE'].oneofs_by_name['override']._loaded_options = None
  _globals['_BUFFERPERROUTE'].oneofs_by_name['override']._serialized_options = b'\370B\001'
  _globals['_BUFFERPERROUTE'].fields_by_name['disabled']._loaded_options = None
  _globals['_BUFFERPERROUTE'].fields_by_name['disabled']._serialized_options = b'\372B\004j\002\010\001'
  _globals['_BUFFERPERROUTE'].fields_by_name['buffer']._loaded_options = None
  _globals['_BUFFERPERROUTE'].fields_by_name['buffer']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_BUFFERPERROUTE']._loaded_options = None
  _globals['_BUFFERPERROUTE']._serialized_options = b'\232\305\210\0363\n1envoy.config.filter.http.buffer.v2.BufferPerRoute'
