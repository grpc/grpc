...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CACHECONFIG_KEYCREATORPARAMS']._loaded_options = None
  _globals['_CACHECONFIG_KEYCREATORPARAMS']._serialized_options = b'\232\305\210\036E\nCenvoy.config.filter.http.cache.v2alpha.CacheConfig.KeyCreatorParams'
  _globals['_CACHECONFIG']._loaded_options = None
  _globals['_CACHECONFIG']._serialized_options = b'\232\305\210\0364\n2envoy.config.filter.http.cache.v2alpha.CacheConfig'
