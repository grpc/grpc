...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CONFIG'].fields_by_name['arn']._loaded_options = None
  _globals['_CONFIG'].fields_by_name['arn']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_CONFIG'].fields_by_name['invocation_mode']._loaded_options = None
  _globals['_CONFIG'].fields_by_name['invocation_mode']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_CONFIG']._loaded_options = None
  _globals['_CONFIG']._serialized_options = b'\232\305\210\0364\n2envoy.config.filter.http.aws_lambda.v2alpha.Config'
  _globals['_CREDENTIALS'].fields_by_name['access_key_id']._loaded_options = None
  _globals['_CREDENTIALS'].fields_by_name['access_key_id']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_CREDENTIALS'].fields_by_name['secret_access_key']._loaded_options = None
  _globals['_CREDENTIALS'].fields_by_name['secret_access_key']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_PERROUTECONFIG']._loaded_options = None
  _globals['_PERROUTECONFIG']._serialized_options = b'\232\305\210\036<\n:envoy.config.filter.http.aws_lambda.v2alpha.PerRouteConfig'
