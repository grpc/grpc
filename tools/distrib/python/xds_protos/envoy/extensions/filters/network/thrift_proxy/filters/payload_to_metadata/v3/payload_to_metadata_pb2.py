...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PAYLOADTOMETADATA_KEYVALUEPAIR'].fields_by_name['key']._loaded_options = None
  _globals['_PAYLOADTOMETADATA_KEYVALUEPAIR'].fields_by_name['key']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_PAYLOADTOMETADATA_KEYVALUEPAIR'].fields_by_name['type']._loaded_options = None
  _globals['_PAYLOADTOMETADATA_KEYVALUEPAIR'].fields_by_name['type']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_PAYLOADTOMETADATA_RULE'].oneofs_by_name['match_specifier']._loaded_options = None
  _globals['_PAYLOADTOMETADATA_RULE'].oneofs_by_name['match_specifier']._serialized_options = b'\370B\001'
  _globals['_PAYLOADTOMETADATA_RULE'].fields_by_name['field_selector']._loaded_options = None
  _globals['_PAYLOADTOMETADATA_RULE'].fields_by_name['field_selector']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_PAYLOADTOMETADATA_FIELDSELECTOR'].fields_by_name['name']._loaded_options = None
  _globals['_PAYLOADTOMETADATA_FIELDSELECTOR'].fields_by_name['name']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_PAYLOADTOMETADATA_FIELDSELECTOR'].fields_by_name['id']._loaded_options = None
  _globals['_PAYLOADTOMETADATA_FIELDSELECTOR'].fields_by_name['id']._serialized_options = b'\372B\021\032\017\030\377\377\001(\200\200\376\377\377\377\377\377\377\001'
  _globals['_PAYLOADTOMETADATA'].fields_by_name['request_rules']._loaded_options = None
  _globals['_PAYLOADTOMETADATA'].fields_by_name['request_rules']._serialized_options = b'\372B\005\222\001\002\010\001'
