...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'envoy/extensions/filters/network/generic_proxy/v3/generic_proxy.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GENERICPROXY'].oneofs_by_name['route_specifier']._loaded_options = None
  _globals['_GENERICPROXY'].oneofs_by_name['route_specifier']._serialized_options = b'\370B\001'
  _globals['_GENERICPROXY'].fields_by_name['stat_prefix']._loaded_options = None
  _globals['_GENERICPROXY'].fields_by_name['stat_prefix']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_GENERICPROXY'].fields_by_name['codec_config']._loaded_options = None
  _globals['_GENERICPROXY'].fields_by_name['codec_config']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_GENERICRDS'].fields_by_name['config_source']._loaded_options = None
  _globals['_GENERICRDS'].fields_by_name['config_source']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_GENERICRDS'].fields_by_name['route_config_name']._loaded_options = None
  _globals['_GENERICRDS'].fields_by_name['route_config_name']._serialized_options = b'\372B\004r\002\020\001'
