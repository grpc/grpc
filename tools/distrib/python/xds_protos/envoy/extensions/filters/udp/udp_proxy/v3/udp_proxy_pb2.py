...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_UDPPROXYCONFIG_HASHPOLICY'].oneofs_by_name['policy_specifier']._loaded_options = None
  _globals['_UDPPROXYCONFIG_HASHPOLICY'].oneofs_by_name['policy_specifier']._serialized_options = b'\370B\001'
  _globals['_UDPPROXYCONFIG_HASHPOLICY'].fields_by_name['source_ip']._loaded_options = None
  _globals['_UDPPROXYCONFIG_HASHPOLICY'].fields_by_name['source_ip']._serialized_options = b'\372B\004j\002\010\001'
  _globals['_UDPPROXYCONFIG_HASHPOLICY'].fields_by_name['key']._loaded_options = None
  _globals['_UDPPROXYCONFIG_HASHPOLICY'].fields_by_name['key']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_UDPPROXYCONFIG_SESSIONFILTER'].fields_by_name['name']._loaded_options = None
  _globals['_UDPPROXYCONFIG_SESSIONFILTER'].fields_by_name['name']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_UDPPROXYCONFIG_UDPTUNNELINGCONFIG'].fields_by_name['proxy_host']._loaded_options = None
  _globals['_UDPPROXYCONFIG_UDPTUNNELINGCONFIG'].fields_by_name['proxy_host']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_UDPPROXYCONFIG_UDPTUNNELINGCONFIG'].fields_by_name['target_host']._loaded_options = None
  _globals['_UDPPROXYCONFIG_UDPTUNNELINGCONFIG'].fields_by_name['target_host']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_UDPPROXYCONFIG_UDPTUNNELINGCONFIG'].fields_by_name['default_target_port']._loaded_options = None
  _globals['_UDPPROXYCONFIG_UDPTUNNELINGCONFIG'].fields_by_name['default_target_port']._serialized_options = b'\372B\010*\006\030\377\377\003 \000'
  _globals['_UDPPROXYCONFIG_UDPTUNNELINGCONFIG'].fields_by_name['headers_to_add']._loaded_options = None
  _globals['_UDPPROXYCONFIG_UDPTUNNELINGCONFIG'].fields_by_name['headers_to_add']._serialized_options = b'\372B\006\222\001\003\020\350\007'
  _globals['_UDPPROXYCONFIG_UDPACCESSLOGOPTIONS'].fields_by_name['access_log_flush_interval']._loaded_options = None
  _globals['_UDPPROXYCONFIG_UDPACCESSLOGOPTIONS'].fields_by_name['access_log_flush_interval']._serialized_options = b'\372B\t\252\001\0062\004\020\300\204='
  _globals['_UDPPROXYCONFIG'].oneofs_by_name['route_specifier']._loaded_options = None
  _globals['_UDPPROXYCONFIG'].oneofs_by_name['route_specifier']._serialized_options = b'\370B\001'
  _globals['_UDPPROXYCONFIG'].fields_by_name['stat_prefix']._loaded_options = None
  _globals['_UDPPROXYCONFIG'].fields_by_name['stat_prefix']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_UDPPROXYCONFIG'].fields_by_name['cluster']._loaded_options = None
  _globals['_UDPPROXYCONFIG'].fields_by_name['cluster']._serialized_options = b'\030\001\372B\004r\002\020\001\222\307\206\330\004\0033.0'
  _globals['_UDPPROXYCONFIG'].fields_by_name['matcher']._loaded_options = None
  _globals['_UDPPROXYCONFIG'].fields_by_name['matcher']._serialized_options = b'\322\306\244\341\006\002\010\001'
  _globals['_UDPPROXYCONFIG'].fields_by_name['hash_policies']._loaded_options = None
  _globals['_UDPPROXYCONFIG'].fields_by_name['hash_policies']._serialized_options = b'\372B\005\222\001\002\020\001'
  _globals['_UDPPROXYCONFIG']._loaded_options = None
  _globals['_UDPPROXYCONFIG']._serialized_options = b'\232\305\210\036:\n8envoy.config.filter.udp.udp_proxy.v2alpha.UdpProxyConfig'
  ...
  _globals['_UDPPROXYCONFIG_UDPACCESSLOGOPTIONS']._serialized_start=2598
  _globals['_UDPPROXYCONFIG_UDPACCESSLOGOPTIONS']._serialized_end=2741
