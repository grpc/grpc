...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FILTERSTATEVALUE'].oneofs_by_name['key']._loaded_options = None
  _globals['_FILTERSTATEVALUE'].oneofs_by_name['key']._serialized_options = b'\370B\001'
  _globals['_FILTERSTATEVALUE'].oneofs_by_name['value']._loaded_options = None
  _globals['_FILTERSTATEVALUE'].oneofs_by_name['value']._serialized_options = b'\370B\001'
  _globals['_FILTERSTATEVALUE'].fields_by_name['object_key']._loaded_options = None
  _globals['_FILTERSTATEVALUE'].fields_by_name['object_key']._serialized_options = b'\372B\004r\002\020\001'
