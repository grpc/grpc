...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'envoy/extensions/compression/brotli/compressor/v3/brotli.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_BROTLI'].fields_by_name['quality']._loaded_options = None
  _globals['_BROTLI'].fields_by_name['quality']._serialized_options = b'\372B\004*\002\030\013'
  _globals['_BROTLI'].fields_by_name['encoder_mode']._loaded_options = None
  _globals['_BROTLI'].fields_by_name['encoder_mode']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_BROTLI'].fields_by_name['window_bits']._loaded_options = None
  _globals['_BROTLI'].fields_by_name['window_bits']._serialized_options = b'\372B\006*\004\030\030(\n'
  _globals['_BROTLI'].fields_by_name['input_block_bits']._loaded_options = None
  _globals['_BROTLI'].fields_by_name['input_block_bits']._serialized_options = b'\372B\006*\004\030\030(\020'
