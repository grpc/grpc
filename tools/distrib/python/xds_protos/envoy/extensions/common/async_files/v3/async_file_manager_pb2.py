...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ASYNCFILEMANAGERCONFIG_THREADPOOL'].fields_by_name['thread_count']._loaded_options = None
  _globals['_ASYNCFILEMANAGERCONFIG_THREADPOOL'].fields_by_name['thread_count']._serialized_options = b'\372B\005*\003\030\200\010'
  _globals['_ASYNCFILEMANAGERCONFIG'].oneofs_by_name['manager_type']._loaded_options = None
  _globals['_ASYNCFILEMANAGERCONFIG'].oneofs_by_name['manager_type']._serialized_options = b'\370B\001'
