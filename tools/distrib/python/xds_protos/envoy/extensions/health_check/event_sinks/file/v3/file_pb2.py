...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_HEALTHCHECKEVENTFILESINK'].fields_by_name['event_log_path']._loaded_options = None
  _globals['_HEALTHCHECKEVENTFILESINK'].fields_by_name['event_log_path']._serialized_options = b'\372B\004r\002\020\001'
