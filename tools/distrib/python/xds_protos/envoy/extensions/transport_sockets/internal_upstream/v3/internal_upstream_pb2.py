...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'envoy/extensions/transport_sockets/internal_upstream/v3/internal_upstream.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_INTERNALUPSTREAMTRANSPORT_METADATAVALUESOURCE'].fields_by_name['kind']._loaded_options = None
  _globals['_INTERNALUPSTREAMTRANSPORT_METADATAVALUESOURCE'].fields_by_name['kind']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_INTERNALUPSTREAMTRANSPORT_METADATAVALUESOURCE'].fields_by_name['name']._loaded_options = None
  _globals['_INTERNALUPSTREAMTRANSPORT_METADATAVALUESOURCE'].fields_by_name['name']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_INTERNALUPSTREAMTRANSPORT'].fields_by_name['transport_socket']._loaded_options = None
  _globals['_INTERNALUPSTREAMTRANSPORT'].fields_by_name['transport_socket']._serialized_options = b'\372B\005\212\001\002\020\001'
