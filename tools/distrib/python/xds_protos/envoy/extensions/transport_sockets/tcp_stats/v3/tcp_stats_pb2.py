...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'envoy/extensions/transport_sockets/tcp_stats/v3/tcp_stats.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CONFIG'].fields_by_name['transport_socket']._loaded_options = None
  _globals['_CONFIG'].fields_by_name['transport_socket']._serialized_options = b'\372B\005\212\001\002\020\001'
