...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GENERICSECRET_SECRETSENTRY._options = None
  _GENERICSECRET_SECRETSENTRY._serialized_options = b'8\001'
  ...
  _GENERICSECRET.fields_by_name['secrets']._options = None
  _GENERICSECRET.fields_by_name['secrets']._serialized_options = b'\270\267\213\244\002\001'
