...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DOWNSTREAMCONNECTIONSCONFIG'].fields_by_name['max_active_downstream_connections']._loaded_options = None
  _globals['_DOWNSTREAMCONNECTIONSCONFIG'].fields_by_name['max_active_downstream_connections']._serialized_options = b'\372B\004\"\002 \000'
