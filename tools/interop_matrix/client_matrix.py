...
LANG_RELEASE_MATRIX = {
    ...
    'java':
    OrderedDict([
        ('v1.0.3', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.1.2', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.2.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.3.1', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.4.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.5.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.6.1', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.7.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.8.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.9.1', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.10.1', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.11.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.12.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.13.1', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.14.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.15.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.16.1', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.17.1', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.18.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
        ('v1.19.0', ReleaseInfo(runtimes=['java_oracle8'], testcases_file='java__v1.0.3')),
