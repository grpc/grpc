...
python tools/run_tests/task_runner.py -f artifact windows python %TASK_RUNNER_EXTRA_FILTERS% -j 2 --inner_jobs 5 -x build_artifacts_python/sponge_log.xml || set FAILED=true
