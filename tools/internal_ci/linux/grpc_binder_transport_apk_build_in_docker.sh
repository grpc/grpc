...
bazel_binder_example_app/bazel_wrapper build --define=use_strict_warning=true \
...
bazel_binder_connection_helper/bazel_wrapper build --define=use_strict_warning=true \
