...
tools/run_tests/task_runner.py -f artifact linux php -j "$(nproc)" -x build_artifacts/sponge_log.xml || FAILED="true"
...
tools/run_tests/task_runner.py -f distribtest linux php -j "$(nproc)" -x distribtests/sponge_log.xml || FAILED="true"
