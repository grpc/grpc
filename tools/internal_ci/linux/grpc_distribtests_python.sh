...
# [DO-NOT-SUBMIT]
tools/run_tests/task_runner.py -f artifact linux python presubmit -j 6 -x build_artifacts/sponge_log.xml || FAILED="true"
...
tools/run_tests/task_runner.py -f distribtest linux python presubmit -j 6 -x distribtests/sponge_log.xml || FAILED="true"
