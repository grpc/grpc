...
python3.9 -m pip install -U 'cython==3.1.1' setuptools==65.4.1 wheel --user
python3.10 -m pip install -U 'cython==3.1.1' setuptools==65.4.1 wheel --user
python3.11 -m pip install -U 'cython==3.1.1' setuptools==65.4.1 wheel --user
python3.12 -m pip install -U 'cython==3.1.1' setuptools==65.4.1 wheel --user --break-system-packages
python3.13 -m pip install -U 'cython==3.1.1' setuptools==65.4.1 wheel --user --break-system-packages
