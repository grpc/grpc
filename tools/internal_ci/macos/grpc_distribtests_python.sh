...
python3.9 -m pip install -U 'cython==3.2.1' setuptools==77.0.1 six==1.16.0 wheel --user
python3.10 -m pip install -U 'cython==3.2.1' setuptools==77.0.1 six==1.16.0 wheel --user
python3.11 -m pip install -U 'cython==3.2.1' setuptools==77.0.1 six==1.16.0 wheel --user
python3.12 -m pip install -U 'cython==3.2.1' setuptools==77.0.1 six==1.16.0 wheel --user --break-system-packages
python3.13 -m pip install -U 'cython==3.2.1' setuptools==77.0.1 six==1.16.0 wheel --user --break-system-packages
python3.14 -m pip install -U 'cython==3.2.1' setuptools==77.0.1 six==1.16.0 wheel --user --break-system-packages
