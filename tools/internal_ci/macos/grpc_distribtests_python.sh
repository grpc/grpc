...
python3.7 -m pip install -U 'cython<3.0.0rc1' setuptools==66.1.0 wheel --user
python3.8 -m pip install -U 'cython<3.0.0rc1' setuptools==66.1.0 wheel --user
python3.9 -m pip install -U 'cython<3.0.0rc1' setuptools==66.1.0 wheel --user
python3.10 -m pip install -U 'cython<3.0.0rc1' setuptools==66.1.0 wheel --user
python3.11 -m pip install -U 'cython<3.0.0rc1' setuptools==66.1.0 wheel --user
python3.12 -m pip install -U 'cython<3.0.0rc1' setuptools==66.1.0 wheel --user
