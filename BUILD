...
grpc_cc_library(
    ...
    hdrs = [
        "tsi/alts/crypt/gsec.h",
        "tsi/alts/frame_protector/alts_counter.h",
        "tsi/alts/frame_protector/alts_crypter.h",
        "tsi/alts/frame_protector/alts_frame_protector.h",
        "tsi/alts/frame_protector/alts_record_protocol_crypter_common.h",
        "tsi/alts/frame_protector/frame_handler.h",
        "tsi/alts/handshaker/alts_handshaker_client.h",
        "tsi/alts/handshaker/alts_shared_resource.h",
        "tsi/alts/handshaker/alts_tsi_handshaker.h",
        "tsi/alts/handshaker/alts_tsi_handshaker_private.h",
        "tsi/alts/handshaker/alts_tsi_utils.h",
        "tsi/alts/zero_copy_frame_protector/alts_grpc_integrity_only_record_protocol.h",
        "tsi/alts/zero_copy_frame_protector/alts_grpc_privacy_integrity_record_protocol.h",
        "tsi/alts/zero_copy_frame_protector/alts_grpc_record_protocol.h",
        "tsi/alts/zero_copy_frame_protector/alts_grpc_record_protocol_common.h",
        "tsi/alts/zero_copy_frame_protector/alts_iovec_record_protocol.h",
        "tsi/alts/zero_copy_frame_protector/alts_zero_copy_grpc_protector.h",
    ],
    external_deps = [
        "libssl",
        "libcrypto",
...
grpc_cc_library(
    ...
    hdrs = [
        "tsi/ssl/session_cache/ssl_session.h",
        "tsi/ssl/session_cache/ssl_session_cache.h",
    ],
    external_deps = [
        "absl/memory",
        "libssl",
...
grpc_cc_library(
    ...
    hdrs = [
        ...
        "tsi/ssl/key_logging/ssl_key_logging.h",
        "tsi/ssl_transport_security.h",
    ],
    external_deps = [
        "absl/base:core_headers",
        "absl/status",
