...
grpc_upb_proto_library(
    ...
    deps = ["@envoy_api//envoy/api/v2:pkg"],
)

grpc_upb_proto_reflection_library(
    name = "xds_ads_upb_proto_reflection",
    deps = ["@envoy_api//envoy/api/v2:pkg"],
)

grpc_upb_proto_library(
    name = "xds_hcm_upb_proto",
    deps = ["@envoy_api//envoy/config/filter/network/http_connection_manager/v2:pkg"],
)

grpc_upb_proto_reflection_library(
    name = "xds_hcm_upb_proto_reflection",
    deps = ["@envoy_api//envoy/config/filter/network/http_connection_manager/v2:pkg"],
)

grpc_upb_proto_library(
    name = "xds_lrs_upb_proto",
    deps = ["@envoy_api//envoy/service/load_stats/v2:pkg"],
)

grpc_upb_proto_reflection_library(
    name = "xds_lrs_upb_proto_reflection",
    deps = ["@envoy_api//envoy/service/load_stats/v2:pkg"],
)
...
grpc_cc_library(
    ...
    deps = [
        ":xds_ads_upb_proto",
        ":xds_ads_upb_proto_reflection",
        ":xds_hcm_upb_proto",
        ":xds_hcm_upb_proto_reflection",
        ":xds_lrs_upb_proto",
        ":xds_lrs_upb_proto_reflection",
    ],
)

grpc_upb_proto_library(
    name = "udpa_orca_upb_proto",
