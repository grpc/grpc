...
grpc_cc_library(
    ...
    srcs = GRPCXX_SRCS_UNSECURE,
    hdrs = GRPCXX_HDRS_UNSECURE,
    language = "c++",
    public_hdrs = GRPCXX_PUBLIC_HDRS_UNSECURE,
    deps = [
        "grpc++_codegen_base",
        "grpc++_codegen_base_src",
        "grpc_health_upb",
