...
grpc_cc_library(
    ...
    srcs = [
        ...
        "src/core/lib/security/credentials/tls/grpc_tls_file_watcher_certificate_provider.cc",
        "src/core/lib/security/credentials/tls/grpc_tls_static_file_certificate_provider.cc",
    ...
    hdrs = [
        ...
        "src/core/lib/security/credentials/tls/grpc_tls_file_watcher_certificate_provider.h",
        "src/core/lib/security/credentials/tls/grpc_tls_static_file_certificate_provider.h",
