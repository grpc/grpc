...
grpc_cc_library(
    name = "grpc_plugin_support_utils",
    hdrs = [
...
grpc_cc_library(
    name = "grpc_csharp_plugin_support",
    srcs = [
...
grpc_cc_library(
    name = "grpc_objective_c_plugin_support",
    srcs = [
