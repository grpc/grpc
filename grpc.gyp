...

{
  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        'third_party/s2a_core/s2a/src/crypto/aes_gcm_crypter.cc',
        'third_party/s2a_core/s2a/src/crypto/chacha_poly_crypter_boringssl.cc',
        'third_party/s2a_core/s2a/src/crypto/chacha_poly_crypter_openssl.cc',
        'third_party/s2a_core/s2a/src/crypto/hkdf.cc',
        'third_party/s2a_core/s2a/src/crypto/s2a_aead_crypter.cc',
        'third_party/s2a_core/s2a/src/crypto/s2a_aead_crypter_util.cc',
        'third_party/s2a_core/s2a/src/frame_protector/s2a_frame_protector.cc',
        'third_party/s2a_core/s2a/src/handshaker/s2a_context.cc',
        ...
        'third_party/s2a_core/s2a/src/record_protocol/s2a_half_connection.cc',
        'third_party/s2a_core/s2a/src/record_protocol/s2a_upb_ticket_sender.cc',
        'third_party/s2a_core/s2a/src/token_manager/single_token_access_token_manager.cc',
      ],
    },
    {
      'target_name': 'upb',
