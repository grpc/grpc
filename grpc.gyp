...

{
  ...
  'targets': [
    ...
    {
      'target_name': 'grpc_test_util_unsecure_minimal',
      'type': 'static_library',
      'dependencies': [
        'gpr',
        'gpr_test_util',
    ...
    {
      'target_name': 'grpc_unsecure_minimal',
      'type': 'static_library',
      'dependencies': [
        'gpr',
      ],
    ...
    {
      'target_name': 'grpc++_test_util_unsecure_minimal',
      'type': 'static_library',
      'dependencies': [
        'grpc++_unsecure_minimal',
        'grpc_test_util_unsecure_minimal',
        'grpc_unsecure_minimal',
      ],
      'sources': [
        'src/proto/grpc/health/v1/health.proto',
    ...
    {
      'target_name': 'grpc++_unsecure_minimal',
      'type': 'static_library',
      'dependencies': [
        'gpr',
        'grpc_unsecure_minimal',
