  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        'test/core/end2end/tests/retry_cancellation.c',
        'test/core/end2end/tests/retry_disabled.c',
        'test/core/end2end/tests/retry_exceeds_buffer_size_in_initial_batch.c',
        'test/core/end2end/tests/retry_exceeds_buffer_size_in_subsequent_batch.c',
        'test/core/end2end/tests/retry_non_retriable_status.c',
        'test/core/end2end/tests/retry_recv_initial_metadata.c',
        'test/core/end2end/tests/retry_recv_message.c',
        'test/core/end2end/tests/retry_server_pushback_delay.c',
        'test/core/end2end/tests/retry_server_pushback_disabled.c',
        'test/core/end2end/tests/retry_streaming.c',
        'test/core/end2end/tests/retry_streaming_after_commit.c',
        'test/core/end2end/tests/retry_streaming_succeeds_before_replay_finished.c',
        'test/core/end2end/tests/retry_throttled.c',
        'test/core/end2end/tests/retry_too_many_attempts.c',
