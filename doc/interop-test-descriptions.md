...
* --use_test_ca=BOOLEAN
    * Whether to replace platform root CAs with
      [ca.pem](https://github.com/grpc/grpc/blob/master/src/core/ext/tsi/test_creds/ca.pem)
      as the CA root
...
[server1.pem](https://github.com/grpc/grpc/blob/master/src/core/ext/tsi/test_creds/server1.pem)
