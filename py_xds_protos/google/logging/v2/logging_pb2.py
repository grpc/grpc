...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DELETELOGREQUEST'].fields_by_name['log_name']._serialized_options = b'\340A\002\372A\034\n\032logging.googleapis.com/Log'
  _globals['_WRITELOGENTRIESREQUEST_LABELSENTRY']._loaded_options = None
  _globals['_WRITELOGENTRIESREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['log_name']._loaded_options = None
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['log_name']._serialized_options = b'\340A\001\372A\034\n\032logging.googleapis.com/Log'
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['resource']._loaded_options = None
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['resource']._serialized_options = b'\340A\001'
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['labels']._loaded_options = None
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['labels']._serialized_options = b'\340A\001'
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['entries']._loaded_options = None
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['entries']._serialized_options = b'\340A\002'
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['partial_success']._loaded_options = None
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['partial_success']._serialized_options = b'\340A\001'
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['dry_run']._loaded_options = None
  _globals['_WRITELOGENTRIESREQUEST'].fields_by_name['dry_run']._serialized_options = b'\340A\001'
  _globals['_WRITELOGENTRIESPARTIALERRORS_LOGENTRYERRORSENTRY']._loaded_options = None
  _globals['_WRITELOGENTRIESPARTIALERRORS_LOGENTRYERRORSENTRY']._serialized_options = b'8\001'
  _globals['_LISTLOGENTRIESREQUEST'].fields_by_name['resource_names']._loaded_options = None
  _globals['_LISTLOGENTRIESREQUEST'].fields_by_name['resource_names']._serialized_options = b'\340A\002\372A\034\022\032logging.googleapis.com/Log'
  _globals['_LISTLOGENTRIESREQUEST'].fields_by_name['filter']._loaded_options = None
  _globals['_LISTLOGENTRIESREQUEST'].fields_by_name['filter']._serialized_options = b'\340A\001'
  _globals['_LISTLOGENTRIESREQUEST'].fields_by_name['order_by']._loaded_options = None
  _globals['_LISTLOGENTRIESREQUEST'].fields_by_name['order_by']._serialized_options = b'\340A\001'
  _globals['_LISTLOGENTRIESREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTLOGENTRIESREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTLOGENTRIESREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTLOGENTRIESREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_LISTMONITOREDRESOURCEDESCRIPTORSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTMONITOREDRESOURCEDESCRIPTORSREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTMONITOREDRESOURCEDESCRIPTORSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTMONITOREDRESOURCEDESCRIPTORSREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_LISTLOGSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTLOGSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A\034\022\032logging.googleapis.com/Log'
  _globals['_LISTLOGSREQUEST'].fields_by_name['resource_names']._loaded_options = None
  _globals['_LISTLOGSREQUEST'].fields_by_name['resource_names']._serialized_options = b'\340A\001\372A\034\022\032logging.googleapis.com/Log'
  _globals['_LISTLOGSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTLOGSREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTLOGSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTLOGSREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_TAILLOGENTRIESREQUEST'].fields_by_name['resource_names']._loaded_options = None
  _globals['_TAILLOGENTRIESREQUEST'].fields_by_name['resource_names']._serialized_options = b'\340A\002'
  _globals['_TAILLOGENTRIESREQUEST'].fields_by_name['filter']._loaded_options = None
  _globals['_TAILLOGENTRIESREQUEST'].fields_by_name['filter']._serialized_options = b'\340A\001'
  _globals['_TAILLOGENTRIESREQUEST'].fields_by_name['buffer_window']._loaded_options = None
  _globals['_TAILLOGENTRIESREQUEST'].fields_by_name['buffer_window']._serialized_options = b'\340A\001'
  ...
  _globals['_LOGGINGSERVICEV2'].methods_by_name['DeleteLog']._serialized_options = b'\332A\010log_name\202\323\344\223\002\266\001* /v2/{log_name=projects/*/logs/*}Z\033*\031/v2/{log_name=*/*/logs/*}Z\'*%/v2/{log_name=organizations/*/logs/*}Z!*\037/v2/{log_name=folders/*/logs/*}Z)*\'/v2/{log_name=billingAccounts/*/logs/*}'
  _globals['_LOGGINGSERVICEV2'].methods_by_name['WriteLogEntries']._loaded_options = None
  _globals['_LOGGINGSERVICEV2'].methods_by_name['WriteLogEntries']._serialized_options = b'\332A log_name,resource,labels,entries\202\323\344\223\002\026\"\021/v2/entries:write:\001*'
  _globals['_LOGGINGSERVICEV2'].methods_by_name['ListLogEntries']._loaded_options = None
  _globals['_LOGGINGSERVICEV2'].methods_by_name['ListLogEntries']._serialized_options = b'\332A\036resource_names,filter,order_by\202\323\344\223\002\025\"\020/v2/entries:list:\001*'
  _globals['_LOGGINGSERVICEV2'].methods_by_name['ListMonitoredResourceDescriptors']._loaded_options = None
  _globals['_LOGGINGSERVICEV2'].methods_by_name['ListMonitoredResourceDescriptors']._serialized_options = b'\202\323\344\223\002\"\022 /v2/monitoredResourceDescriptors'
  ...
  _globals['_LOGGINGSERVICEV2'].methods_by_name['TailLogEntries']._serialized_options = b'\202\323\344\223\002\025\"\020/v2/entries:tail:\001*'
