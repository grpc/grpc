...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DISTRIBUTIONVALUE_EXEMPLAR_ATTACHMENTSENTRY']._loaded_options = None
  _globals['_DISTRIBUTIONVALUE_EXEMPLAR_ATTACHMENTSENTRY']._serialized_options = b'8\001'
