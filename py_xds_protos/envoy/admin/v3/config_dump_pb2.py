...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CONFIGDUMP']._loaded_options = None
  _globals['_CONFIGDUMP']._serialized_options = b'\232\305\210\036 \n\036envoy.admin.v2alpha.ConfigDump'
  _globals['_BOOTSTRAPCONFIGDUMP']._loaded_options = None
  _globals['_BOOTSTRAPCONFIGDUMP']._serialized_options = b'\232\305\210\036)\n\'envoy.admin.v2alpha.BootstrapConfigDump'
  _globals['_SECRETSCONFIGDUMP_DYNAMICSECRET']._loaded_options = None
  _globals['_SECRETSCONFIGDUMP_DYNAMICSECRET']._serialized_options = b'\232\305\210\0365\n3envoy.admin.v2alpha.SecretsConfigDump.DynamicSecret'
  _globals['_SECRETSCONFIGDUMP_STATICSECRET']._loaded_options = None
  _globals['_SECRETSCONFIGDUMP_STATICSECRET']._serialized_options = b'\232\305\210\0364\n2envoy.admin.v2alpha.SecretsConfigDump.StaticSecret'
  _globals['_SECRETSCONFIGDUMP']._loaded_options = None
  _globals['_SECRETSCONFIGDUMP']._serialized_options = b'\232\305\210\036\'\n%envoy.admin.v2alpha.SecretsConfigDump'
