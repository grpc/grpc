...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_AWSREQUESTSIGNING'].fields_by_name['service_name']._serialized_options = b'\372B\004r\002 \001'
  _globals['_AWSREQUESTSIGNING'].fields_by_name['region']._loaded_options = None
  _globals['_AWSREQUESTSIGNING'].fields_by_name['region']._serialized_options = b'\372B\004r\002 \001'
