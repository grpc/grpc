...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GZIP'].fields_by_name['memory_level']._loaded_options = None
  _globals['_GZIP'].fields_by_name['memory_level']._serialized_options = b'\372B\006*\004\030\t(\001'
  _globals['_GZIP'].fields_by_name['content_length']._loaded_options = None
  _globals['_GZIP'].fields_by_name['content_length']._serialized_options = b'\030\001'
  _globals['_GZIP'].fields_by_name['compression_level']._loaded_options = None
  _globals['_GZIP'].fields_by_name['compression_level']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_GZIP'].fields_by_name['compression_strategy']._loaded_options = None
  _globals['_GZIP'].fields_by_name['compression_strategy']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_GZIP'].fields_by_name['content_type']._loaded_options = None
  _globals['_GZIP'].fields_by_name['content_type']._serialized_options = b'\030\001'
  _globals['_GZIP'].fields_by_name['disable_on_etag_header']._loaded_options = None
  _globals['_GZIP'].fields_by_name['disable_on_etag_header']._serialized_options = b'\030\001'
  _globals['_GZIP'].fields_by_name['remove_accept_encoding_header']._loaded_options = None
  _globals['_GZIP'].fields_by_name['remove_accept_encoding_header']._serialized_options = b'\030\001'
