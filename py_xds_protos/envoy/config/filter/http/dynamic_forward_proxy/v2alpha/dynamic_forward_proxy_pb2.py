...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PERROUTECONFIG'].fields_by_name['host_rewrite']._loaded_options = None
  ...
  _globals['_PERROUTECONFIG'].fields_by_name['auto_host_rewrite_header']._loaded_options = None
