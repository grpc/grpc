...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TRACING_HTTP'].fields_by_name['name']._serialized_options = b'\372B\004r\002 \001'
  _globals['_TRACING_HTTP'].fields_by_name['config']._loaded_options = None
  _globals['_TRACING_HTTP'].fields_by_name['config']._serialized_options = b'\030\001'
