...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ZIPKINCONFIG_COLLECTORENDPOINTVERSION'].values_by_name["HTTP_JSON_V1"]._loaded_options = None
  _globals['_ZIPKINCONFIG_COLLECTORENDPOINTVERSION'].values_by_name["HTTP_JSON_V1"]._serialized_options = b'\010\001\250\367\264\213\002\001'
  _globals['_ZIPKINCONFIG'].fields_by_name['collector_cluster']._loaded_options = None
  _globals['_ZIPKINCONFIG'].fields_by_name['collector_cluster']._serialized_options = b'\372B\004r\002 \001'
  _globals['_ZIPKINCONFIG'].fields_by_name['collector_endpoint']._loaded_options = None
  _globals['_ZIPKINCONFIG'].fields_by_name['collector_endpoint']._serialized_options = b'\372B\004r\002 \001'
