...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PRESERVECASEFORMATTERCONFIG'].fields_by_name['formatter_type_on_envoy_headers']._loaded_options = None
  _globals['_PRESERVECASEFORMATTERCONFIG'].fields_by_name['formatter_type_on_envoy_headers']._serialized_options = b'\372B\005\202\001\002\020\001'
