...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_REDIRECTPOLICY'].oneofs_by_name['redirect_action_specifier']._loaded_options = None
  _globals['_REDIRECTPOLICY'].oneofs_by_name['redirect_action_specifier']._serialized_options = b'\370B\001'
  _globals['_REDIRECTPOLICY'].fields_by_name['uri']._loaded_options = None
  _globals['_REDIRECTPOLICY'].fields_by_name['uri']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_REDIRECTPOLICY'].fields_by_name['status_code']._loaded_options = None
  _globals['_REDIRECTPOLICY'].fields_by_name['status_code']._serialized_options = b'\372B\010*\006\030\347\007(\310\001'
  _globals['_REDIRECTPOLICY'].fields_by_name['response_headers_to_add']._loaded_options = None
  _globals['_REDIRECTPOLICY'].fields_by_name['response_headers_to_add']._serialized_options = b'\372B\006\222\001\003\020\350\007'
  _globals['_REDIRECTPOLICY'].fields_by_name['request_headers_to_add']._loaded_options = None
  _globals['_REDIRECTPOLICY'].fields_by_name['request_headers_to_add']._serialized_options = b'\372B\006\222\001\003\020\350\007'
