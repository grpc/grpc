...
from envoy.extensions.clusters.dns.v3 import dns_cluster_pb2 as envoy_dot_extensions_dot_clusters_dot_dns_dot_v3_dot_dns__cluster__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CLUSTERCONFIG']._serialized_options = b'\232\305\210\036B\n@envoy.config.cluster.dynamic_forward_proxy.v2alpha.ClusterConfig'
  _globals['_SUBCLUSTERSCONFIG'].fields_by_name['lb_policy']._loaded_options = None
  _globals['_SUBCLUSTERSCONFIG'].fields_by_name['lb_policy']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_SUBCLUSTERSCONFIG'].fields_by_name['max_sub_clusters']._loaded_options = None
  _globals['_SUBCLUSTERSCONFIG'].fields_by_name['max_sub_clusters']._serialized_options = b'\372B\004*\002 \000'
  _globals['_SUBCLUSTERSCONFIG'].fields_by_name['sub_cluster_ttl']._loaded_options = None
  _globals['_SUBCLUSTERSCONFIG'].fields_by_name['sub_cluster_ttl']._serialized_options = b'\372B\005\252\001\002*\000'
  _globals['_CLUSTERCONFIG']._serialized_start=469
  _globals['_CLUSTERCONFIG']._serialized_end=866
  _globals['_SUBCLUSTERSCONFIG']._serialized_start=869
  _globals['_SUBCLUSTERSCONFIG']._serialized_end=1227
