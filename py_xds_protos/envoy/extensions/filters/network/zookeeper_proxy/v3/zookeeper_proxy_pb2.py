...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ZOOKEEPERPROXY'].fields_by_name['stat_prefix']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_ZOOKEEPERPROXY'].fields_by_name['default_latency_threshold']._loaded_options = None
  _globals['_ZOOKEEPERPROXY'].fields_by_name['default_latency_threshold']._serialized_options = b'\372B\t\252\001\0062\004\020\300\204='
  _globals['_ZOOKEEPERPROXY']._loaded_options = None
  _globals['_ZOOKEEPERPROXY']._serialized_options = b'\232\305\210\036E\nCenvoy.config.filter.network.zookeeper_proxy.v1alpha1.ZooKeeperProxy'
  _globals['_LATENCYTHRESHOLDOVERRIDE'].fields_by_name['opcode']._loaded_options = None
  _globals['_LATENCYTHRESHOLDOVERRIDE'].fields_by_name['opcode']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_LATENCYTHRESHOLDOVERRIDE'].fields_by_name['threshold']._loaded_options = None
  _globals['_LATENCYTHRESHOLDOVERRIDE'].fields_by_name['threshold']._serialized_options = b'\372B\013\252\001\010\010\0012\004\020\300\204='
