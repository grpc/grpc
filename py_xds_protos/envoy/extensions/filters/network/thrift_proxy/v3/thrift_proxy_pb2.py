...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PROTOCOLTYPE'].values_by_name["TWITTER"]._loaded_options = None
  _globals['_PROTOCOLTYPE'].values_by_name["TWITTER"]._serialized_options = b'\010\001\212\364\233\263\005\0033.0'
  _globals['_TRDS'].fields_by_name['config_source']._loaded_options = None
  _globals['_TRDS'].fields_by_name['config_source']._serialized_options = b'\372B\005\212\001\002\020\001'
  ...
  _globals['_THRIFTPROXY'].fields_by_name['stat_prefix']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_THRIFTPROXY'].fields_by_name['route_config']._loaded_options = None
  _globals['_THRIFTPROXY'].fields_by_name['route_config']._serialized_options = b'\362\230\376\217\005\021\022\017route_specifier'
  _globals['_THRIFTPROXY'].fields_by_name['trds']._loaded_options = None
  _globals['_THRIFTPROXY'].fields_by_name['trds']._serialized_options = b'\362\230\376\217\005\021\022\017route_specifier'
  _globals['_THRIFTPROXY']._loaded_options = None
  _globals['_THRIFTPROXY']._serialized_options = b'\232\305\210\036?\n=envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProxy'
  _globals['_THRIFTFILTER'].fields_by_name['name']._loaded_options = None
  _globals['_THRIFTFILTER'].fields_by_name['name']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_THRIFTFILTER']._loaded_options = None
  _globals['_THRIFTFILTER']._serialized_options = b'\232\305\210\036@\n>envoy.config.filter.network.thrift_proxy.v2alpha1.ThriftFilter'
  ...
  _globals['_THRIFTPROTOCOLOPTIONS']._loaded_options = None
  _globals['_THRIFTPROTOCOLOPTIONS']._serialized_options = b'\232\305\210\036I\nGenvoy.config.filter.network.thrift_proxy.v2alpha1.ThriftProtocolOptions'
