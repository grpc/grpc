...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    5,
    '',
    'envoy/extensions/filters/network/generic_proxy/action/v3/action.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ROUTEACTION_PERFILTERCONFIGENTRY']._loaded_options = None
  _globals['_ROUTEACTION_PERFILTERCONFIGENTRY']._serialized_options = b'8\001'
