...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_STATEFULSESSION']._serialized_end=342
  _globals['_STATEFULSESSIONPERROUTE']._serialized_start=345
  _globals['_STATEFULSESSIONPERROUTE']._serialized_end=512
