...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_KEYVALUEPAIR'].fields_by_name['key']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_FIELDSELECTOR'].fields_by_name['name']._loaded_options = None
  _globals['_FIELDSELECTOR'].fields_by_name['name']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_FIELDSELECTOR'].fields_by_name['id']._loaded_options = None
  _globals['_FIELDSELECTOR'].fields_by_name['id']._serialized_options = b'\372B\021\032\017\030\377\377\001(\200\200\376\377\377\377\377\377\377\001'
  _globals['_THRIFTTOMETADATA'].fields_by_name['transport']._loaded_options = None
  _globals['_THRIFTTOMETADATA'].fields_by_name['transport']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_THRIFTTOMETADATA'].fields_by_name['protocol']._loaded_options = None
  _globals['_THRIFTTOMETADATA'].fields_by_name['protocol']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_THRIFTTOMETADATA'].fields_by_name['allow_content_types']._loaded_options = None
  _globals['_THRIFTTOMETADATA'].fields_by_name['allow_content_types']._serialized_options = b'\372B\t\222\001\006\"\004r\002\020\001'
  _globals['_THRIFTTOMETADATAPERROUTE']._loaded_options = None
  _globals['_THRIFTTOMETADATAPERROUTE']._serialized_options = b'\322\306\244\341\006\002\010\001'
  _globals['_FIELD']._serialized_start=1608
  _globals['_FIELD']._serialized_end=1730
  ...
  _globals['_FIELDSELECTOR']._serialized_end=582
  _globals['_RULE']._serialized_start=585
  _globals['_RULE']._serialized_end=953
  _globals['_THRIFTTOMETADATA']._serialized_start=956
  _globals['_THRIFTTOMETADATA']._serialized_end=1402
  _globals['_THRIFTTOMETADATAPERROUTE']._serialized_start=1405
  _globals['_THRIFTTOMETADATAPERROUTE']._serialized_end=1606
