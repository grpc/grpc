...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'envoy/extensions/filters/http/cdn_loop/v3/cdn_loop.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CDNLOOPCONFIG'].fields_by_name['cdn_id']._loaded_options = None
  _globals['_CDNLOOPCONFIG'].fields_by_name['cdn_id']._serialized_options = b'\372B\004r\002\020\001'
