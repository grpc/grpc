...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_JSONTOMETADATA_KEYVALUEPAIR'].fields_by_name['key']._loaded_options = None
  _globals['_JSONTOMETADATA_KEYVALUEPAIR'].fields_by_name['key']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_JSONTOMETADATA_KEYVALUEPAIR'].fields_by_name['type']._loaded_options = None
  _globals['_JSONTOMETADATA_KEYVALUEPAIR'].fields_by_name['type']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_JSONTOMETADATA_SELECTOR'].fields_by_name['key']._loaded_options = None
  _globals['_JSONTOMETADATA_SELECTOR'].fields_by_name['key']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_JSONTOMETADATA_RULE'].fields_by_name['selectors']._loaded_options = None
  _globals['_JSONTOMETADATA_RULE'].fields_by_name['selectors']._serialized_options = b'\372B\005\222\001\002\010\001'
  _globals['_JSONTOMETADATA_MATCHRULES'].fields_by_name['rules']._loaded_options = None
  _globals['_JSONTOMETADATA_MATCHRULES'].fields_by_name['rules']._serialized_options = b'\372B\005\222\001\002\010\001'
  _globals['_JSONTOMETADATA_MATCHRULES'].fields_by_name['allow_content_types']._loaded_options = None
  _globals['_JSONTOMETADATA_MATCHRULES'].fields_by_name['allow_content_types']._serialized_options = b'\372B\t\222\001\006\"\004r\002\020\001'
