...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_IPTAGGING_IPTAG']._loaded_options = None
  _globals['_IPTAGGING_IPTAG']._serialized_options = b'\232\305\210\0368\n6envoy.config.filter.http.ip_tagging.v2.IPTagging.IPTag'
  _globals['_IPTAGGING_IPTAGHEADER'].fields_by_name['header']._loaded_options = None
