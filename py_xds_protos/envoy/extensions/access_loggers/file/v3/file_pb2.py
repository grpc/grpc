...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FILEACCESSLOG'].fields_by_name['path']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_FILEACCESSLOG'].fields_by_name['format']._loaded_options = None
  _globals['_FILEACCESSLOG'].fields_by_name['format']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_FILEACCESSLOG'].fields_by_name['json_format']._loaded_options = None
  _globals['_FILEACCESSLOG'].fields_by_name['json_format']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_FILEACCESSLOG'].fields_by_name['typed_json_format']._loaded_options = None
  _globals['_FILEACCESSLOG'].fields_by_name['typed_json_format']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_FILEACCESSLOG'].fields_by_name['log_format']._loaded_options = None
  _globals['_FILEACCESSLOG'].fields_by_name['log_format']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_FILEACCESSLOG']._loaded_options = None
  _globals['_FILEACCESSLOG']._serialized_options = b'\232\305\210\036)\n\'envoy.config.accesslog.v2.FileAccessLog'
