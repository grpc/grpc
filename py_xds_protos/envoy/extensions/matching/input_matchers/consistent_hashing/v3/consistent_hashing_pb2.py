...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CONSISTENTHASHING'].fields_by_name['modulo']._loaded_options = None
  _globals['_CONSISTENTHASHING'].fields_by_name['modulo']._serialized_options = b'\372B\004*\002 \000'
