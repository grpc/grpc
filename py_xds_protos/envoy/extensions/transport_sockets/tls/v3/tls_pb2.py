...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_UPSTREAMTLSCONTEXT'].fields_by_name['sni']._loaded_options = None
  _globals['_UPSTREAMTLSCONTEXT'].fields_by_name['sni']._serialized_options = b'\372B\005r\003(\377\001'
  _globals['_UPSTREAMTLSCONTEXT'].fields_by_name['enforce_rsa_key_usage']._loaded_options = None
  _globals['_UPSTREAMTLSCONTEXT'].fields_by_name['enforce_rsa_key_usage']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_UPSTREAMTLSCONTEXT']._loaded_options = None
  _globals['_UPSTREAMTLSCONTEXT']._serialized_options = b'\232\305\210\036&\n$envoy.api.v2.auth.UpstreamTlsContext'
  _globals['_DOWNSTREAMTLSCONTEXT'].fields_by_name['session_timeout']._loaded_options = None
  _globals['_DOWNSTREAMTLSCONTEXT'].fields_by_name['session_timeout']._serialized_options = b'\372B\r\252\001\n\032\006\010\200\200\200\200\0202\000'
  _globals['_DOWNSTREAMTLSCONTEXT'].fields_by_name['ocsp_staple_policy']._loaded_options = None
  _globals['_DOWNSTREAMTLSCONTEXT'].fields_by_name['ocsp_staple_policy']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_DOWNSTREAMTLSCONTEXT']._loaded_options = None
  _globals['_DOWNSTREAMTLSCONTEXT']._serialized_options = b'\232\305\210\036(\n&envoy.api.v2.auth.DownstreamTlsContext'
  _globals['_TLSKEYLOG'].fields_by_name['path']._loaded_options = None
  _globals['_TLSKEYLOG'].fields_by_name['path']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_COMMONTLSCONTEXT_CERTIFICATEPROVIDER'].oneofs_by_name['config']._loaded_options = None
  _globals['_COMMONTLSCONTEXT_CERTIFICATEPROVIDER'].oneofs_by_name['config']._serialized_options = b'\370B\001'
  _globals['_COMMONTLSCONTEXT_CERTIFICATEPROVIDER'].fields_by_name['name']._loaded_options = None
  _globals['_COMMONTLSCONTEXT_CERTIFICATEPROVIDER'].fields_by_name['name']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT'].fields_by_name['default_validation_context']._loaded_options = None
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT'].fields_by_name['default_validation_context']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT'].fields_by_name['validation_context_sds_secret_config']._loaded_options = None
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT'].fields_by_name['validation_context_sds_secret_config']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT'].fields_by_name['validation_context_certificate_provider']._loaded_options = None
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT'].fields_by_name['validation_context_certificate_provider']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT'].fields_by_name['validation_context_certificate_provider_instance']._loaded_options = None
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT'].fields_by_name['validation_context_certificate_provider_instance']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT']._loaded_options = None
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT']._serialized_options = b'\232\305\210\036I\nGenvoy.api.v2.auth.CommonTlsContext.CombinedCertificateValidationContext'
  _globals['_COMMONTLSCONTEXT'].fields_by_name['tls_certificate_certificate_provider']._loaded_options = None
  _globals['_COMMONTLSCONTEXT'].fields_by_name['tls_certificate_certificate_provider']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMMONTLSCONTEXT'].fields_by_name['tls_certificate_certificate_provider_instance']._loaded_options = None
  _globals['_COMMONTLSCONTEXT'].fields_by_name['tls_certificate_certificate_provider_instance']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMMONTLSCONTEXT'].fields_by_name['validation_context_certificate_provider']._loaded_options = None
  _globals['_COMMONTLSCONTEXT'].fields_by_name['validation_context_certificate_provider']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMMONTLSCONTEXT'].fields_by_name['validation_context_certificate_provider_instance']._loaded_options = None
  _globals['_COMMONTLSCONTEXT'].fields_by_name['validation_context_certificate_provider_instance']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMMONTLSCONTEXT']._loaded_options = None
  _globals['_COMMONTLSCONTEXT']._serialized_options = b'\232\305\210\036$\n\"envoy.api.v2.auth.CommonTlsContext'
  _globals['_UPSTREAMTLSCONTEXT']._serialized_start=477
  _globals['_UPSTREAMTLSCONTEXT']._serialized_end=867
  _globals['_DOWNSTREAMTLSCONTEXT']._serialized_start=870
  _globals['_DOWNSTREAMTLSCONTEXT']._serialized_end=1837
  _globals['_DOWNSTREAMTLSCONTEXT_OCSPSTAPLEPOLICY']._serialized_start=1684
  _globals['_DOWNSTREAMTLSCONTEXT_OCSPSTAPLEPOLICY']._serialized_end=1762
  _globals['_TLSKEYLOG']._serialized_start=1840
  _globals['_TLSKEYLOG']._serialized_end=1999
  _globals['_COMMONTLSCONTEXT']._serialized_start=2002
  _globals['_COMMONTLSCONTEXT']._serialized_end=4562
  _globals['_COMMONTLSCONTEXT_CERTIFICATEPROVIDER']._serialized_start=3618
  _globals['_COMMONTLSCONTEXT_CERTIFICATEPROVIDER']._serialized_end=3745
  _globals['_COMMONTLSCONTEXT_CERTIFICATEPROVIDERINSTANCE']._serialized_start=3747
  _globals['_COMMONTLSCONTEXT_CERTIFICATEPROVIDERINSTANCE']._serialized_end=3825
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT']._serialized_start=3828
  _globals['_COMMONTLSCONTEXT_COMBINEDCERTIFICATEVALIDATIONCONTEXT']._serialized_end=4486
