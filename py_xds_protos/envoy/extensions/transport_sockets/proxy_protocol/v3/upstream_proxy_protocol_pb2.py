...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PROXYPROTOCOLUPSTREAMTRANSPORT'].fields_by_name['transport_socket']._loaded_options = None
  _globals['_PROXYPROTOCOLUPSTREAMTRANSPORT'].fields_by_name['transport_socket']._serialized_options = b'\372B\005\212\001\002\020\001'
