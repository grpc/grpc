...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PERCENT'].fields_by_name['value']._loaded_options = None
  _globals['_PERCENT'].fields_by_name['value']._serialized_options = b'\372B\024\022\022\031\000\000\000\000\000\000Y@)\000\000\000\000\000\000\000\000'
  _globals['_PERCENT']._loaded_options = None
  _globals['_PERCENT']._serialized_options = b'\232\305\210\036\024\n\022envoy.type.Percent'
  _globals['_FRACTIONALPERCENT'].fields_by_name['denominator']._loaded_options = None
  _globals['_FRACTIONALPERCENT'].fields_by_name['denominator']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_FRACTIONALPERCENT']._loaded_options = None
  _globals['_FRACTIONALPERCENT']._serialized_options = b'\232\305\210\036\036\n\034envoy.type.FractionalPercent'
