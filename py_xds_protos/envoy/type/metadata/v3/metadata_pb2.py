...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_METADATAKEY_PATHSEGMENT'].fields_by_name['key']._serialized_options = b'\372B\004r\002\020\001'
  _globals['_METADATAKEY_PATHSEGMENT']._loaded_options = None
  _globals['_METADATAKEY_PATHSEGMENT']._serialized_options = b'\232\305\210\0360\n.envoy.type.metadata.v2.MetadataKey.PathSegment'
  _globals['_METADATAKEY'].fields_by_name['key']._loaded_options = None
  _globals['_METADATAKEY'].fields_by_name['key']._serialized_options = b'\372B\004r\002\020\001'
  ...
  _globals['_METADATAKEY']._loaded_options = None
  _globals['_METADATAKEY']._serialized_options = b'\232\305\210\036$\n\"envoy.type.metadata.v2.MetadataKey'
  _globals['_METADATAKIND_REQUEST']._loaded_options = None
  _globals['_METADATAKIND_REQUEST']._serialized_options = b'\232\305\210\036-\n+envoy.type.metadata.v2.MetadataKind.Request'
  _globals['_METADATAKIND_ROUTE']._loaded_options = None
  _globals['_METADATAKIND_ROUTE']._serialized_options = b'\232\305\210\036+\n)envoy.type.metadata.v2.MetadataKind.Route'
  _globals['_METADATAKIND_CLUSTER']._loaded_options = None
  _globals['_METADATAKIND_CLUSTER']._serialized_options = b'\232\305\210\036-\n+envoy.type.metadata.v2.MetadataKind.Cluster'
  _globals['_METADATAKIND_HOST']._loaded_options = None
  _globals['_METADATAKIND_HOST']._serialized_options = b'\232\305\210\036*\n(envoy.type.metadata.v2.MetadataKind.Host'
  ...
  _globals['_METADATAKIND']._loaded_options = None
  _globals['_METADATAKIND']._serialized_options = b'\232\305\210\036%\n#envoy.type.metadata.v2.MetadataKind'
