...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in envoy/service/accesslog/v3/als_pb2_grpc.py depends on'
...
def add_AccessLogServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('envoy.service.accesslog.v3.AccessLogService', rpc_method_handlers)
