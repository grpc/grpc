...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LDSDUMMY']._loaded_options = None
  _globals['_LDSDUMMY']._serialized_options = b'\232\305\210\036\027\n\025envoy.api.v2.LdsDummy'
  _globals['_LISTENERDISCOVERYSERVICE']._loaded_options = None
  _globals['_LISTENERDISCOVERYSERVICE']._serialized_options = b'\212\244\226\363\007#\n!envoy.config.listener.v3.Listener'
  _globals['_LISTENERDISCOVERYSERVICE'].methods_by_name['FetchListeners']._loaded_options = None
  _globals['_LISTENERDISCOVERYSERVICE'].methods_by_name['FetchListeners']._serialized_options = b'\202\323\344\223\002\034\"\027/v3/discovery:listeners:\001*'
