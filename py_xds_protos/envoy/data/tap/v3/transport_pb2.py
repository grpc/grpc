...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SOCKETEVENT_READ']._loaded_options = None
  _globals['_SOCKETEVENT_READ']._serialized_options = b'\232\305\210\036)\n\'envoy.data.tap.v2alpha.SocketEvent.Read'
  _globals['_SOCKETEVENT_WRITE']._loaded_options = None
  _globals['_SOCKETEVENT_WRITE']._serialized_options = b'\232\305\210\036*\n(envoy.data.tap.v2alpha.SocketEvent.Write'
  _globals['_SOCKETEVENT_CLOSED']._loaded_options = None
  _globals['_SOCKETEVENT_CLOSED']._serialized_options = b'\232\305\210\036+\n)envoy.data.tap.v2alpha.SocketEvent.Closed'
  _globals['_SOCKETEVENT']._loaded_options = None
  _globals['_SOCKETEVENT']._serialized_options = b'\232\305\210\036$\n\"envoy.data.tap.v2alpha.SocketEvent'
  _globals['_SOCKETBUFFEREDTRACE']._loaded_options = None
  _globals['_SOCKETBUFFEREDTRACE']._serialized_options = b'\232\305\210\036,\n*envoy.data.tap.v2alpha.SocketBufferedTrace'
  _globals['_SOCKETSTREAMEDTRACESEGMENT']._loaded_options = None
  _globals['_SOCKETSTREAMEDTRACESEGMENT']._serialized_options = b'\232\305\210\0363\n1envoy.data.tap.v2alpha.SocketStreamedTraceSegment'
  _globals['_SOCKETEVENT']._serialized_start=188
  _globals['_SOCKETEVENT']._serialized_end=814
  _globals['_SOCKETEVENT_READ']._serialized_start=483
  _globals['_SOCKETEVENT_READ']._serialized_end=576
  _globals['_SOCKETEVENT_WRITE']._serialized_start=578
  _globals['_SOCKETEVENT_WRITE']._serialized_end=693
  _globals['_SOCKETEVENT_CLOSED']._serialized_start=695
  _globals['_SOCKETEVENT_CLOSED']._serialized_end=753
  _globals['_SOCKETBUFFEREDTRACE']._serialized_start=817
  _globals['_SOCKETBUFFEREDTRACE']._serialized_end=1055
  _globals['_SOCKETEVENTS']._serialized_start=1057
  _globals['_SOCKETEVENTS']._serialized_end=1119
  _globals['_SOCKETSTREAMEDTRACESEGMENT']._serialized_start=1122
  _globals['_SOCKETSTREAMEDTRACESEGMENT']._serialized_end=1396
