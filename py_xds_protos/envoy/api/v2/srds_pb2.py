...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SCOPEDROUTESDISCOVERYSERVICE']._loaded_options = None
  _globals['_SCOPEDROUTESDISCOVERYSERVICE']._serialized_options = b'\212\244\226\363\007\'\n%envoy.api.v2.ScopedRouteConfiguration'
  _globals['_SCOPEDROUTESDISCOVERYSERVICE'].methods_by_name['FetchScopedRoutes']._loaded_options = None
  _globals['_SCOPEDROUTESDISCOVERYSERVICE'].methods_by_name['FetchScopedRoutes']._serialized_options = b'\202\323\344\223\002 \"\033/v2/discovery:scoped-routes:\001*'
