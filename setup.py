...
if sys.version_info.major < 3:
    msg =  "Python version {}.{} is not supported. " \
                     "The last release supporting Python 2 is 1.26. " \
                     "Either migrate to Python 3 or pin to 1.26.".format(sys.version_info.major,
...
EXTENSION_INCLUDE_DIRECTORIES = ((PYTHON_STEM,) + CORE_INCLUDE + SSL_INCLUDE +
                                 ZLIB_INCLUDE + NANOPB_INCLUDE + CARES_INCLUDE +
