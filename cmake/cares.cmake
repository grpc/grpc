...
elseif(gRPC_CARES_PROVIDER STREQUAL "package")
  if (MSVC)
    ...
    # for mingw/cygwin like environments
    find_package(PkgConfig REQUIRED)
    pkg_check_modules(C-ARES libcares>=1.13.0 REQUIRED)
  endif()

  if (WIN32)
     set(CARESPRIVLIBS "ws2_32")
  endif ()
  set(_gRPC_CARES_LIBRARIES ${C-ARES_LIBRARIES} ${CARESPRIVLIBS})
  set(_gRPC_CARES_CFLAGS ${C-ARES_CFLAGS})
