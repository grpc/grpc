...
func (m *StartTestSessionRequest) GetScenarios() []*Scenario {
	if m != nil {
		return m.Scenarios
	}
	return nil
...
type TestSessionResults struct {
	...
	ScenarioResults []*ScenarioResult `protobuf:"bytes,1,rep,name=scenario_results,json=scenarioResults,proto3" json:"scenario_results,omitempty"`
...
func (m *TestSessionResults) GetScenarioResults() []*ScenarioResult {
	if m != nil {
...
var fileDescriptor_a1b4997a3f60ea72 = []byte{
	...
	,
}
...
// TestSessionClient is the client API for TestSession service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type TestSessionClient interface {
	...
	StartTestSession(ctx context.Context, in *StartTestSessionRequest, opts ...grpc.CallOption) (*Operation, error)
}
...
func NewTestSessionClient(cc *grpc.ClientConn) TestSessionClient {
	return &testSessionClient{cc}
}

func (c *testSessionClient) StartTestSession(ctx context.Context, in *StartTestSessionRequest, opts ...grpc.CallOption) (*Operation, error) {
	out := new(Operation)
	err := c.cc.Invoke(ctx, "/proto.TestSession/StartTestSession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// TestSessionServer is the server API for TestSession service.
type TestSessionServer interface {
	// Starts a set of test scenarios.
	//
	// This is a long-running operation that is managed by the Operations service
	// on the same server.  The long-running operation will assign a unique
	...
	// like killing a running process. If they occur while results are being
	// reported, the persistent storage may receive some but not all of them.
	StartTestSession(context.Context, *StartTestSessionRequest) (*Operation, error)
}

// UnimplementedTestSessionServer can be embedded to have forward compatible implementations.
type UnimplementedTestSessionServer struct {
}

func (*UnimplementedTestSessionServer) StartTestSession(ctx context.Context, req *StartTestSessionRequest) (*Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartTestSession not implemented")
}

func RegisterTestSessionServer(s *grpc.Server, srv TestSessionServer) {
	s.RegisterService(&_TestSession_serviceDesc, srv)
}

func _TestSession_StartTestSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StartTestSessionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestSessionServer).StartTestSession(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.TestSession/StartTestSession",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestSessionServer).StartTestSession(ctx, req.(*StartTestSessionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _TestSession_serviceDesc = grpc.ServiceDesc{
	ServiceName: "proto.TestSession",
	HandlerType: (*TestSessionServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "StartTestSession",
			Handler:    _TestSession_StartTestSession_Handler,
		},
	},
