...
{
    /// <summary>
    /// Platform invoke method bindings for 64-bit Windows platforms
    /// </summary>
    internal class PlatformInvocationWin64 : IPlatformInvocation
    {
        // Environment

        [DllImport("grpc_csharp_ext-x64.dll")]
        ...
        [DllImport("grpc_csharp_ext-x64.dll", CharSet = CharSet.Ansi)]
