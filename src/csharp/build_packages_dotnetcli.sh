...
nuget pack Grpc.nuspec -Version "1.14.1" -OutputDirectory ../../artifacts
nuget pack Grpc.Core.NativeDebug.nuspec -Version "1.14.1" -OutputDirectory ../../artifacts
nuget pack Grpc.Tools.nuspec -Version "1.14.1" -OutputDirectory ../../artifacts
