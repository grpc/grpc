...
nuget pack Grpc.nuspec -Version "1.14.2" -OutputDirectory ../../artifacts
nuget pack Grpc.Core.NativeDebug.nuspec -Version "1.14.2" -OutputDirectory ../../artifacts
nuget pack Grpc.Tools.nuspec -Version "1.14.2" -OutputDirectory ../../artifacts
