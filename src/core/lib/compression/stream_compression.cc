...
bool
grpc_stream_compress (grpc_stream_compression_context * ctx,
...
bool
grpc_stream_decompress (grpc_stream_compression_context * ctx,
			grpc_slice_buffer * in, grpc_slice_buffer * out,
			size_t * output_size, size_t max_output_size,
			bool * end_of_context)
{
...
grpc_stream_compression_context_create (grpc_stream_compression_method method)
{
  switch (method)
    {
...
void
grpc_stream_compression_context_destroy (grpc_stream_compression_context *
					 ctx)
{
...
int
grpc_stream_compression_method_parse (grpc_slice value, bool is_compress,
