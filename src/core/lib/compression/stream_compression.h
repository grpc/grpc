...
struct grpc_stream_compression_vtable
{
  ...
  bool (*decompress) (grpc_stream_compression_context * ctx,
		      ...
		      bool * end_of_context);
  grpc_stream_compression_context
    *(*context_create) (grpc_stream_compression_method method);
 ...
 */
grpc_stream_compression_context
  *grpc_stream_compression_context_create (grpc_stream_compression_method
					   method);

/**
 * Destroys a stream compression context.
 */
void grpc_stream_compression_context_destroy (grpc_stream_compression_context
					      * ctx);
