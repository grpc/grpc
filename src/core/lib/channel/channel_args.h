...
grpc_channel_args *grpc_channel_args_copy_and_add (const grpc_channel_args *
						   src,
...
/** Copies the arguments in \a src except for those whose keys are in
    \a to_remove. */
grpc_channel_args *grpc_channel_args_copy_and_remove (const grpc_channel_args
						      * src,
...
grpc_channel_args *grpc_channel_args_copy_and_add_and_remove (const
							      grpc_channel_args
							      * src,
							      const char
							      **to_remove,
...
grpc_compression_algorithm grpc_channel_args_get_compression_algorithm (const
									grpc_channel_args
									* a);
...
grpc_channel_args
  *grpc_channel_args_set_stream_compression_algorithm (grpc_channel_args * a,
						       grpc_stream_compression_algorithm
						       algorithm);
 ...
 * input value of \a a). */
grpc_channel_args
  *grpc_channel_args_stream_compression_algorithm_set_state (grpc_channel_args
							     ** a,
							     grpc_stream_compression_algorithm
							     algorithm,
							     int enabled);
...
uint32_t grpc_channel_args_compression_algorithm_get_states (const
							     grpc_channel_args
							     * a);
...
uint32_t grpc_channel_args_stream_compression_algorithm_get_states (const
								    grpc_channel_args
								    * a);
...
grpc_channel_args *grpc_channel_args_set_socket_mutator (grpc_channel_args *
							 a,
							 grpc_socket_mutator *
							 mutator);
