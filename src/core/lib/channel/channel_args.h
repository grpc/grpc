...
inline int grpc_channel_arg_get_integer(const grpc_channel_args* args,
                                        const char* name,
                                        const grpc_integer_options options) {
...
/** convinience helper for the above that finds the arg first. */
inline char* grpc_channel_arg_get_string(const grpc_channel_args* args,
                                         const char* name) {
...
/** convinience helper for the above that finds the arg first. */
template <typename Type>
inline Type* grpc_channel_arg_get_pointer(const grpc_channel_args* args,
                                          const char* name) {
  return grpc_channel_arg_get_pointer<Type>(grpc_channel_args_find(args, name));
}

bool grpc_channel_arg_get_bool(const grpc_arg* arg, bool default_value);
inline bool grpc_channel_arg_get_bool(const grpc_channel_args* args,
