...
/// grpc_channel_stack_builder offers a programmatic interface to
/// selected and order channel filters
...
/// Assign a name to the channel stack: \a name must be statically
/// allocated
...
/// Begin iterating over already defined filters in the builder at the
/// beginning
grpc_channel_stack_builder_iterator*
...
/// Return an iterator at \a filter_name, or at the end of the list if
/// not found.
grpc_channel_stack_builder_iterator*
...
/// Remove any filter whose name is \a filter_name from \a builder.
/// Returns true if \a filter_name was not found.
...
/// Destroy the builder, return the freshly minted channel stack in \a
/// result. Allocates \a prefix_bytes bytes before the channel stack
