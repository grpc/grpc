...
#ifndef GRPC_CORE_EXT_FILTERS_CLIENT_CHANNEL_AUTHORITY_FILTER_H
#define GRPC_CORE_EXT_FILTERS_CLIENT_CHANNEL_AUTHORITY_FILTER_H
...
#endif  // GRPC_CORE_EXT_FILTERS_CLIENT_CHANNEL_AUTHORITY_FILTER_H
