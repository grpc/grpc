...
grpc_handshake_manager* grpc_handshake_manager_create() {
  grpc_handshake_manager* mgr = reinterpret_cast<grpc_handshake_manager*>(
...
void grpc_handshake_manager_add(grpc_handshake_manager* mgr,
  ...
  if (realloc_count > 0) {
    mgr->handshakers = reinterpret_cast<grpc_handshaker**>(gpr_realloc(
...
static void call_next_handshaker(grpc_exec_ctx* exec_ctx, void* arg,
                                 grpc_error* error) {
  grpc_handshake_manager* mgr = reinterpret_cast<grpc_handshake_manager*>(arg);
  gpr_mu_lock(&mgr->mu);
...
void grpc_handshake_manager_do_handshake(
  ...
  mgr->args.read_buffer = reinterpret_cast<grpc_slice_buffer*>(
