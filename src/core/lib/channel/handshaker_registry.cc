...
void HandshakerFactoryList::Register(bool at_start, std::unique_ptr<HandshakerFactory> factory) {
...
void HandshakerRegistry::RegisterHandshakerFactory(bool at_start, HandshakerType handshaker_type,
