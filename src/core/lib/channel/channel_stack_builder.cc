...
grpc_channel_stack_builder* grpc_channel_stack_builder_create(void) {
  grpc_channel_stack_builder* b =
      reinterpret_cast<grpc_channel_stack_builder*>(gpr_zalloc(sizeof(*b)));
...
static grpc_channel_stack_builder_iterator* create_iterator_at_filter_node(
  ...
  grpc_channel_stack_builder_iterator* it =
      reinterpret_cast<grpc_channel_stack_builder_iterator*>(
...
static void add_after(filter_node* before, const grpc_channel_filter* filter,
  ...
  filter_node* new_node =
      reinterpret_cast<filter_node*>(gpr_malloc(sizeof(*new_node)));
...
grpc_error* grpc_channel_stack_builder_finish(
  ...
  const grpc_channel_filter** filters =
      reinterpret_cast<const grpc_channel_filter**>(
  ...
  *result = gpr_zalloc(prefix_bytes + channel_stack_size);
  ...
  grpc_channel_stack* channel_stack = reinterpret_cast<grpc_channel_stack*>(
      reinterpret_cast<char*>(*result) + prefix_bytes);
  // and initialize it
