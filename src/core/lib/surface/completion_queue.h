...
bool
grpc_cq_begin_op (grpc_completion_queue * cc, void *tag);

/* Queue a GRPC_OP_COMPLETED operation; tag must correspond to the tag passed to
   grpc_cq_begin_op */
void
grpc_cq_end_op (grpc_completion_queue * cc, void *tag, grpc_error * error,
...
bool
grpc_cq_can_listen (grpc_completion_queue * cc);

grpc_cq_completion_type
grpc_get_cq_completion_type (grpc_completion_queue * cc);

int
grpc_get_cq_poll_num (grpc_completion_queue * cc);
