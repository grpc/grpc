...
const cq_poller_vtable g_poller_vtable_by_poller_type[] = {
    ...
    {true, true, maybe_event_engine_poller_size, maybe_event_engine_poller_init,
    ...
    {true, false, maybe_event_engine_poller_size,
     maybe_event_engine_poller_init, maybe_event_engine_poller_kick,
     maybe_event_engine_pollset_work, maybe_event_engine_poller_shutdown,
     maybe_event_engine_poller_destroy},
    // GRPC_CQ_NON_POLLING
