...
static void
alarm_ref (grpc_alarm * alarm)
{
  gpr_ref (&alarm->refs);
}

static void
alarm_unref (grpc_alarm * alarm)
{
...
#ifndef NDEBUG
static void
alarm_ref_dbg (grpc_alarm * alarm, const char *reason,
...
static void
alarm_unref_dbg (grpc_alarm * alarm, const char *reason,
		 const char *file, int line)
{
  if (grpc_trace_alarm_refcount.enabled ())
    {
...
static void
alarm_end_completion (void *arg, grpc_cq_completion * c)
{
...
static void
alarm_cb (void *arg, grpc_error * error)
{
  grpc_alarm *alarm = (grpc_alarm *) arg;
...
grpc_alarm *
grpc_alarm_create (void *reserved)
{
...
void
grpc_alarm_set (grpc_alarm * alarm, grpc_completion_queue * cq,
...
void
grpc_alarm_cancel (grpc_alarm * alarm, void *reserved)
{
  grpc_core::ExecCtx exec_ctx;
...
void
grpc_alarm_destroy (grpc_alarm * alarm, void *reserved)
{
