...
static void
json_writer_output_string_with_len (grpc_json_writer * writer,
...
void
grpc_json_writer_init (grpc_json_writer * writer, int indent,
...
static void
json_writer_escape_utf16 (grpc_json_writer * writer, uint16_t utf16)
{
...
void
grpc_json_writer_container_begins (grpc_json_writer * writer,
				   grpc_json_type type)
{
  if (!writer->got_key)
...
void
grpc_json_writer_container_ends (grpc_json_writer * writer,
				 grpc_json_type type)
{
...
void
grpc_json_writer_value_raw_with_len (grpc_json_writer * writer,
