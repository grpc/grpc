...
typedef enum {
  ...
  GRPC_STATS_HISTOGRAM_CALL_COMBINER_THREAD_SWITCH_FIRST_SLOT = 832,
  GRPC_STATS_HISTOGRAM_CALL_COMBINER_THREAD_SWITCH_BUCKETS = 8,
  GRPC_STATS_HISTOGRAM_SERVER_CQS_CHECKED_FIRST_SLOT = 840,
  GRPC_STATS_HISTOGRAM_SERVER_CQS_CHECKED_BUCKETS = 8,
  GRPC_STATS_HISTOGRAM_BUCKETS = 848
...
void grpc_stats_inc_http2_send_flowctl_per_write(grpc_exec_ctx *exec_ctx,
                                                 int x);
#define GRPC_STATS_INC_CALL_COMBINER_THREAD_SWITCH(exec_ctx, value) \
  grpc_stats_inc_call_combiner_thread_switch((exec_ctx), (int)(value))
void grpc_stats_inc_call_combiner_thread_switch(grpc_exec_ctx *exec_ctx, int x);
