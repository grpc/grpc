...
HistogramView GlobalStats::histogram(Histogram which) const {
  switch (which) {
    ...
    case Histogram::kCallInitialSize:
      return HistogramView{&Histogram_65536_26::BucketFor, kStatsTable0, 26, call_initial_size.buckets()};
    ...
    case Histogram::kHttp2MetadataSize:
      return HistogramView{&Histogram_65536_26::BucketFor, kStatsTable0, 26, http2_metadata_size.buckets()};
  }
}
