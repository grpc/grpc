...
grpc_slice grpc_slice_from_stream_owned_buffer(grpc_stream_refcount* refcount,
  ...
  res.data.refcounted.bytes = reinterpret_cast<uint8_t*>(buffer);
...
static void destroy_made_transport_op(grpc_exec_ctx* exec_ctx, void* arg,
                                      grpc_error* error) {
  made_transport_op* op = reinterpret_cast<made_transport_op*>(arg);
...
grpc_transport_op* grpc_make_transport_op(grpc_closure* on_complete) {
  made_transport_op* op =
      reinterpret_cast<made_transport_op*>(gpr_malloc(sizeof(*op)));
...
static void destroy_made_transport_stream_op(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  made_transport_stream_op* op =
      reinterpret_cast<made_transport_stream_op*>(arg);
...
grpc_transport_stream_op_batch* grpc_make_transport_stream_op(
  ...
  made_transport_stream_op* op =
      reinterpret_cast<made_transport_stream_op*>(gpr_zalloc(sizeof(*op)));
