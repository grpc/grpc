...
static void
move64 (uint64_t * from, uint64_t * to)
{
  *to += *from;
  *from = 0;
}
...
static void
destroy_made_transport_op (void *arg, grpc_error * error)
{
...
grpc_transport_op *
grpc_make_transport_op (grpc_closure * on_complete)
{
...
static void
destroy_made_transport_stream_op (void *arg, grpc_error * error)
{
...
grpc_make_transport_stream_op (grpc_closure * on_complete)
{
