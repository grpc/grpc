...
static uint8_t g_bytes[] = {
    ...
    45,  97,  116, 116, 101, 109, 112, 116, 115, 103, 114, 112, 99,  45,  114,
    101, 116, 114, 121, 45,  112, 117, 115, 104, 98,  97,  99,  107, 45,  109,
    115, 103, 114, 112, 99,  45,  116, 105, 109, 101, 111, 117, 116, 103, 114,
    ...
    99,  101, 76,  111, 97,  100, 48,  49,  50,  105, 100, 101, 110, 116, 105,
...
const grpc_slice grpc_static_slice_table[GRPC_STATIC_MDSTR_COUNT] = {
    ...
    {&grpc_static_metadata_refcounts[23], {{g_bytes + 309, 22}}},
    {&grpc_static_metadata_refcounts[24], {{g_bytes + 331, 12}}},
    {&grpc_static_metadata_refcounts[25], {{g_bytes + 343, 0}}},
    {&grpc_static_metadata_refcounts[26], {{g_bytes + 343, 19}}},
    {&grpc_static_metadata_refcounts[27], {{g_bytes + 362, 12}}},
    {&grpc_static_metadata_refcounts[28], {{g_bytes + 374, 30}}},
    {&grpc_static_metadata_refcounts[29], {{g_bytes + 404, 31}}},
    {&grpc_static_metadata_refcounts[30], {{g_bytes + 435, 36}}},
    {&grpc_static_metadata_refcounts[31], {{g_bytes + 471, 1}}},
    {&grpc_static_metadata_refcounts[32], {{g_bytes + 472, 1}}},
    {&grpc_static_metadata_refcounts[33], {{g_bytes + 473, 1}}},
    {&grpc_static_metadata_refcounts[34], {{g_bytes + 474, 8}}},
    {&grpc_static_metadata_refcounts[35], {{g_bytes + 482, 4}}},
    {&grpc_static_metadata_refcounts[36], {{g_bytes + 486, 7}}},
    {&grpc_static_metadata_refcounts[37], {{g_bytes + 493, 8}}},
    {&grpc_static_metadata_refcounts[38], {{g_bytes + 501, 16}}},
    {&grpc_static_metadata_refcounts[39], {{g_bytes + 517, 4}}},
    {&grpc_static_metadata_refcounts[40], {{g_bytes + 521, 3}}},
    {&grpc_static_metadata_refcounts[41], {{g_bytes + 524, 3}}},
    {&grpc_static_metadata_refcounts[42], {{g_bytes + 527, 4}}},
    {&grpc_static_metadata_refcounts[43], {{g_bytes + 531, 5}}},
    {&grpc_static_metadata_refcounts[44], {{g_bytes + 536, 4}}},
    {&grpc_static_metadata_refcounts[45], {{g_bytes + 540, 3}}},
    {&grpc_static_metadata_refcounts[46], {{g_bytes + 543, 3}}},
    {&grpc_static_metadata_refcounts[47], {{g_bytes + 546, 1}}},
    {&grpc_static_metadata_refcounts[48], {{g_bytes + 547, 11}}},
    {&grpc_static_metadata_refcounts[49], {{g_bytes + 558, 3}}},
    {&grpc_static_metadata_refcounts[50], {{g_bytes + 561, 3}}},
    {&grpc_static_metadata_refcounts[51], {{g_bytes + 564, 3}}},
    {&grpc_static_metadata_refcounts[52], {{g_bytes + 567, 3}}},
    {&grpc_static_metadata_refcounts[53], {{g_bytes + 570, 3}}},
    {&grpc_static_metadata_refcounts[54], {{g_bytes + 573, 14}}},
    {&grpc_static_metadata_refcounts[55], {{g_bytes + 587, 13}}},
    {&grpc_static_metadata_refcounts[56], {{g_bytes + 600, 15}}},
    {&grpc_static_metadata_refcounts[57], {{g_bytes + 615, 13}}},
    {&grpc_static_metadata_refcounts[58], {{g_bytes + 628, 6}}},
    {&grpc_static_metadata_refcounts[59], {{g_bytes + 634, 27}}},
    {&grpc_static_metadata_refcounts[60], {{g_bytes + 661, 3}}},
    {&grpc_static_metadata_refcounts[61], {{g_bytes + 664, 5}}},
    {&grpc_static_metadata_refcounts[62], {{g_bytes + 669, 13}}},
    {&grpc_static_metadata_refcounts[63], {{g_bytes + 682, 13}}},
    {&grpc_static_metadata_refcounts[64], {{g_bytes + 695, 19}}},
    {&grpc_static_metadata_refcounts[65], {{g_bytes + 714, 16}}},
    {&grpc_static_metadata_refcounts[66], {{g_bytes + 730, 14}}},
    {&grpc_static_metadata_refcounts[67], {{g_bytes + 744, 16}}},
    {&grpc_static_metadata_refcounts[68], {{g_bytes + 760, 13}}},
    {&grpc_static_metadata_refcounts[69], {{g_bytes + 773, 6}}},
    {&grpc_static_metadata_refcounts[70], {{g_bytes + 779, 4}}},
    {&grpc_static_metadata_refcounts[71], {{g_bytes + 783, 4}}},
    {&grpc_static_metadata_refcounts[72], {{g_bytes + 787, 6}}},
    {&grpc_static_metadata_refcounts[73], {{g_bytes + 793, 7}}},
    {&grpc_static_metadata_refcounts[74], {{g_bytes + 800, 4}}},
    {&grpc_static_metadata_refcounts[75], {{g_bytes + 804, 8}}},
    {&grpc_static_metadata_refcounts[76], {{g_bytes + 812, 17}}},
    {&grpc_static_metadata_refcounts[77], {{g_bytes + 829, 13}}},
    {&grpc_static_metadata_refcounts[78], {{g_bytes + 842, 8}}},
    {&grpc_static_metadata_refcounts[79], {{g_bytes + 850, 19}}},
    {&grpc_static_metadata_refcounts[80], {{g_bytes + 869, 13}}},
    {&grpc_static_metadata_refcounts[81], {{g_bytes + 882, 11}}},
    {&grpc_static_metadata_refcounts[82], {{g_bytes + 893, 4}}},
    {&grpc_static_metadata_refcounts[83], {{g_bytes + 897, 8}}},
    {&grpc_static_metadata_refcounts[84], {{g_bytes + 905, 12}}},
    {&grpc_static_metadata_refcounts[85], {{g_bytes + 917, 18}}},
    {&grpc_static_metadata_refcounts[86], {{g_bytes + 935, 19}}},
    {&grpc_static_metadata_refcounts[87], {{g_bytes + 954, 5}}},
    {&grpc_static_metadata_refcounts[88], {{g_bytes + 959, 7}}},
    {&grpc_static_metadata_refcounts[89], {{g_bytes + 966, 7}}},
    {&grpc_static_metadata_refcounts[90], {{g_bytes + 973, 11}}},
    {&grpc_static_metadata_refcounts[91], {{g_bytes + 984, 6}}},
    {&grpc_static_metadata_refcounts[92], {{g_bytes + 990, 10}}},
    {&grpc_static_metadata_refcounts[93], {{g_bytes + 1000, 25}}},
    {&grpc_static_metadata_refcounts[94], {{g_bytes + 1025, 17}}},
    {&grpc_static_metadata_refcounts[95], {{g_bytes + 1042, 4}}},
    {&grpc_static_metadata_refcounts[96], {{g_bytes + 1046, 3}}},
    {&grpc_static_metadata_refcounts[97], {{g_bytes + 1049, 16}}},
    {&grpc_static_metadata_refcounts[98], {{g_bytes + 1065, 16}}},
    {&grpc_static_metadata_refcounts[99], {{g_bytes + 1081, 13}}},
    {&grpc_static_metadata_refcounts[100], {{g_bytes + 1094, 12}}},
    {&grpc_static_metadata_refcounts[101], {{g_bytes + 1106, 21}}},
};
