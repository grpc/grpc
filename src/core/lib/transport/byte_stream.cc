...
bool
grpc_byte_stream_next (grpc_byte_stream * byte_stream, size_t max_size_hint,
...
grpc_error *
grpc_byte_stream_pull (grpc_byte_stream * byte_stream, grpc_slice * slice)
{
  return byte_stream->vtable->pull (byte_stream, slice);
}

void
grpc_byte_stream_shutdown (grpc_byte_stream * byte_stream, grpc_error * error)
{
  byte_stream->vtable->shutdown (byte_stream, error);
}

void
grpc_byte_stream_destroy (grpc_byte_stream * byte_stream)
{
...
static bool
slice_buffer_stream_next (grpc_byte_stream * byte_stream,
...
static grpc_error *
slice_buffer_stream_pull (grpc_byte_stream * byte_stream, grpc_slice * slice)
{
  grpc_slice_buffer_stream *stream = (grpc_slice_buffer_stream *) byte_stream;
...
static void
slice_buffer_stream_shutdown (grpc_byte_stream * byte_stream,
			      grpc_error * error)
{
  grpc_slice_buffer_stream *stream = (grpc_slice_buffer_stream *) byte_stream;
...
static void
slice_buffer_stream_destroy (grpc_byte_stream * byte_stream)
{
  grpc_slice_buffer_stream *stream = (grpc_slice_buffer_stream *) byte_stream;
...
void
grpc_slice_buffer_stream_init (grpc_slice_buffer_stream * stream,
...
void
grpc_byte_stream_cache_init (grpc_byte_stream_cache * cache,
...
void
grpc_byte_stream_cache_destroy (grpc_byte_stream_cache * cache)
{
...
static bool
caching_byte_stream_next (grpc_byte_stream * byte_stream,
			  size_t max_size_hint, grpc_closure * on_complete)
{
  ...
  if (stream->cursor < stream->cache->cache_buffer.count)
    return true;
  return grpc_byte_stream_next (stream->cache->underlying_stream,
				max_size_hint, on_complete);
}

static grpc_error *
caching_byte_stream_pull (grpc_byte_stream * byte_stream, grpc_slice * slice)
{
  grpc_caching_byte_stream *stream = (grpc_caching_byte_stream *) byte_stream;
  if (stream->shutdown_error != GRPC_ERROR_NONE)
    {
  ...
  if (stream->cursor < stream->cache->cache_buffer.count)
    {
      *slice =
	grpc_slice_ref_internal (stream->cache->cache_buffer.
				 slices[stream->cursor]);
      ++stream->cursor;
      return GRPC_ERROR_NONE;
    }
  grpc_error *error =
...
static void
caching_byte_stream_shutdown (grpc_byte_stream * byte_stream,
			      grpc_error * error)
{
  grpc_caching_byte_stream *stream = (grpc_caching_byte_stream *) byte_stream;
  GRPC_ERROR_UNREF (stream->shutdown_error);
...
static void
caching_byte_stream_destroy (grpc_byte_stream * byte_stream)
{
  grpc_caching_byte_stream *stream = (grpc_caching_byte_stream *) byte_stream;
  GRPC_ERROR_UNREF (stream->shutdown_error);
}
...
void
grpc_caching_byte_stream_init (grpc_caching_byte_stream * stream,
...
void
grpc_caching_byte_stream_reset (grpc_caching_byte_stream * stream)
{
  stream->cursor = 0;
}
