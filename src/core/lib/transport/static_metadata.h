...
#define GRPC_STATIC_MDSTR_COUNT 102
...
/* "" */
#define GRPC_MDSTR_EMPTY (grpc_static_slice_table[25])
/* "grpc.wait_for_ready" */
#define GRPC_MDSTR_GRPC_DOT_WAIT_FOR_READY (grpc_static_slice_table[26])
/* "grpc.timeout" */
#define GRPC_MDSTR_GRPC_DOT_TIMEOUT (grpc_static_slice_table[27])
...
#define GRPC_MDSTR_GRPC_DOT_MAX_RESPONSE_MESSAGE_BYTES \
  (grpc_static_slice_table[29])
/* "/grpc.lb.v1.LoadBalancer/BalanceLoad" */
#define GRPC_MDSTR_SLASH_GRPC_DOT_LB_DOT_V1_DOT_LOADBALANCER_SLASH_BALANCELOAD \
  (grpc_static_slice_table[30])
/* "0" */
#define GRPC_MDSTR_0 (grpc_static_slice_table[31])
/* "1" */
#define GRPC_MDSTR_1 (grpc_static_slice_table[32])
/* "2" */
#define GRPC_MDSTR_2 (grpc_static_slice_table[33])
/* "identity" */
#define GRPC_MDSTR_IDENTITY (grpc_static_slice_table[34])
/* "gzip" */
#define GRPC_MDSTR_GZIP (grpc_static_slice_table[35])
/* "deflate" */
#define GRPC_MDSTR_DEFLATE (grpc_static_slice_table[36])
/* "trailers" */
#define GRPC_MDSTR_TRAILERS (grpc_static_slice_table[37])
/* "application/grpc" */
#define GRPC_MDSTR_APPLICATION_SLASH_GRPC (grpc_static_slice_table[38])
/* "POST" */
#define GRPC_MDSTR_POST (grpc_static_slice_table[39])
/* "200" */
#define GRPC_MDSTR_200 (grpc_static_slice_table[40])
/* "404" */
#define GRPC_MDSTR_404 (grpc_static_slice_table[41])
/* "http" */
#define GRPC_MDSTR_HTTP (grpc_static_slice_table[42])
/* "https" */
#define GRPC_MDSTR_HTTPS (grpc_static_slice_table[43])
/* "grpc" */
#define GRPC_MDSTR_GRPC (grpc_static_slice_table[44])
/* "GET" */
#define GRPC_MDSTR_GET (grpc_static_slice_table[45])
/* "PUT" */
#define GRPC_MDSTR_PUT (grpc_static_slice_table[46])
/* "/" */
#define GRPC_MDSTR_SLASH (grpc_static_slice_table[47])
/* "/index.html" */
#define GRPC_MDSTR_SLASH_INDEX_DOT_HTML (grpc_static_slice_table[48])
/* "204" */
...
/* "lb-cost-bin" */
#define GRPC_MDSTR_LB_COST_BIN (grpc_static_slice_table[81])
/* "link" */
...
/* "identity,deflate" */
#define GRPC_MDSTR_IDENTITY_COMMA_DEFLATE (grpc_static_slice_table[98])
/* "identity,gzip" */
#define GRPC_MDSTR_IDENTITY_COMMA_GZIP (grpc_static_slice_table[99])
/* "deflate,gzip" */
#define GRPC_MDSTR_DEFLATE_COMMA_GZIP (grpc_static_slice_table[100])
/* "identity,deflate,gzip" */
#define GRPC_MDSTR_IDENTITY_COMMA_DEFLATE_COMMA_GZIP \
  (grpc_static_slice_table[101])
