...
/* "0" */
#define GRPC_MDSTR_0 (grpc_static_slice_table[35])
/* "identity" */
#define GRPC_MDSTR_IDENTITY (grpc_static_slice_table[36])
/* "gzip" */
#define GRPC_MDSTR_GZIP (grpc_static_slice_table[37])
/* "deflate" */
#define GRPC_MDSTR_DEFLATE (grpc_static_slice_table[38])
/* "trailers" */
#define GRPC_MDSTR_TRAILERS (grpc_static_slice_table[39])
/* "application/grpc" */
#define GRPC_MDSTR_APPLICATION_SLASH_GRPC (grpc_static_slice_table[40])
/* "POST" */
#define GRPC_MDSTR_POST (grpc_static_slice_table[41])
/* "200" */
#define GRPC_MDSTR_200 (grpc_static_slice_table[42])
/* "404" */
#define GRPC_MDSTR_404 (grpc_static_slice_table[43])
/* "http" */
#define GRPC_MDSTR_HTTP (grpc_static_slice_table[44])
/* "https" */
#define GRPC_MDSTR_HTTPS (grpc_static_slice_table[45])
/* "grpc" */
#define GRPC_MDSTR_GRPC (grpc_static_slice_table[46])
/* "GET" */
#define GRPC_MDSTR_GET (grpc_static_slice_table[47])
/* "PUT" */
#define GRPC_MDSTR_PUT (grpc_static_slice_table[48])
/* "/" */
#define GRPC_MDSTR_SLASH (grpc_static_slice_table[49])
/* "/index.html" */
#define GRPC_MDSTR_SLASH_INDEX_DOT_HTML (grpc_static_slice_table[50])
/* "204" */
...
/* "lb-cost-bin" */
#define GRPC_MDSTR_LB_COST_BIN (grpc_static_slice_table[83])
/* "link" */
...
/* "identity,deflate" */
#define GRPC_MDSTR_IDENTITY_COMMA_DEFLATE (grpc_static_slice_table[100])
/* "identity,gzip" */
#define GRPC_MDSTR_IDENTITY_COMMA_GZIP (grpc_static_slice_table[101])
/* "deflate,gzip" */
#define GRPC_MDSTR_DEFLATE_COMMA_GZIP (grpc_static_slice_table[102])
/* "identity,deflate,gzip" */
#define GRPC_MDSTR_IDENTITY_COMMA_DEFLATE_COMMA_GZIP \
  (grpc_static_slice_table[103])
