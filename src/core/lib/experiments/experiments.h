...
#define GRPC_EXPERIMENT_IS_INCLUDED_PEER_METADATA_HACK
inline bool IsPeerMetadataHackEnabled() { return true; }
...
#define GRPC_EXPERIMENT_IS_INCLUDED_PEER_METADATA_HACK
inline bool IsPeerMetadataHackEnabled() {
  return IsExperimentEnabled(kExperimentIdPeerMetadataHack);
}
