...
inline bool IsPh2OptimizationEnabled() { return false; }
...
#define GRPC_EXPERIMENT_IS_INCLUDED_PH2_OPTIMIZATION
inline bool IsPh2OptimizationEnabled() {
  return IsExperimentEnabled<kExperimentIdPh2Optimization>();
}
