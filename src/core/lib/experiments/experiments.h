...
#define GRPC_EXPERIMENT_IS_INCLUDED_BLOCK_EXCESSIVE_REQUESTS_BEFORE_SETTINGS_ACK
inline bool IsBlockExcessiveRequestsBeforeSettingsAckEnabled() { return IsExperimentEnabled(kExperimentIdBlockExcessiveRequestsBeforeSettingsAck); }
#define GRPC_EXPERIMENT_IS_INCLUDED_CALL_STATUS_OVERRIDE_ON_CANCELLATION
...
#define GRPC_EXPERIMENT_IS_INCLUDED_CHTTP2_BATCH_REQUESTS
inline bool IsChttp2BatchRequestsEnabled() { return IsExperimentEnabled(kExperimentIdChttp2BatchRequests); }
#define GRPC_EXPERIMENT_IS_INCLUDED_CHTTP2_OFFLOAD_ON_RST_STREAM
inline bool IsChttp2OffloadOnRstStreamEnabled() { return IsExperimentEnabled(kExperimentIdChttp2OffloadOnRstStream); }
#define GRPC_EXPERIMENT_IS_INCLUDED_CLIENT_IDLENESS
...
#define GRPC_EXPERIMENT_IS_INCLUDED_COMBINER_OFFLOAD_TO_EVENT_ENGINE
inline bool IsCombinerOffloadToEventEngineEnabled() { return IsExperimentEnabled(kExperimentIdCombinerOffloadToEventEngine); }
...
#define GRPC_EXPERIMENT_IS_INCLUDED_LAZIER_STREAM_UPDATES
inline bool IsLazierStreamUpdatesEnabled() { return IsExperimentEnabled(kExperimentIdLazierStreamUpdates); }
#define GRPC_EXPERIMENT_IS_INCLUDED_MEMORY_PRESSURE_CONTROLLER
inline bool IsMemoryPressureControllerEnabled() { return IsExperimentEnabled(kExperimentIdMemoryPressureController); }
#define GRPC_EXPERIMENT_IS_INCLUDED_MONITORING_EXPERIMENT
...
#define GRPC_EXPERIMENT_IS_INCLUDED_OVERLOAD_PROTECTION
inline bool IsOverloadProtectionEnabled() { return IsExperimentEnabled(kExperimentIdOverloadProtection); }
...
#define GRPC_EXPERIMENT_IS_INCLUDED_PING_ON_RST_STREAM
inline bool IsPingOnRstStreamEnabled() { return IsExperimentEnabled(kExperimentIdPingOnRstStream); }
...
inline bool IsRedMaxConcurrentStreamsEnabled() { return IsExperimentEnabled(kExperimentIdRedMaxConcurrentStreams); }
#define GRPC_EXPERIMENT_IS_INCLUDED_REGISTERED_METHOD_LOOKUP_IN_TRANSPORT
...
#define GRPC_EXPERIMENT_IS_INCLUDED_SEPARATE_PING_FROM_KEEPALIVE
inline bool IsSeparatePingFromKeepaliveEnabled() { return IsExperimentEnabled(kExperimentIdSeparatePingFromKeepalive); }
...
#define GRPC_EXPERIMENT_IS_INCLUDED_SETTINGS_TIMEOUT
inline bool IsSettingsTimeoutEnabled() { return IsExperimentEnabled(kExperimentIdSettingsTimeout); }
#define GRPC_EXPERIMENT_IS_INCLUDED_TARPIT
inline bool IsTarpitEnabled() { return IsExperimentEnabled(kExperimentIdTarpit); }
