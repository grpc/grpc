...
inline bool IsChttp2AllowConfigOverrideKeepalivePermitWithoutCallsEnabled() {
  return false;
}
#else
...
#define GRPC_EXPERIMENT_IS_INCLUDED_CHTTP2_ALLOW_CONFIG_OVERRIDE_KEEPALIVE_PERMIT_WITHOUT_CALLS
inline bool IsChttp2AllowConfigOverrideKeepalivePermitWithoutCallsEnabled() {
  return IsExperimentEnabled(19);
}
