...
inline bool IsFixV3FilterStackServerSideOrderingEnabled() { return IsExperimentEnabled<kExperimentIdFixV3FilterStackServerSideOrdering>(); }
...
#define GRPC_EXPERIMENT_IS_INCLUDED_HEADER_DATA_FRAME
inline bool IsHeaderDataFrameEnabled() { return IsExperimentEnabled<kExperimentIdHeaderDataFrame>(); }
#define GRPC_EXPERIMENT_IS_INCLUDED_INPROC_CANCEL_STREAM
...
inline bool IsOptimization06Enabled() { return IsExperimentEnabled<kExperimentIdOptimization06>(); }
