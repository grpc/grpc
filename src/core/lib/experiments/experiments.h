...
inline bool IsServerGlobalCallbacksOwnershipEnabled() { return IsExperimentEnabled<kExperimentIdServerGlobalCallbacksOwnership>(); }
#define GRPC_EXPERIMENT_IS_INCLUDED_SHARD_GLOBAL_CONNECTION_POOL
inline bool IsShardGlobalConnectionPoolEnabled() { return IsExperimentEnabled<kExperimentIdShardGlobalConnectionPool>(); }
