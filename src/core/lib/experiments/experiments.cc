...
const char* const description_jitter_max_idle = "Enable jitter on connection max idle times. Historically this jitter was only on max connection age, but it seems like this could smooth out some herding problems.";
...
const ExperimentMetadata g_experiment_metadata[] = {
  ...
  {"jitter_max_idle", description_jitter_max_idle, additional_constraints_jitter_max_idle, true, true},
