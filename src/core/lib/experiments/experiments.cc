...
const ExperimentMetadata g_experiment_metadata[] = {
    {"block_excessive_requests_before_settings_ack",
     ...
     additional_constraints_block_excessive_requests_before_settings_ack,
     required_experiments_block_excessive_requests_before_settings_ack, 0, true,
     true},
    {"call_status_override_on_cancellation",
     description_call_status_override_on_cancellation,
     additional_constraints_call_status_override_on_cancellation,
     required_experiments_call_status_override_on_cancellation, 0,
    ...
    {"client_privacy", description_client_privacy,
     additional_constraints_client_privacy, required_experiments_client_privacy,
     0, false, false},
    ...
    {"event_engine_dns", description_event_engine_dns,
     additional_constraints_event_engine_dns,
     required_experiments_event_engine_dns, 0, false, false},
    {"event_engine_listener", description_event_engine_listener,
     additional_constraints_event_engine_listener,
     required_experiments_event_engine_listener, 0, false, true},
    {"free_large_allocator", description_free_large_allocator,
     additional_constraints_free_large_allocator,
     required_experiments_free_large_allocator, 0, false, true},
    {"http2_stats_fix", description_http2_stats_fix,
     additional_constraints_http2_stats_fix,
     required_experiments_http2_stats_fix, 0, true, true},
    {"keepalive_fix", description_keepalive_fix,
     additional_constraints_keepalive_fix, required_experiments_keepalive_fix,
     0, false, false},
    {"keepalive_server_fix", description_keepalive_server_fix,
     additional_constraints_keepalive_server_fix,
     required_experiments_keepalive_server_fix, 0, false, false},
    {"lazier_stream_updates", description_lazier_stream_updates,
     additional_constraints_lazier_stream_updates,
     required_experiments_lazier_stream_updates, 0, true, true},
    {"memory_pressure_controller", description_memory_pressure_controller,
     additional_constraints_memory_pressure_controller,
     required_experiments_memory_pressure_controller, 0, false, true},
    {"monitoring_experiment", description_monitoring_experiment,
     additional_constraints_monitoring_experiment,
     required_experiments_monitoring_experiment, 0, true, true},
    {"multiping", description_multiping, additional_constraints_multiping,
     required_experiments_multiping, 0, false, true},
    {"overload_protection", description_overload_protection,
     additional_constraints_overload_protection,
     required_experiments_overload_protection, 0, true, true},
    {"peer_state_based_framing", description_peer_state_based_framing,
     additional_constraints_peer_state_based_framing,
     required_experiments_peer_state_based_framing, 0, false, true},
    {"pending_queue_cap", description_pending_queue_cap,
     additional_constraints_pending_queue_cap,
     required_experiments_pending_queue_cap, 0, true, true},
    {"pick_first_happy_eyeballs", description_pick_first_happy_eyeballs,
     additional_constraints_pick_first_happy_eyeballs,
     required_experiments_pick_first_happy_eyeballs, 0, true, true},
    {"ping_on_rst_stream", description_ping_on_rst_stream,
     additional_constraints_ping_on_rst_stream,
     required_experiments_ping_on_rst_stream, 0, true, true},
    {"promise_based_client_call", description_promise_based_client_call,
     additional_constraints_promise_based_client_call,
     required_experiments_promise_based_client_call, 0, false, true},
    {"promise_based_inproc_transport",
     description_promise_based_inproc_transport,
     additional_constraints_promise_based_inproc_transport,
     required_experiments_promise_based_inproc_transport, 0, false, false},
    ...
    {"red_max_concurrent_streams", description_red_max_concurrent_streams,
     additional_constraints_red_max_concurrent_streams,
     required_experiments_red_max_concurrent_streams, 0, false, true},
    {"registered_method_lookup_in_transport",
     description_registered_method_lookup_in_transport,
     additional_constraints_registered_method_lookup_in_transport,
     required_experiments_registered_method_lookup_in_transport, 0, true, true},
    {"registered_methods_map", description_registered_methods_map,
     additional_constraints_registered_methods_map,
     required_experiments_registered_methods_map, 0, false, true},
    {"rfc_max_concurrent_streams", description_rfc_max_concurrent_streams,
     additional_constraints_rfc_max_concurrent_streams,
     required_experiments_rfc_max_concurrent_streams, 0, false, true},
    {"round_robin_delegate_to_pick_first",
     description_round_robin_delegate_to_pick_first,
     additional_constraints_round_robin_delegate_to_pick_first,
     required_experiments_round_robin_delegate_to_pick_first, 0, true, true},
    {"rstpit", description_rstpit, additional_constraints_rstpit,
     required_experiments_rstpit, 0, false, true},
    {"schedule_cancellation_over_write",
     description_schedule_cancellation_over_write,
     additional_constraints_schedule_cancellation_over_write,
     required_experiments_schedule_cancellation_over_write, 0, false, true},
    {"separate_ping_from_keepalive", description_separate_ping_from_keepalive,
     additional_constraints_separate_ping_from_keepalive,
     required_experiments_separate_ping_from_keepalive, 0, true, true},
    {"server_privacy", description_server_privacy,
     additional_constraints_server_privacy, required_experiments_server_privacy,
     0, false, false},
    {"settings_timeout", description_settings_timeout,
     additional_constraints_settings_timeout,
     required_experiments_settings_timeout, 0, true, true},
    {"tarpit", description_tarpit, additional_constraints_tarpit,
     required_experiments_tarpit, 0, true, true},
    {"tcp_frame_size_tuning", description_tcp_frame_size_tuning,
     additional_constraints_tcp_frame_size_tuning,
     required_experiments_tcp_frame_size_tuning, 0, false, true},
    {"tcp_rcv_lowat", description_tcp_rcv_lowat,
     additional_constraints_tcp_rcv_lowat, required_experiments_tcp_rcv_lowat,
     0, false, true},
    {"trace_record_callops", description_trace_record_callops,
     additional_constraints_trace_record_callops,
     required_experiments_trace_record_callops, 0, false, true},
    {"unconstrained_max_quota_buffer_size",
     description_unconstrained_max_quota_buffer_size,
     additional_constraints_unconstrained_max_quota_buffer_size,
     required_experiments_unconstrained_max_quota_buffer_size, 0, false, true},
    {"uniquely_unowned", description_uniquely_unowned,
     additional_constraints_uniquely_unowned,
     required_experiments_uniquely_unowned, 0, true, true},
    {"work_serializer_clears_time_cache",
     ...
     required_experiments_work_serializer_clears_time_cache, 0, true, true},
...
const ExperimentMetadata g_experiment_metadata[] = {
    ...
    {"event_engine_listener", description_event_engine_listener,
     additional_constraints_event_engine_listener,
     required_experiments_event_engine_listener, 0, true, true},
    {"free_large_allocator", description_free_large_allocator,
     additional_constraints_free_large_allocator,
     required_experiments_free_large_allocator, 0, false, true},
    {"http2_stats_fix", description_http2_stats_fix,
