...
const ExperimentMetadata g_experiment_metadata[] = {
    ...
    {"client_privacy", description_client_privacy, false},
    {"canary_client_privacy", description_canary_client_privacy, false},
    {"server_privacy", description_server_privacy, false},
};
