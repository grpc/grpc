...
const char* const description_client_channel_subchannel_wrapper_work_serializer_orphan = "Client channel subchannel wrapper hops into WorkSerializer at Orphan() time, rather than requiring callers to do it.";
const char* const additional_constraints_client_channel_subchannel_wrapper_work_serializer_orphan = "{}";
...
const ExperimentMetadata g_experiment_metadata[] = {
  ...
  {"work_stealing", description_work_stealing, additional_constraints_work_stealing, true, false},
  ...
  {"client_channel_subchannel_wrapper_work_serializer_orphan", description_client_channel_subchannel_wrapper_work_serializer_orphan, additional_constraints_client_channel_subchannel_wrapper_work_serializer_orphan, true, true},
  {"chttp2_batch_requests", description_chttp2_batch_requests, additional_constraints_chttp2_batch_requests, false, true},
};
