...
GPR_GLOBAL_CONFIG_DEFINE_BOOL(grpc_experimental_enable_tcp_frame_size_tuning, false, description_tcp_frame_size_tuning);
...
const ExperimentMetadata g_experiment_metadata[] = {
  {"tcp_frame_size_tuning", description_tcp_frame_size_tuning, false, IsTcpFrameSizeTuningEnabled},
};
