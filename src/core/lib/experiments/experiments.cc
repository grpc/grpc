...
const char* const description_tcp_read_chunks = "Allocate only 8kb or 64kb chunks for TCP reads to reduce pressure on malloc to recycle arbitrary large blocks.";
...
const char* const description_flow_control_fixes = "Various fixes for flow control, max frame size setting.";
const char* const description_memory_pressure_controller = "New memory pressure controller";
const char* const description_periodic_resource_quota_reclamation = "Periodically return memory to the resource quota";
...
const char* const description_new_hpack_huffman_decoder = "New HPACK huffman decoder - should be much faster than the existing implementation.";
...
const char* const description_posix_event_engine_enable_polling = "If set, enables polling on the default posix event engine.";
...
const ExperimentMetadata g_experiment_metadata[] = {
  ...
  {"memory_pressure_controller", description_memory_pressure_controller, false},
  {"periodic_resource_quota_reclamation", description_periodic_resource_quota_reclamation, true},
  {"unconstrained_max_quota_buffer_size", description_unconstrained_max_quota_buffer_size, false},
  {"new_hpack_huffman_decoder", description_new_hpack_huffman_decoder, kDefaultForDebugOnly},
  ...
  {"posix_event_engine_enable_polling", description_posix_event_engine_enable_polling, kDefaultForDebugOnly},
