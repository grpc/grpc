...
const char* const description_round_robin_dualstack = "Change round_robin code to delegate to pick_first as per dualstack backend design.";
...
const ExperimentMetadata g_experiment_metadata[] = {
  ...
  {"round_robin_dualstack", description_round_robin_dualstack, additional_constraints_round_robin_dualstack, true, true},
};
