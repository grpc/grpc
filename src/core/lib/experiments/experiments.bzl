...
"""Dictionary of gRPC experiments."""

EXPERIMENTS = [
    {
        "name": "buffer_list_deletion_prep",
        "description": "Gate the removal of old TCP timestamp collection mechanism.",
        "expiry": "2026/05/01",
    ...
    {
        "name": "chaotic_good_send_supported_features",
        "description": "Send supported features in chaotic good settings frames.",
        "expiry": "2026/05/01",
        "owner": "ctiller@google.com",
        "test_tags": ["core_end2end_test"],
    },
    {
        ...
        "expiry": "2026/04/01",
        "owner": "roth@google.com",
        "test_tags": ["core_end2end_test", "cpp_end2end_test", "xds_end2end_test", "error_tests"],
        "allow_in_fuzzing_config": False,
    },
    {
    ...
    },
    {
        ...
        "allow_in_fuzzing_config": False,
        "uses_polling": True,
        "requires": ["event_engine_client", "event_engine_listener", "event_engine_dns", "event_engine_dns_non_client_channel"],
    },
    {
    ...
    },
    {
        ...
        "description": "Avoid explicitly cancelling the keepalive timer. Instead adjust the callback to re-schedule itself to the next ping interval.",
        "expiry": "2026/05/01",
        "owner": "vigneshbabu@google.com",
        "test_tags": [],
    },
    ...
    },
    {
        ...
        "description": "Publish metadata to the app using the kPublishToApp metadata field.",
        "expiry": "2026/04/01",
        "owner": "leonzz@google.com",
        "test_tags": [],
    },
    {
    ...
    },
    {
        ...
        "description": "When the subchannel goes from READY to CONNECTING or TRANSIENT_FAILURE, pick_first goes to CONNECTING and starts a new Happy Eyeballs pass.",
        "expiry": "2026/05/01",
        "owner": "roth@google.com",
    ...
    },
    {
        ...
        "description": "Code outside iomgr that relies directly on pollsets will use non-pollset alternatives when enabled.",
        "expiry": "2026/04/23",
        "owner": "mlumish@google.com",
        "test_tags": ["core_end2end_test"],
        "requires": ["event_engine_client", "event_engine_listener"],
    ...
    },
    {
        ...
        "description": "Prioritize flushing out finished requests over other in-flight requests during transport writes.",
        "expiry": "2026/05/01",
        "owner": "vigneshbabu@google.com",
        "test_tags": [],
    },
    {
        ...
        "description": "Use promises for the http2 client transport. We have kept client and server transport experiments separate to help with smoother roll outs and also help with interop testing.",
        "expiry": "2027/01/16",
    ...
    },
    {
        ...
        "description": "Use promises for the http2 server transport. We have kept client and server transport experiments separate to help with smoother roll outs and also help with interop testing.",
        "expiry": "2027/01/16",
        "owner": "tjagtap@google.com",
        "test_tags": [],
        "allow_in_fuzzing_config": True,
    ...
    },
    {
        ...
        "description": "Enables sending all trailing metadata fields from server side promise-based filters upon stream cancellation.",
        "expiry": "2026/04/01",
        "owner": "akshitpatel@google.com",
        "test_tags": ["core_end2end_test"],
        "allow_in_fuzzing_config": True,
    ...
    {
        "name": "return_preexisting_errors",
        "description": "Return errors that exist before the start of the call in RunHandler.",
        "expiry": "2026/06/30",
        "owner": "aananthv@google.com",
        "test_tags": [],
    },
    {
        "name": "rr_wrr_connect_from_random_index",
        "description": "RR and WRR LB policies start connecting from a random index in the address list.",
        "expiry": "2026/04/01",
        "owner": "roth@google.com",
        "test_tags": ["lb_unit_test", "cpp_lb_end2end_test"],
    },
    ...
    {
        "name": "secure_endpoint_read_coalescing",
        "description": "Coalesce decrypted bytes in SecureEndpoint if a read_hint is provided.",
        "expiry": "2026/06/01",
        "owner": "aananthv@google.com",
        "test_tags": ["core_end2end_test"],
        "requires": ["event_engine_client", "event_engine_listener"],
    },
    {
        ...
        "description": "If set, skips clearing of peer string on call cancellation.",
        "expiry": "2026/05/01",
        "owner": "vigneshbabu@google.com",
        "test_tags": [],
    },
    ...
    {
        "name": "subchannel_connection_scaling",
        "description": "Subchannel connection scaling support.",
        "expiry": "2026/07/01",
        "owner": "roth@google.com",
        "test_tags": ["core_end2end_test", "cpp_lb_end2end_test", "chttp2_keepalive_tests"],
    },
    {
        "name": "subchannel_wrapper_cleanup_on_orphan",
        "description": "Fixes the subchannel wrapper to drop any non-cancelled watchers when it gets orphaned.",
        "expiry": "2026/05/15",
        "owner": "roth@google.com",
    ...
    },
    {
        ...
        "description": "If set, enables TCP to use RPC size estimation made by higher layers. TCP would not indicate completion of a read operation until a specified number of bytes have been read over the socket. Buffers are also allocated according to estimated RPC sizes.",
        "expiry": "2026/08/01",
        "owner": "vigneshbabu@google.com",
    ...
    },
    {
        ...
        "description": "Use the call event engine to run callbacks in completion queue.",
        "expiry": "2026/06/01",
        "owner": "aananthv@google.com",
        "test_tags": ["core_end2end_test"],
    },
    {
        "name": "wildcard_ip_expansion_restriction",
        "description": "If set, adds optional restriction on when to expand wildcard IPs.",
        "expiry": "2026/07/01",
        "owner": "alishananda@google.com",
        "test_tags": ["core_end2end_test"],
    },
    {
        ...
        "description": "xDS channels use a separate filter chain for each route.",
        "expiry": "2026/06/01",
        "owner": "roth@google.com",
