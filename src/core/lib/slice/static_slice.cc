...
const StaticMetadataSlice
    g_static_metadata_slice_table[GRPC_STATIC_MDSTR_COUNT] = {
        ...
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[19].base, 26,
            g_static_metadata_bytes + 270),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[20].base, 22,
            g_static_metadata_bytes + 296),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[21].base, 27,
            g_static_metadata_bytes + 318),
        grpc_core::StaticMetadataSlice(
            &g_static_metadata_slice_refcounts[22].base, 12,
