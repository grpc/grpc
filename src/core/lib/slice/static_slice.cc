...
const uint8_t g_static_metadata_bytes[] = {
    ...
    117, 115, 103, 114, 112, 99,  45,  112, 97,  121, 108, 111, 97,  100, 45,
    98,  105, 110, 103, 114, 112, 99,  45,  101, 110, 99,  111, 100, 105, 110,
    103, 103, 114, 112, 99,  45,  97,  99,  99,  101, 112, 116, 45,  101, 110,
    99,  111, 100, 105, 110, 103, 103, 114, 112, 99,  45,  115, 101, 114, 118,
    101, 114, 45,  115, 116, 97,  116, 115, 45,  98,  105, 110, 103, 114, 112,
    99,  45,  116, 97,  103, 115, 45,  98,  105, 110, 103, 114, 112, 99,  45,
    116, 114, 97,  99,  101, 45,  98,  105, 110, 99,  111, 110, 116, 101, 110,
    ...
    114, 101, 113, 117, 101, 115, 116, 103, 114, 112, 99,  45,  105, 110, 116,
    101, 114, 110, 97,  108, 45,  115, 116, 114, 101, 97,  109, 45,  101, 110,
    99,  111, 100, 105, 110, 103, 45,  114, 101, 113, 117, 101, 115, 116, 103,
    114, 112, 99,  45,  112, 114, 101, 118, 105, 111, 117, 115, 45,  114, 112,
    99,  45,  97,  116, 116, 101, 109, 112, 116, 115, 103, 114, 112, 99,  45,
    114, 101, 116, 114, 121, 45,  112, 117, 115, 104, 98,  97,  99,  107, 45,
    109, 115, 120, 45,  101, 110, 100, 112, 111, 105, 110, 116, 45,  108, 111,
    97,  100, 45,  109, 101, 116, 114, 105, 99,  115, 45,  98,  105, 110, 104,
    111, 115, 116, 103, 114, 112, 99,  45,  116, 105, 109, 101, 111, 117, 116,
    117, 115, 101, 114, 45,  97,  103, 101, 110, 116, 103, 114, 112, 99,  45,
    109, 101, 115, 115, 97,  103, 101, 49,  50,  51,  52,  103, 114, 112, 99,
...
const StaticMetadataSlice
    g_static_metadata_slice_table[GRPC_STATIC_MDSTR_COUNT] = {
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[6].base, 16,
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[9].base, 21,
                            g_static_metadata_bytes + 96),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[10].base, 13,
                            g_static_metadata_bytes + 117),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[11].base, 14,
                            g_static_metadata_bytes + 130),
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[15].base, 30,
                            g_static_metadata_bytes + 187),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[16].base, 37,
                            g_static_metadata_bytes + 217),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[17].base, 26,
                            g_static_metadata_bytes + 254),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[18].base, 22,
                            g_static_metadata_bytes + 280),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[19].base, 27,
                            g_static_metadata_bytes + 302),
