...
const uint8_t g_static_metadata_bytes[] = {
    ...
    101, 115, 116, 103, 114, 112, 99,  45,  105, 110, 116, 101, 114, 110, 97,
    108, 45,  115, 116, 114, 101, 97,  109, 45,  101, 110, 99,  111, 100, 105,
    ...
    121, 45,  112, 117, 115, 104, 98,  97,  99,  107, 45,  109, 115, 103, 114,
    112, 99,  45,  116, 105, 109, 101, 111, 117, 116, 49,  50,  51,  52,  47,
    103, 114, 112, 99,  46,  108, 98,  46,  118, 49,  46,  76,  111, 97,  100,
    66,  97,  108, 97,  110, 99,  101, 114, 47,  66,  97,  108, 97,  110, 99,
    101, 76,  111, 97,  100, 47,  101, 110, 118, 111, 121, 46,  115, 101, 114,
    118, 105, 99,  101, 46,  108, 111, 97,  100, 95,  115, 116, 97,  116, 115,
    46,  118, 50,  46,  76,  111, 97,  100, 82,  101, 112, 111, 114, 116, 105,
    110, 103, 83,  101, 114, 118, 105, 99,  101, 47,  83,  116, 114, 101, 97,
    109, 76,  111, 97,  100, 83,  116, 97,  116, 115, 47,  101, 110, 118, 111,
    121, 46,  115, 101, 114, 118, 105, 99,  101, 46,  108, 111, 97,  100, 95,
    115, 116, 97,  116, 115, 46,  118, 51,  46,  76,  111, 97,  100, 82,  101,
    112, 111, 114, 116, 105, 110, 103, 83,  101, 114, 118, 105, 99,  101, 47,
    83,  116, 114, 101, 97,  109, 76,  111, 97,  100, 83,  116, 97,  116, 115,
    47,  103, 114, 112, 99,  46,  104, 101, 97,  108, 116, 104, 46,  118, 49,
    46,  72,  101, 97,  108, 116, 104, 47,  87,  97,  116, 99,  104, 47,  101,
    110, 118, 111, 121, 46,  115, 101, 114, 118, 105, 99,  101, 46,  100, 105,
    115, 99,  111, 118, 101, 114, 121, 46,  118, 50,  46,  65,  103, 103, 114,
    101, 103, 97,  116, 101, 100, 68,  105, 115, 99,  111, 118, 101, 114, 121,
    83,  101, 114, 118, 105, 99,  101, 47,  83,  116, 114, 101, 97,  109, 65,
    103, 103, 114, 101, 103, 97,  116, 101, 100, 82,  101, 115, 111, 117, 114,
    99,  101, 115, 47,  101, 110, 118, 111, 121, 46,  115, 101, 114, 118, 105,
    99,  101, 46,  100, 105, 115, 99,  111, 118, 101, 114, 121, 46,  118, 51,
    ...
    116, 101, 116, 114, 97,  105, 108, 101, 114, 115, 71,  69,  84,  80,  79,
    ...
    105, 116, 105, 111, 110, 99,  111, 110, 116, 101, 110, 116, 45,  108, 97,
    110, 103, 117, 97,  103, 101, 99,  111, 110, 116, 101, 110, 116, 45,  108,
    101, 110, 103, 116, 104, 99,  111, 110, 116, 101, 110, 116, 45,  108, 111,
    99,  97,  116, 105, 111, 110, 99,  111, 110, 116, 101, 110, 116, 45,  114,
    97,  110, 103, 101, 99,  111, 111, 107, 105, 101, 100, 97,  116, 101, 101,
    116, 97,  103, 101, 120, 112, 101, 99,  116, 101, 120, 112, 105, 114, 101,
    115, 102, 114, 111, 109, 104, 111, 115, 116, 105, 102, 45,  109, 97,  116,
    ...
    97,  115, 116, 45,  109, 111, 100, 105, 102, 105, 101, 100, 108, 105, 110,
    ...
    101, 114, 45,  101, 110, 99,  111, 100, 105, 110, 103, 117, 115, 101, 114,
    45,  97,  103, 101, 110, 116, 118, 97,  114, 121, 118, 105, 97,  119, 119,
...
const StaticMetadataSlice
    g_static_metadata_slice_table[GRPC_STATIC_MDSTR_COUNT] = {
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[12].base, 37,
                            g_static_metadata_bytes + 153),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[13].base, 26,
                            g_static_metadata_bytes + 190),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[14].base, 22,
                            g_static_metadata_bytes + 216),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[15].base, 12,
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[18].base, 1,
                            g_static_metadata_bytes + 252),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[19].base, 1,
                            g_static_metadata_bytes + 253),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[20].base, 0,
                            g_static_metadata_bytes + 254),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[21].base, 36,
                            g_static_metadata_bytes + 254),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[22].base, 65,
                            g_static_metadata_bytes + 290),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[23].base, 65,
                            g_static_metadata_bytes + 355),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[24].base, 28,
                            g_static_metadata_bytes + 420),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[25].base, 80,
                            g_static_metadata_bytes + 448),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[26].base, 80,
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[29].base, 11,
                            g_static_metadata_bytes + 619),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[30].base, 2,
                            g_static_metadata_bytes + 630),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[31].base, 8,
