...
const uint8_t g_static_metadata_bytes[] = {
    ...
    115, 116, 103, 114, 112, 99,  45,  116, 105, 109, 101, 111, 117, 116, 103,
    114, 112, 99,  45,  112, 97,  121, 108, 111, 97,  100, 45,  98,  105, 110,
    117, 115, 101, 114, 45,  97,  103, 101, 110, 116, 103, 114, 112, 99,  45,
    109, 101, 115, 115, 97,  103, 101, 103, 114, 112, 99,  45,  115, 101, 114,
    118, 101, 114, 45,  115, 116, 97,  116, 115, 45,  98,  105, 110, 103, 114,
    112, 99,  45,  116, 97,  103, 115, 45,  98,  105, 110, 103, 114, 112, 99,
    45,  116, 114, 97,  99,  101, 45,  98,  105, 110, 49,  50,  51,  52,  120,
    45,  101, 110, 100, 112, 111, 105, 110, 116, 45,  108, 111, 97,  100, 45,
    109, 101, 116, 114, 105, 99,  115, 45,  98,  105, 110, 103, 114, 112, 99,
...
const StaticMetadataSlice
    g_static_metadata_slice_table[GRPC_STATIC_MDSTR_COUNT] = {
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[17].base, 16,
                            g_static_metadata_bytes + 254),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[18].base, 10,
                            g_static_metadata_bytes + 270),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[19].base, 12,
                            g_static_metadata_bytes + 280),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[20].base, 21,
                            g_static_metadata_bytes + 292),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[21].base, 13,
                            g_static_metadata_bytes + 313),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[22].base, 14,
                            g_static_metadata_bytes + 326),
