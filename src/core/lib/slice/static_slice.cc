...
const uint8_t g_static_metadata_bytes[] = {
    ...
    116, 45,  101, 110, 99,  111, 100, 105, 110, 103, 97,  99,  99,  101, 112,
    116, 45,  101, 110, 99,  111, 100, 105, 110, 103, 103, 114, 112, 99,  45,
    105, 110, 116, 101, 114, 110, 97,  108, 45,  101, 110, 99,  111, 100, 105,
    110, 103, 45,  114, 101, 113, 117, 101, 115, 116, 103, 114, 112, 99,  45,
    116, 105, 109, 101, 111, 117, 116, 47,  103, 114, 112, 99,  46,  108, 98,
...
const StaticMetadataSlice
    g_static_metadata_slice_table[GRPC_STATIC_MDSTR_COUNT] = {
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[9].base, 30,
                            g_static_metadata_bytes + 100),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[10].base, 12,
                            g_static_metadata_bytes + 130),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[11].base, 0,
                            g_static_metadata_bytes + 142),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[12].base, 36,
                            g_static_metadata_bytes + 142),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[13].base, 65,
                            g_static_metadata_bytes + 178),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[14].base, 65,
                            g_static_metadata_bytes + 243),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[15].base, 28,
                            g_static_metadata_bytes + 308),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[16].base, 80,
                            g_static_metadata_bytes + 336),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[17].base, 80,
                            g_static_metadata_bytes + 416),
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[20].base, 11,
                            g_static_metadata_bytes + 507),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[21].base, 2,
                            g_static_metadata_bytes + 518),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[22].base, 8,
                            g_static_metadata_bytes + 520),
