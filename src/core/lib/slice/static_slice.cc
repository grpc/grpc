...
const uint8_t g_static_metadata_bytes[] = {
    ...
    121, 45,  112, 117, 115, 104, 98,  97,  99,  107, 45,  109, 115, 104, 111,
    115, 116, 103, 114, 112, 99,  45,  116, 105, 109, 101, 111, 117, 116, 49,
    ...
    109, 47,  103, 122, 105, 112, 116, 101, 116, 114, 97,  105, 108, 101, 114,
    115, 71,  69,  84,  80,  79,  83,  84,  47,  47,  105, 110, 100, 101, 120,
    ...
    115, 102, 101, 114, 45,  101, 110, 99,  111, 100, 105, 110, 103, 117, 115,
    101, 114, 45,  97,  103, 101, 110, 116, 118, 97,  114, 121, 118, 105, 97,
    119, 119, 119, 45,  97,  117, 116, 104, 101, 110, 116, 105, 99,  97,  116,
    101, 48,  105, 100, 101, 110, 116, 105, 116, 121, 97,  112, 112, 108, 105,
...
const StaticMetadataSlice
    g_static_metadata_slice_table[GRPC_STATIC_MDSTR_COUNT] = {
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[16].base, 12,
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[19].base, 1,
                            g_static_metadata_bytes + 256),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[20].base, 1,
                            g_static_metadata_bytes + 257),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[21].base, 0,
                            g_static_metadata_bytes + 258),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[22].base, 19,
                            g_static_metadata_bytes + 258),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[23].base, 12,
                            g_static_metadata_bytes + 277),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[24].base, 30,
                            g_static_metadata_bytes + 289),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[25].base, 31,
                            g_static_metadata_bytes + 319),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[26].base, 36,
                            g_static_metadata_bytes + 350),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[27].base, 65,
                            g_static_metadata_bytes + 386),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[28].base, 65,
                            g_static_metadata_bytes + 451),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[29].base, 28,
                            g_static_metadata_bytes + 516),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[30].base, 80,
                            g_static_metadata_bytes + 544),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[31].base, 80,
                            g_static_metadata_bytes + 624),
        ...
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[34].base, 11,
                            g_static_metadata_bytes + 715),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[35].base, 2,
                            g_static_metadata_bytes + 726),
        StaticMetadataSlice(&g_static_metadata_slice_refcounts[36].base, 8,
