...
typedef enum
{
GRPC_SECURITY_OK = 0, GRPC_SECURITY_ERROR } grpc_security_status;
...
typedef struct grpc_security_connector
...
grpc_security_connector *
grpc_security_connector_ref (grpc_security_connector * policy,
			     const char *file, int line, const char *reason);
void
grpc_security_connector_unref (grpc_security_connector * policy,
...
struct grpc_channel_security_connector
{
  ...
  bool (*check_call_host) (grpc_channel_security_connector * sc,
...
*/
grpc_security_status
grpc_ssl_server_security_connector_create (grpc_server_credentials *
					   server_credentials,
					   grpc_server_security_connector **
					   sc);
