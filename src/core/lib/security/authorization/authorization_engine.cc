...
constexpr auto kUrlPath = "url_path";
constexpr auto kHost = "host";
constexpr auto kMethod = "method";
constexpr auto kHeaders = "headers";
constexpr auto kSourceAddress = "source_address";
constexpr auto kSourcePort = "source_port";
constexpr auto kDestinationAddress = "destination_address";
constexpr auto kDestinationPort = "destination_port";
constexpr auto kSpiffeId = "spiffe_id";
constexpr auto kCertServerName = "cert_server_name";
