...
class EvaluateArgs {
 public:
  ...
  std::multimap<absl::string_view, absl::string_view> Headers() const;
  absl::string_view SourceAddress() const;
  int SourcePort() const;
  absl::string_view DestinationAddress() const;
  int DestinationPort() const;
  absl::string_view SpiffeID() const;
  absl::string_view CertServerName() const;
