...
#ifndef GRPC_CORE_LIB_SECURITY_AUTHORIZATION_CEL_STUB_CEL_INTERNAL_H
#define GRPC_CORE_LIB_SECURITY_AUTHORIZATION_CEL_STUB_CEL_INTERNAL_H
...
#endif  // GRPC_CORE_LIB_SECURITY_AUTHORIZATION_CEL_STUB_CEL_INTERNAL_H