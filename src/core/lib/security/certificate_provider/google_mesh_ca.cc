...
#include "src/core/ext/upb-generated/src/proto/grpc/meshca/v1/ca.upb.h"
...
static std::string RandomUuid() {
  ...
  std::uniform_int_distribution<uint8_t> uniform_nibble(0, 15);
  std::uniform_int_distribution<uint8_t> uniform_variant(8, 11);
