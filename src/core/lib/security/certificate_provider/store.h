...
#ifndef GRPC_CORE_LIB_SECURITY_CERTIFICATE_PROVIDER_STORE_H
#define GRPC_CORE_LIB_SECURITY_CERTIFICATE_PROVIDER_STORE_H
...
#endif  // GRPC_CORE_LIB_SECURITY_CERTIFICATE_PROVIDER_STORE_H
