...
fake_transport_security_create_security_connector (grpc_channel_credentials *
						   c,
...
grpc_arg
grpc_fake_transport_expected_targets_arg (char *expected_targets)
{
  return grpc_channel_arg_string_create ((char *)
					 GRPC_ARG_FAKE_SECURITY_EXPECTED_TARGETS,
					 expected_targets);
}

const char *
grpc_fake_transport_get_expected_targets (const grpc_channel_args * args)
{
...
static void
md_only_test_destruct (grpc_call_credentials * creds)
{
...
static bool
md_only_test_get_request_metadata (grpc_call_credentials * creds,
...
static void
md_only_test_cancel_get_request_metadata (grpc_call_credentials * c,
