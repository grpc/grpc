...
grpc_security_status grpc_local_credentials::create_security_connector(
  ...
  return grpc_local_channel_security_connector_create(
      this, request_metadata_creds, args, target_name, sc);
}

grpc_security_status grpc_local_server_credentials::create_security_connector(
    grpc_server_security_connector** sc) {
  return grpc_local_server_security_connector_create(this, sc);
}
