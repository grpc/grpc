...
grpc_local_credentials::create_security_connector(
    grpc_core::RefCountedPtr<grpc_call_credentials> request_metadata_creds, const char* target_name,
...
grpc_local_server_credentials::create_security_connector(const grpc_channel_args* /* args */) {
...
grpc_local_credentials::grpc_local_credentials(grpc_local_connect_type connect_type)
    : grpc_channel_credentials(GRPC_CREDENTIALS_TYPE_LOCAL), connect_type_(connect_type) {}
...
grpc_local_server_credentials::grpc_local_server_credentials(grpc_local_connect_type connect_type)
    : grpc_server_credentials(GRPC_CREDENTIALS_TYPE_LOCAL), connect_type_(connect_type) {}
