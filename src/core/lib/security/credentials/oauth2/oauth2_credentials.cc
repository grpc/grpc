...
grpc_oauth2_token_fetcher_credentials_parse_server_response(
  ...
  if (response->body_length > 0) {
    null_terminated_body =
        reinterpret_cast<char*>(gpr_malloc(response->body_length + 1));
...
static void on_oauth2_token_fetcher_http_response(grpc_exec_ctx* exec_ctx,
  ...
  grpc_credentials_metadata_request* r =
      reinterpret_cast<grpc_credentials_metadata_request*>(user_data);
  grpc_oauth2_token_fetcher_credentials* c =
...
static bool oauth2_token_fetcher_get_request_metadata(
  ...
  grpc_oauth2_pending_get_request_metadata* pending_request =
      reinterpret_cast<grpc_oauth2_pending_get_request_metadata*>(
...
grpc_refresh_token_credentials_create_from_auth_refresh_token(
  ...
  c = reinterpret_cast<grpc_google_refresh_token_credentials*>(
...
grpc_call_credentials* grpc_access_token_credentials_create(
  ...
  grpc_access_token_credentials* c =
      reinterpret_cast<grpc_access_token_credentials*>(
