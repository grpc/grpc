...
grpc_security_status grpc_alts_credentials::create_security_connector(
  ...
  return grpc_alts_channel_security_connector_create(
      this, request_metadata_creds, target_name, sc);
}
...
grpc_security_status grpc_alts_server_credentials::create_security_connector(
    grpc_server_security_connector** sc) {
  return grpc_alts_server_security_connector_create(this, sc);
}
