...
static void
iam_destruct (grpc_call_credentials * creds)
{
...
static bool
iam_get_request_metadata (grpc_call_credentials * creds,
...
static void
iam_cancel_get_request_metadata (grpc_call_credentials * c,
				 grpc_credentials_mdelem_array * md_array,
				 grpc_error * error)
{
				    ...
				    void *reserved)
{
  ...
  GRPC_API_TRACE
    ("grpc_iam_credentials_create(token=%s, authority_selector=%s, "
     "reserved=%p)", 3, (token, authority_selector, reserved));
