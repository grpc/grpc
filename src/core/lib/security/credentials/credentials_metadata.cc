...
static void
mdelem_list_ensure_capacity (grpc_credentials_mdelem_array * list,
...
void
grpc_credentials_mdelem_array_add (grpc_credentials_mdelem_array * list,
				   grpc_mdelem md)
{
...
void
grpc_credentials_mdelem_array_append (grpc_credentials_mdelem_array * dst,
...
void
grpc_credentials_mdelem_array_destroy (grpc_credentials_mdelem_array * list)
{
