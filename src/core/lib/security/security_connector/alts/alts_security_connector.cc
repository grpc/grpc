...
void atls_check_peer(tsi_peer peer, grpc_auth_context** auth_context,
 ...
 public:
  grpc_alts_channel_security_connector(
    ...
    grpc_alts_credentials* creds =
        reinterpret_cast<grpc_alts_credentials*>(channel_creds);
 ...
 public:
  ...
  int cmp(const grpc_security_connector* other) const override {
    return grpc_server_security_connector_cmp(
        this,
        reinterpret_cast<const grpc_alts_server_security_connector*>(other));
  }
};
}  // namespace
...
grpc_security_status grpc_alts_channel_security_connector_create(
  ...
  *sc = grpc_core::New<grpc_alts_channel_security_connector>(
...
grpc_security_status grpc_alts_server_security_connector_create(
  ...
  *sc = grpc_core::New<grpc_alts_server_security_connector>(server_creds);
  return GRPC_SECURITY_OK;
}
