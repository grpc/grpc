 ...
 * memory visibility guarantees only. i.e In case of multiple pollers, the
 * designated polling thread keeps changing; the thread that wrote these
 * values may be different from the thread reading the values
 */
