...
#ifndef GRPC_SRC_CORE_LIB_EVENT_ENGINE_DNS_RESOLVER_H
#define GRPC_SRC_CORE_LIB_EVENT_ENGINE_DNS_RESOLVER_H
...
#endif  // GRPC_SRC_CORE_LIB_EVENT_ENGINE_DNS_RESOLVER_H