...
void grpc_set_timer_impl(grpc_timer_vtable* vtable) { grpc_timer_impl = vtable; }
...
grpc_timer_check_result grpc_timer_check(grpc_millis* next) { return grpc_timer_impl->check(next); }
