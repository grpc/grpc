...
#ifndef GRPC_CORE_LIB_IOMGR_EVENT_ENGINE_SHIMS_CLOSURE_H
#define GRPC_CORE_LIB_IOMGR_EVENT_ENGINE_SHIMS_CLOSURE_H
...
#endif  // GRPC_CORE_LIB_IOMGR_EVENT_ENGINE_SHIMS_CLOSURE_H