...
typedef struct grpc_closure_scheduler
...
#ifndef NDEBUG
inline grpc_closure *
grpc_closure_init (const char *file, int line,
...
#else
inline grpc_closure *
grpc_closure_init (grpc_closure * closure,
		   grpc_iomgr_cb_func cb, void *cb_arg,
		   grpc_closure_scheduler * scheduler)
{
#endif
  ...
  closure_impl
{
  ...
  inline void
  closure_wrapper (void *arg, grpc_error * error)
  {
    wrapped_closure *
      wc = (wrapped_closure *) arg;
    grpc_iomgr_cb_func
      cb = wc->cb;
    void *
      cb_arg = wc->cb_arg;
...
#ifndef NDEBUG
inline grpc_closure *
grpc_closure_create (const char *file, int line,
		     grpc_iomgr_cb_func cb, void *cb_arg,
		     grpc_closure_scheduler * scheduler)
{
#else
inline grpc_closure *
grpc_closure_create (grpc_iomgr_cb_func cb, void *cb_arg,
		     grpc_closure_scheduler * scheduler)
{
#endif
...
inline void
grpc_closure_list_init (grpc_closure_list * closure_list)
{
...
inline bool
grpc_closure_list_append (grpc_closure_list * closure_list,
			  grpc_closure * closure, grpc_error * error)
{
  ...
  bool
    was_empty = (closure_list->head == nullptr);
  if (was_empty)
    {
...
inline void
grpc_closure_list_fail_all (grpc_closure_list * list,
...
#else
inline void
grpc_closure_run (grpc_closure * c, grpc_error * error)
{
#endif
...
#ifndef NDEBUG
inline void
grpc_closure_sched (const char *file, int line, grpc_closure * c,
		    grpc_error * error)
{
#else
inline void
grpc_closure_sched (grpc_closure * c, grpc_error * error)
{
#endif
...
#ifndef NDEBUG
inline void
grpc_closure_list_sched (const char *file, int line, grpc_closure_list * list)
{
#else
inline void
grpc_closure_list_sched (grpc_closure_list * list)
{
#endif
  grpc_closure *
    c = list->head;
