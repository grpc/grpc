...
void
grpc_socket_mutator_init (grpc_socket_mutator * mutator,
...
grpc_socket_mutator *
grpc_socket_mutator_ref (grpc_socket_mutator * mutator)
{
...
bool
grpc_socket_mutator_mutate_fd (grpc_socket_mutator * mutator, int fd)
{
  return mutator->vtable->mutate_fd (fd, mutator);
}

int
grpc_socket_mutator_compare (grpc_socket_mutator * a, grpc_socket_mutator * b)
{
  int c = GPR_ICMP (a, b);
  if (c != 0)
    {
...
void
grpc_socket_mutator_unref (grpc_socket_mutator * mutator)
{
...
grpc_arg
grpc_socket_mutator_to_arg (grpc_socket_mutator * mutator)
{
