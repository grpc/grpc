...
static void
exec_ctx_sched (grpc_closure * closure, grpc_error * error)
{
...
static gpr_atm
timespec_to_atm_round_down (gpr_timespec ts)
{
...
static gpr_atm
timespec_to_atm_round_up (gpr_timespec ts)
{
  ts = gpr_time_sub (ts, g_start_time);
...
gpr_timespec
grpc_millis_to_timespec (grpc_millis millis, gpr_clock_type clock_type)
{
...
grpc_millis
grpc_timespec_to_millis_round_down (gpr_timespec ts)
{
  return
    timespec_to_atm_round_down (gpr_convert_clock_type
				(ts, g_start_time.clock_type));
}

grpc_millis
grpc_timespec_to_millis_round_up (gpr_timespec ts)
{
  return
    timespec_to_atm_round_up (gpr_convert_clock_type
			      (ts, g_start_time.clock_type));
}
...
static grpc_closure_scheduler exec_ctx_scheduler =
  { &exec_ctx_scheduler_vtable };
