...
grpc_winsocket_shutdown (grpc_winsocket * winsocket)
{
  ...
  status = WSAIoctl (winsocket->socket, SIO_GET_EXTENSION_FUNCTION_POINTER,
		     ...
		     sizeof (DisconnectEx), &ioctl_num_bytes, NULL, NULL);
...
static void
destroy (grpc_winsocket * winsocket)
{
...
static bool
check_destroyable (grpc_winsocket * winsocket)
{
...
static void
socket_notify_on_iocp (grpc_winsocket * socket, grpc_closure * closure,
...
void
grpc_socket_notify_on_write (grpc_winsocket * socket, grpc_closure * closure)
{
  socket_notify_on_iocp (socket, closure, &socket->write_info);
}

void
grpc_socket_notify_on_read (grpc_winsocket * socket, grpc_closure * closure)
{
  socket_notify_on_iocp (socket, closure, &socket->read_info);
}

void
grpc_socket_become_ready (grpc_winsocket * socket,
			  grpc_winsocket_callback_info * info)
{
