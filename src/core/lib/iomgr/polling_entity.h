...
/* A grpc_polling_entity is a pollset-or-pollset_set container. It
 * allows functions that accept a pollset XOR a pollset_set to do so
 * through an abstract interface. No ownership is taken. */
...
/** If \a pollent contains a pollset_set, return it. Otherwise, return
 * NULL */
...
/** Add the pollset or pollset_set in \a pollent to the destination
