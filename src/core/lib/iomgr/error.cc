...
static const char* error_int_name(grpc_error_ints key) {
  switch (key) {
    ...
    case GRPC_ERROR_INT_OCCURRED_WHILE_AWAITING_NAME_RESOLUTION:
      return "occurred_while_awaiting_name_resolution";
...
static const char* error_str_name(grpc_error_strs key) {
  switch (key) {
    ...
    case GRPC_ERROR_STRING_CHANNEL_LAST_NAME_RESOLUTION_TIME:
      return "channel_last_name_resolution_time";
