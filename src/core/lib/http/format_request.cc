...
static void
fill_common_header (const grpc_httpcli_request * request,
...
grpc_slice
grpc_httpcli_format_post_request (const grpc_httpcli_request * request,
...
grpc_slice
grpc_httpcli_format_connect_request (const grpc_httpcli_request * request)
{
  gpr_strvec out;
  gpr_strvec_init (&out);
