...
static grpc_security_status httpcli_ssl_channel_security_connector_create(
  ...
  c = reinterpret_cast<grpc_httpcli_ssl_channel_security_connector*>(
...
static void on_handshake_done(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  on_done_closure* c = reinterpret_cast<on_done_closure*>(args->user_data);
...
static void ssl_handshake(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  on_done_closure* c =
      reinterpret_cast<on_done_closure*>(gpr_malloc(sizeof(*c)));
