...
static void
httpcli_ssl_add_handshakers (grpc_channel_security_connector * sc,
			     grpc_handshake_manager * handshake_mgr)
{
  ...
  grpc_handshake_manager_add (handshake_mgr,
			      ...
			      (tsi_create_adapter_handshaker (handshaker),
			       &sc->base));
}

static void
httpcli_ssl_check_peer (grpc_security_connector * sc, tsi_peer peer,
...
static int
httpcli_ssl_cmp (grpc_security_connector * sc1, grpc_security_connector * sc2)
{
					       ...
					       ** sc)
{
  ...
  result =
    tsi_create_ssl_client_handshaker_factory (nullptr, pem_root_certs,
					      nullptr, nullptr, 0,
...
static void
ssl_handshake (void *arg, grpc_endpoint * tcp, const char *host,
	       ...
	       void (*on_done) (void *arg, grpc_endpoint * endpoint))
{
  ...
  grpc_handshake_manager_do_handshake (c->handshake_mgr,
				       nullptr /* interested_parties */ , tcp,
				       nullptr /* channel_args */ , deadline,
				       nullptr /* acceptor */ ,
