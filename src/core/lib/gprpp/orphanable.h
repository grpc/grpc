...
// and destruction.
  ...
  template < typename T > class OrphanableDelete
  {
  public:
    void operator () (T * p)
    {
...
// eliminate this class.
  ...
  public:
    ...
    InternallyRefCountedWithTracing (const InternallyRefCountedWithTracing &)
      = delete;
      InternallyRefCountedWithTracing & operator= (const
  ...
  GRPC_ABSTRACT_BASE_CLASS protected:
    // Allow Delete() to access destructor.
      ...
      (static_cast < TraceFlag * >(nullptr))
    {
    }

    explicit InternallyRefCountedWithTracing (TraceFlag *
...
#ifdef NDEBUG
    explicit InternallyRefCountedWithTracing (DebugOnlyTraceFlag *
					      trace_flag):InternallyRefCountedWithTracing
      ()
    {
    }
#endif
