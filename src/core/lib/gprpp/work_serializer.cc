...
class WorkSerializer::Impl final
    : public grpc_event_engine::experimental::EventEngine::Closure {
 public:
  explicit Impl(std::shared_ptr<grpc_event_engine::experimental::EventEngine>
                    event_engine)
...
#ifndef NDEBUG
  static thread_local Impl* running_work_serializer_;
#endif
};

#ifndef NDEBUG
thread_local WorkSerializer::Impl*
    WorkSerializer::Impl::running_work_serializer_ = nullptr;
#endif

void WorkSerializer::Impl::Orphan() {
...
void WorkSerializer::Impl::Run(std::function<void()> callback,
...
WorkSerializer::Impl::RefillResult WorkSerializer::Impl::RefillInner() {
...
bool WorkSerializer::Impl::Refill() {
...
WorkSerializer::WorkSerializer(
    ...
    : impl_(MakeOrphanable<Impl>(std::move(event_engine))) {}
