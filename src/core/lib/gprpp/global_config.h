...
#define GPR_GLOBAL_CONFIG_DEFINE_BOOL GPR_GLOBAL_CONFIG_CUSTOM_DEFINE_BOOL
#define GPR_GLOBAL_CONFIG_DEFINE_INT32 GPR_GLOBAL_CONFIG_CUSTOM_DEFINE_INT32
#define GPR_GLOBAL_CONFIG_DEFINE_STRING GPR_GLOBAL_CONFIG_CUSTOM_DEFINE_STRING
#else
#include "src/core/lib/gprpp/global_config_env.h"
#define GPR_GLOBAL_CONFIG_DEFINE_BOOL GPR_GLOBAL_CONFIG_ENV_DEFINE_BOOL
#define GPR_GLOBAL_CONFIG_DEFINE_INT32 GPR_GLOBAL_CONFIG_ENV_DEFINE_INT32
#define GPR_GLOBAL_CONFIG_DEFINE_STRING GPR_GLOBAL_CONFIG_ENV_DEFINE_STRING
#endif
