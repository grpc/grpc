...
class RefCount {
 public:
  ...
  constexpr explicit RefCount(Value init = 1,
                              DebugOnlyTraceFlag* trace_flag = nullptr)
      :
#ifndef NDEBUG
...
#ifndef NDEBUG
  DebugOnlyTraceFlag* trace_flag_;
#endif
...
class RefCounted : public Impl {
 ...
 protected:
  ...
  explicit RefCounted(DebugOnlyTraceFlag* trace_flag = nullptr)
      : refs_(1, trace_flag) {}
