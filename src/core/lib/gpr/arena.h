...
// right amount of memory This transitional API is deprecated and will
// be removed soon in favour of src/core/lib/gprpp/arena.h .
...
// TODO(arjunroy) : Remove deprecated gpr_arena API once all callers are
// gone.
