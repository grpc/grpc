...
bool
gpr_mpscq_push (gpr_mpscq * q, gpr_mpscq_node * n)
{
...
gpr_mpscq_node *
gpr_mpscq_pop_and_check_end (gpr_mpscq * q, bool * empty)
{
...
void
gpr_locked_mpscq_init (gpr_locked_mpscq * q)
{
...
void
gpr_locked_mpscq_destroy (gpr_locked_mpscq * q)
{
...
bool
gpr_locked_mpscq_push (gpr_locked_mpscq * q, gpr_mpscq_node * n)
{
  return gpr_mpscq_push (&q->queue, n);
}

gpr_mpscq_node *
gpr_locked_mpscq_try_pop (gpr_locked_mpscq * q)
{
