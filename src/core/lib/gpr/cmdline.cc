...
void
gpr_cmdline_set_survive_failure (gpr_cmdline * cl)
{
...
static int
extra_state (gpr_cmdline * cl, char *str)
{
  if (!cl->extra_arg)
    {
...
static int
value_state (gpr_cmdline * cl, char *str)
{
  long intval;
  char *end;
...
static int
normal_state (gpr_cmdline * cl, char *str)
{
  char *eq = nullptr;
  char *tmp = nullptr;
