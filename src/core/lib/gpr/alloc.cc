...
static void *
zalloc_with_calloc (size_t sz)
{
  return calloc (sz, 1);
}

static void *
zalloc_with_gpr_malloc (size_t sz)
{
...
void
gpr_set_allocation_functions (gpr_allocation_functions functions)
{
