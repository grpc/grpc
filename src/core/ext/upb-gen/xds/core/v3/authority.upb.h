...
extern "C" {
#endif
typedef struct xds_core_v3_Authority {
...
UPB_INLINE xds_core_v3_Authority* xds_core_v3_Authority_parse(const char* buf, size_t size,
  ...
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &xds__core__v3__Authority_msg_init, NULL, 0,
...
UPB_INLINE xds_core_v3_Authority* xds_core_v3_Authority_parse_ex(
  ...
  xds_core_v3_Authority* ret = xds_core_v3_Authority_new(arena);
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &xds__core__v3__Authority_msg_init, extreg,
