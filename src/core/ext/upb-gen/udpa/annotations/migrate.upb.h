...
extern "C" {
#endif
typedef struct udpa_annotations_MigrateAnnotation {
  upb_Message UPB_PRIVATE(base);
} udpa_annotations_MigrateAnnotation;

typedef struct udpa_annotations_FieldMigrateAnnotation {
  upb_Message UPB_PRIVATE(base);
} udpa_annotations_FieldMigrateAnnotation;

typedef struct udpa_annotations_FileMigrateAnnotation {
  upb_Message UPB_PRIVATE(base);
} udpa_annotations_FileMigrateAnnotation;
...
UPB_INLINE udpa_annotations_MigrateAnnotation* udpa_annotations_MigrateAnnotation_parse(const char* buf, size_t size,
  ...
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &udpa__annotations__MigrateAnnotation_msg_init, NULL, 0,
                 arena) != kUpb_DecodeStatus_Ok) {
    return NULL;
  }
  return ret;
}
UPB_INLINE udpa_annotations_MigrateAnnotation* udpa_annotations_MigrateAnnotation_parse_ex(
    const char* buf, size_t size, const upb_ExtensionRegistry* extreg,
    int options, upb_Arena* arena) {
  udpa_annotations_MigrateAnnotation* ret = udpa_annotations_MigrateAnnotation_new(arena);
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &udpa__annotations__MigrateAnnotation_msg_init, extreg,
                 options, arena) != kUpb_DecodeStatus_Ok) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char* udpa_annotations_MigrateAnnotation_serialize(const udpa_annotations_MigrateAnnotation* msg,
                                      upb_Arena* arena, size_t* len) {
  char* ptr;
  (void)upb_Encode(UPB_UPCAST(msg), &udpa__annotations__MigrateAnnotation_msg_init, 0, arena, &ptr, len);
  return ptr;
}
UPB_INLINE char* udpa_annotations_MigrateAnnotation_serialize_ex(const udpa_annotations_MigrateAnnotation* msg,
                                         int options, upb_Arena* arena,
                                         size_t* len) {
  char* ptr;
...
UPB_INLINE udpa_annotations_FieldMigrateAnnotation* udpa_annotations_FieldMigrateAnnotation_parse(const char* buf, size_t size,
  ...
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &udpa__annotations__FieldMigrateAnnotation_msg_init, NULL, 0,
                 arena) != kUpb_DecodeStatus_Ok) {
    return NULL;
  }
  return ret;
}
UPB_INLINE udpa_annotations_FieldMigrateAnnotation* udpa_annotations_FieldMigrateAnnotation_parse_ex(
    const char* buf, size_t size, const upb_ExtensionRegistry* extreg,
    int options, upb_Arena* arena) {
  udpa_annotations_FieldMigrateAnnotation* ret = udpa_annotations_FieldMigrateAnnotation_new(arena);
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &udpa__annotations__FieldMigrateAnnotation_msg_init, extreg,
                 options, arena) != kUpb_DecodeStatus_Ok) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char* udpa_annotations_FieldMigrateAnnotation_serialize(const udpa_annotations_FieldMigrateAnnotation* msg,
                                      upb_Arena* arena, size_t* len) {
  char* ptr;
  (void)upb_Encode(UPB_UPCAST(msg), &udpa__annotations__FieldMigrateAnnotation_msg_init, 0, arena, &ptr, len);
  return ptr;
}
UPB_INLINE char* udpa_annotations_FieldMigrateAnnotation_serialize_ex(const udpa_annotations_FieldMigrateAnnotation* msg,
                                         int options, upb_Arena* arena,
                                         size_t* len) {
  char* ptr;
...
UPB_INLINE udpa_annotations_FileMigrateAnnotation* udpa_annotations_FileMigrateAnnotation_parse(const char* buf, size_t size,
  ...
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &udpa__annotations__FileMigrateAnnotation_msg_init, NULL, 0,
                 arena) != kUpb_DecodeStatus_Ok) {
    return NULL;
  }
  return ret;
}
UPB_INLINE udpa_annotations_FileMigrateAnnotation* udpa_annotations_FileMigrateAnnotation_parse_ex(
    const char* buf, size_t size, const upb_ExtensionRegistry* extreg,
    int options, upb_Arena* arena) {
  udpa_annotations_FileMigrateAnnotation* ret = udpa_annotations_FileMigrateAnnotation_new(arena);
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &udpa__annotations__FileMigrateAnnotation_msg_init, extreg,
                 options, arena) != kUpb_DecodeStatus_Ok) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char* udpa_annotations_FileMigrateAnnotation_serialize(const udpa_annotations_FileMigrateAnnotation* msg,
                                      upb_Arena* arena, size_t* len) {
  char* ptr;
  (void)upb_Encode(UPB_UPCAST(msg), &udpa__annotations__FileMigrateAnnotation_msg_init, 0, arena, &ptr, len);
  return ptr;
}
UPB_INLINE char* udpa_annotations_FileMigrateAnnotation_serialize_ex(const udpa_annotations_FileMigrateAnnotation* msg,
                                         int options, upb_Arena* arena,
                                         size_t* len) {
  char* ptr;
...
UPB_INLINE const udpa_annotations_MigrateAnnotation*
udpa_annotations_message_migrate(const struct google_protobuf_MessageOptions* msg) {
...
UPB_INLINE void udpa_annotations_set_message_migrate(struct google_protobuf_MessageOptions* msg,
                                        const udpa_annotations_MigrateAnnotation* val,
                                        upb_Arena* arena) {
  const upb_MiniTableExtension* ext = &udpa_annotations_message_migrate_ext;
  UPB_ASSUME(upb_MiniTableField_IsScalar(&ext->UPB_PRIVATE(field)));
  UPB_ASSUME(UPB_PRIVATE(_upb_MiniTableField_GetRep)(
...
UPB_INLINE struct udpa_annotations_MigrateAnnotation* udpa_annotations_mutable_message_migrate(
    struct google_protobuf_MessageOptions* msg, upb_Arena* arena) {
...
udpa_annotations_field_migrate(const struct google_protobuf_FieldOptions* msg) {
...
UPB_INLINE void udpa_annotations_set_field_migrate(struct google_protobuf_FieldOptions* msg,
                                        const udpa_annotations_FieldMigrateAnnotation* val,
                                        upb_Arena* arena) {
  const upb_MiniTableExtension* ext = &udpa_annotations_field_migrate_ext;
  UPB_ASSUME(upb_MiniTableField_IsScalar(&ext->UPB_PRIVATE(field)));
  UPB_ASSUME(UPB_PRIVATE(_upb_MiniTableField_GetRep)(
...
UPB_INLINE struct udpa_annotations_FieldMigrateAnnotation* udpa_annotations_mutable_field_migrate(
...
UPB_INLINE const udpa_annotations_MigrateAnnotation*
udpa_annotations_enum_migrate(const struct google_protobuf_EnumOptions* msg) {
...
UPB_INLINE void udpa_annotations_set_enum_migrate(struct google_protobuf_EnumOptions* msg,
                                        const udpa_annotations_MigrateAnnotation* val,
                                        upb_Arena* arena) {
  const upb_MiniTableExtension* ext = &udpa_annotations_enum_migrate_ext;
  UPB_ASSUME(upb_MiniTableField_IsScalar(&ext->UPB_PRIVATE(field)));
...
UPB_INLINE struct udpa_annotations_MigrateAnnotation* udpa_annotations_mutable_enum_migrate(
    struct google_protobuf_EnumOptions* msg, upb_Arena* arena) {
...
UPB_INLINE const udpa_annotations_MigrateAnnotation*
udpa_annotations_enum_value_migrate(const struct google_protobuf_EnumValueOptions* msg) {
...
UPB_INLINE void udpa_annotations_set_enum_value_migrate(struct google_protobuf_EnumValueOptions* msg,
                                        const udpa_annotations_MigrateAnnotation* val,
                                        upb_Arena* arena) {
  const upb_MiniTableExtension* ext = &udpa_annotations_enum_value_migrate_ext;
  UPB_ASSUME(upb_MiniTableField_IsScalar(&ext->UPB_PRIVATE(field)));
...
UPB_INLINE struct udpa_annotations_MigrateAnnotation* udpa_annotations_mutable_enum_value_migrate(
...
udpa_annotations_file_migrate(const struct google_protobuf_FileOptions* msg) {
...
UPB_INLINE void udpa_annotations_set_file_migrate(struct google_protobuf_FileOptions* msg,
                                        const udpa_annotations_FileMigrateAnnotation* val,
                                        upb_Arena* arena) {
  const upb_MiniTableExtension* ext = &udpa_annotations_file_migrate_ext;
  UPB_ASSUME(upb_MiniTableField_IsScalar(&ext->UPB_PRIVATE(field)));
  UPB_ASSUME(UPB_PRIVATE(_upb_MiniTableField_GetRep)(
...
UPB_INLINE struct udpa_annotations_FileMigrateAnnotation* udpa_annotations_mutable_file_migrate(
    struct google_protobuf_FileOptions* msg, upb_Arena* arena) {
