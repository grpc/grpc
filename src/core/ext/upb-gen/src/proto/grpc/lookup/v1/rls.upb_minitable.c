...
} grpc__lookup__v1__RouteLookupRequest_msg_init_Fields;

static const grpc__lookup__v1__RouteLookupRequest_msg_init_Fields grpc_lookup_v1_RouteLookupRequest__fields = {{
  {3, 16, 0, kUpb_NoSub, 9, (int)kUpb_FieldMode_Scalar | ((int)kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  {4, UPB_SIZE(8, 48), 0, 9, 11, (int)kUpb_FieldMode_Map | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
...
const upb_MiniTable grpc__lookup__v1__RouteLookupRequest_msg_init = {
  &grpc_lookup_v1_RouteLookupRequest__fields.fields[0],
...
} grpc__lookup__v1__RouteLookupRequest__KeyMapEntry_msg_init_Fields;

static const grpc__lookup__v1__RouteLookupRequest__KeyMapEntry_msg_init_Fields grpc_lookup_v1_RouteLookupRequest_KeyMapEntry__fields = {{
...
typedef struct {
  upb_MiniTableField fields[2];
} grpc__lookup__v1__RouteLookupResponse_msg_init_Fields;

static const grpc__lookup__v1__RouteLookupResponse_msg_init_Fields grpc_lookup_v1_RouteLookupResponse__fields = {{
