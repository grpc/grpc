...
} grpc__gcp__AltsContext_msg_init_Fields;

static const grpc__gcp__AltsContext_msg_init_Fields grpc_gcp_AltsContext__fields = {{
  ...
  {6, UPB_SIZE(16, 80), 64, UPB_SIZE(6, 7), 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  {7, UPB_SIZE(20, 88), 0, UPB_SIZE(4, 6), 11, (int)kUpb_FieldMode_Map | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
 },
  {
  {.UPB_PRIVATE(submsg) = &grpc__gcp__RpcProtocolVersions_msg_init},
  {.UPB_PRIVATE(submsg) = &grpc__gcp__AltsContext__PeerAttributesEntry_msg_init},
}};

const upb_MiniTable grpc__gcp__AltsContext_msg_init = {
  &grpc_gcp_AltsContext__fields.fields[0],
...
} grpc__gcp__AltsContext__PeerAttributesEntry_msg_init_Fields;

static const grpc__gcp__AltsContext__PeerAttributesEntry_msg_init_Fields grpc_gcp_AltsContext_PeerAttributesEntry__fields = {{
