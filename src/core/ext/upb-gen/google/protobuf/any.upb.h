...
UPB_INLINE google_protobuf_Any* google_protobuf_Any_parse(const char* buf, size_t size,
  ...
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &google__protobuf__Any_msg_init, NULL, 0,
...
UPB_INLINE google_protobuf_Any* google_protobuf_Any_parse_ex(
  ...
  google_protobuf_Any* ret = google_protobuf_Any_new(arena);
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &google__protobuf__Any_msg_init, extreg,
