...
} envoy__extensions__filters__http__fault__v3__FaultAbort_msg_init_Fields;

static const envoy__extensions__filters__http__fault__v3__FaultAbort_msg_init_Fields envoy_extensions_filters_http_fault_v3_FaultAbort__fields = {{
  {2, UPB_SIZE(20, 40), UPB_SIZE(-17, -13), kUpb_NoSub, 13, (int)kUpb_FieldMode_Scalar | ((int)kUpb_FieldRep_4Byte << kUpb_FieldRep_Shift)},
  {3, UPB_SIZE(12, 32), 64, UPB_SIZE(12, 13), 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  {4, UPB_SIZE(20, 40), UPB_SIZE(-17, -13), UPB_SIZE(10, 12), 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  {5, UPB_SIZE(20, 40), UPB_SIZE(-17, -13), kUpb_NoSub, 13, (int)kUpb_FieldMode_Scalar | ((int)kUpb_FieldRep_4Byte << kUpb_FieldRep_Shift)},
...
const upb_MiniTable envoy__extensions__filters__http__fault__v3__FaultAbort_msg_init = {
  &envoy_extensions_filters_http_fault_v3_FaultAbort__fields.fields[0],
  UPB_SIZE(32, 48), 5, kUpb_ExtMode_NonExtendable, 0, UPB_FASTTABLE_MASK(56), 0,
  ...
  UPB_FASTTABLE_INIT({
    ...
    {0x0000000000000000, &_upb_FastDecoder_DecodeGeneric},
    {0x0028000c02000010, &upb_DecodeFast_Varint32_Oneof_Tag1Byte},
    {0x0000000000000000, &_upb_FastDecoder_DecodeGeneric},
    {0x0000000000000000, &_upb_FastDecoder_DecodeGeneric},
    {0x0028000c05000028, &upb_DecodeFast_Varint32_Oneof_Tag1Byte},
...
} envoy__extensions__filters__http__fault__v3__HTTPFault_msg_init_Fields;

static const envoy__extensions__filters__http__fault__v3__HTTPFault_msg_init_Fields envoy_extensions_filters_http_fault_v3_HTTPFault__fields = {{
  {1, UPB_SIZE(12, 144), 64, 48, 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  {2, UPB_SIZE(16, 152), 65, UPB_SIZE(46, 47), 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  {3, UPB_SIZE(40, 16), 0, kUpb_NoSub, 9, (int)kUpb_FieldMode_Scalar | ((int)kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  {4, UPB_SIZE(20, 160), 0, UPB_SIZE(41, 43), 11, (int)kUpb_FieldMode_Array | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  ...
  {6, UPB_SIZE(28, 176), 66, UPB_SIZE(36, 39), 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  {7, UPB_SIZE(32, 184), 67, UPB_SIZE(34, 38), 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  ...
  {16, UPB_SIZE(36, 192), 68, UPB_SIZE(8, 13), 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
 },
  {
...
const upb_MiniTable envoy__extensions__filters__http__fault__v3__HTTPFault_msg_init = {
  &envoy_extensions_filters_http_fault_v3_HTTPFault__fields.fields[0],
  ...
  UPB_FASTTABLE_INIT({
    ...
    {0x0000000000000000, &_upb_FastDecoder_DecodeGeneric},
    {0x00a800003f00002a, &upb_DecodeFast_String_Repeated_Tag1Byte},
    {0x0000000000000000, &_upb_FastDecoder_DecodeGeneric},
    {0x0000000000000000, &_upb_FastDecoder_DecodeGeneric},
    {0x002000003f000042, &upb_DecodeFast_String_Scalar_Tag1Byte},
    {0x003000003f00004a, &upb_DecodeFast_String_Scalar_Tag1Byte},
    {0x004000003f000052, &upb_DecodeFast_String_Scalar_Tag1Byte},
    {0x005000003f00005a, &upb_DecodeFast_String_Scalar_Tag1Byte},
    {0x006000003f000062, &upb_DecodeFast_String_Scalar_Tag1Byte},
    {0x007000003f00006a, &upb_DecodeFast_String_Scalar_Tag1Byte},
    {0x008000003f000072, &upb_DecodeFast_String_Scalar_Tag1Byte},
