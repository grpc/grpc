...
} envoy__type__v3__SemanticVersion_msg_init_Fields;

static const envoy__type__v3__SemanticVersion_msg_init_Fields envoy_type_v3_SemanticVersion__fields = {{
...
const upb_MiniTable envoy__type__v3__SemanticVersion_msg_init = {
  &envoy_type_v3_SemanticVersion__fields.fields[0],
