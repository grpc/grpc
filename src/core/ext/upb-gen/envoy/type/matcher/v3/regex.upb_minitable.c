...
} envoy__type__matcher__v3__RegexMatcher_msg_init_Fields;

static const envoy__type__matcher__v3__RegexMatcher_msg_init_Fields envoy_type_matcher_v3_RegexMatcher__fields = {{
...
const upb_MiniTable envoy__type__matcher__v3__RegexMatcher_msg_init = {
  &envoy_type_matcher_v3_RegexMatcher__fields.fields[0],
...
typedef struct {
  ...
  upb_MiniTableSubInternal subs[1];
} envoy__type__matcher__v3__RegexMatcher__GoogleRE2_msg_init_Fields;

static const envoy__type__matcher__v3__RegexMatcher__GoogleRE2_msg_init_Fields envoy_type_matcher_v3_RegexMatcher_GoogleRE2__fields = {{
...
typedef struct {
  upb_MiniTableField fields[2];
  upb_MiniTableSubInternal subs[1];
} envoy__type__matcher__v3__RegexMatchAndSubstitute_msg_init_Fields;

static const envoy__type__matcher__v3__RegexMatchAndSubstitute_msg_init_Fields envoy_type_matcher_v3_RegexMatchAndSubstitute__fields = {{
...
const upb_MiniTable envoy__type__matcher__v3__RegexMatchAndSubstitute_msg_init = {
  &envoy_type_matcher_v3_RegexMatchAndSubstitute__fields.fields[0],
  UPB_SIZE(24, 40), 2, kUpb_ExtMode_NonExtendable, 2, UPB_FASTTABLE_MASK(24), 0,
#ifdef UPB_TRACING_ENABLED
