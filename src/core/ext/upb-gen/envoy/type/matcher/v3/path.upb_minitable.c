...
} envoy__type__matcher__v3__PathMatcher_msg_init_Fields;

static const envoy__type__matcher__v3__PathMatcher_msg_init_Fields envoy_type_matcher_v3_PathMatcher__fields = {{
