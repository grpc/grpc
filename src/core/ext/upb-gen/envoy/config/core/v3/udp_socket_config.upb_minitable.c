...
} envoy__config__core__v3__UdpSocketConfig_msg_init_Fields;

static const envoy__config__core__v3__UdpSocketConfig_msg_init_Fields envoy_config_core_v3_UdpSocketConfig__fields = {{
...
const upb_MiniTable envoy__config__core__v3__UdpSocketConfig_msg_init = {
  &envoy_config_core_v3_UdpSocketConfig__fields.fields[0],
