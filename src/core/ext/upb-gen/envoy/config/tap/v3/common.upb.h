...
UPB_INLINE struct google_protobuf_UInt32Value* envoy_config_tap_v3_OutputConfig_mutable_min_streamed_sent_bytes(envoy_config_tap_v3_OutputConfig* msg, upb_Arena* arena) {
