...
} envoy__config__metrics__v3__MetricsServiceConfig_msg_init_Fields;

static const envoy__config__metrics__v3__MetricsServiceConfig_msg_init_Fields envoy_config_metrics_v3_MetricsServiceConfig__fields = {{
...
const upb_MiniTable envoy__config__metrics__v3__MetricsServiceConfig_msg_init = {
  &envoy_config_metrics_v3_MetricsServiceConfig__fields.fields[0],
