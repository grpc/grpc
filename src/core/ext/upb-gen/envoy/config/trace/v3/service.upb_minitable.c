...
} envoy__config__trace__v3__TraceServiceConfig_msg_init_Fields;

static const envoy__config__trace__v3__TraceServiceConfig_msg_init_Fields envoy_config_trace_v3_TraceServiceConfig__fields = {{
