...
} envoy__config__trace__v3__Tracing_msg_init_Fields;

static const envoy__config__trace__v3__Tracing_msg_init_Fields envoy_config_trace_v3_Tracing__fields = {{
...
const upb_MiniTable envoy__config__trace__v3__Tracing_msg_init = {
  &envoy_config_trace_v3_Tracing__fields.fields[0],
...
typedef struct {
  ...
  upb_MiniTableSubInternal subs[1];
} envoy__config__trace__v3__Tracing__Http_msg_init_Fields;

static const envoy__config__trace__v3__Tracing__Http_msg_init_Fields envoy_config_trace_v3_Tracing_Http__fields = {{
...
const upb_MiniTable envoy__config__trace__v3__Tracing__Http_msg_init = {
  &envoy_config_trace_v3_Tracing_Http__fields.fields[0],
