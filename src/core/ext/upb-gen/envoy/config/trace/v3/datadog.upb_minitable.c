...
static const upb_MiniTableSubInternal envoy_config_trace_v3_DatadogRemoteConfig_submsgs[1] = {
...
static const upb_MiniTableSubInternal envoy_config_trace_v3_DatadogConfig_submsgs[1] = {
