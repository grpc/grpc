...
UPB_INLINE void envoy_config_trace_v3_ZipkinConfig_clear_collector_service(envoy_config_trace_v3_ZipkinConfig* msg) {
  const upb_MiniTableField field = {9, UPB_SIZE(24, 80), 65, 1, 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)};
  upb_Message_ClearBaseField(UPB_UPCAST(msg), &field);
}
...
UPB_INLINE struct envoy_config_core_v3_HttpService* envoy_config_trace_v3_ZipkinConfig_mutable_collector_service(envoy_config_trace_v3_ZipkinConfig* msg, upb_Arena* arena) {
