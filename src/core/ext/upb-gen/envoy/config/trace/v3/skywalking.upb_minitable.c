...
} envoy__config__trace__v3__SkyWalkingConfig_msg_init_Fields;

static const envoy__config__trace__v3__SkyWalkingConfig_msg_init_Fields envoy_config_trace_v3_SkyWalkingConfig__fields = {{
...
} envoy__config__trace__v3__ClientConfig_msg_init_Fields;

static const envoy__config__trace__v3__ClientConfig_msg_init_Fields envoy_config_trace_v3_ClientConfig__fields = {{
