...
#include "grpc/gcp/handshaker.upb_minitable.h"
...
static const grpc__gcp__ServerHandshakeParameters_msg_init_Fields grpc_gcp_ServerHandshakeParameters__fields = {{
  ...
  {2, UPB_SIZE(16, 40), 0, UPB_SIZE(6, 7), 11, (int)kUpb_FieldMode_Array | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
  {3, UPB_SIZE(20, 16), 64, kUpb_NoSub, 9, (int)kUpb_FieldMode_Scalar | ((int)kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
 },
  {
  {.UPB_PRIVATE(submsg) = &grpc__gcp__Identity_msg_init},
}};
...
const upb_MiniTableFile grpc_gcp_handshaker_proto_upb_file_layout = {
  messages_layout,
  NULL,
  NULL,
  12,
