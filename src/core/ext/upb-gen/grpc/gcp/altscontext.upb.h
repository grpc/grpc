...
#ifndef GRPC_GCP_ALTSCONTEXT_PROTO_UPB_H__UPB_H_
#define GRPC_GCP_ALTSCONTEXT_PROTO_UPB_H__UPB_H_

#include "upb/generated_code_support.h"
#include "grpc/gcp/altscontext.upb_minitable.h"
#include "grpc/gcp/transport_security_common.upb_minitable.h"
...
extern "C" {
#endif
typedef struct grpc_gcp_AltsContext {
...
UPB_INLINE grpc_gcp_AltsContext* grpc_gcp_AltsContext_parse(const char* buf, size_t size,
  ...
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &grpc__gcp__AltsContext_msg_init, NULL, 0,
                 arena) != kUpb_DecodeStatus_Ok) {
    return NULL;
  }
  return ret;
}
UPB_INLINE grpc_gcp_AltsContext* grpc_gcp_AltsContext_parse_ex(
    const char* buf, size_t size, const upb_ExtensionRegistry* extreg,
    int options, upb_Arena* arena) {
  grpc_gcp_AltsContext* ret = grpc_gcp_AltsContext_new(arena);
  if (!ret) return NULL;
  if (upb_Decode(buf, size, UPB_UPCAST(ret), &grpc__gcp__AltsContext_msg_init, extreg,
...
UPB_INLINE void grpc_gcp_AltsContext_clear_peer_rpc_versions(grpc_gcp_AltsContext* msg) {
  const upb_MiniTableField field = {6, UPB_SIZE(16, 80), 64, UPB_SIZE(6, 7), 11, (int)kUpb_FieldMode_Scalar | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)};
  upb_Message_ClearBaseField(UPB_UPCAST(msg), &field);
}
...
UPB_INLINE void grpc_gcp_AltsContext_clear_peer_attributes(grpc_gcp_AltsContext* msg) {
  const upb_MiniTableField field = {7, UPB_SIZE(20, 88), 0, UPB_SIZE(4, 6), 11, (int)kUpb_FieldMode_Map | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)};
  upb_Message_ClearBaseField(UPB_UPCAST(msg), &field);
}
...
UPB_INLINE bool grpc_gcp_AltsContext_peer_attributes_next(const grpc_gcp_AltsContext* msg,
                                       upb_StringView* key,
                                       upb_StringView* val,
                                       size_t* iter) {
  const upb_MiniTableField field = {7, UPB_SIZE(20, 88), 0, UPB_SIZE(4, 6), 11, (int)kUpb_FieldMode_Map | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)};
...
UPB_INLINE upb_Map* _grpc_gcp_AltsContext_peer_attributes_mutable_upb_map(
    grpc_gcp_AltsContext* msg, upb_Arena* a) {
  const upb_MiniTableField field = {7, UPB_SIZE(20, 88), 0, UPB_SIZE(4, 6), 11, (int)kUpb_FieldMode_Map | ((int)UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)};
  UPB_PRIVATE(_upb_MiniTable_StrongReference)(&grpc__gcp__AltsContext__PeerAttributesEntry_msg_init);
...
UPB_INLINE struct grpc_gcp_RpcProtocolVersions* grpc_gcp_AltsContext_mutable_peer_rpc_versions(
    grpc_gcp_AltsContext* msg, upb_Arena* arena) {
...
UPB_INLINE bool grpc_gcp_AltsContext_peer_attributes_set(grpc_gcp_AltsContext* msg, upb_StringView key,
...
#endif /* GRPC_GCP_ALTSCONTEXT_PROTO_UPB_H__UPB_H_ */
