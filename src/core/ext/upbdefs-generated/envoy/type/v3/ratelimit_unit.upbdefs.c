...
't', 'P', 'r', 'o', 't', 'o', 'P', '\001', '\272', '\200', '\310', '\321', '\006', '\002', '\020', '\002', 'b', '\006', 'p', 'r', 'o', 't', 'o', '3', 
};
...
upb_def_init envoy_type_v3_ratelimit_unit_proto_upbdefinit = {
  deps,
  &envoy_type_v3_ratelimit_unit_proto_upb_file_layout,
  "envoy/type/v3/ratelimit_unit.proto",
  UPB_STRVIEW_INIT(descriptor, 224)
};
