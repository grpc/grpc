...
'v', 'a', 'l', 'i', 'd', 'a', 't', 'e', '.', 'p', 'r', 'o', 't', 'o', '\"', '\271', '\001', '\n', '\n', 'H', 'a', 's', 'h', 'P', 'o', 
'l', 'i', 'c', 'y', '\022', 'A', '\n', '\t', 's', 'o', 'u', 'r', 'c', 'e', '_', 'i', 'p', '\030', '\001', ' ', '\001', '(', '\013', '2', '\"', 
'.', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'v', '3', '.', 'H', 'a', 's', 'h', 'P', 'o', 'l', 'i', 'c', 'y', 
'.', 'S', 'o', 'u', 'r', 'c', 'e', 'I', 'p', 'H', '\000', 'R', '\010', 's', 'o', 'u', 'r', 'c', 'e', 'I', 'p', '\032', '1', '\n', '\010', 
'S', 'o', 'u', 'r', 'c', 'e', 'I', 'p', ':', '%', '\232', '\305', '\210', '\036', ' ', '\n', '\036', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 
'p', 'e', '.', 'H', 'a', 's', 'h', 'P', 'o', 'l', 'i', 'c', 'y', '.', 'S', 'o', 'u', 'r', 'c', 'e', 'I', 'p', ':', '\034', '\232', 
'\305', '\210', '\036', '\027', '\n', '\025', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'H', 'a', 's', 'h', 'P', 'o', 'l', 'i', 
'c', 'y', 'B', '\027', '\n', '\020', 'p', 'o', 'l', 'i', 'c', 'y', '_', 's', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'r', '\022', '\003', '\370', 
'B', '\001', 'B', '8', '\n', '\033', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', 
'.', 't', 'y', 'p', 'e', '.', 'v', '3', 'B', '\017', 'H', 'a', 's', 'h', 'P', 'o', 'l', 'i', 'c', 'y', 'P', 'r', 'o', 't', 'o', 
...
upb_def_init envoy_type_v3_hash_policy_proto_upbdefinit = {
  deps,
  &envoy_type_v3_hash_policy_proto_upb_file_layout,
  "envoy/type/v3/hash_policy.proto",
  UPB_STRVIEW_INIT(descriptor, 393)
};
