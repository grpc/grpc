...
'n', 'B', '\014', '\n', '\005', 'v', 'a', 'l', 'u', 'e', '\022', '\003', '\370', 'B', '\001', '\"', 'b', '\n', '\025', 'S', 'o', 'c', 'k', 'e', 't', 
'O', 'p', 't', 'i', 'o', 'n', 's', 'O', 'v', 'e', 'r', 'r', 'i', 'd', 'e', '\022', 'I', '\n', '\016', 's', 'o', 'c', 'k', 'e', 't', 
'_', 'o', 'p', 't', 'i', 'o', 'n', 's', '\030', '\001', ' ', '\003', '(', '\013', '2', '\"', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 
'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'S', 'o', 'c', 'k', 'e', 't', 'O', 'p', 't', 'i', 'o', 'n', 
'R', '\r', 's', 'o', 'c', 'k', 'e', 't', 'O', 'p', 't', 'i', 'o', 'n', 's', 'B', '\205', '\001', '\n', '\"', 'i', 'o', '.', 'e', 'n', 
...
_upb_DefPool_Init envoy_config_core_v3_socket_option_proto_upbdefinit = {
  ...
  "envoy/config/core/v3/socket_option.proto",
  UPB_STRINGVIEW_INIT(descriptor, 759)
};
