...
'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 't', 'r', 'a', 'c', 'e', '.', 'v', '3', 'B', '\013', 'Z', 'i', 'p', 'k', 
'i', 'n', 'P', 'r', 'o', 't', 'o', 'P', '\001', '\362', '\230', '\376', '\217', '\005', ')', '\022', '\'', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x', 
't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 't', 'r', 'a', 'c', 'e', 'r', 's', '.', 'z', 'i', 'p', 'k', 'i', 'n', '.', 'v', 
...
upb_def_init envoy_config_trace_v3_zipkin_proto_upbdefinit = {
  deps,
  &envoy_config_trace_v3_zipkin_proto_upb_file_layout,
  "envoy/config/trace/v3/zipkin.proto",
  UPB_STRVIEW_INIT(descriptor, 947)
};
