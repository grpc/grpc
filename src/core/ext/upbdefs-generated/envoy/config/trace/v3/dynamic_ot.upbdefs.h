...
UPB_INLINE const upb_msgdef *envoy_config_trace_v3_DynamicOtConfig_getmsgdef(upb_symtab *s) {
  _upb_symtab_loaddefinit(s, &envoy_config_trace_v3_dynamic_ot_proto_upbdefinit);
  return upb_symtab_lookupmsg(s, "envoy.config.trace.v3.DynamicOtConfig");
}
