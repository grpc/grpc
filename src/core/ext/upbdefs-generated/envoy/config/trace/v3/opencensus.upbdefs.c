...
's', 'C', 'o', 'n', 'f', 'i', 'g', 'J', '\004', '\010', '\007', '\020', '\010', 'B', 's', '\n', '#', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 
'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 't', 'r', 'a', 'c', 'e', '.', 
'v', '3', 'B', '\017', 'O', 'p', 'e', 'n', 'c', 'e', 'n', 's', 'u', 's', 'P', 'r', 'o', 't', 'o', 'P', '\001', '\362', '\230', '\376', '\217', 
'\005', '-', '\022', '+', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 't', 'r', 'a', 'c', 
'e', 'r', 's', '.', 'o', 'p', 'e', 'n', 'c', 'e', 'n', 's', 'u', 's', '.', 'v', '4', 'a', 'l', 'p', 'h', 'a', '\272', '\200', '\310', 
...
upb_def_init envoy_config_trace_v3_opencensus_proto_upbdefinit = {
  ...
  "envoy/config/trace/v3/opencensus.proto",
  UPB_STRVIEW_INIT(descriptor, 1488)
};
