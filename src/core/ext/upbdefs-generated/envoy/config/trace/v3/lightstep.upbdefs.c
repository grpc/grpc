...
'i', 'g', 'h', 't', 's', 't', 'e', 'p', 'C', 'o', 'n', 'f', 'i', 'g', 'B', 'q', '\n', '#', 'i', 'o', '.', 'e', 'n', 'v', 'o', 
'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 't', 'r', 'a', 'c', 'e', 
'.', 'v', '3', 'B', '\016', 'L', 'i', 'g', 'h', 't', 's', 't', 'e', 'p', 'P', 'r', 'o', 't', 'o', 'P', '\001', '\362', '\230', '\376', '\217', 
'\005', ',', '\022', '*', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 't', 'r', 'a', 'c', 
'e', 'r', 's', '.', 'l', 'i', 'g', 'h', 't', 's', 't', 'e', 'p', '.', 'v', '4', 'a', 'l', 'p', 'h', 'a', '\272', '\200', '\310', '\321', 
...
upb_def_init envoy_config_trace_v3_lightstep_proto_upbdefinit = {
  deps,
  &envoy_config_trace_v3_lightstep_proto_upb_file_layout,
  "envoy/config/trace/v3/lightstep.proto",
  UPB_STRVIEW_INIT(descriptor, 812)
};
