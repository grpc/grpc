...
UPB_INLINE const upb_msgdef *envoy_config_trace_v3_OpenCensusConfig_getmsgdef(upb_symtab *s) {
  _upb_symtab_loaddefinit(s, &envoy_config_trace_v3_opencensus_proto_upbdefinit);
  return upb_symtab_lookupmsg(s, "envoy.config.trace.v3.OpenCensusConfig");
}
