...
#ifndef ENVOY_API_V2_LISTENER_PROTO_UPBDEFS_H_
#define ENVOY_API_V2_LISTENER_PROTO_UPBDEFS_H_
...
UPB_INLINE const upb_msgdef *envoy_api_v2_Listener_getmsgdef(upb_symtab *s) {
  _upb_symtab_loaddefinit(s, &envoy_api_v2_listener_proto_upbdefinit);
...
#endif  /* ENVOY_API_V2_LISTENER_PROTO_UPBDEFS_H_ */
