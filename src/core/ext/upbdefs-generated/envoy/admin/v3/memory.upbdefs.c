...
'd', 'm', 'i', 'n', '.', 'v', '2', 'a', 'l', 'p', 'h', 'a', '.', 'M', 'e', 'm', 'o', 'r', 'y', 'B', '5', '\n', '\034', 'i', 'o', 
'.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'a', 'd', 'm', 'i', 'n', '.', 'v', 
'3', 'B', '\013', 'M', 'e', 'm', 'o', 'r', 'y', 'P', 'r', 'o', 't', 'o', 'P', '\001', '\272', '\200', '\310', '\321', '\006', '\002', '\020', '\002', 'b', 
'\006', 'p', 'r', 'o', 't', 'o', '3', 
};
...
upb_def_init envoy_admin_v3_memory_proto_upbdefinit = {
  ...
  "envoy/admin/v3/memory.proto",
  UPB_STRVIEW_INIT(descriptor, 457)
};
