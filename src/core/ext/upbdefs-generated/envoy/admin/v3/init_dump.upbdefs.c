...
'R', '\013', 't', 'a', 'r', 'g', 'e', 't', 'N', 'a', 'm', 'e', 's', 'B', '7', '\n', '\034', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 
'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'a', 'd', 'm', 'i', 'n', '.', 'v', '3', 'B', '\r', 'I', 'n', 'i', 
't', 'D', 'u', 'm', 'p', 'P', 'r', 'o', 't', 'o', 'P', '\001', '\272', '\200', '\310', '\321', '\006', '\002', '\020', '\002', 'b', '\006', 'p', 'r', 'o', 
't', 'o', '3', 
};
...
upb_def_init envoy_admin_v3_init_dump_proto_upbdefinit = {
  deps,
  &envoy_admin_v3_init_dump_proto_upb_file_layout,
  "envoy/admin/v3/init_dump.proto",
  UPB_STRVIEW_INIT(descriptor, 353)
};
