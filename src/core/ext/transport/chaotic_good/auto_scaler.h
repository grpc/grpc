...
#ifndef GRPC_SRC_CORE_EXT_TRANSPORT_CHAOTIC_GOOD_AUTO_SCALER_H
#define GRPC_SRC_CORE_EXT_TRANSPORT_CHAOTIC_GOOD_AUTO_SCALER_H
...
#endif  // GRPC_SRC_CORE_EXT_TRANSPORT_CHAOTIC_GOOD_AUTO_SCALER_H
