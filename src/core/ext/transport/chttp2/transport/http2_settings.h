...
class Http2Settings {
 ...
 private:
  ...
  // to 0 for client.
  // SERVER : This settomg can change for the server. The recommendation is to
  // reduce this when server has memory pressure.
  ...
  // When a peer that updates this more than once, that might indicate either an
