...
static void destroy_stream_locked(grpc_exec_ctx* exec_ctx, void* sp,
                                  grpc_error* error) {
  grpc_chttp2_stream* s = reinterpret_cast<grpc_chttp2_stream*>(sp);
...
grpc_chttp2_stream* grpc_chttp2_parsing_accept_stream(grpc_exec_ctx* exec_ctx,
  ...
  t->channel_callback.accept_stream(
      exec_ctx, t->channel_callback.accept_stream_user_data, &t->base,
  ...
  for (;;) {
    ...
    if (s->fetched_send_message_length == s->fetching_send_message->length) {
      ...
      if (notify_offset <= s->flow_controlled_bytes_written) {
        ...
        if (cb == nullptr) {
          cb = reinterpret_cast<grpc_chttp2_write_cb*>(gpr_malloc(sizeof(*cb)));
        } else {
...
static void perform_stream_op_locked(grpc_exec_ctx* exec_ctx, void* stream_op,
  ...
  grpc_transport_stream_op_batch* op =
      reinterpret_cast<grpc_transport_stream_op_batch*>(stream_op);
  grpc_chttp2_stream* s =
      reinterpret_cast<grpc_chttp2_stream*>(op->handler_private.extra_arg);
...
static void perform_transport_op_locked(grpc_exec_ctx* exec_ctx,
                                        void* stream_op,
                                        grpc_error* error_ignored) {
  grpc_transport_op* op = reinterpret_cast<grpc_transport_op*>(stream_op);
  grpc_chttp2_transport* t =
      reinterpret_cast<grpc_chttp2_transport*>(op->handler_private.extra_arg);
...
static void remove_stream(grpc_exec_ctx* exec_ctx, grpc_chttp2_transport* t,
  ...
  grpc_chttp2_stream* s = reinterpret_cast<grpc_chttp2_stream*>(
...
static void cancel_stream_cb(void* user_data, uint32_t key, void* stream) {
  cancel_stream_cb_args* args =
      reinterpret_cast<cancel_stream_cb_args*>(user_data);
  grpc_chttp2_stream* s = reinterpret_cast<grpc_chttp2_stream*>(stream);
...
static void init_keepalive_ping_locked(grpc_exec_ctx* exec_ctx, void* arg,
                                       grpc_error* error) {
  grpc_chttp2_transport* t = reinterpret_cast<grpc_chttp2_transport*>(arg);
...
static void reset_byte_stream(grpc_exec_ctx* exec_ctx, void* arg,
                              grpc_error* error) {
  grpc_chttp2_stream* s = reinterpret_cast<grpc_chttp2_stream*>(arg);
...
static void incoming_byte_stream_next_locked(grpc_exec_ctx* exec_ctx,
                                             ...
                                             grpc_error* error_ignored) {
  grpc_chttp2_incoming_byte_stream* bs =
      reinterpret_cast<grpc_chttp2_incoming_byte_stream*>(argp);
...
grpc_chttp2_incoming_byte_stream* grpc_chttp2_incoming_byte_stream_create(
  ...
  grpc_chttp2_incoming_byte_stream* incoming_byte_stream =
      reinterpret_cast<grpc_chttp2_incoming_byte_stream*>(
