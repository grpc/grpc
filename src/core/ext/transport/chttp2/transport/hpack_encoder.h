...
typedef struct
{
  ...
  uint8_t
    filter_elems[GRPC_CHTTP2_HPACKC_NUM_FILTERS];
  ...
  grpc_mdelem
    entries_elems[GRPC_CHTTP2_HPACKC_NUM_VALUES];
  uint32_t
    indices_keys[GRPC_CHTTP2_HPACKC_NUM_VALUES];
  uint32_t
    indices_elems[GRPC_CHTTP2_HPACKC_NUM_VALUES];
