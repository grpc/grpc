...
struct grpc_chttp2_transport
{
  ...
  grpc_chttp2_goaway_parser goaway_parser;
    ...
    grpc_core::chttp2::TransportFlowControlDisabled > flow_control;
...
struct grpc_chttp2_stream
{
  ...
  bool sent_trailing_metadata;
    ...
    grpc_core::chttp2::StreamFlowControlDisabled > flow_control;
...
void grpc_chttp2_act_on_flowctl_action (const grpc_core::chttp2::
...
grpc_chttp2_stream *grpc_chttp2_parsing_lookup_stream (grpc_chttp2_transport *
						       t, uint32_t id);
grpc_chttp2_stream *grpc_chttp2_parsing_accept_stream (grpc_chttp2_transport *
						       t, uint32_t id);
...
grpc_error
  *grpc_chttp2_incoming_byte_stream_finished (grpc_chttp2_incoming_byte_stream
					      * bs, grpc_error * error,
					      bool reset_on_error);
void grpc_chttp2_incoming_byte_stream_notify (grpc_chttp2_incoming_byte_stream
					      * bs, grpc_error * error);
...
void grpc_chttp2_maybe_complete_recv_initial_metadata (grpc_chttp2_transport *
						       t,
						       grpc_chttp2_stream *
						       s);
void grpc_chttp2_maybe_complete_recv_message (grpc_chttp2_transport * t,
					      grpc_chttp2_stream * s);
void grpc_chttp2_maybe_complete_recv_trailing_metadata (grpc_chttp2_transport
							* t,
							grpc_chttp2_stream *
							s);
