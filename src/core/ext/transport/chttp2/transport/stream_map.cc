...
void
grpc_chttp2_stream_map_init (grpc_chttp2_stream_map * map,
...
static size_t
compact (uint32_t * keys, void **values, size_t count)
{
  size_t i, out;
...
void
grpc_chttp2_stream_map_add (grpc_chttp2_stream_map * map, uint32_t key,
			    void *value)
{
...
static void **
find (grpc_chttp2_stream_map * map, uint32_t key)
{
  size_t min_idx = 0;
...
void *
grpc_chttp2_stream_map_delete (grpc_chttp2_stream_map * map, uint32_t key)
{
...
void *
grpc_chttp2_stream_map_find (grpc_chttp2_stream_map * map, uint32_t key)
{
  void **pvalue = find (map, key);
...
void *
grpc_chttp2_stream_map_rand (grpc_chttp2_stream_map * map)
{
...
void
grpc_chttp2_stream_map_for_each (grpc_chttp2_stream_map * map,
