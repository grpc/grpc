...
static constexpr const int64_t kDefaultPreferredRxFrameSize = 16384;
...
class FlowControlAction {
 public:
  ...
  Urgency preferred_rx_frame_size_update() const {
    return preferred_rx_frame_size_update_;
  }
  uint32_t initial_window_size() const { return initial_window_size_; }
  uint32_t max_frame_size() const { return max_frame_size_; }
  uint32_t preferred_rx_frame_size() const { return preferred_rx_frame_size_; }
  ...
  FlowControlAction& set_preferred_rx_frame_size_update(Urgency u,
                                                        uint32_t update) {
    preferred_rx_frame_size_update_ = u;
    preferred_rx_frame_size_ = update;
    return *this;
  }
  ...
  bool operator==(const FlowControlAction& other) const {
    return send_stream_update_ == other.send_stream_update_ &&
           ...
           (preferred_rx_frame_size_update_ == Urgency::NO_ACTION_NEEDED ||
            preferred_rx_frame_size_ == other.preferred_rx_frame_size_);
  }
 ...
 private:
  ...
  Urgency preferred_rx_frame_size_update_ = Urgency::NO_ACTION_NEEDED;
  uint32_t initial_window_size_ = 0;
  uint32_t max_frame_size_ = 0;
  uint32_t preferred_rx_frame_size_ = 0;
};
...
class TransportFlowControl final {
 public:
  ...
  int64_t target_preferred_rx_frame_size() const {
    return target_preferred_rx_frame_size_;
  }
 ...
 private:
  ...
  int64_t target_preferred_rx_frame_size_ = kDefaultPreferredRxFrameSize;
