...
#ifndef GRPC_LOOKUP_V1_RLS_CONFIG_PROTO_UPB_H__UPBDEFS_H_
#define GRPC_LOOKUP_V1_RLS_CONFIG_PROTO_UPB_H__UPBDEFS_H_
...
extern _upb_DefPool_Init grpc_lookup_v1_rls_config_proto_upbdefinit;

UPB_INLINE const upb_MessageDef *grpc_lookup_v1_NameMatcher_getmsgdef(upb_DefPool *s) {
  _upb_DefPool_LoadDefInit(s, &grpc_lookup_v1_rls_config_proto_upbdefinit);
...
#endif  /* GRPC_LOOKUP_V1_RLS_CONFIG_PROTO_UPB_H__UPBDEFS_H_ */
