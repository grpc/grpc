...
static const char descriptor[863] = {
    '\n', '\025', 'x', 'd', 's', '/', 't', 'y', 'p', 'e', '/', 'v',
    ...
    'x', '.', 'p', 'r', 'o', 't', 'o', '\032', '\026', 'c', 'e', 'l',
    '/', 'e', 'x', 'p', 'r', '/', 'c', 'h', 'e', 'c', 'k', 'e',
    'd', '.', 'p', 'r', 'o', 't', 'o', '\032', '\025', 'c', 'e', 'l',
    '/', 'e', 'x', 'p', 'r', '/', 's', 'y', 'n', 't', 'a', 'x',
    ...
    '\"', '\345', '\002', '\n', '\r', 'C', 'e', 'l', 'E', 'x', 'p', 'r',
    'e', 's', 's', 'i', 'o', 'n', '\022', 'K', '\n', '\013', 'p', 'a',
    'r', 's', 'e', 'd', '_', 'e', 'x', 'p', 'r', '\030', '\001', ' ',
    '\001', '(', '\013', '2', '$', '.', 'g', 'o', 'o', 'g', 'l', 'e',
    '.', 'a', 'p', 'i', '.', 'e', 'x', 'p', 'r', '.', 'v', '1',
    'a', 'l', 'p', 'h', 'a', '1', '.', 'P', 'a', 'r', 's', 'e',
    'd', 'E', 'x', 'p', 'r', 'B', '\002', '\030', '\001', 'H', '\000', 'R',
    '\n', 'p', 'a', 'r', 's', 'e', 'd', 'E', 'x', 'p', 'r', '\022',
    'N', '\n', '\014', 'c', 'h', 'e', 'c', 'k', 'e', 'd', '_', 'e',
    'x', 'p', 'r', '\030', '\002', ' ', '\001', '(', '\013', '2', '%', '.',
    'g', 'o', 'o', 'g', 'l', 'e', '.', 'a', 'p', 'i', '.', 'e',
    'x', 'p', 'r', '.', 'v', '1', 'a', 'l', 'p', 'h', 'a', '1',
    '.', 'C', 'h', 'e', 'c', 'k', 'e', 'd', 'E', 'x', 'p', 'r',
    'B', '\002', '\030', '\001', 'H', '\000', 'R', '\013', 'c', 'h', 'e', 'c',
    'k', 'e', 'd', 'E', 'x', 'p', 'r', '\022', '<', '\n', '\017', 'c',
    'e', 'l', '_', 'e', 'x', 'p', 'r', '_', 'p', 'a', 'r', 's',
    'e', 'd', '\030', '\003', ' ', '\001', '(', '\013', '2', '\024', '.', 'c',
    'e', 'l', '.', 'e', 'x', 'p', 'r', '.', 'P', 'a', 'r', 's',
    'e', 'd', 'E', 'x', 'p', 'r', 'R', '\r', 'c', 'e', 'l', 'E',
    'x', 'p', 'r', 'P', 'a', 'r', 's', 'e', 'd', '\022', '?', '\n',
    '\020', 'c', 'e', 'l', '_', 'e', 'x', 'p', 'r', '_', 'c', 'h',
    'e', 'c', 'k', 'e', 'd', '\030', '\004', ' ', '\001', '(', '\013', '2',
    '\025', '.', 'c', 'e', 'l', '.', 'e', 'x', 'p', 'r', '.', 'C',
    'h', 'e', 'c', 'k', 'e', 'd', 'E', 'x', 'p', 'r', 'R', '\016',
    'c', 'e', 'l', 'E', 'x', 'p', 'r', 'C', 'h', 'e', 'c', 'k',
    'e', 'd', '\022', '&', '\n', '\017', 'c', 'e', 'l', '_', 'e', 'x',
    'p', 'r', '_', 's', 't', 'r', 'i', 'n', 'g', '\030', '\005', ' ',
    '\001', '(', '\t', 'R', '\r', 'c', 'e', 'l', 'E', 'x', 'p', 'r',
    'S', 't', 'r', 'i', 'n', 'g', 'B', '\020', '\n', '\016', 'e', 'x',
    'p', 'r', '_', 's', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'r',
    '\"', '\236', '\001', '\n', '\020', 'C', 'e', 'l', 'E', 'x', 't', 'r',
    'a', 'c', 't', 'S', 't', 'r', 'i', 'n', 'g', '\022', 'G', '\n',
    '\014', 'e', 'x', 'p', 'r', '_', 'e', 'x', 't', 'r', 'a', 'c',
    't', '\030', '\001', ' ', '\001', '(', '\013', '2', '\032', '.', 'x', 'd',
    's', '.', 't', 'y', 'p', 'e', '.', 'v', '3', '.', 'C', 'e',
    'l', 'E', 'x', 'p', 'r', 'e', 's', 's', 'i', 'o', 'n', 'B',
    '\010', '\372', 'B', '\005', '\212', '\001', '\002', '\020', '\001', 'R', '\013', 'e',
    'x', 'p', 'r', 'E', 'x', 't', 'r', 'a', 'c', 't', '\022', 'A',
    '\n', '\r', 'd', 'e', 'f', 'a', 'u', 'l', 't', '_', 'v', 'a',
    'l', 'u', 'e', '\030', '\002', ' ', '\001', '(', '\013', '2', '\034', '.',
    'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o', 't', 'o',
    'b', 'u', 'f', '.', 'S', 't', 'r', 'i', 'n', 'g', 'V', 'a',
    'l', 'u', 'e', 'R', '\014', 'd', 'e', 'f', 'a', 'u', 'l', 't',
    'V', 'a', 'l', 'u', 'e', 'B', 'P', '\n', '\026', 'c', 'o', 'm',
    '.', 'g', 'i', 't', 'h', 'u', 'b', '.', 'x', 'd', 's', '.',
    't', 'y', 'p', 'e', '.', 'v', '3', 'B', '\010', 'C', 'e', 'l',
    'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', '\"', 'g', 'i', 't',
    'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'c', 'n', 'c', 'f',
    '/', 'x', 'd', 's', '/', 'g', 'o', '/', 'x', 'd', 's', '/',
    't', 'y', 'p', 'e', '/', 'v', '3', '\322', '\306', '\244', '\341', '\006',
...
static _upb_DefPool_Init *deps[8] = {
    ...
    &cel_expr_checked_proto_upbdefinit,
