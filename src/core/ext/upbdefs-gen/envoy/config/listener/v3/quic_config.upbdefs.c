...
'e', '/', 'v', 'a', 'l', 'i', 'd', 'a', 't', 'e', '.', 'p', 'r', 'o', 't', 'o', '\"', '\366', '\010', '\n', '\023', 'Q', 'u', 'i', 'c', 
...
'g', '\022', ']', '\n', '\035', 's', 'e', 'n', 'd', '_', 'd', 'i', 's', 'a', 'b', 'l', 'e', '_', 'a', 'c', 't', 'i', 'v', 'e', '_', 
'm', 'i', 'g', 'r', 'a', 't', 'i', 'o', 'n', '\030', '\n', ' ', '\001', '(', '\013', '2', '\032', '.', 'g', 'o', 'o', 'g', 'l', 'e', '.', 
'p', 'r', 'o', 't', 'o', 'b', 'u', 'f', '.', 'B', 'o', 'o', 'l', 'V', 'a', 'l', 'u', 'e', 'R', '\032', 's', 'e', 'n', 'd', 'D', 
'i', 's', 'a', 'b', 'l', 'e', 'A', 'c', 't', 'i', 'v', 'e', 'M', 'i', 'g', 'r', 'a', 't', 'i', 'o', 'n', '\022', 'q', '\n', '\037', 
'c', 'o', 'n', 'n', 'e', 'c', 't', 'i', 'o', 'n', '_', 'd', 'e', 'b', 'u', 'g', '_', 'v', 'i', 's', 'i', 't', 'o', 'r', '_', 
'c', 'o', 'n', 'f', 'i', 'g', '\030', '\013', ' ', '\001', '(', '\013', '2', '*', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 
'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'T', 'y', 'p', 'e', 'd', 'E', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 
'C', 'o', 'n', 'f', 'i', 'g', 'R', '\034', 'c', 'o', 'n', 'n', 'e', 'c', 't', 'i', 'o', 'n', 'D', 'e', 'b', 'u', 'g', 'V', 'i', 
's', 'i', 't', 'o', 'r', 'C', 'o', 'n', 'f', 'i', 'g', ':', '0', '\232', '\305', '\210', '\036', '+', '\n', ')', 'e', 'n', 'v', 'o', 'y', 
'.', 'a', 'p', 'i', '.', 'v', '2', '.', 'l', 'i', 's', 't', 'e', 'n', 'e', 'r', '.', 'Q', 'u', 'i', 'c', 'P', 'r', 'o', 't', 
'o', 'c', 'o', 'l', 'O', 'p', 't', 'i', 'o', 'n', 's', 'B', '\217', '\001', '\n', '&', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 
'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'l', 'i', 's', 't', 'e', 'n', 'e', 
'r', '.', 'v', '3', 'B', '\017', 'Q', 'u', 'i', 'c', 'C', 'o', 'n', 'f', 'i', 'g', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', 'J', 
'g', 'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '/', 'g', 'o', '-', 
'c', 'o', 'n', 't', 'r', 'o', 'l', '-', 'p', 'l', 'a', 'n', 'e', '/', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f', 'i', 
'g', '/', 'l', 'i', 's', 't', 'e', 'n', 'e', 'r', '/', 'v', '3', ';', 'l', 'i', 's', 't', 'e', 'n', 'e', 'r', 'v', '3', '\272', 
...
_upb_DefPool_Init envoy_config_listener_v3_quic_config_proto_upbdefinit = {
  ...
  "envoy/config/listener/v3/quic_config.proto",
  UPB_STRINGVIEW_INIT(descriptor, 1665)
};
