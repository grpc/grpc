...
static const char descriptor[903] = {
    ...
    'e', 'r', 'v', 'i', 'c', 'e', 'N', 'a', 'm', 'e', '\022', 'Y',
    '\n', '\022', 'r', 'e', 's', 'o', 'u', 'r', 'c', 'e', '_', 'd',
    'e', 't', 'e', 'c', 't', 'o', 'r', 's', '\030', '\004', ' ', '\003',
    '(', '\013', '2', '*', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c',
    'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v',
    '3', '.', 'T', 'y', 'p', 'e', 'd', 'E', 'x', 't', 'e', 'n',
    's', 'i', 'o', 'n', 'C', 'o', 'n', 'f', 'i', 'g', 'R', '\021',
    'r', 'e', 's', 'o', 'u', 'r', 'c', 'e', 'D', 'e', 't', 'e',
    'c', 't', 'o', 'r', 's', '\022', 'D', '\n', '\007', 's', 'a', 'm',
    'p', 'l', 'e', 'r', '\030', '\005', ' ', '\001', '(', '\013', '2', '*',
    '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
    'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'T', 'y',
    'p', 'e', 'd', 'E', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n',
    'C', 'o', 'n', 'f', 'i', 'g', 'R', '\007', 's', 'a', 'm', 'p',
    'l', 'e', 'r', '\022', 'B', '\n', '\016', 'm', 'a', 'x', '_', 'c',
    'a', 'c', 'h', 'e', '_', 's', 'i', 'z', 'e', '\030', '\006', ' ',
    '\001', '(', '\013', '2', '\034', '.', 'g', 'o', 'o', 'g', 'l', 'e',
    '.', 'p', 'r', 'o', 't', 'o', 'b', 'u', 'f', '.', 'U', 'I',
    'n', 't', '3', '2', 'V', 'a', 'l', 'u', 'e', 'R', '\014', 'm',
    'a', 'x', 'C', 'a', 'c', 'h', 'e', 'S', 'i', 'z', 'e', 'B',
    '\211', '\001', '\n', '#', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y',
    'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.',
    'c', 'o', 'n', 'f', 'i', 'g', '.', 't', 'r', 'a', 'c', 'e',
    '.', 'v', '3', 'B', '\022', 'O', 'p', 'e', 'n', 't', 'e', 'l',
    'e', 'm', 'e', 't', 'r', 'y', 'P', 'r', 'o', 't', 'o', 'P',
    '\001', 'Z', 'D', 'g', 'i', 't', 'h', 'u', 'b', '.', 'c', 'o',
