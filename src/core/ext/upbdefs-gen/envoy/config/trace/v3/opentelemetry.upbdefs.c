...
static const char descriptor[1302] = {
    ...
    'i', 'o', 'n', 's', '/', 's', 't', 'a', 't', 'u', 's', '.',
    'p', 'r', 'o', 't', 'o', '\"', '\346', '\006', '\n', '\023', 'O', 'p',
    'e', 'n', 'T', 'e', 'l', 'e', 'm', 'e', 't', 'r', 'y', 'C',
    'o', 'n', 'f', 'i', 'g', '\022', '[', '\n', '\014', 'g', 'r', 'p',
    'c', '_', 's', 'e', 'r', 'v', 'i', 'c', 'e', '\030', '\001', ' ',
    '\001', '(', '\013', '2', '!', '.', 'e', 'n', 'v', 'o', 'y', '.',
    'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.',
    'v', '3', '.', 'G', 'r', 'p', 'c', 'S', 'e', 'r', 'v', 'i',
    'c', 'e', 'B', '\025', '\362', '\230', '\376', '\217', '\005', '\017', '\022', '\r',
    'o', 't', 'l', 'p', '_', 'e', 'x', 'p', 'o', 'r', 't', 'e',
    'r', 'R', '\013', 'g', 'r', 'p', 'c', 'S', 'e', 'r', 'v', 'i',
    'c', 'e', '\022', '[', '\n', '\014', 'h', 't', 't', 'p', '_', 's',
    'e', 'r', 'v', 'i', 'c', 'e', '\030', '\003', ' ', '\001', '(', '\013',
    '2', '!', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n',
    'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.',
    'H', 't', 't', 'p', 'S', 'e', 'r', 'v', 'i', 'c', 'e', 'B',
    '\025', '\362', '\230', '\376', '\217', '\005', '\017', '\022', '\r', 'o', 't', 'l',
    'p', '_', 'e', 'x', 'p', 'o', 'r', 't', 'e', 'r', 'R', '\013',
    'h', 't', 't', 'p', 'S', 'e', 'r', 'v', 'i', 'c', 'e', '\022',
    ']', '\n', '\010', 'e', 'x', 'p', 'o', 'r', 't', 'e', 'r', '\030',
    '\n', ' ', '\001', '(', '\013', '2', '*', '.', 'e', 'n', 'v', 'o',
    'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r',
    'e', '.', 'v', '3', '.', 'T', 'y', 'p', 'e', 'd', 'E', 'x',
    't', 'e', 'n', 's', 'i', 'o', 'n', 'C', 'o', 'n', 'f', 'i',
    'g', 'B', '\025', '\362', '\230', '\376', '\217', '\005', '\017', '\022', '\r', 'o',
    't', 'l', 'p', '_', 'e', 'x', 'p', 'o', 'r', 't', 'e', 'r',
    'R', '\010', 'e', 'x', 'p', 'o', 'r', 't', 'e', 'r', '\022', '!',
    '\n', '\014', 's', 'e', 'r', 'v', 'i', 'c', 'e', '_', 'n', 'a',
    'm', 'e', '\030', '\002', ' ', '\001', '(', '\t', 'R', '\013', 's', 'e',
    'r', 'v', 'i', 'c', 'e', 'N', 'a', 'm', 'e', '\022', 'Y', '\n',
    '\022', 'r', 'e', 's', 'o', 'u', 'r', 'c', 'e', '_', 'd', 'e',
    't', 'e', 'c', 't', 'o', 'r', 's', '\030', '\004', ' ', '\003', '(',
    '\013', '2', '*', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o',
    'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3',
    '.', 'T', 'y', 'p', 'e', 'd', 'E', 'x', 't', 'e', 'n', 's',
    'i', 'o', 'n', 'C', 'o', 'n', 'f', 'i', 'g', 'R', '\021', 'r',
    'e', 's', 'o', 'u', 'r', 'c', 'e', 'D', 'e', 't', 'e', 'c',
    't', 'o', 'r', 's', '\022', 'D', '\n', '\007', 's', 'a', 'm', 'p',
    'l', 'e', 'r', '\030', '\005', ' ', '\001', '(', '\013', '2', '*', '.',
    'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g',
    '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'T', 'y', 'p',
    'e', 'd', 'E', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 'C',
    'o', 'n', 'f', 'i', 'g', 'R', '\007', 's', 'a', 'm', 'p', 'l',
    'e', 'r', '\022', 'B', '\n', '\016', 'm', 'a', 'x', '_', 'c', 'a',
    'c', 'h', 'e', '_', 's', 'i', 'z', 'e', '\030', '\006', ' ', '\001',
    '(', '\013', '2', '\034', '.', 'g', 'o', 'o', 'g', 'l', 'e', '.',
    'p', 'r', 'o', 't', 'o', 'b', 'u', 'f', '.', 'U', 'I', 'n',
    't', '3', '2', 'V', 'a', 'l', 'u', 'e', 'R', '\014', 'm', 'a',
    'x', 'C', 'a', 'c', 'h', 'e', 'S', 'i', 'z', 'e', '\022', 'l',
    '\n', '%', 's', 'e', 't', '_', 't', 'e', 'l', 'e', 'm', 'e',
    't', 'r', 'y', '_', 's', 'd', 'k', '_', 'r', 'e', 's', 'o',
    'u', 'r', 'c', 'e', '_', 'a', 't', 't', 'r', 'i', 'b', 'u',
    't', 'e', 's', '\030', '\007', ' ', '\001', '(', '\013', '2', '\032', '.',
    'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o', 't', 'o',
    'b', 'u', 'f', '.', 'B', 'o', 'o', 'l', 'V', 'a', 'l', 'u',
    'e', 'R', '!', 's', 'e', 't', 'T', 'e', 'l', 'e', 'm', 'e',
    't', 'r', 'y', 'S', 'd', 'k', 'R', 'e', 's', 'o', 'u', 'r',
    'c', 'e', 'A', 't', 't', 'r', 'i', 'b', 'u', 't', 'e', 's',
    '\022', 'h', '\n', '#', 's', 'e', 't', '_', 's', 'e', 'r', 'v',
    'i', 'c', 'e', '_', 'n', 'a', 'm', 'e', '_', 'r', 'e', 's',
    'o', 'u', 'r', 'c', 'e', '_', 'a', 't', 't', 'r', 'i', 'b',
    'u', 't', 'e', '\030', '\010', ' ', '\001', '(', '\013', '2', '\032', '.',
    'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o', 't', 'o',
    'b', 'u', 'f', '.', 'B', 'o', 'o', 'l', 'V', 'a', 'l', 'u',
    'e', 'R', '\037', 's', 'e', 't', 'S', 'e', 'r', 'v', 'i', 'c',
    'e', 'N', 'a', 'm', 'e', 'R', 'e', 's', 'o', 'u', 'r', 'c',
    'e', 'A', 't', 't', 'r', 'i', 'b', 'u', 't', 'e', '\022', 'V',
    '\n', '\031', 's', 'e', 't', '_', 'i', 'n', 's', 't', 'r', 'u',
    'm', 'e', 'n', 't', 'a', 't', 'i', 'o', 'n', '_', 's', 'c',
    'o', 'p', 'e', '\030', '\t', ' ', '\001', '(', '\013', '2', '\032', '.',
    'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o', 't', 'o',
    'b', 'u', 'f', '.', 'B', 'o', 'o', 'l', 'V', 'a', 'l', 'u',
    'e', 'R', '\027', 's', 'e', 't', 'I', 'n', 's', 't', 'r', 'u',
    'm', 'e', 'n', 't', 'a', 't', 'i', 'o', 'n', 'S', 'c', 'o',
    'p', 'e', 'B', '\211', '\001', '\n', '#', 'i', 'o', '.', 'e', 'n',
