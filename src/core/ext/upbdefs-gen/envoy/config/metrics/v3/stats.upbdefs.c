...
static const char descriptor[2227] = {
    '\n', '#', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
    'i', 'g', '/', 'm', 'e', 't', 'r', 'i', 'c', 's', '/', 'v',
    '3', '/', 's', 't', 'a', 't', 's', '.', 'p', 'r', 'o', 't',
    ...
    'h', '\022', '/', '\n', '\007', 'b', 'u', 'c', 'k', 'e', 't', 's',
    '\030', '\002', ' ', '\003', '(', '\001', 'B', '\025', '\372', 'B', '\022', '\222',
    '\001', '\017', '\030', '\001', '\"', '\013', '\022', '\t', '!', '\000', '\000', '\000',
    '\000', '\000', '\000', '\000', '\000', 'R', '\007', 'b', 'u', 'c', 'k', 'e',
    't', 's', '\022', '=', '\n', '\004', 'b', 'i', 'n', 's', '\030', '\003',
    ' ', '\001', '(', '\013', '2', '\034', '.', 'g', 'o', 'o', 'g', 'l',
    'e', '.', 'p', 'r', 'o', 't', 'o', 'b', 'u', 'f', '.', 'U',
    'I', 'n', 't', '3', '2', 'V', 'a', 'l', 'u', 'e', 'B', '\013',
    '\372', 'B', '\010', '*', '\006', '\030', '\202', '\350', '\002', ' ', '\000', 'R',
    '\004', 'b', 'i', 'n', 's', '\"', '\317', '\001', '\n', '\n', 'S', 't',
    'a', 't', 's', 'd', 'S', 'i', 'n', 'k', '\022', '9', '\n', '\007',
    'a', 'd', 'd', 'r', 'e', 's', 's', '\030', '\001', ' ', '\001', '(',
    '\013', '2', '\035', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o',
    'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3',
    '.', 'A', 'd', 'd', 'r', 'e', 's', 's', 'H', '\000', 'R', '\007',
    'a', 'd', 'd', 'r', 'e', 's', 's', '\022', '*', '\n', '\020', 't',
    'c', 'p', '_', 'c', 'l', 'u', 's', 't', 'e', 'r', '_', 'n',
    'a', 'm', 'e', '\030', '\002', ' ', '\001', '(', '\t', 'H', '\000', 'R',
    '\016', 't', 'c', 'p', 'C', 'l', 'u', 's', 't', 'e', 'r', 'N',
    'a', 'm', 'e', '\022', '\026', '\n', '\006', 'p', 'r', 'e', 'f', 'i',
    'x', '\030', '\003', ' ', '\001', '(', '\t', 'R', '\006', 'p', 'r', 'e',
    'f', 'i', 'x', ':', ')', '\232', '\305', '\210', '\036', '$', '\n', '\"',
    'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g',
    '.', 'm', 'e', 't', 'r', 'i', 'c', 's', '.', 'v', '2', '.',
    'S', 't', 'a', 't', 's', 'd', 'S', 'i', 'n', 'k', 'B', '\027',
    '\n', '\020', 's', 't', 'a', 't', 's', 'd', '_', 's', 'p', 'e',
    'c', 'i', 'f', 'i', 'e', 'r', '\022', '\003', '\370', 'B', '\001', '\"',
    '\217', '\002', '\n', '\r', 'D', 'o', 'g', 'S', 't', 'a', 't', 's',
    'd', 'S', 'i', 'n', 'k', '\022', '9', '\n', '\007', 'a', 'd', 'd',
    'r', 'e', 's', 's', '\030', '\001', ' ', '\001', '(', '\013', '2', '\035',
    '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
    'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'A', 'd',
    'd', 'r', 'e', 's', 's', 'H', '\000', 'R', '\007', 'a', 'd', 'd',
    'r', 'e', 's', 's', '\022', '\026', '\n', '\006', 'p', 'r', 'e', 'f',
    'i', 'x', '\030', '\003', ' ', '\001', '(', '\t', 'R', '\006', 'p', 'r',
    'e', 'f', 'i', 'x', '\022', 'Z', '\n', '\026', 'm', 'a', 'x', '_',
    'b', 'y', 't', 'e', 's', '_', 'p', 'e', 'r', '_', 'd', 'a',
    't', 'a', 'g', 'r', 'a', 'm', '\030', '\004', ' ', '\001', '(', '\013',
    '2', '\034', '.', 'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r',
    'o', 't', 'o', 'b', 'u', 'f', '.', 'U', 'I', 'n', 't', '6',
    '4', 'V', 'a', 'l', 'u', 'e', 'B', '\007', '\372', 'B', '\004', '2',
    '\002', ' ', '\000', 'R', '\023', 'm', 'a', 'x', 'B', 'y', 't', 'e',
    's', 'P', 'e', 'r', 'D', 'a', 't', 'a', 'g', 'r', 'a', 'm',
    ':', ',', '\232', '\305', '\210', '\036', '\'', '\n', '%', 'e', 'n', 'v',
    'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'm', 'e',
    't', 'r', 'i', 'c', 's', '.', 'v', '2', '.', 'D', 'o', 'g',
    'S', 't', 'a', 't', 's', 'd', 'S', 'i', 'n', 'k', 'B', '\033',
    '\n', '\024', 'd', 'o', 'g', '_', 's', 't', 'a', 't', 's', 'd',
    '_', 's', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'r', '\022', '\003',
    '\370', 'B', '\001', 'J', '\004', '\010', '\002', '\020', '\003', '\"', 'Z', '\n',
    '\013', 'H', 'y', 's', 't', 'r', 'i', 'x', 'S', 'i', 'n', 'k',
    '\022', '\037', '\n', '\013', 'n', 'u', 'm', '_', 'b', 'u', 'c', 'k',
    'e', 't', 's', '\030', '\001', ' ', '\001', '(', '\003', 'R', '\n', 'n',
    'u', 'm', 'B', 'u', 'c', 'k', 'e', 't', 's', ':', '*', '\232',
    '\305', '\210', '\036', '%', '\n', '#', 'e', 'n', 'v', 'o', 'y', '.',
    'c', 'o', 'n', 'f', 'i', 'g', '.', 'm', 'e', 't', 'r', 'i',
    'c', 's', '.', 'v', '2', '.', 'H', 'y', 's', 't', 'r', 'i',
    'x', 'S', 'i', 'n', 'k', 'B', '\207', '\001', '\n', '%', 'i', 'o',
    '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '.',
    'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g',
