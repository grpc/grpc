...
static const char descriptor[2972] = {
    '\n', '/', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
    'i', 'g', '/', 'c', 'l', 'u', 's', 't', 'e', 'r', '/', 'v',
    ...
    't', '\022', 'N', '\n', '\025', 'd', 'e', 't', 'e', 'c', 't', '_',
    'd', 'e', 'g', 'r', 'a', 'd', 'e', 'd', '_', 'h', 'o', 's',
    't', 's', '\030', '\032', ' ', '\001', '(', '\013', '2', '\032', '.', 'g',
    'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o', 't', 'o', 'b',
    'u', 'f', '.', 'B', 'o', 'o', 'l', 'V', 'a', 'l', 'u', 'e',
    'R', '\023', 'd', 'e', 't', 'e', 'c', 't', 'D', 'e', 'g', 'r',
    'a', 'd', 'e', 'd', 'H', 'o', 's', 't', 's', ':', ',', '\232',
    '\305', '\210', '\036', '\'', '\n', '%', 'e', 'n', 'v', 'o', 'y', '.',
    'a', 'p', 'i', '.', 'v', '2', '.', 'c', 'l', 'u', 's', 't',
    'e', 'r', '.', 'O', 'u', 't', 'l', 'i', 'e', 'r', 'D', 'e',
    't', 'e', 'c', 't', 'i', 'o', 'n', 'B', '\222', '\001', '\n', '%',
    'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x',
    'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f',
    'i', 'g', '.', 'c', 'l', 'u', 's', 't', 'e', 'r', '.', 'v',
    '3', 'B', '\025', 'O', 'u', 't', 'l', 'i', 'e', 'r', 'D', 'e',
    't', 'e', 'c', 't', 'i', 'o', 'n', 'P', 'r', 'o', 't', 'o',
    'P', '\001', 'Z', 'H', 'g', 'i', 't', 'h', 'u', 'b', '.', 'c',
