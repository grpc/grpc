...
static const char descriptor[1218] = {
    '\n', '(', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
    'i', 'g', '/', 'c', 'o', 'r', 'e', '/', 'v', '3', '/', 's',
    ...
    'e', '\022', 'Q', '\n', '\n', 'i', 'p', '_', 'v', 'e', 'r', 's',
    'i', 'o', 'n', '\030', '\010', ' ', '\001', '(', '\016', '2', '2', '.',
    'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g',
    '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'S', 'o', 'c',
    'k', 'e', 't', 'O', 'p', 't', 'i', 'o', 'n', '.', 'S', 'o',
    'c', 'k', 'e', 't', 'I', 'p', 'V', 'e', 'r', 's', 'i', 'o',
    'n', 'R', '\t', 'i', 'p', 'V', 'e', 'r', 's', 'i', 'o', 'n',
    '\032', '\304', '\001', '\n', '\n', 'S', 'o', 'c', 'k', 'e', 't', 'T',
    'y', 'p', 'e', '\022', 'L', '\n', '\006', 's', 't', 'r', 'e', 'a',
    'm', '\030', '\001', ' ', '\001', '(', '\013', '2', '4', '.', 'e', 'n',
    'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c',
    'o', 'r', 'e', '.', 'v', '3', '.', 'S', 'o', 'c', 'k', 'e',
    't', 'O', 'p', 't', 'i', 'o', 'n', '.', 'S', 'o', 'c', 'k',
    'e', 't', 'T', 'y', 'p', 'e', '.', 'S', 't', 'r', 'e', 'a',
    'm', 'R', '\006', 's', 't', 'r', 'e', 'a', 'm', '\022', 'R', '\n',
    '\010', 'd', 'a', 't', 'a', 'g', 'r', 'a', 'm', '\030', '\002', ' ',
    '\001', '(', '\013', '2', '6', '.', 'e', 'n', 'v', 'o', 'y', '.',
    'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.',
    'v', '3', '.', 'S', 'o', 'c', 'k', 'e', 't', 'O', 'p', 't',
    'i', 'o', 'n', '.', 'S', 'o', 'c', 'k', 'e', 't', 'T', 'y',
    'p', 'e', '.', 'D', 'a', 't', 'a', 'g', 'r', 'a', 'm', 'R',
    '\010', 'd', 'a', 't', 'a', 'g', 'r', 'a', 'm', '\032', '\010', '\n',
    '\006', 'S', 't', 'r', 'e', 'a', 'm', '\032', '\n', '\n', '\010', 'D',
    'a', 't', 'a', 'g', 'r', 'a', 'm', '\"', 'F', '\n', '\013', 'S',
    'o', 'c', 'k', 'e', 't', 'S', 't', 'a', 't', 'e', '\022', '\021',
    '\n', '\r', 'S', 'T', 'A', 'T', 'E', '_', 'P', 'R', 'E', 'B',
    'I', 'N', 'D', '\020', '\000', '\022', '\017', '\n', '\013', 'S', 'T', 'A',
    'T', 'E', '_', 'B', 'O', 'U', 'N', 'D', '\020', '\001', '\022', '\023',
    '\n', '\017', 'S', 'T', 'A', 'T', 'E', '_', 'L', 'I', 'S', 'T',
    'E', 'N', 'I', 'N', 'G', '\020', '\002', '\"', 'l', '\n', '\017', 'S',
    'o', 'c', 'k', 'e', 't', 'I', 'p', 'V', 'e', 'r', 's', 'i',
    'o', 'n', '\022', '!', '\n', '\035', 'S', 'O', 'C', 'K', 'E', 'T',
    '_', 'I', 'P', '_', 'V', 'E', 'R', 'S', 'I', 'O', 'N', '_',
    'U', 'N', 'S', 'P', 'E', 'C', 'I', 'F', 'I', 'E', 'D', '\020',
    '\000', '\022', '\032', '\n', '\026', 'S', 'O', 'C', 'K', 'E', 'T', '_',
    'I', 'P', '_', 'V', 'E', 'R', 'S', 'I', 'O', 'N', '_', 'I',
    'P', 'V', '4', '\020', '\001', '\022', '\032', '\n', '\026', 'S', 'O', 'C',
    'K', 'E', 'T', '_', 'I', 'P', '_', 'V', 'E', 'R', 'S', 'I',
    'O', 'N', '_', 'I', 'P', 'V', '6', '\020', '\002', ':', '%', '\232',
    '\305', '\210', '\036', ' ', '\n', '\036', 'e', 'n', 'v', 'o', 'y', '.',
    'a', 'p', 'i', '.', 'v', '2', '.', 'c', 'o', 'r', 'e', '.',
    'S', 'o', 'c', 'k', 'e', 't', 'O', 'p', 't', 'i', 'o', 'n',
    'B', '\014', '\n', '\005', 'v', 'a', 'l', 'u', 'e', '\022', '\003', '\370',
    'B', '\001', '\"', 'b', '\n', '\025', 'S', 'o', 'c', 'k', 'e', 't',
    'O', 'p', 't', 'i', 'o', 'n', 's', 'O', 'v', 'e', 'r', 'r',
    'i', 'd', 'e', '\022', 'I', '\n', '\016', 's', 'o', 'c', 'k', 'e',
    't', '_', 'o', 'p', 't', 'i', 'o', 'n', 's', '\030', '\001', ' ',
    '\003', '(', '\013', '2', '\"', '.', 'e', 'n', 'v', 'o', 'y', '.',
    'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.',
    'v', '3', '.', 'S', 'o', 'c', 'k', 'e', 't', 'O', 'p', 't',
    'i', 'o', 'n', 'R', '\r', 's', 'o', 'c', 'k', 'e', 't', 'O',
    'p', 't', 'i', 'o', 'n', 's', 'B', '\205', '\001', '\n', '\"', 'i',
    'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y',
    '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
    'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', 'B', '\021', 'S',
    'o', 'c', 'k', 'e', 't', 'O', 'p', 't', 'i', 'o', 'n', 'P',
