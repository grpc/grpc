...
static const char descriptor[2660] = {
    ...
    'f', 'i', 'e', 'r', '\022', '\003', '\370', 'B', '\001', '\"', '\264', '\003',
    ...
    '\006', ' ', '\001', '(', '\010', 'R', '\n', 'i', 'p', 'v', '4', 'C',
    'o', 'm', 'p', 'a', 't', '\022', '<', '\n', '\032', 'n', 'e', 't',
    'w', 'o', 'r', 'k', '_', 'n', 'a', 'm', 'e', 's', 'p', 'a',
    'c', 'e', '_', 'f', 'i', 'l', 'e', 'p', 'a', 't', 'h', '\030',
    '\007', ' ', '\001', '(', '\t', 'R', '\030', 'n', 'e', 't', 'w', 'o',
    'r', 'k', 'N', 'a', 'm', 'e', 's', 'p', 'a', 'c', 'e', 'F',
    'i', 'l', 'e', 'p', 'a', 't', 'h', '\"', '\034', '\n', '\010', 'P',
    'r', 'o', 't', 'o', 'c', 'o', 'l', '\022', '\007', '\n', '\003', 'T',
    'C', 'P', '\020', '\000', '\022', '\007', '\n', '\003', 'U', 'D', 'P', '\020',
    '\001', ':', '&', '\232', '\305', '\210', '\036', '!', '\n', '\037', 'e', 'n',
    'v', 'o', 'y', '.', 'a', 'p', 'i', '.', 'v', '2', '.', 'c',
    'o', 'r', 'e', '.', 'S', 'o', 'c', 'k', 'e', 't', 'A', 'd',
    'd', 'r', 'e', 's', 's', 'B', '\025', '\n', '\016', 'p', 'o', 'r',
    't', '_', 's', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'r', '\022',
    '\003', '\370', 'B', '\001', '\"', '\220', '\002', '\n', '\014', 'T', 'c', 'p',
    'K', 'e', 'e', 'p', 'a', 'l', 'i', 'v', 'e', '\022', 'G', '\n',
    '\020', 'k', 'e', 'e', 'p', 'a', 'l', 'i', 'v', 'e', '_', 'p',
    'r', 'o', 'b', 'e', 's', '\030', '\001', ' ', '\001', '(', '\013', '2',
    '\034', '.', 'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o',
    't', 'o', 'b', 'u', 'f', '.', 'U', 'I', 'n', 't', '3', '2',
    'V', 'a', 'l', 'u', 'e', 'R', '\017', 'k', 'e', 'e', 'p', 'a',
    'l', 'i', 'v', 'e', 'P', 'r', 'o', 'b', 'e', 's', '\022', 'C',
    '\n', '\016', 'k', 'e', 'e', 'p', 'a', 'l', 'i', 'v', 'e', '_',
    't', 'i', 'm', 'e', '\030', '\002', ' ', '\001', '(', '\013', '2', '\034',
    '.', 'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o', 't',
    'o', 'b', 'u', 'f', '.', 'U', 'I', 'n', 't', '3', '2', 'V',
    'a', 'l', 'u', 'e', 'R', '\r', 'k', 'e', 'e', 'p', 'a', 'l',
    'i', 'v', 'e', 'T', 'i', 'm', 'e', '\022', 'K', '\n', '\022', 'k',
    'e', 'e', 'p', 'a', 'l', 'i', 'v', 'e', '_', 'i', 'n', 't',
    'e', 'r', 'v', 'a', 'l', '\030', '\003', ' ', '\001', '(', '\013', '2',
    '\034', '.', 'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o',
    't', 'o', 'b', 'u', 'f', '.', 'U', 'I', 'n', 't', '3', '2',
    'V', 'a', 'l', 'u', 'e', 'R', '\021', 'k', 'e', 'e', 'p', 'a',
    'l', 'i', 'v', 'e', 'I', 'n', 't', 'e', 'r', 'v', 'a', 'l',
    ':', '%', '\232', '\305', '\210', '\036', ' ', '\n', '\036', 'e', 'n', 'v',
    'o', 'y', '.', 'a', 'p', 'i', '.', 'v', '2', '.', 'c', 'o',
    'r', 'e', '.', 'T', 'c', 'p', 'K', 'e', 'e', 'p', 'a', 'l',
    'i', 'v', 'e', '\"', '\261', '\001', '\n', '\022', 'E', 'x', 't', 'r',
    'a', 'S', 'o', 'u', 'r', 'c', 'e', 'A', 'd', 'd', 'r', 'e',
    's', 's', '\022', 'G', '\n', '\007', 'a', 'd', 'd', 'r', 'e', 's',
    's', '\030', '\001', ' ', '\001', '(', '\013', '2', '#', '.', 'e', 'n',
    'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c',
    'o', 'r', 'e', '.', 'v', '3', '.', 'S', 'o', 'c', 'k', 'e',
    't', 'A', 'd', 'd', 'r', 'e', 's', 's', 'B', '\010', '\372', 'B',
    '\005', '\212', '\001', '\002', '\020', '\001', 'R', '\007', 'a', 'd', 'd', 'r',
    'e', 's', 's', '\022', 'R', '\n', '\016', 's', 'o', 'c', 'k', 'e',
    't', '_', 'o', 'p', 't', 'i', 'o', 'n', 's', '\030', '\002', ' ',
    '\001', '(', '\013', '2', '+', '.', 'e', 'n', 'v', 'o', 'y', '.',
    'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.',
    'v', '3', '.', 'S', 'o', 'c', 'k', 'e', 't', 'O', 'p', 't',
    'i', 'o', 'n', 's', 'O', 'v', 'e', 'r', 'r', 'i', 'd', 'e',
    'R', '\r', 's', 'o', 'c', 'k', 'e', 't', 'O', 'p', 't', 'i',
    'o', 'n', 's', '\"', '\364', '\004', '\n', '\n', 'B', 'i', 'n', 'd',
    'C', 'o', 'n', 'f', 'i', 'g', '\022', 'J', '\n', '\016', 's', 'o',
    ...
    'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o',
    'r', 'e', '.', 'v', '3', '.', 'S', 'o', 'c', 'k', 'e', 't',
    'A', 'd', 'd', 'r', 'e', 's', 's', 'R', '\r', 's', 'o', 'u',
    'r', 'c', 'e', 'A', 'd', 'd', 'r', 'e', 's', 's', '\022', '6',
    '\n', '\010', 'f', 'r', 'e', 'e', 'b', 'i', 'n', 'd', '\030', '\002',
    ' ', '\001', '(', '\013', '2', '\032', '.', 'g', 'o', 'o', 'g', 'l',
    'e', '.', 'p', 'r', 'o', 't', 'o', 'b', 'u', 'f', '.', 'B',
    'o', 'o', 'l', 'V', 'a', 'l', 'u', 'e', 'R', '\010', 'f', 'r',
    'e', 'e', 'b', 'i', 'n', 'd', '\022', 'I', '\n', '\016', 's', 'o',
    'c', 'k', 'e', 't', '_', 'o', 'p', 't', 'i', 'o', 'n', 's',
    '\030', '\003', ' ', '\003', '(', '\013', '2', '\"', '.', 'e', 'n', 'v',
    'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o',
    'r', 'e', '.', 'v', '3', '.', 'S', 'o', 'c', 'k', 'e', 't',
    'O', 'p', 't', 'i', 'o', 'n', 'R', '\r', 's', 'o', 'c', 'k',
    'e', 't', 'O', 'p', 't', 'i', 'o', 'n', 's', '\022', '^', '\n',
    '\026', 'e', 'x', 't', 'r', 'a', '_', 's', 'o', 'u', 'r', 'c',
    'e', '_', 'a', 'd', 'd', 'r', 'e', 's', 's', 'e', 's', '\030',
    '\005', ' ', '\003', '(', '\013', '2', '(', '.', 'e', 'n', 'v', 'o',
    'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r',
    'e', '.', 'v', '3', '.', 'E', 'x', 't', 'r', 'a', 'S', 'o',
    'u', 'r', 'c', 'e', 'A', 'd', 'd', 'r', 'e', 's', 's', 'R',
    '\024', 'e', 'x', 't', 'r', 'a', 'S', 'o', 'u', 'r', 'c', 'e',
    'A', 'd', 'd', 'r', 'e', 's', 's', 'e', 's', '\022', 'p', '\n',
    '\033', 'a', 'd', 'd', 'i', 't', 'i', 'o', 'n', 'a', 'l', '_',
    's', 'o', 'u', 'r', 'c', 'e', '_', 'a', 'd', 'd', 'r', 'e',
    's', 's', 'e', 's', '\030', '\004', ' ', '\003', '(', '\013', '2', '#',
    '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
    'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'S', 'o',
    'c', 'k', 'e', 't', 'A', 'd', 'd', 'r', 'e', 's', 's', 'B',
    '\013', '\030', '\001', '\222', '\307', '\206', '\330', '\004', '\003', '3', '.', '0',
    'R', '\031', 'a', 'd', 'd', 'i', 't', 'i', 'o', 'n', 'a', 'l',
    'S', 'o', 'u', 'r', 'c', 'e', 'A', 'd', 'd', 'r', 'e', 's',
    's', 'e', 's', '\022', '`', '\n', '\026', 'l', 'o', 'c', 'a', 'l',
    '_', 'a', 'd', 'd', 'r', 'e', 's', 's', '_', 's', 'e', 'l',
    'e', 'c', 't', 'o', 'r', '\030', '\006', ' ', '\001', '(', '\013', '2',
    '*', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f',
    'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'T',
    'y', 'p', 'e', 'd', 'E', 'x', 't', 'e', 'n', 's', 'i', 'o',
    'n', 'C', 'o', 'n', 'f', 'i', 'g', 'R', '\024', 'l', 'o', 'c',
    'a', 'l', 'A', 'd', 'd', 'r', 'e', 's', 's', 'S', 'e', 'l',
    'e', 'c', 't', 'o', 'r', '\022', '>', '\n', '\033', 'v', 'a', 'l',
    'i', 'd', 'a', 't', 'e', '_', 'n', 'e', 't', 'w', 'o', 'r',
    'k', '_', 'n', 'a', 'm', 'e', 's', 'p', 'a', 'c', 'e', 's',
    '\030', '\007', ' ', '\001', '(', '\010', 'R', '\031', 'v', 'a', 'l', 'i',
    'd', 'a', 't', 'e', 'N', 'e', 't', 'w', 'o', 'r', 'k', 'N',
    'a', 'm', 'e', 's', 'p', 'a', 'c', 'e', 's', ':', '#', '\232',
    '\305', '\210', '\036', '\036', '\n', '\034', 'e', 'n', 'v', 'o', 'y', '.',
    'a', 'p', 'i', '.', 'v', '2', '.', 'c', 'o', 'r', 'e', '.',
    'B', 'i', 'n', 'd', 'C', 'o', 'n', 'f', 'i', 'g', '\"', '\237',
    '\002', '\n', '\007', 'A', 'd', 'd', 'r', 'e', 's', 's', '\022', 'L',
    '\n', '\016', 's', 'o', 'c', 'k', 'e', 't', '_', 'a', 'd', 'd',
    'r', 'e', 's', 's', '\030', '\001', ' ', '\001', '(', '\013', '2', '#',
    '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
    'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'S', 'o',
    'c', 'k', 'e', 't', 'A', 'd', 'd', 'r', 'e', 's', 's', 'H',
    '\000', 'R', '\r', 's', 'o', 'c', 'k', 'e', 't', 'A', 'd', 'd',
    'r', 'e', 's', 's', '\022', '0', '\n', '\004', 'p', 'i', 'p', 'e',
    '\030', '\002', ' ', '\001', '(', '\013', '2', '\032', '.', 'e', 'n', 'v',
    'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o',
    'r', 'e', '.', 'v', '3', '.', 'P', 'i', 'p', 'e', 'H', '\000',
    'R', '\004', 'p', 'i', 'p', 'e', '\022', 'b', '\n', '\026', 'e', 'n',
    'v', 'o', 'y', '_', 'i', 'n', 't', 'e', 'r', 'n', 'a', 'l',
    '_', 'a', 'd', 'd', 'r', 'e', 's', 's', '\030', '\003', ' ', '\001',
    '(', '\013', '2', '*', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c',
    'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v',
    '3', '.', 'E', 'n', 'v', 'o', 'y', 'I', 'n', 't', 'e', 'r',
    'n', 'a', 'l', 'A', 'd', 'd', 'r', 'e', 's', 's', 'H', '\000',
    'R', '\024', 'e', 'n', 'v', 'o', 'y', 'I', 'n', 't', 'e', 'r',
    'n', 'a', 'l', 'A', 'd', 'd', 'r', 'e', 's', 's', ':', ' ',
    '\232', '\305', '\210', '\036', '\033', '\n', '\031', 'e', 'n', 'v', 'o', 'y',
    '.', 'a', 'p', 'i', '.', 'v', '2', '.', 'c', 'o', 'r', 'e',
    '.', 'A', 'd', 'd', 'r', 'e', 's', 's', 'B', '\016', '\n', '\007',
    'a', 'd', 'd', 'r', 'e', 's', 's', '\022', '\003', '\370', 'B', '\001',
    '\"', '\246', '\001', '\n', '\t', 'C', 'i', 'd', 'r', 'R', 'a', 'n',
    'g', 'e', '\022', '.', '\n', '\016', 'a', 'd', 'd', 'r', 'e', 's',
    's', '_', 'p', 'r', 'e', 'f', 'i', 'x', '\030', '\001', ' ', '\001',
    '(', '\t', 'B', '\007', '\372', 'B', '\004', 'r', '\002', '\020', '\001', 'R',
    '\r', 'a', 'd', 'd', 'r', 'e', 's', 's', 'P', 'r', 'e', 'f',
    'i', 'x', '\022', 'E', '\n', '\n', 'p', 'r', 'e', 'f', 'i', 'x',
    '_', 'l', 'e', 'n', '\030', '\002', ' ', '\001', '(', '\013', '2', '\034',
    '.', 'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o', 't',
    'o', 'b', 'u', 'f', '.', 'U', 'I', 'n', 't', '3', '2', 'V',
    'a', 'l', 'u', 'e', 'B', '\010', '\372', 'B', '\005', '*', '\003', '\030',
    '\200', '\001', 'R', '\t', 'p', 'r', 'e', 'f', 'i', 'x', 'L', 'e',
    'n', ':', '\"', '\232', '\305', '\210', '\036', '\035', '\n', '\033', 'e', 'n',
    'v', 'o', 'y', '.', 'a', 'p', 'i', '.', 'v', '2', '.', 'c',
    'o', 'r', 'e', '.', 'C', 'i', 'd', 'r', 'R', 'a', 'n', 'g',
    'e', 'B', '\200', '\001', '\n', '\"', 'i', 'o', '.', 'e', 'n', 'v',
    'o', 'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o',
    'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r',
    'e', '.', 'v', '3', 'B', '\014', 'A', 'd', 'd', 'r', 'e', 's',
    's', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', 'B', 'g', 'i',
    't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'e', 'n', 'v',
    'o', 'y', 'p', 'r', 'o', 'x', 'y', '/', 'g', 'o', '-', 'c',
