...
#ifndef ENVOY_CONFIG_CORE_V3_EXTENSION_PROTO_UPB_H__UPBDEFS_H_
#define ENVOY_CONFIG_CORE_V3_EXTENSION_PROTO_UPB_H__UPBDEFS_H_
...
#endif  /* ENVOY_CONFIG_CORE_V3_EXTENSION_PROTO_UPB_H__UPBDEFS_H_ */
