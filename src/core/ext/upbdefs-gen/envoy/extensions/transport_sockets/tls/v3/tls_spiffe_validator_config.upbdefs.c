...
static const char descriptor[802] = {
    '\n', 'K', 'e', 'n', 'v', 'o', 'y', '/', 'e', 'x', 't', 'e',
    ...
    'B', 'u', 'n', 'd', 'l', 'e', 's', '\032', '\243', '\001', '\n', '\013',
    'T', 'r', 'u', 's', 't', 'D', 'o', 'm', 'a', 'i', 'n', '\022',
    '\033', '\n', '\004', 'n', 'a', 'm', 'e', '\030', '\001', ' ', '\001', '(',
    '\t', 'B', '\007', '\372', 'B', '\004', 'r', '\002', '\020', '\001', 'R', '\004',
    'n', 'a', 'm', 'e', '\022', 'C', '\n', '\014', 't', 'r', 'u', 's',
    't', '_', 'b', 'u', 'n', 'd', 'l', 'e', '\030', '\002', ' ', '\001',
    '(', '\013', '2', ' ', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c',
    'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v',
    '3', '.', 'D', 'a', 't', 'a', 'S', 'o', 'u', 'r', 'c', 'e',
    'R', '\013', 't', 'r', 'u', 's', 't', 'B', 'u', 'n', 'd', 'l',
    'e', '\022', '2', '\n', '\025', 'w', 'o', 'r', 'k', 'l', 'o', 'a',
    'd', '_', 't', 'r', 'u', 's', 't', '_', 'd', 'o', 'm', 'a',
    'i', 'n', '\030', '\003', ' ', '\001', '(', '\t', 'R', '\023', 'w', 'o',
    'r', 'k', 'l', 'o', 'a', 'd', 'T', 'r', 'u', 's', 't', 'D',
    'o', 'm', 'a', 'i', 'n', 'B', '\272', '\001', '\n', '7', 'i', 'o',
    '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '.',
    'e', 'n', 'v', 'o', 'y', '.', 'e', 'x', 't', 'e', 'n', 's',
    'i', 'o', 'n', 's', '.', 't', 'r', 'a', 'n', 's', 'p', 'o',
    'r', 't', '_', 's', 'o', 'c', 'k', 'e', 't', 's', '.', 't',
    'l', 's', '.', 'v', '3', 'B', '\035', 'T', 'l', 's', 'S', 'p',
    'i', 'f', 'f', 'e', 'V', 'a', 'l', 'i', 'd', 'a', 't', 'o',
    'r', 'C', 'o', 'n', 'f', 'i', 'g', 'P', 'r', 'o', 't', 'o',
    'P', '\001', 'Z', 'V', 'g', 'i', 't', 'h', 'u', 'b', '.', 'c',
    ...
    't', 'r', 'a', 'n', 's', 'p', 'o', 'r', 't', '_', 's', 'o',
    'c', 'k', 'e', 't', 's', '/', 't', 'l', 's', '/', 'v', '3',
    ';', 't', 'l', 's', 'v', '3', '\272', '\200', '\310', '\321', '\006', '\002',
