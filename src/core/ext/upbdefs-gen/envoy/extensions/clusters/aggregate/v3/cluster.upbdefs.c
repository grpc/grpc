...
static const char descriptor[681] = {
    ...
    '.', 'c', 'l', 'u', 's', 't', 'e', 'r', 's', '.', 'a', 'g',
    'g', 'r', 'e', 'g', 'a', 't', 'e', '.', 'v', '3', '\032', '(',
    'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f', 'i', 'g',
    '/', 'c', 'o', 'r', 'e', '/', 'v', '3', '/', 'c', 'o', 'n',
    'f', 'i', 'g', '_', 's', 'o', 'u', 'r', 'c', 'e', '.', 'p',
    ...
    'r', '\n', '\r', 'C', 'l', 'u', 's', 't', 'e', 'r', 'C', 'o',
    'n', 'f', 'i', 'g', '\022', '$', '\n', '\010', 'c', 'l', 'u', 's',
    't', 'e', 'r', 's', '\030', '\001', ' ', '\003', '(', '\t', 'B', '\010',
    '\372', 'B', '\005', '\222', '\001', '\002', '\010', '\001', 'R', '\010', 'c', 'l',
    'u', 's', 't', 'e', 'r', 's', ':', ';', '\232', '\305', '\210', '\036',
    '6', '\n', '4', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n',
    'f', 'i', 'g', '.', 'c', 'l', 'u', 's', 't', 'e', 'r', '.',
    'a', 'g', 'g', 'r', 'e', 'g', 'a', 't', 'e', '.', 'v', '2',
    'a', 'l', 'p', 'h', 'a', '.', 'C', 'l', 'u', 's', 't', 'e',
    'r', 'C', 'o', 'n', 'f', 'i', 'g', '\"', '\233', '\001', '\n', '\030',
    'A', 'g', 'g', 'r', 'e', 'g', 'a', 't', 'e', 'C', 'l', 'u',
    's', 't', 'e', 'r', 'R', 'e', 's', 'o', 'u', 'r', 'c', 'e',
    '\022', 'Q', '\n', '\r', 'c', 'o', 'n', 'f', 'i', 'g', '_', 's',
    'o', 'u', 'r', 'c', 'e', '\030', '\001', ' ', '\001', '(', '\013', '2',
    '\"', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f',
    'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'C',
    'o', 'n', 'f', 'i', 'g', 'S', 'o', 'u', 'r', 'c', 'e', 'B',
    '\010', '\372', 'B', '\005', '\212', '\001', '\002', '\020', '\001', 'R', '\014', 'c',
    'o', 'n', 'f', 'i', 'g', 'S', 'o', 'u', 'r', 'c', 'e', '\022',
    ',', '\n', '\r', 'r', 'e', 's', 'o', 'u', 'r', 'c', 'e', '_',
    'n', 'a', 'm', 'e', '\030', '\002', ' ', '\001', '(', '\t', 'B', '\007',
    '\372', 'B', '\004', 'r', '\002', '\020', '\001', 'R', '\014', 'r', 'e', 's',
    'o', 'u', 'r', 'c', 'e', 'N', 'a', 'm', 'e', 'B', '\251', '\001',
    '\n', '4', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r',
    'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x',
    't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 'c', 'l', 'u',
    's', 't', 'e', 'r', 's', '.', 'a', 'g', 'g', 'r', 'e', 'g',
    'a', 't', 'e', '.', 'v', '3', 'B', '\014', 'C', 'l', 'u', 's',
    't', 'e', 'r', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', 'Y',
    'g', 'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'e',
    'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '/', 'g', 'o',
    '-', 'c', 'o', 'n', 't', 'r', 'o', 'l', '-', 'p', 'l', 'a',
    'n', 'e', '/', 'e', 'n', 'v', 'o', 'y', '/', 'e', 'x', 't',
    'e', 'n', 's', 'i', 'o', 'n', 's', '/', 'c', 'l', 'u', 's',
    't', 'e', 'r', 's', '/', 'a', 'g', 'g', 'r', 'e', 'g', 'a',
    't', 'e', '/', 'v', '3', ';', 'a', 'g', 'g', 'r', 'e', 'g',
    'a', 't', 'e', 'v', '3', '\272', '\200', '\310', '\321', '\006', '\002', '\020',
