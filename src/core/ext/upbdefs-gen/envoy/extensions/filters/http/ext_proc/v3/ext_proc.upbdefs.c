...
static const char descriptor[4782] = {
    '\n', '8', 'e', 'n', 'v', 'o', 'y', '/', 'e', 'x', 't', 'e',
    ...
    'u', 's', 'O', 'n', 'E', 'r', 'r', 'o', 'r', '\022', '=', '\n',
    '\033', 'a', 'l', 'l', 'o', 'w', '_', 'c', 'o', 'n', 't', 'e',
    'n', 't', '_', 'l', 'e', 'n', 'g', 't', 'h', '_', 'h', 'e',
    'a', 'd', 'e', 'r', '\030', '\032', ' ', '\001', '(', '\010', 'R', '\030',
    'a', 'l', 'l', 'o', 'w', 'C', 'o', 'n', 't', 'e', 'n', 't',
    'L', 'e', 'n', 'g', 't', 'h', 'H', 'e', 'a', 'd', 'e', 'r',
    '\"', '6', '\n', '\020', 'R', 'o', 'u', 't', 'e', 'C', 'a', 'c',
    'h', 'e', 'A', 'c', 't', 'i', 'o', 'n', '\022', '\013', '\n', '\007',
    'D', 'E', 'F', 'A', 'U', 'L', 'T', '\020', '\000', '\022', '\t', '\n',
    '\005', 'C', 'L', 'E', 'A', 'R', '\020', '\001', '\022', '\n', '\n', '\006',
    'R', 'E', 'T', 'A', 'I', 'N', '\020', '\002', 'J', '\004', '\010', '\004',
    '\020', '\005', 'R', '\n', 'a', 's', 'y', 'n', 'c', '_', 'm', 'o',
    'd', 'e', '\"', 'Z', '\n', '\022', 'E', 'x', 't', 'P', 'r', 'o',
    'c', 'H', 't', 't', 'p', 'S', 'e', 'r', 'v', 'i', 'c', 'e',
    '\022', 'D', '\n', '\014', 'h', 't', 't', 'p', '_', 's', 'e', 'r',
    'v', 'i', 'c', 'e', '\030', '\001', ' ', '\001', '(', '\013', '2', '!',
    '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
    'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'H', 't',
    't', 'p', 'S', 'e', 'r', 'v', 'i', 'c', 'e', 'R', '\013', 'h',
    't', 't', 'p', 'S', 'e', 'r', 'v', 'i', 'c', 'e', '\"', '\204',
    '\004', '\n', '\017', 'M', 'e', 't', 'a', 'd', 'a', 't', 'a', 'O',
    'p', 't', 'i', 'o', 'n', 's', '\022', '\202', '\001', '\n', '\025', 'f',
    'o', 'r', 'w', 'a', 'r', 'd', 'i', 'n', 'g', '_', 'n', 'a',
    'm', 'e', 's', 'p', 'a', 'c', 'e', 's', '\030', '\001', ' ', '\001',
    '(', '\013', '2', 'M', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e',
    'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 'f', 'i',
    'l', 't', 'e', 'r', 's', '.', 'h', 't', 't', 'p', '.', 'e',
    'x', 't', '_', 'p', 'r', 'o', 'c', '.', 'v', '3', '.', 'M',
    'e', 't', 'a', 'd', 'a', 't', 'a', 'O', 'p', 't', 'i', 'o',
    'n', 's', '.', 'M', 'e', 't', 'a', 'd', 'a', 't', 'a', 'N',
    'a', 'm', 'e', 's', 'p', 'a', 'c', 'e', 's', 'R', '\024', 'f',
    'o', 'r', 'w', 'a', 'r', 'd', 'i', 'n', 'g', 'N', 'a', 'm',
    'e', 's', 'p', 'a', 'c', 'e', 's', '\022', '\200', '\001', '\n', '\024',
    'r', 'e', 'c', 'e', 'i', 'v', 'i', 'n', 'g', '_', 'n', 'a',
    'm', 'e', 's', 'p', 'a', 'c', 'e', 's', '\030', '\002', ' ', '\001',
    '(', '\013', '2', 'M', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e',
    'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 'f', 'i',
    'l', 't', 'e', 'r', 's', '.', 'h', 't', 't', 'p', '.', 'e',
    'x', 't', '_', 'p', 'r', 'o', 'c', '.', 'v', '3', '.', 'M',
    'e', 't', 'a', 'd', 'a', 't', 'a', 'O', 'p', 't', 'i', 'o',
    'n', 's', '.', 'M', 'e', 't', 'a', 'd', 'a', 't', 'a', 'N',
    'a', 'm', 'e', 's', 'p', 'a', 'c', 'e', 's', 'R', '\023', 'r',
    'e', 'c', 'e', 'i', 'v', 'i', 'n', 'g', 'N', 'a', 'm', 'e',
    's', 'p', 'a', 'c', 'e', 's', '\022', '\242', '\001', '\n', '&', 'c',
    'l', 'u', 's', 't', 'e', 'r', '_', 'm', 'e', 't', 'a', 'd',
    'a', 't', 'a', '_', 'f', 'o', 'r', 'w', 'a', 'r', 'd', 'i',
    'n', 'g', '_', 'n', 'a', 'm', 'e', 's', 'p', 'a', 'c', 'e',
    's', '\030', '\003', ' ', '\001', '(', '\013', '2', 'M', '.', 'e', 'n',
    'v', 'o', 'y', '.', 'e', 'x', 't', 'e', 'n', 's', 'i', 'o',
    'n', 's', '.', 'f', 'i', 'l', 't', 'e', 'r', 's', '.', 'h',
    't', 't', 'p', '.', 'e', 'x', 't', '_', 'p', 'r', 'o', 'c',
    '.', 'v', '3', '.', 'M', 'e', 't', 'a', 'd', 'a', 't', 'a',
    'O', 'p', 't', 'i', 'o', 'n', 's', '.', 'M', 'e', 't', 'a',
    'd', 'a', 't', 'a', 'N', 'a', 'm', 'e', 's', 'p', 'a', 'c',
    'e', 's', 'R', '#', 'c', 'l', 'u', 's', 't', 'e', 'r', 'M',
    'e', 't', 'a', 'd', 'a', 't', 'a', 'F', 'o', 'r', 'w', 'a',
    'r', 'd', 'i', 'n', 'g', 'N', 'a', 'm', 'e', 's', 'p', 'a',
    'c', 'e', 's', '\032', 'D', '\n', '\022', 'M', 'e', 't', 'a', 'd',
    'a', 't', 'a', 'N', 'a', 'm', 'e', 's', 'p', 'a', 'c', 'e',
    's', '\022', '\030', '\n', '\007', 'u', 'n', 't', 'y', 'p', 'e', 'd',
    '\030', '\001', ' ', '\003', '(', '\t', 'R', '\007', 'u', 'n', 't', 'y',
    'p', 'e', 'd', '\022', '\024', '\n', '\005', 't', 'y', 'p', 'e', 'd',
    '\030', '\002', ' ', '\003', '(', '\t', 'R', '\005', 't', 'y', 'p', 'e',
    'd', '\"', '\303', '\001', '\n', '\025', 'H', 'e', 'a', 'd', 'e', 'r',
    'F', 'o', 'r', 'w', 'a', 'r', 'd', 'i', 'n', 'g', 'R', 'u',
    'l', 'e', 's', '\022', 'Q', '\n', '\017', 'a', 'l', 'l', 'o', 'w',
    'e', 'd', '_', 'h', 'e', 'a', 'd', 'e', 'r', 's', '\030', '\001',
    ' ', '\001', '(', '\013', '2', '(', '.', 'e', 'n', 'v', 'o', 'y',
    '.', 't', 'y', 'p', 'e', '.', 'm', 'a', 't', 'c', 'h', 'e',
    'r', '.', 'v', '3', '.', 'L', 'i', 's', 't', 'S', 't', 'r',
    'i', 'n', 'g', 'M', 'a', 't', 'c', 'h', 'e', 'r', 'R', '\016',
    'a', 'l', 'l', 'o', 'w', 'e', 'd', 'H', 'e', 'a', 'd', 'e',
    'r', 's', '\022', 'W', '\n', '\022', 'd', 'i', 's', 'a', 'l', 'l',
    'o', 'w', 'e', 'd', '_', 'h', 'e', 'a', 'd', 'e', 'r', 's',
    '\030', '\002', ' ', '\001', '(', '\013', '2', '(', '.', 'e', 'n', 'v',
    'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'm', 'a', 't', 'c',
    'h', 'e', 'r', '.', 'v', '3', '.', 'L', 'i', 's', 't', 'S',
    't', 'r', 'i', 'n', 'g', 'M', 'a', 't', 'c', 'h', 'e', 'r',
    'R', '\021', 'd', 'i', 's', 'a', 'l', 'l', 'o', 'w', 'e', 'd',
    'H', 'e', 'a', 'd', 'e', 'r', 's', '\"', '\246', '\001', '\n', '\017',
    'E', 'x', 't', 'P', 'r', 'o', 'c', 'P', 'e', 'r', 'R', 'o',
    'u', 't', 'e', '\022', '%', '\n', '\010', 'd', 'i', 's', 'a', 'b',
    'l', 'e', 'd', '\030', '\001', ' ', '\001', '(', '\010', 'B', '\007', '\372',
    'B', '\004', 'j', '\002', '\010', '\001', 'H', '\000', 'R', '\010', 'd', 'i',
    's', 'a', 'b', 'l', 'e', 'd', '\022', '[', '\n', '\t', 'o', 'v',
    'e', 'r', 'r', 'i', 'd', 'e', 's', '\030', '\002', ' ', '\001', '(',
    '\013', '2', ';', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x',
    't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 'f', 'i', 'l',
    't', 'e', 'r', 's', '.', 'h', 't', 't', 'p', '.', 'e', 'x',
    't', '_', 'p', 'r', 'o', 'c', '.', 'v', '3', '.', 'E', 'x',
    't', 'P', 'r', 'o', 'c', 'O', 'v', 'e', 'r', 'r', 'i', 'd',
    'e', 's', 'H', '\000', 'R', '\t', 'o', 'v', 'e', 'r', 'r', 'i',
    'd', 'e', 's', 'B', '\017', '\n', '\010', 'o', 'v', 'e', 'r', 'r',
    'i', 'd', 'e', '\022', '\003', '\370', 'B', '\001', '\"', '\306', '\005', '\n',
    '\020', 'E', 'x', 't', 'P', 'r', 'o', 'c', 'O', 'v', 'e', 'r',
    'r', 'i', 'd', 'e', 's', '\022', 'b', '\n', '\017', 'p', 'r', 'o',
    'c', 'e', 's', 's', 'i', 'n', 'g', '_', 'm', 'o', 'd', 'e',
    '\030', '\001', ' ', '\001', '(', '\013', '2', '9', '.', 'e', 'n', 'v',
    'o', 'y', '.', 'e', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n',
    's', '.', 'f', 'i', 'l', 't', 'e', 'r', 's', '.', 'h', 't',
    't', 'p', '.', 'e', 'x', 't', '_', 'p', 'r', 'o', 'c', '.',
    'v', '3', '.', 'P', 'r', 'o', 'c', 'e', 's', 's', 'i', 'n',
    'g', 'M', 'o', 'd', 'e', 'R', '\016', 'p', 'r', 'o', 'c', 'e',
    's', 's', 'i', 'n', 'g', 'M', 'o', 'd', 'e', '\022', '*', '\n',
    '\n', 'a', 's', 'y', 'n', 'c', '_', 'm', 'o', 'd', 'e', '\030',
    '\002', ' ', '\001', '(', '\010', 'B', '\013', '\030', '\001', '\222', '\307', '\206',
    '\330', '\004', '\003', '3', '.', '0', 'R', '\t', 'a', 's', 'y', 'n',
    'c', 'M', 'o', 'd', 'e', '\022', '-', '\n', '\022', 'r', 'e', 'q',
    'u', 'e', 's', 't', '_', 'a', 't', 't', 'r', 'i', 'b', 'u',
    't', 'e', 's', '\030', '\003', ' ', '\003', '(', '\t', 'R', '\021', 'r',
    'e', 'q', 'u', 'e', 's', 't', 'A', 't', 't', 'r', 'i', 'b',
    'u', 't', 'e', 's', '\022', '/', '\n', '\023', 'r', 'e', 's', 'p',
    'o', 'n', 's', 'e', '_', 'a', 't', 't', 'r', 'i', 'b', 'u',
    't', 'e', 's', '\030', '\004', ' ', '\003', '(', '\t', 'R', '\022', 'r',
    'e', 's', 'p', 'o', 'n', 's', 'e', 'A', 't', 't', 'r', 'i',
    'b', 'u', 't', 'e', 's', '\022', 'D', '\n', '\014', 'g', 'r', 'p',
    'c', '_', 's', 'e', 'r', 'v', 'i', 'c', 'e', '\030', '\005', ' ',
    '\001', '(', '\013', '2', '!', '.', 'e', 'n', 'v', 'o', 'y', '.',
    'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.',
    'v', '3', '.', 'G', 'r', 'p', 'c', 'S', 'e', 'r', 'v', 'i',
    'c', 'e', 'R', '\013', 'g', 'r', 'p', 'c', 'S', 'e', 'r', 'v',
    'i', 'c', 'e', '\022', 'e', '\n', '\020', 'm', 'e', 't', 'a', 'd',
    'a', 't', 'a', '_', 'o', 'p', 't', 'i', 'o', 'n', 's', '\030',
    '\006', ' ', '\001', '(', '\013', '2', ':', '.', 'e', 'n', 'v', 'o',
    'y', '.', 'e', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 's',
    '.', 'f', 'i', 'l', 't', 'e', 'r', 's', '.', 'h', 't', 't',
    'p', '.', 'e', 'x', 't', '_', 'p', 'r', 'o', 'c', '.', 'v',
    '3', '.', 'M', 'e', 't', 'a', 'd', 'a', 't', 'a', 'O', 'p',
    't', 'i', 'o', 'n', 's', 'R', '\017', 'm', 'e', 't', 'a', 'd',
    'a', 't', 'a', 'O', 'p', 't', 'i', 'o', 'n', 's', '\022', 'U',
    '\n', '\025', 'g', 'r', 'p', 'c', '_', 'i', 'n', 'i', 't', 'i',
    'a', 'l', '_', 'm', 'e', 't', 'a', 'd', 'a', 't', 'a', '\030',
    '\007', ' ', '\003', '(', '\013', '2', '!', '.', 'e', 'n', 'v', 'o',
    'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r',
    'e', '.', 'v', '3', '.', 'H', 'e', 'a', 'd', 'e', 'r', 'V',
    'a', 'l', 'u', 'e', 'R', '\023', 'g', 'r', 'p', 'c', 'I', 'n',
    'i', 't', 'i', 'a', 'l', 'M', 'e', 't', 'a', 'd', 'a', 't',
    'a', '\022', 'H', '\n', '\022', 'f', 'a', 'i', 'l', 'u', 'r', 'e',
    '_', 'm', 'o', 'd', 'e', '_', 'a', 'l', 'l', 'o', 'w', '\030',
    '\010', ' ', '\001', '(', '\013', '2', '\032', '.', 'g', 'o', 'o', 'g',
    'l', 'e', '.', 'p', 'r', 'o', 't', 'o', 'b', 'u', 'f', '.',
    'B', 'o', 'o', 'l', 'V', 'a', 'l', 'u', 'e', 'R', '\020', 'f',
    'a', 'i', 'l', 'u', 'r', 'e', 'M', 'o', 'd', 'e', 'A', 'l',
    'l', 'o', 'w', '\022', 't', '\n', '\033', 'p', 'r', 'o', 'c', 'e',
    's', 's', 'i', 'n', 'g', '_', 'r', 'e', 'q', 'u', 'e', 's',
    't', '_', 'm', 'o', 'd', 'i', 'f', 'i', 'e', 'r', '\030', '\t',
    ' ', '\001', '(', '\013', '2', '*', '.', 'e', 'n', 'v', 'o', 'y',
    '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e',
    '.', 'v', '3', '.', 'T', 'y', 'p', 'e', 'd', 'E', 'x', 't',
    'e', 'n', 's', 'i', 'o', 'n', 'C', 'o', 'n', 'f', 'i', 'g',
    'B', '\010', '\322', '\306', '\244', '\341', '\006', '\002', '\010', '\001', 'R', '\031',
    'p', 'r', 'o', 'c', 'e', 's', 's', 'i', 'n', 'g', 'R', 'e',
    'q', 'u', 'e', 's', 't', 'M', 'o', 'd', 'i', 'f', 'i', 'e',
    'r', 'B', '\256', '\001', '\n', '7', 'i', 'o', '.', 'e', 'n', 'v',
    'o', 'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o',
    'y', '.', 'e', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 's',
    '.', 'f', 'i', 'l', 't', 'e', 'r', 's', '.', 'h', 't', 't',
    'p', '.', 'e', 'x', 't', '_', 'p', 'r', 'o', 'c', '.', 'v',
    '3', 'B', '\014', 'E', 'x', 't', 'P', 'r', 'o', 'c', 'P', 'r',
