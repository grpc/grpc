...
static const char descriptor[1675] = {
    '\n', ':', 'e', 'n', 'v', 'o', 'y', '/', 'e', 'x', 't', 'e',
    ...
    'r', 'o', 't', 'o', '\"', '\316', '\002', '\n', '\t', 'C', 'o', 'm',
    'p', 'o', 's', 'i', 't', 'e', '\022', '|', '\n', '\023', 'n', 'a',
    'm', 'e', 'd', '_', 'f', 'i', 'l', 't', 'e', 'r', '_', 'c',
    'h', 'a', 'i', 'n', 's', '\030', '\001', ' ', '\003', '(', '\013', '2',
    'L', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x', 't', 'e',
    'n', 's', 'i', 'o', 'n', 's', '.', 'f', 'i', 'l', 't', 'e',
    'r', 's', '.', 'h', 't', 't', 'p', '.', 'c', 'o', 'm', 'p',
    'o', 's', 'i', 't', 'e', '.', 'v', '3', '.', 'C', 'o', 'm',
    'p', 'o', 's', 'i', 't', 'e', '.', 'N', 'a', 'm', 'e', 'd',
    'F', 'i', 'l', 't', 'e', 'r', 'C', 'h', 'a', 'i', 'n', 's',
    'E', 'n', 't', 'r', 'y', 'R', '\021', 'n', 'a', 'm', 'e', 'd',
    'F', 'i', 'l', 't', 'e', 'r', 'C', 'h', 'a', 'i', 'n', 's',
    '\022', '6', '\n', '\007', 'm', 'a', 't', 'c', 'h', 'e', 'r', '\030',
    '\002', ' ', '\001', '(', '\013', '2', '\034', '.', 'x', 'd', 's', '.',
    't', 'y', 'p', 'e', '.', 'm', 'a', 't', 'c', 'h', 'e', 'r',
    '.', 'v', '3', '.', 'M', 'a', 't', 'c', 'h', 'e', 'r', 'R',
    '\007', 'm', 'a', 't', 'c', 'h', 'e', 'r', '\032', '\212', '\001', '\n',
    '\026', 'N', 'a', 'm', 'e', 'd', 'F', 'i', 'l', 't', 'e', 'r',
    'C', 'h', 'a', 'i', 'n', 's', 'E', 'n', 't', 'r', 'y', '\022',
    '\020', '\n', '\003', 'k', 'e', 'y', '\030', '\001', ' ', '\001', '(', '\t',
    'R', '\003', 'k', 'e', 'y', '\022', 'Z', '\n', '\005', 'v', 'a', 'l',
    'u', 'e', '\030', '\002', ' ', '\001', '(', '\013', '2', 'D', '.', 'e',
    'n', 'v', 'o', 'y', '.', 'e', 'x', 't', 'e', 'n', 's', 'i',
    'o', 'n', 's', '.', 'f', 'i', 'l', 't', 'e', 'r', 's', '.',
    'h', 't', 't', 'p', '.', 'c', 'o', 'm', 'p', 'o', 's', 'i',
    't', 'e', '.', 'v', '3', '.', 'F', 'i', 'l', 't', 'e', 'r',
    'C', 'h', 'a', 'i', 'n', 'C', 'o', 'n', 'f', 'i', 'g', 'u',
    'r', 'a', 't', 'i', 'o', 'n', 'R', '\005', 'v', 'a', 'l', 'u',
    'e', ':', '\002', '8', '\001', '\"', 'U', '\n', '\021', 'C', 'o', 'm',
    'p', 'o', 's', 'i', 't', 'e', 'P', 'e', 'r', 'R', 'o', 'u',
    't', 'e', '\022', '@', '\n', '\007', 'm', 'a', 't', 'c', 'h', 'e',
    'r', '\030', '\001', ' ', '\001', '(', '\013', '2', '\034', '.', 'x', 'd',
    's', '.', 't', 'y', 'p', 'e', '.', 'm', 'a', 't', 'c', 'h',
    'e', 'r', '.', 'v', '3', '.', 'M', 'a', 't', 'c', 'h', 'e',
    'r', 'B', '\010', '\372', 'B', '\005', '\212', '\001', '\002', '\020', '\001', 'R',
    '\007', 'm', 'a', 't', 'c', 'h', 'e', 'r', '\"', 'i', '\n', '\030',
    'F', 'i', 'l', 't', 'e', 'r', 'C', 'h', 'a', 'i', 'n', 'C',
    'o', 'n', 'f', 'i', 'g', 'u', 'r', 'a', 't', 'i', 'o', 'n',
    '\022', 'M', '\n', '\014', 't', 'y', 'p', 'e', 'd', '_', 'c', 'o',
    'n', 'f', 'i', 'g', '\030', '\001', ' ', '\003', '(', '\013', '2', '*',
    '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
    'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'T', 'y',
    'p', 'e', 'd', 'E', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n',
    'C', 'o', 'n', 'f', 'i', 'g', 'R', '\013', 't', 'y', 'p', 'e',
    'd', 'C', 'o', 'n', 'f', 'i', 'g', '\"', '\204', '\001', '\n', '\r',
    'D', 'y', 'n', 'a', 'm', 'i', 'c', 'C', 'o', 'n', 'f', 'i',
    'g', '\022', '\033', '\n', '\004', 'n', 'a', 'm', 'e', '\030', '\001', ' ',
    '\001', '(', '\t', 'B', '\007', '\372', 'B', '\004', 'r', '\002', '\020', '\001',
    'R', '\004', 'n', 'a', 'm', 'e', '\022', 'V', '\n', '\020', 'c', 'o',
    'n', 'f', 'i', 'g', '_', 'd', 'i', 's', 'c', 'o', 'v', 'e',
    'r', 'y', '\030', '\002', ' ', '\001', '(', '\013', '2', '+', '.', 'e',
    'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.',
    'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'E', 'x', 't', 'e',
    'n', 's', 'i', 'o', 'n', 'C', 'o', 'n', 'f', 'i', 'g', 'S',
    'o', 'u', 'r', 'c', 'e', 'R', '\017', 'c', 'o', 'n', 'f', 'i',
    'g', 'D', 'i', 's', 'c', 'o', 'v', 'e', 'r', 'y', '\"', '\334',
    '\003', '\n', '\023', 'E', 'x', 'e', 'c', 'u', 't', 'e', 'F', 'i',
    'l', 't', 'e', 'r', 'A', 'c', 't', 'i', 'o', 'n', '\022', 'b',
    '\n', '\014', 't', 'y', 'p', 'e', 'd', '_', 'c', 'o', 'n', 'f',
    'i', 'g', '\030', '\001', ' ', '\001', '(', '\013', '2', '*', '.', 'e',
    'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.',
    'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'T', 'y', 'p', 'e',
    'd', 'E', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 'C', 'o',
    'n', 'f', 'i', 'g', 'B', '\023', '\362', '\230', '\376', '\217', '\005', '\r',
    '\022', '\013', 'c', 'o', 'n', 'f', 'i', 'g', '_', 't', 'y', 'p',
    'e', 'R', '\013', 't', 'y', 'p', 'e', 'd', 'C', 'o', 'n', 'f',
    'i', 'g', '\022', 'u', '\n', '\016', 'd', 'y', 'n', 'a', 'm', 'i',
    'c', '_', 'c', 'o', 'n', 'f', 'i', 'g', '\030', '\002', ' ', '\001',
    '(', '\013', '2', '9', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e',
    'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 'f', 'i',
    'l', 't', 'e', 'r', 's', '.', 'h', 't', 't', 'p', '.', 'c',
    'o', 'm', 'p', 'o', 's', 'i', 't', 'e', '.', 'v', '3', '.',
    'D', 'y', 'n', 'a', 'm', 'i', 'c', 'C', 'o', 'n', 'f', 'i',
    'g', 'B', '\023', '\362', '\230', '\376', '\217', '\005', '\r', '\022', '\013', 'c',
    'o', 'n', 'f', 'i', 'g', '_', 't', 'y', 'p', 'e', 'R', '\r',
    'd', 'y', 'n', 'a', 'm', 'i', 'c', 'C', 'o', 'n', 'f', 'i',
    'g', '\022', 'g', '\n', '\014', 'f', 'i', 'l', 't', 'e', 'r', '_',
    'c', 'h', 'a', 'i', 'n', '\030', '\004', ' ', '\001', '(', '\013', '2',
    'D', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x', 't', 'e',
    'n', 's', 'i', 'o', 'n', 's', '.', 'f', 'i', 'l', 't', 'e',
    'r', 's', '.', 'h', 't', 't', 'p', '.', 'c', 'o', 'm', 'p',
    'o', 's', 'i', 't', 'e', '.', 'v', '3', '.', 'F', 'i', 'l',
    't', 'e', 'r', 'C', 'h', 'a', 'i', 'n', 'C', 'o', 'n', 'f',
    'i', 'g', 'u', 'r', 'a', 't', 'i', 'o', 'n', 'R', '\013', 'f',
    'i', 'l', 't', 'e', 'r', 'C', 'h', 'a', 'i', 'n', '\022', '*',
    '\n', '\021', 'f', 'i', 'l', 't', 'e', 'r', '_', 'c', 'h', 'a',
    'i', 'n', '_', 'n', 'a', 'm', 'e', '\030', '\005', ' ', '\001', '(',
    '\t', 'R', '\017', 'f', 'i', 'l', 't', 'e', 'r', 'C', 'h', 'a',
    'i', 'n', 'N', 'a', 'm', 'e', '\022', 'U', '\n', '\016', 's', 'a',
    'm', 'p', 'l', 'e', '_', 'p', 'e', 'r', 'c', 'e', 'n', 't',
    '\030', '\003', ' ', '\001', '(', '\013', '2', '.', '.', 'e', 'n', 'v',
    'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o',
    'r', 'e', '.', 'v', '3', '.', 'R', 'u', 'n', 't', 'i', 'm',
    'e', 'F', 'r', 'a', 'c', 't', 'i', 'o', 'n', 'a', 'l', 'P',
    'e', 'r', 'c', 'e', 'n', 't', 'R', '\r', 's', 'a', 'm', 'p',
    'l', 'e', 'P', 'e', 'r', 'c', 'e', 'n', 't', 'B', '\263', '\001',
    '\n', '8', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r',
    'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x',
    't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 'f', 'i', 'l',
    't', 'e', 'r', 's', '.', 'h', 't', 't', 'p', '.', 'c', 'o',
    'm', 'p', 'o', 's', 'i', 't', 'e', '.', 'v', '3', 'B', '\016',
    'C', 'o', 'm', 'p', 'o', 's', 'i', 't', 'e', 'P', 'r', 'o',
