...
static const char descriptor[874] = {
    '\n', 'H', 'e', 'n', 'v', 'o', 'y', '/', 'e', 'x', 't', 'e',
    ...
    '/', 'v', 'a', 'l', 'i', 'd', 'a', 't', 'e', '.', 'p', 'r',
    'o', 't', 'o', '\"', '\356', '\001', '\n', '\017', 'S', 't', 'a', 't',
    'e', 'f', 'u', 'l', 'S', 'e', 's', 's', 'i', 'o', 'n', '\022',
    'O', '\n', '\r', 's', 'e', 's', 's', 'i', 'o', 'n', '_', 's',
    't', 'a', 't', 'e', '\030', '\001', ' ', '\001', '(', '\013', '2', '*',
    '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
    'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'T', 'y',
    'p', 'e', 'd', 'E', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n',
    'C', 'o', 'n', 'f', 'i', 'g', 'R', '\014', 's', 'e', 's', 's',
    'i', 'o', 'n', 'S', 't', 'a', 't', 'e', '\022', '\026', '\n', '\006',
    's', 't', 'r', 'i', 'c', 't', '\030', '\002', ' ', '\001', '(', '\010',
    'R', '\006', 's', 't', 'r', 'i', 'c', 't', '\022', '\037', '\n', '\013',
    's', 't', 'a', 't', '_', 'p', 'r', 'e', 'f', 'i', 'x', '\030',
    '\003', ' ', '\001', '(', '\t', 'R', '\n', 's', 't', 'a', 't', 'P',
    'r', 'e', 'f', 'i', 'x', '\022', 'Q', '\n', '&', 's', 't', 'a',
    't', 'u', 's', '_', 'o', 'n', '_', 's', 't', 'r', 'i', 'c',
    't', '_', 'd', 'e', 's', 't', 'i', 'n', 'a', 't', 'i', 'o',
    'n', '_', 'n', 'o', 't', '_', 'f', 'o', 'u', 'n', 'd', '\030',
    '\004', ' ', '\001', '(', '\r', 'R', '!', 's', 't', 'a', 't', 'u',
    's', 'O', 'n', 'S', 't', 'r', 'i', 'c', 't', 'D', 'e', 's',
    't', 'i', 'n', 'a', 't', 'i', 'o', 'n', 'N', 'o', 't', 'F',
    'o', 'u', 'n', 'd', '\"', '\302', '\001', '\n', '\027', 'S', 't', 'a',
    't', 'e', 'f', 'u', 'l', 'S', 'e', 's', 's', 'i', 'o', 'n',
    'P', 'e', 'r', 'R', 'o', 'u', 't', 'e', '\022', '%', '\n', '\010',
    'd', 'i', 's', 'a', 'b', 'l', 'e', 'd', '\030', '\001', ' ', '\001',
    '(', '\010', 'B', '\007', '\372', 'B', '\004', 'j', '\002', '\010', '\001', 'H',
    '\000', 'R', '\010', 'd', 'i', 's', 'a', 'b', 'l', 'e', 'd', '\022',
    'o', '\n', '\020', 's', 't', 'a', 't', 'e', 'f', 'u', 'l', '_',
    's', 'e', 's', 's', 'i', 'o', 'n', '\030', '\002', ' ', '\001', '(',
    '\013', '2', 'B', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x',
    't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 'f', 'i', 'l',
    't', 'e', 'r', 's', '.', 'h', 't', 't', 'p', '.', 's', 't',
    'a', 't', 'e', 'f', 'u', 'l', '_', 's', 'e', 's', 's', 'i',
    'o', 'n', '.', 'v', '3', '.', 'S', 't', 'a', 't', 'e', 'f',
    'u', 'l', 'S', 'e', 's', 's', 'i', 'o', 'n', 'H', '\000', 'R',
    '\017', 's', 't', 'a', 't', 'e', 'f', 'u', 'l', 'S', 'e', 's',
    's', 'i', 'o', 'n', 'B', '\017', '\n', '\010', 'o', 'v', 'e', 'r',
    'r', 'i', 'd', 'e', '\022', '\003', '\370', 'B', '\001', 'B', '\316', '\001',
    '\n', '?', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r',
    'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x',
    't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 'f', 'i', 'l',
    't', 'e', 'r', 's', '.', 'h', 't', 't', 'p', '.', 's', 't',
    'a', 't', 'e', 'f', 'u', 'l', '_', 's', 'e', 's', 's', 'i',
    'o', 'n', '.', 'v', '3', 'B', '\024', 'S', 't', 'a', 't', 'e',
    'f', 'u', 'l', 'S', 'e', 's', 's', 'i', 'o', 'n', 'P', 'r',
    'o', 't', 'o', 'P', '\001', 'Z', 'k', 'g', 'i', 't', 'h', 'u',
    'b', '.', 'c', 'o', 'm', '/', 'e', 'n', 'v', 'o', 'y', 'p',
    'r', 'o', 'x', 'y', '/', 'g', 'o', '-', 'c', 'o', 'n', 't',
    'r', 'o', 'l', '-', 'p', 'l', 'a', 'n', 'e', '/', 'e', 'n',
    ...
    's', 'i', 'o', 'n', 'v', '3', '\272', '\200', '\310', '\321', '\006', '\002',
