...
static const char descriptor[360] = {
    '\n', '#', 'e', 'n', 'v', 'o', 'y', '/', 't', 'y', 'p', 'e',
    '/', 'm', 'a', 't', 'c', 'h', 'e', 'r', '/', 'v', '3', '/',
    ...
    's', '\022', '!', '\n', '\014', 'i', 'n', 'v', 'e', 'r', 't', '_',
    'm', 'a', 't', 'c', 'h', '\030', '\002', ' ', '\001', '(', '\010', 'R',
    '\013', 'i', 'n', 'v', 'e', 'r', 't', 'M', 'a', 't', 'c', 'h',
    'B', '\205', '\001', '\n', '#', 'i', 'o', '.', 'e', 'n', 'v', 'o',
    'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y',
    '.', 't', 'y', 'p', 'e', '.', 'm', 'a', 't', 'c', 'h', 'e',
    'r', '.', 'v', '3', 'B', '\014', 'A', 'd', 'd', 'r', 'e', 's',
    's', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', 'F', 'g', 'i',
    't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'e', 'n', 'v',
    'o', 'y', 'p', 'r', 'o', 'x', 'y', '/', 'g', 'o', '-', 'c',
    'o', 'n', 't', 'r', 'o', 'l', '-', 'p', 'l', 'a', 'n', 'e',
    '/', 'e', 'n', 'v', 'o', 'y', '/', 't', 'y', 'p', 'e', '/',
    'm', 'a', 't', 'c', 'h', 'e', 'r', '/', 'v', '3', ';', 'm',
    'a', 't', 'c', 'h', 'e', 'r', 'v', '3', '\272', '\200', '\310', '\321',
