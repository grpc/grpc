...
static const char descriptor[555] = {
    ...
    'a', 't', 'i', 'o', 'n', 'B', '\010', '\372', 'B', '\005', '\252', '\001',
    '\002', '2', '\000', 'R', '\003', 't', 't', 'l', '\022', '\022', '\n', '\004',
    'p', 'a', 't', 'h', '\030', '\003', ' ', '\001', '(', '\t', 'R', '\004',
    'p', 'a', 't', 'h', '\022', 'C', '\n', '\n', 'a', 't', 't', 'r',
    'i', 'b', 'u', 't', 'e', 's', '\030', '\004', ' ', '\003', '(', '\013',
    '2', '#', '.', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p',
    'e', '.', 'h', 't', 't', 'p', '.', 'v', '3', '.', 'C', 'o',
    'o', 'k', 'i', 'e', 'A', 't', 't', 'r', 'i', 'b', 'u', 't',
    'e', 'R', '\n', 'a', 't', 't', 'r', 'i', 'b', 'u', 't', 'e',
    's', '\"', '_', '\n', '\017', 'C', 'o', 'o', 'k', 'i', 'e', 'A',
    't', 't', 'r', 'i', 'b', 'u', 't', 'e', '\022', '%', '\n', '\004',
    'n', 'a', 'm', 'e', '\030', '\001', ' ', '\001', '(', '\t', 'B', '\021',
    '\372', 'B', '\016', 'r', '\014', '\020', '\001', '(', '\200', '\200', '\001', '\300',
    '\001', '\001', '\310', '\001', '\000', 'R', '\004', 'n', 'a', 'm', 'e', '\022',
    '%', '\n', '\005', 'v', 'a', 'l', 'u', 'e', '\030', '\002', ' ', '\001',
    '(', '\t', 'B', '\017', '\372', 'B', '\014', 'r', '\n', '(', '\200', '\200',
    '\001', '\300', '\001', '\002', '\310', '\001', '\000', 'R', '\005', 'v', 'a', 'l',
    'u', 'e', 'B', '{', '\n', ' ', 'i', 'o', '.', 'e', 'n', 'v',
    'o', 'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o',
    'y', '.', 't', 'y', 'p', 'e', '.', 'h', 't', 't', 'p', '.',
    'v', '3', 'B', '\013', 'C', 'o', 'o', 'k', 'i', 'e', 'P', 'r',
    'o', 't', 'o', 'P', '\001', 'Z', '@', 'g', 'i', 't', 'h', 'u',
    'b', '.', 'c', 'o', 'm', '/', 'e', 'n', 'v', 'o', 'y', 'p',
    'r', 'o', 'x', 'y', '/', 'g', 'o', '-', 'c', 'o', 'n', 't',
    'r', 'o', 'l', '-', 'p', 'l', 'a', 'n', 'e', '/', 'e', 'n',
    'v', 'o', 'y', '/', 't', 'y', 'p', 'e', '/', 'h', 't', 't',
    'p', '/', 'v', '3', ';', 'h', 't', 't', 'p', 'v', '3', '\272',
