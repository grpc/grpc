...
static const char descriptor[484] = {
    ...
    '\"', 'R', '\n', '\n', 'I', 'n', 't', '6', '4', 'R', 'a', 'n',
    'g', 'e', '\022', '\024', '\n', '\005', 's', 't', 'a', 'r', 't', '\030',
    '\001', ' ', '\001', '(', '\003', 'R', '\005', 's', 't', 'a', 'r', 't',
    '\022', '\020', '\n', '\003', 'e', 'n', 'd', '\030', '\002', ' ', '\001', '(',
    '\003', 'R', '\003', 'e', 'n', 'd', ':', '\034', '\232', '\305', '\210', '\036',
    '\027', '\n', '\025', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p',
    'e', '.', 'I', 'n', 't', '6', '4', 'R', 'a', 'n', 'g', 'e',
    '\"', 'R', '\n', '\n', 'I', 'n', 't', '3', '2', 'R', 'a', 'n',
    'g', 'e', '\022', '\024', '\n', '\005', 's', 't', 'a', 'r', 't', '\030',
    '\001', ' ', '\001', '(', '\005', 'R', '\005', 's', 't', 'a', 'r', 't',
    '\022', '\020', '\n', '\003', 'e', 'n', 'd', '\030', '\002', ' ', '\001', '(',
    '\005', 'R', '\003', 'e', 'n', 'd', ':', '\034', '\232', '\305', '\210', '\036',
    '\027', '\n', '\025', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p',
    'e', '.', 'I', 'n', 't', '3', '2', 'R', 'a', 'n', 'g', 'e',
    '\"', 'T', '\n', '\013', 'D', 'o', 'u', 'b', 'l', 'e', 'R', 'a',
    'n', 'g', 'e', '\022', '\024', '\n', '\005', 's', 't', 'a', 'r', 't',
    '\030', '\001', ' ', '\001', '(', '\001', 'R', '\005', 's', 't', 'a', 'r',
    't', '\022', '\020', '\n', '\003', 'e', 'n', 'd', '\030', '\002', ' ', '\001',
    '(', '\001', 'R', '\003', 'e', 'n', 'd', ':', '\035', '\232', '\305', '\210',
    '\036', '\030', '\n', '\026', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y',
    'p', 'e', '.', 'D', 'o', 'u', 'b', 'l', 'e', 'R', 'a', 'n',
    'g', 'e', 'B', 'p', '\n', '\033', 'i', 'o', '.', 'e', 'n', 'v',
    'o', 'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o',
    'y', '.', 't', 'y', 'p', 'e', '.', 'v', '3', 'B', '\n', 'R',
    'a', 'n', 'g', 'e', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z',
    ';', 'g', 'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/',
