...
'a', 'l', 'p', 'h', 'a', '.', 'E', 'c', 'd', 's', 'C', 'o', 'n', 'f', 'i', 'g', 'D', 'u', 'm', 'p', '*', 'x', '\n', '\024', 'C', 
...
'D', '\020', '\003', '\022', '\n', '\n', '\006', 'N', 'A', 'C', 'K', 'E', 'D', '\020', '\004', '\022', '\031', '\n', '\025', 'C', 'L', 'I', 'E', 'N', 'T', 
'_', 'R', 'E', 'C', 'E', 'I', 'V', 'E', 'D', '_', 'E', 'R', 'R', 'O', 'R', '\020', '\005', 'B', '~', '\n', '\034', 'i', 'o', '.', 'e', 
'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'a', 'd', 'm', 'i', 'n', '.', 'v', '3', 'B', 
'\025', 'C', 'o', 'n', 'f', 'i', 'g', 'D', 'u', 'm', 'p', 'S', 'h', 'a', 'r', 'e', 'd', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', 
'=', 'g', 'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '/', 'g', 'o', 
'-', 'c', 'o', 'n', 't', 'r', 'o', 'l', '-', 'p', 'l', 'a', 'n', 'e', '/', 'e', 'n', 'v', 'o', 'y', '/', 'a', 'd', 'm', 'i', 
'n', '/', 'v', '3', ';', 'a', 'd', 'm', 'i', 'n', 'v', '3', '\272', '\200', '\310', '\321', '\006', '\002', '\020', '\002', 'b', '\006', 'p', 'r', 'o', 
't', 'o', '3', 
};
...
_upb_DefPool_Init envoy_admin_v3_config_dump_shared_proto_upbdefinit = {
  ...
  "envoy/admin/v3/config_dump_shared.proto",
  UPB_STRINGVIEW_INIT(descriptor, 6128)
};
