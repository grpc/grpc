...
static const char descriptor[549] = {
    '\n', ')', 's', 'r', 'c', '/', 'p', 'r', 'o', 't', 'o', '/',
    ...
    'p', 'h', 'a', 'n', 'e', 'd', '\022', '*', '\n', '\004', 'd', 'a',
    't', 'a', '\030', '\005', ' ', '\003', '(', '\013', '2', '\026', '.', 'g',
    'r', 'p', 'c', '.', 'c', 'h', 'a', 'n', 'n', 'e', 'l', 'z',
    '.', 'v', '2', '.', 'D', 'a', 't', 'a', 'R', '\004', 'd', 'a',
    't', 'a', '\022', '2', '\n', '\005', 't', 'r', 'a', 'c', 'e', '\030',
    '\006', ' ', '\003', '(', '\013', '2', '\034', '.', 'g', 'r', 'p', 'c',
    '.', 'c', 'h', 'a', 'n', 'n', 'e', 'l', 'z', '.', 'v', '2',
    '.', 'T', 'r', 'a', 'c', 'e', 'E', 'v', 'e', 'n', 't', 'R',
    '\005', 't', 'r', 'a', 'c', 'e', '\"', '\224', '\001', '\n', '\n', 'T',
    'r', 'a', 'c', 'e', 'E', 'v', 'e', 'n', 't', '\022', ' ', '\n',
    '\013', 'd', 'e', 's', 'c', 'r', 'i', 'p', 't', 'i', 'o', 'n',
    '\030', '\001', ' ', '\001', '(', '\t', 'R', '\013', 'd', 'e', 's', 'c',
    'r', 'i', 'p', 't', 'i', 'o', 'n', '\022', '8', '\n', '\t', 't',
    'i', 'm', 'e', 's', 't', 'a', 'm', 'p', '\030', '\002', ' ', '\001',
    '(', '\013', '2', '\032', '.', 'g', 'o', 'o', 'g', 'l', 'e', '.',
    'p', 'r', 'o', 't', 'o', 'b', 'u', 'f', '.', 'T', 'i', 'm',
    'e', 's', 't', 'a', 'm', 'p', 'R', '\t', 't', 'i', 'm', 'e',
    's', 't', 'a', 'm', 'p', '\022', '*', '\n', '\004', 'd', 'a', 't',
    'a', '\030', '\003', ' ', '\003', '(', '\013', '2', '\026', '.', 'g', 'r',
    'p', 'c', '.', 'c', 'h', 'a', 'n', 'n', 'e', 'l', 'z', '.',
    'v', '2', '.', 'D', 'a', 't', 'a', 'R', '\004', 'd', 'a', 't',
    'a', 'b', '\006', 'p', 'r', 'o', 't', 'o', '3',
};
