...
#ifndef GRPC_CORE_EXT_FILTERS_CENSUS_SERVER_FILTER_H
#define GRPC_CORE_EXT_FILTERS_CENSUS_SERVER_FILTER_H
...
#endif /* GRPC_CORE_EXT_FILTERS_CENSUS_SERVER_FILTER_H */
