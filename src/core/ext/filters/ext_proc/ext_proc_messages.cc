...
void SetObservabilityMode(
    envoy_service_ext_proc_v3_ProcessingRequest* request, bool mode) {
...
std::string CreateExtProcRequest(
  ...
  SetProtocolConfigResponse(request, arena, is_first_message, send_response_body);
