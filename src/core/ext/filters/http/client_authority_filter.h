...
/// Filter responsible for setting the authority header, if not already
/// set. It uses the value of the GRPC_ARG_DEFAULT_AUTHORITY channel arg
/// if the initial metadata doesn't already contain an authority value.
