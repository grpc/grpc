...
grpc_dns_lookup_ares_impl (const char *dns_server, const char *name,
...
grpc_ares_request *(*grpc_dns_lookup_ares) (const char *dns_server,
					    const char *name,
					    const char *default_port,
					    grpc_pollset_set *
					    interested_parties,
  ...
  grpc_dns_lookup_ares_impl;

void
grpc_cancel_ares_request (grpc_ares_request * r)
{
}
...
void
grpc_ares_cleanup (void)
{
}

static void
grpc_resolve_address_ares_impl (const char *name,
				const char *default_port,
				grpc_pollset_set * interested_parties,
				grpc_closure * on_done,
