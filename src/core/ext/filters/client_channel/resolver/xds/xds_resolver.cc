...
class XdsResolver : public Resolver {
 ...
 private:
  ...
  // Create the service config generated by the route config.
...
void XdsResolver::ListenerWatcher::OnListenerChanged(
  ...
  Result result;
  grpc_error* error = resolver_->CreateServiceConfig(listener_data.routes,
...
WeightedClustersKeys GetWeightedClustersKey(
    const std::vector<XdsApi::Route::ClusterWeight>&
        weighted_clusters) {
