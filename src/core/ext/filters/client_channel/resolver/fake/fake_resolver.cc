...
static void set_response_closure_fn(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  if (closure_arg->notify) fake_resolver_maybe_finish_next_locked(exec_ctx, r);
...
void grpc_fake_resolver_response_generator_set_response(
    grpc_exec_ctx* exec_ctx, grpc_fake_resolver_response_generator* generator,
    grpc_channel_args* next_response) {
  set_response_and_maybe_push(exec_ctx, generator, next_response, true);
}

void grpc_fake_resolver_response_generator_set_response_no_notify(
    grpc_exec_ctx* exec_ctx, grpc_fake_resolver_response_generator* generator,
    grpc_channel_args* next_response) {
  set_response_and_maybe_push(exec_ctx, generator, next_response, false);
}
