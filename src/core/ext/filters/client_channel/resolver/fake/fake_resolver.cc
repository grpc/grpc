...
static void
fake_resolver_destroy (grpc_resolver * gr)
{
...
static void
fake_resolver_shutdown_locked (grpc_resolver * resolver)
{
...
static void
fake_resolver_maybe_finish_next_locked (fake_resolver * r)
{
...
static void
fake_resolver_channel_saw_error_locked (grpc_resolver * resolver)
{
  fake_resolver *r = (fake_resolver *) resolver;
...
static void
fake_resolver_next_locked (grpc_resolver * resolver,
			   grpc_channel_args ** target_result,
...
static void
set_response_closure_fn (void *arg, grpc_error * error)
{
   ...
   grpc_channel_args * next_response)
{
  ...
  GRPC_CLOSURE_SCHED (GRPC_CLOSURE_INIT (&closure_arg->set_response_closure,
					 ...
					 grpc_combiner_scheduler (generator->
								  resolver->
								  base.
								  combiner)),
		      GRPC_ERROR_NONE);
...
static void *
response_generator_arg_copy (void *p)
{
  return grpc_fake_resolver_response_generator_ref ((grpc_fake_resolver_response_generator *) p);
}

static void
response_generator_arg_destroy (void *p)
{
  grpc_fake_resolver_response_generator_unref ((grpc_fake_resolver_response_generator *) p);
}

static int
response_generator_cmp (void *a, void *b)
{
  return GPR_ICMP (a, b);
}
...
static void
fake_resolver_factory_ref (grpc_resolver_factory * factory)
{
}

static void
fake_resolver_factory_unref (grpc_resolver_factory * factory)
{
}

static grpc_resolver *
fake_resolver_create (grpc_resolver_factory * factory,
...
static char *
fake_resolver_get_default_authority (grpc_resolver_factory * factory,
				     grpc_uri * uri)
{
...
void
grpc_resolver_fake_init (void)
{
  grpc_register_resolver_type (&fake_resolver_factory);
}

void
grpc_resolver_fake_shutdown (void)
{
}
