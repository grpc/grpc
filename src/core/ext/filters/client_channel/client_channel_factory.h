...
struct grpc_client_channel_factory_vtable
{
  ...
  grpc_subchannel *(*create_subchannel) (grpc_client_channel_factory *
					 factory,
					 const grpc_subchannel_args * args);
  grpc_channel *(*create_client_channel) (grpc_client_channel_factory *
...
void grpc_client_channel_factory_unref (grpc_client_channel_factory *
					factory);
