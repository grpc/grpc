...
// FIXME
  ...
  chand->request_router.Init(
      chand->owning_stack, chand->combiner, chand->client_channel_factory,
      chand->interested_parties, &grpc_client_channel_trace,
      nullptr /* FIXME: on_resolver_result */,
      true /* request_service_config */,
