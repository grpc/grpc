...
const grpc_channel_filter grpc_client_channel_filter = {
    grpc_core::CallData::StartTransportStreamOpBatch,
    grpc_core::ChannelData::StartTransportOp,
    sizeof(grpc_core::CallData),
    grpc_core::CallData::Init,
    grpc_core::CallData::SetPollsetOrPollsetSet,
    grpc_core::CallData::Destroy,
...
grpc_client_channel_get_subchannel_call(grpc_call_element* elem) {
  auto* calld = static_cast<grpc_core::CallData*>(elem->call_data);
