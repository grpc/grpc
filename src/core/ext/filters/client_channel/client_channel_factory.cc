...
grpc_subchannel *
grpc_client_channel_factory_create_subchannel (grpc_client_channel_factory *
					       factory,
...
grpc_channel *
grpc_client_channel_factory_create_channel (grpc_client_channel_factory *
					    factory, const char *target,
...
static void
factory_arg_destroy (void *factory)
{
  grpc_client_channel_factory_unref ((grpc_client_channel_factory *) factory);
}

static int
factory_arg_cmp (void *factory1, void *factory2)
{
...
grpc_arg
grpc_client_channel_factory_create_channel_arg (grpc_client_channel_factory *
						factory)
{
