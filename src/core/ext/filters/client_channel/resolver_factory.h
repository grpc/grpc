...
struct grpc_resolver_factory_vtable
{
  ...
  char *(*get_default_authority) (grpc_resolver_factory * factory,
				  grpc_uri * uri);
...
grpc_resolver *grpc_resolver_factory_create_resolver (grpc_resolver_factory *
						      factory,
						      grpc_resolver_args *
						      args);
...
char *grpc_resolver_factory_get_default_authority (grpc_resolver_factory *
						   factory, grpc_uri * uri);
