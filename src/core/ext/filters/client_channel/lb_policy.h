 ...
 public:
  ...
  class MetadataInterface {
   public:
    class iterator
     ...
     public:
      ...
      iterator& operator++() {
        handle_ = md_->IteratorNext(handle_);
        return *this;
      }
      ...
      value_type operator*() const { return md_->IteratorGet(handle_); }
   ...
   private:
    ...
    virtual intptr_t IteratorNext(intptr_t handle) const = 0;
    virtual std::pair<StringView /*key*/, StringView /*value */> IteratorGet(
