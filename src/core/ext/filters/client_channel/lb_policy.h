...
typedef struct grpc_lb_policy_pick_state
{
  ...
  grpc_call_context_element
    subchannel_call_context[GRPC_CONTEXT_COUNT];
  /// Upon success, \a *user_data will be set to whatever opaque information
  /// may need to be propagated from the LB policy, or NULL if not needed.
  void **
    user_data;
  /// Next pointer.  For internal use by LB policy.
  struct grpc_lb_policy_pick_state *
    next;
...
struct grpc_lb_policy_vtable
{
  ...
  void (*ping_one_locked) (grpc_lb_policy * policy,
  ...
  grpc_connectivity_state (*check_connectivity_locked) (grpc_lb_policy *
							policy,
							grpc_error **
							connectivity_error);
