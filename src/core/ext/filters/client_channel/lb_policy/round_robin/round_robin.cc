...
RoundRobin::~RoundRobin() {
  grpc_lb_round_robin_trace.Log(GPR_INFO, "[RR %p] Destroying Round Robin policy", this);
...
void RoundRobin::UpdateLocked(UpdateArgs args) {
  grpc_lb_round_robin_trace.Log(GPR_INFO, "[RR %p] received update with %" PRIuPTR " addresses",
