...
class XdsClient : public InternallyRefCounted<XdsClient> {
 ...
 private:
  ...
  // final_actions_ to reflect all the actions in the service config and remove
  // old actions from the previous update/service config.
  ...
  // 4. Store all names used in final_actions_ for the next update.
