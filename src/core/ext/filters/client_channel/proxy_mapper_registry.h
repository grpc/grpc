...
class ProxyMapperRegistry {
 public:
  ...
  static bool MapName(const char* server_uri, const grpc_channel_args* args, char** name_to_resolve,
                      grpc_channel_args** new_args);

  static bool MapAddress(const grpc_resolved_address& address, const grpc_channel_args* args,
