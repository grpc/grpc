...
// Channel arg key for enabling parsing fault injection via method
// config.
...
// This channel filter is intended to be used by the dynamic filters,
// instead of the ordinary channel stack. The fault injection filter
// fetches fault injection policy from the method config of service
// config returned by the resolver, and enforces the fault injection
// policy.
