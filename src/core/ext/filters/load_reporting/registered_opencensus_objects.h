...
#ifndef GRPC_SRC_CPP_SERVER_LOAD_REPORTER_OPENCENSUS_H
#define GRPC_SRC_CPP_SERVER_LOAD_REPORTER_OPENCENSUS_H
...
#endif  // GRPC_SRC_CPP_SERVER_LOAD_REPORTER_OPENCENSUS_H
