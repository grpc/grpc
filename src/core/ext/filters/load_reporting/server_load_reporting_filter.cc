...
static void
on_initial_md_ready (void *user_data, grpc_error * err)
{
  ...
  calld->ops_recv_initial_metadata_ready->cb (calld->
					      ops_recv_initial_metadata_ready->
					      cb_arg, err);
...
static grpc_filtered_mdelem
lr_trailing_md_filter (void *user_data, grpc_mdelem md)
{
  grpc_call_element *elem = (grpc_call_element *) user_data;
  call_data *calld = (call_data *) elem->call_data;
...
static void
lr_start_transport_stream_op_batch (grpc_call_element * elem,
				    grpc_transport_stream_op_batch * op)
{
  ...
  if (op->recv_initial_metadata)
    ...
    {
      GRPC_LOG_IF_ERROR ("grpc_metadata_batch_filter",
			 grpc_metadata_batch_filter (op->payload->
						     send_trailing_metadata.
						     send_trailing_metadata,
						     lr_trailing_md_filter,
						     elem,
