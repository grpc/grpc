...
static bool
get_user_agent_mdelem (const grpc_metadata_batch * batch, grpc_mdelem * md)
{
...
static void
recv_initial_metadata_ready (void *user_data, grpc_error * error)
{
...
static void
start_transport_stream_op_batch (grpc_call_element * elem,
...
static grpc_error *
init_call_elem (grpc_call_element * elem, const grpc_call_element_args * args)
{
  call_data *calld = (call_data *) elem->call_data;
...
static grpc_error *
init_channel_elem (grpc_channel_element * elem,
...
static bool
parse_user_agent (grpc_mdelem md)
{
...
static bool
register_workaround_cronet_compression (grpc_channel_stack_builder * builder,
					void *arg)
{
...
void
grpc_workaround_cronet_compression_filter_init (void)
{
...
void
grpc_workaround_cronet_compression_filter_shutdown (void)
{
}
