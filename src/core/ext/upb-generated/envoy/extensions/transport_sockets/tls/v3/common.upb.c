...
static const upb_msglayout_field envoy_extensions_transport_sockets_tls_v3_TlsCertificate__fields[8] = {
  ...
  {8, UPB_SIZE(28, 56), 7, 0, 11, _UPB_MODE_SCALAR | (_UPB_REP_PTR << _UPB_REP_SHIFT)},
};
...
const upb_msglayout envoy_extensions_transport_sockets_tls_v3_TlsCertificate_msginit = {
  ...
  UPB_SIZE(40, 72), 8, _UPB_MSGEXT_NONE, 8, 255,
};
...
static const upb_msglayout_sub envoy_extensions_transport_sockets_tls_v3_SubjectAltNameMatcher_submsgs[1] = {
  {.submsg = &envoy_type_matcher_v3_StringMatcher_msginit},
};

static const upb_msglayout_field envoy_extensions_transport_sockets_tls_v3_SubjectAltNameMatcher__fields[2] = {
...
const upb_msglayout envoy_extensions_transport_sockets_tls_v3_SubjectAltNameMatcher_msginit = {
...
static const upb_msglayout_sub envoy_extensions_transport_sockets_tls_v3_CertificateValidationContext_submsgs[7] = {
  {.submsg = &envoy_config_core_v3_DataSource_msginit},
...
static const upb_msglayout_field envoy_extensions_transport_sockets_tls_v3_CertificateValidationContext__fields[13] = {
  ...
  {6, UPB_SIZE(16, 24), 2, 6, 11, _UPB_MODE_SCALAR | (_UPB_REP_PTR << _UPB_REP_SHIFT)},
  ...
  {9, UPB_SIZE(44, 80), 0, 5, 11, _UPB_MODE_ARRAY | (_UPB_REP_PTR << _UPB_REP_SHIFT)},
  ...
  {14, UPB_SIZE(9, 9), 0, 0, 8, _UPB_MODE_SCALAR | (_UPB_REP_1BYTE << _UPB_REP_SHIFT)},
  {15, UPB_SIZE(48, 88), 0, 4, 11, _UPB_MODE_ARRAY | (_UPB_REP_PTR << _UPB_REP_SHIFT)},
};
...
const upb_msglayout envoy_extensions_transport_sockets_tls_v3_CertificateValidationContext_msginit = {
  ...
  UPB_SIZE(56, 96), 13, _UPB_MSGEXT_NONE, 3, 255,
};
