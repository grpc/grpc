...
UPB_INLINE envoy_config_rbac_v3_RBAC *envoy_config_rbac_v3_RBAC_new(upb_arena *arena) {
  return (envoy_config_rbac_v3_RBAC *)upb_msg_new(&envoy_config_rbac_v3_RBAC_msginit, arena);
}
...
UPB_INLINE int32_t envoy_config_rbac_v3_RBAC_action(const envoy_config_rbac_v3_RBAC *msg) { return UPB_FIELD_AT(msg, int32_t, UPB_SIZE(0, 0)); }
UPB_INLINE const envoy_config_rbac_v3_RBAC_PoliciesEntry* const* envoy_config_rbac_v3_RBAC_policies(const envoy_config_rbac_v3_RBAC *msg, size_t *len) { return (const envoy_config_rbac_v3_RBAC_PoliciesEntry* const*)_upb_array_accessor(msg, UPB_SIZE(8, 8), len); }

UPB_INLINE void envoy_config_rbac_v3_RBAC_set_action(envoy_config_rbac_v3_RBAC *msg, int32_t value) {
  UPB_FIELD_AT(msg, int32_t, UPB_SIZE(0, 0)) = value;
}
UPB_INLINE envoy_config_rbac_v3_RBAC_PoliciesEntry** envoy_config_rbac_v3_RBAC_mutable_policies(envoy_config_rbac_v3_RBAC *msg, size_t *len) {
  return (envoy_config_rbac_v3_RBAC_PoliciesEntry**)_upb_array_mutable_accessor(msg, UPB_SIZE(8, 8), len);
}
UPB_INLINE envoy_config_rbac_v3_RBAC_PoliciesEntry** envoy_config_rbac_v3_RBAC_resize_policies(envoy_config_rbac_v3_RBAC *msg, size_t len, upb_arena *arena) {
  return (envoy_config_rbac_v3_RBAC_PoliciesEntry**)_upb_array_resize_accessor(msg, UPB_SIZE(8, 8), len, UPB_SIZE(4, 8), UPB_TYPE_MESSAGE, arena);
}
UPB_INLINE struct envoy_config_rbac_v3_RBAC_PoliciesEntry* envoy_config_rbac_v3_RBAC_add_policies(envoy_config_rbac_v3_RBAC *msg, upb_arena *arena) {
  struct envoy_config_rbac_v3_RBAC_PoliciesEntry* sub = (struct envoy_config_rbac_v3_RBAC_PoliciesEntry*)upb_msg_new(&envoy_config_rbac_v3_RBAC_PoliciesEntry_msginit, arena);
...
UPB_INLINE envoy_config_rbac_v3_RBAC_PoliciesEntry *envoy_config_rbac_v3_RBAC_PoliciesEntry_new(upb_arena *arena) {
  return (envoy_config_rbac_v3_RBAC_PoliciesEntry *)upb_msg_new(&envoy_config_rbac_v3_RBAC_PoliciesEntry_msginit, arena);
}
UPB_INLINE envoy_config_rbac_v3_RBAC_PoliciesEntry *envoy_config_rbac_v3_RBAC_PoliciesEntry_parse(const char *buf, size_t size,
                        upb_arena *arena) {
  envoy_config_rbac_v3_RBAC_PoliciesEntry *ret = envoy_config_rbac_v3_RBAC_PoliciesEntry_new(arena);
  return (ret && upb_decode(buf, size, ret, &envoy_config_rbac_v3_RBAC_PoliciesEntry_msginit, arena)) ? ret : NULL;
}
UPB_INLINE char *envoy_config_rbac_v3_RBAC_PoliciesEntry_serialize(const envoy_config_rbac_v3_RBAC_PoliciesEntry *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_rbac_v3_RBAC_PoliciesEntry_msginit, arena, len);
}

UPB_INLINE upb_strview envoy_config_rbac_v3_RBAC_PoliciesEntry_key(const envoy_config_rbac_v3_RBAC_PoliciesEntry *msg) { return UPB_FIELD_AT(msg, upb_strview, UPB_SIZE(0, 0)); }
UPB_INLINE const envoy_config_rbac_v3_Policy* envoy_config_rbac_v3_RBAC_PoliciesEntry_value(const envoy_config_rbac_v3_RBAC_PoliciesEntry *msg) { return UPB_FIELD_AT(msg, const envoy_config_rbac_v3_Policy*, UPB_SIZE(8, 16)); }

UPB_INLINE void envoy_config_rbac_v3_RBAC_PoliciesEntry_set_key(envoy_config_rbac_v3_RBAC_PoliciesEntry *msg, upb_strview value) {
...
UPB_INLINE void envoy_config_rbac_v3_RBAC_PoliciesEntry_set_value(envoy_config_rbac_v3_RBAC_PoliciesEntry *msg, envoy_config_rbac_v3_Policy* value) {
  UPB_FIELD_AT(msg, envoy_config_rbac_v3_Policy*, UPB_SIZE(8, 16)) = value;
}
UPB_INLINE struct envoy_config_rbac_v3_Policy* envoy_config_rbac_v3_RBAC_PoliciesEntry_mutable_value(envoy_config_rbac_v3_RBAC_PoliciesEntry *msg, upb_arena *arena) {
  struct envoy_config_rbac_v3_Policy* sub = (struct envoy_config_rbac_v3_Policy*)envoy_config_rbac_v3_RBAC_PoliciesEntry_value(msg);
  if (sub == NULL) {
    sub = (struct envoy_config_rbac_v3_Policy*)upb_msg_new(&envoy_config_rbac_v3_Policy_msginit, arena);
    if (!sub) return NULL;
    envoy_config_rbac_v3_RBAC_PoliciesEntry_set_value(msg, sub);
  }
  return sub;
}
...
UPB_INLINE envoy_config_rbac_v3_Policy *envoy_config_rbac_v3_Policy_new(upb_arena *arena) {
  return (envoy_config_rbac_v3_Policy *)upb_msg_new(&envoy_config_rbac_v3_Policy_msginit, arena);
}
...
UPB_INLINE const struct google_api_expr_v1alpha1_Expr* envoy_config_rbac_v3_Policy_condition(const envoy_config_rbac_v3_Policy *msg) { return UPB_FIELD_AT(msg, const struct google_api_expr_v1alpha1_Expr*, UPB_SIZE(0, 0)); }
...
UPB_INLINE envoy_config_rbac_v3_Permission** envoy_config_rbac_v3_Policy_resize_permissions(envoy_config_rbac_v3_Policy *msg, size_t len, upb_arena *arena) {
  return (envoy_config_rbac_v3_Permission**)_upb_array_resize_accessor(msg, UPB_SIZE(4, 8), len, UPB_SIZE(4, 8), UPB_TYPE_MESSAGE, arena);
}
UPB_INLINE struct envoy_config_rbac_v3_Permission* envoy_config_rbac_v3_Policy_add_permissions(envoy_config_rbac_v3_Policy *msg, upb_arena *arena) {
  struct envoy_config_rbac_v3_Permission* sub = (struct envoy_config_rbac_v3_Permission*)upb_msg_new(&envoy_config_rbac_v3_Permission_msginit, arena);
  bool ok = _upb_array_append_accessor(
...
UPB_INLINE envoy_config_rbac_v3_Principal** envoy_config_rbac_v3_Policy_resize_principals(envoy_config_rbac_v3_Policy *msg, size_t len, upb_arena *arena) {
  return (envoy_config_rbac_v3_Principal**)_upb_array_resize_accessor(msg, UPB_SIZE(8, 16), len, UPB_SIZE(4, 8), UPB_TYPE_MESSAGE, arena);
}
UPB_INLINE struct envoy_config_rbac_v3_Principal* envoy_config_rbac_v3_Policy_add_principals(envoy_config_rbac_v3_Policy *msg, upb_arena *arena) {
  struct envoy_config_rbac_v3_Principal* sub = (struct envoy_config_rbac_v3_Principal*)upb_msg_new(&envoy_config_rbac_v3_Principal_msginit, arena);
  bool ok = _upb_array_append_accessor(
...
UPB_INLINE envoy_config_rbac_v3_Permission *envoy_config_rbac_v3_Permission_new(upb_arena *arena) {
  return (envoy_config_rbac_v3_Permission *)upb_msg_new(&envoy_config_rbac_v3_Permission_msginit, arena);
}
...
UPB_INLINE envoy_config_rbac_v3_Permission_rule_oneofcases envoy_config_rbac_v3_Permission_rule_case(const envoy_config_rbac_v3_Permission* msg) { return (envoy_config_rbac_v3_Permission_rule_oneofcases)UPB_FIELD_AT(msg, int32_t, UPB_SIZE(4, 8)); }

UPB_INLINE bool envoy_config_rbac_v3_Permission_has_and_rules(const envoy_config_rbac_v3_Permission *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 1); }
...
UPB_INLINE bool envoy_config_rbac_v3_Permission_has_or_rules(const envoy_config_rbac_v3_Permission *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 2); }
...
UPB_INLINE bool envoy_config_rbac_v3_Permission_has_any(const envoy_config_rbac_v3_Permission *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 3); }
...
UPB_INLINE bool envoy_config_rbac_v3_Permission_has_header(const envoy_config_rbac_v3_Permission *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 4); }
...
UPB_INLINE bool envoy_config_rbac_v3_Permission_has_destination_ip(const envoy_config_rbac_v3_Permission *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 5); }
...
UPB_INLINE bool envoy_config_rbac_v3_Permission_has_destination_port(const envoy_config_rbac_v3_Permission *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 6); }
...
UPB_INLINE bool envoy_config_rbac_v3_Permission_has_metadata(const envoy_config_rbac_v3_Permission *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 7); }
...
UPB_INLINE bool envoy_config_rbac_v3_Permission_has_not_rule(const envoy_config_rbac_v3_Permission *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 8); }
...
UPB_INLINE bool envoy_config_rbac_v3_Permission_has_requested_server_name(const envoy_config_rbac_v3_Permission *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 9); }
...
UPB_INLINE bool envoy_config_rbac_v3_Permission_has_url_path(const envoy_config_rbac_v3_Permission *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 10); }
...
UPB_INLINE struct envoy_config_rbac_v3_Permission_Set* envoy_config_rbac_v3_Permission_mutable_and_rules(envoy_config_rbac_v3_Permission *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_rbac_v3_Permission_Set*)upb_msg_new(&envoy_config_rbac_v3_Permission_Set_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_config_core_v3_CidrRange* envoy_config_rbac_v3_Permission_mutable_destination_ip(envoy_config_rbac_v3_Permission *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_core_v3_CidrRange*)upb_msg_new(&envoy_config_core_v3_CidrRange_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_type_matcher_v3_MetadataMatcher* envoy_config_rbac_v3_Permission_mutable_metadata(envoy_config_rbac_v3_Permission *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_type_matcher_v3_MetadataMatcher*)upb_msg_new(&envoy_type_matcher_v3_MetadataMatcher_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_config_rbac_v3_Permission* envoy_config_rbac_v3_Permission_mutable_not_rule(envoy_config_rbac_v3_Permission *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_rbac_v3_Permission*)upb_msg_new(&envoy_config_rbac_v3_Permission_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_type_matcher_v3_PathMatcher* envoy_config_rbac_v3_Permission_mutable_url_path(envoy_config_rbac_v3_Permission *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_type_matcher_v3_PathMatcher*)upb_msg_new(&envoy_type_matcher_v3_PathMatcher_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE envoy_config_rbac_v3_Permission_Set *envoy_config_rbac_v3_Permission_Set_new(upb_arena *arena) {
  return (envoy_config_rbac_v3_Permission_Set *)upb_msg_new(&envoy_config_rbac_v3_Permission_Set_msginit, arena);
}
...
UPB_INLINE envoy_config_rbac_v3_Permission** envoy_config_rbac_v3_Permission_Set_resize_rules(envoy_config_rbac_v3_Permission_Set *msg, size_t len, upb_arena *arena) {
  return (envoy_config_rbac_v3_Permission**)_upb_array_resize_accessor(msg, UPB_SIZE(0, 0), len, UPB_SIZE(4, 8), UPB_TYPE_MESSAGE, arena);
}
...
UPB_INLINE envoy_config_rbac_v3_Principal *envoy_config_rbac_v3_Principal_new(upb_arena *arena) {
  return (envoy_config_rbac_v3_Principal *)upb_msg_new(&envoy_config_rbac_v3_Principal_msginit, arena);
}
...
UPB_INLINE envoy_config_rbac_v3_Principal_identifier_oneofcases envoy_config_rbac_v3_Principal_identifier_case(const envoy_config_rbac_v3_Principal* msg) { return (envoy_config_rbac_v3_Principal_identifier_oneofcases)UPB_FIELD_AT(msg, int32_t, UPB_SIZE(4, 8)); }

UPB_INLINE bool envoy_config_rbac_v3_Principal_has_and_ids(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 1); }
...
UPB_INLINE bool envoy_config_rbac_v3_Principal_has_or_ids(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 2); }
...
UPB_INLINE bool envoy_config_rbac_v3_Principal_has_any(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 3); }
...
UPB_INLINE bool envoy_config_rbac_v3_Principal_has_authenticated(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 4); }
...
UPB_INLINE bool envoy_config_rbac_v3_Principal_has_source_ip(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 5); }
...
UPB_INLINE bool envoy_config_rbac_v3_Principal_has_header(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 6); }
...
UPB_INLINE bool envoy_config_rbac_v3_Principal_has_metadata(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 7); }
...
UPB_INLINE bool envoy_config_rbac_v3_Principal_has_not_id(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 8); }
...
UPB_INLINE bool envoy_config_rbac_v3_Principal_has_url_path(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 9); }
...
UPB_INLINE bool envoy_config_rbac_v3_Principal_has_direct_remote_ip(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 10); }
...
UPB_INLINE bool envoy_config_rbac_v3_Principal_has_remote_ip(const envoy_config_rbac_v3_Principal *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 11); }
...
UPB_INLINE struct envoy_config_rbac_v3_Principal_Set* envoy_config_rbac_v3_Principal_mutable_and_ids(envoy_config_rbac_v3_Principal *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_rbac_v3_Principal_Set*)upb_msg_new(&envoy_config_rbac_v3_Principal_Set_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_config_rbac_v3_Principal_Authenticated* envoy_config_rbac_v3_Principal_mutable_authenticated(envoy_config_rbac_v3_Principal *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_rbac_v3_Principal_Authenticated*)upb_msg_new(&envoy_config_rbac_v3_Principal_Authenticated_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_config_rbac_v3_Principal* envoy_config_rbac_v3_Principal_mutable_not_id(envoy_config_rbac_v3_Principal *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_rbac_v3_Principal*)upb_msg_new(&envoy_config_rbac_v3_Principal_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE envoy_config_rbac_v3_Principal_Set *envoy_config_rbac_v3_Principal_Set_new(upb_arena *arena) {
  return (envoy_config_rbac_v3_Principal_Set *)upb_msg_new(&envoy_config_rbac_v3_Principal_Set_msginit, arena);
}
...
UPB_INLINE envoy_config_rbac_v3_Principal** envoy_config_rbac_v3_Principal_Set_resize_ids(envoy_config_rbac_v3_Principal_Set *msg, size_t len, upb_arena *arena) {
  return (envoy_config_rbac_v3_Principal**)_upb_array_resize_accessor(msg, UPB_SIZE(0, 0), len, UPB_SIZE(4, 8), UPB_TYPE_MESSAGE, arena);
}
...
UPB_INLINE envoy_config_rbac_v3_Principal_Authenticated *envoy_config_rbac_v3_Principal_Authenticated_new(upb_arena *arena) {
  return (envoy_config_rbac_v3_Principal_Authenticated *)upb_msg_new(&envoy_config_rbac_v3_Principal_Authenticated_msginit, arena);
}
...
UPB_INLINE const struct envoy_type_matcher_v3_StringMatcher* envoy_config_rbac_v3_Principal_Authenticated_principal_name(const envoy_config_rbac_v3_Principal_Authenticated *msg) { return UPB_FIELD_AT(msg, const struct envoy_type_matcher_v3_StringMatcher*, UPB_SIZE(0, 0)); }
...
UPB_INLINE void envoy_config_rbac_v3_Principal_Authenticated_set_principal_name(envoy_config_rbac_v3_Principal_Authenticated *msg, struct envoy_type_matcher_v3_StringMatcher* value) {
  UPB_FIELD_AT(msg, struct envoy_type_matcher_v3_StringMatcher*, UPB_SIZE(0, 0)) = value;
}
