...
static const upb_MiniTableSub envoy_config_rbac_v3_RBAC_submsgs[1] = {
  {.submsg = &envoy_config_rbac_v3_RBAC_PoliciesEntry_msg_init},
};

static const upb_MiniTableField envoy_config_rbac_v3_RBAC__fields[2] = {
...
const upb_MiniTable envoy_config_rbac_v3_RBAC_msg_init = {
  ...
  UPB_SIZE(8, 16), 2, kUpb_ExtMode_NonExtendable, 2, UPB_FASTTABLE_MASK(8), 0,
  UPB_FASTTABLE_INIT({
