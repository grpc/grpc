...
static const upb_MiniTableSub envoy_config_bootstrap_v3_Bootstrap_submsgs[26] = {
...
static const upb_MiniTableField envoy_config_bootstrap_v3_Bootstrap__fields[34] = {
  ...
  {5, UPB_SIZE(124, 48), 0, kUpb_NoSub, 9, kUpb_FieldMode_Scalar | (kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  ...
  {18, UPB_SIZE(132, 136), 0, kUpb_NoSub, 9, kUpb_FieldMode_Scalar | (kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  ...
  {24, UPB_SIZE(140, 184), 0, kUpb_NoSub, 9, kUpb_FieldMode_Scalar | (kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  ...
  {33, UPB_SIZE(148, 256), 0, kUpb_NoSub, 9, kUpb_FieldMode_Scalar | (kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
...
const upb_MiniTable envoy_config_bootstrap_v3_Bootstrap_msg_init = {
  ...
  UPB_SIZE(160, 296), 34, kUpb_ExtMode_NonExtendable, 9, UPB_FASTTABLE_MASK(248), 0,
  UPB_FASTTABLE_INIT({
