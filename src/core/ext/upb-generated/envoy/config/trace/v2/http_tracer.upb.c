...
static const upb_msglayout_sub envoy_config_trace_v2_Tracing_submsgs[1] = {
...
static const upb_msglayout_sub envoy_config_trace_v2_Tracing_Http_submsgs[2] = {
...
const upb_msglayout_file envoy_config_trace_v2_http_tracer_proto_upb_file_layout = {
  messages_layout,
  NULL,
  2,
  0,
