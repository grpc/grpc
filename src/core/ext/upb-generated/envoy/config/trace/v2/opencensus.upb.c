...
static const upb_msglayout_sub envoy_config_trace_v2_OpenCensusConfig_submsgs[2] = {
  {.submsg = &envoy_api_v2_core_GrpcService_msginit},
  {.submsg = &opencensus_proto_trace_v1_TraceConfig_msginit},
};

static const upb_msglayout_field envoy_config_trace_v2_OpenCensusConfig__fields[13] = {
...
const upb_msglayout envoy_config_trace_v2_OpenCensusConfig_msginit = {
  &envoy_config_trace_v2_OpenCensusConfig_submsgs[0],
  &envoy_config_trace_v2_OpenCensusConfig__fields[0],
  UPB_SIZE(64, 112), 13, _UPB_MSGEXT_NONE, 6, 255,
};

static const upb_msglayout *messages_layout[1] = {
  &envoy_config_trace_v2_OpenCensusConfig_msginit,
};

const upb_msglayout_file envoy_config_trace_v2_opencensus_proto_upb_file_layout = {
  messages_layout,
  NULL,
  1,
  0,
