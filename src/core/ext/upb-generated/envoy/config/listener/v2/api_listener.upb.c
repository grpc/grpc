...
static const upb_msglayout_sub envoy_config_listener_v2_ApiListener_submsgs[1] = {
...
const upb_msglayout_file envoy_config_listener_v2_api_listener_proto_upb_file_layout = {
  messages_layout,
  NULL,
  1,
  0,
