...
static const upb_MiniTableSub envoy_config_listener_v3_QuicProtocolOptions_submsgs[8] = {
...
static const upb_MiniTableField envoy_config_listener_v3_QuicProtocolOptions__fields[8] = {
