...
static const upb_MiniTable_Sub envoy_config_route_v3_RouteConfiguration_submsgs[7] = {
...
static const upb_MiniTable_Field envoy_config_route_v3_RouteConfiguration__fields[13] = {
  ...
  {2, UPB_SIZE(24, 48), 0, 4, 11, kUpb_FieldMode_Array | (upb_FieldRep_Pointer << upb_FieldRep_Shift)},
  ...
  {7, UPB_SIZE(12, 24), 1, 5, 11, kUpb_FieldMode_Scalar | (upb_FieldRep_Pointer << upb_FieldRep_Shift)},
  {8, UPB_SIZE(44, 88), 0, 0, 9, kUpb_FieldMode_Array | (upb_FieldRep_Pointer << upb_FieldRep_Shift)},
  {9, UPB_SIZE(16, 32), 2, 3, 11, kUpb_FieldMode_Scalar | (upb_FieldRep_Pointer << upb_FieldRep_Shift)},
  {10, UPB_SIZE(1, 1), 0, 0, 8, kUpb_FieldMode_Scalar | (upb_FieldRep_1Byte << upb_FieldRep_Shift)},
  {11, UPB_SIZE(20, 40), 3, 6, 11, kUpb_FieldMode_Scalar | (upb_FieldRep_Pointer << upb_FieldRep_Shift)},
  {12, UPB_SIZE(48, 96), 0, 1, 11, kUpb_FieldMode_Array | (upb_FieldRep_Pointer << upb_FieldRep_Shift)},
  {13, UPB_SIZE(52, 104), 0, 2, 11, kUpb_FieldMode_Array | (upb_FieldRep_Pointer << upb_FieldRep_Shift)},
};
...
const upb_MiniTable envoy_config_route_v3_RouteConfiguration_msginit = {
  ...
  UPB_SIZE(56, 112), 13, upb_ExtMode_NonExtendable, 13, 255, 0,
};
