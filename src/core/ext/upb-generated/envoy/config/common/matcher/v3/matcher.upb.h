...
extern const upb_msglayout envoy_config_common_matcher_v3_Matcher_msginit;
extern const upb_msglayout envoy_config_common_matcher_v3_Matcher_OnMatch_msginit;
extern const upb_msglayout envoy_config_common_matcher_v3_Matcher_MatcherList_msginit;
extern const upb_msglayout envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_msginit;
extern const upb_msglayout envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit;
extern const upb_msglayout envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit;
extern const upb_msglayout envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit;
extern const upb_msglayout envoy_config_common_matcher_v3_Matcher_MatcherTree_msginit;
...
extern const upb_msglayout envoy_config_common_matcher_v3_MatchPredicate_MatchSet_msginit;
extern const upb_msglayout envoy_config_common_matcher_v3_HttpHeadersMatch_msginit;
extern const upb_msglayout envoy_config_common_matcher_v3_HttpGenericBodyMatch_msginit;
extern const upb_msglayout envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_msginit;
...
UPB_INLINE envoy_config_common_matcher_v3_Matcher *envoy_config_common_matcher_v3_Matcher_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_Matcher *)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher *envoy_config_common_matcher_v3_Matcher_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher *envoy_config_common_matcher_v3_Matcher_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_Matcher *ret = envoy_config_common_matcher_v3_Matcher_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_Matcher_serialize(const envoy_config_common_matcher_v3_Matcher *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_Matcher_msginit, arena, len);
}
...
UPB_INLINE const envoy_config_common_matcher_v3_Matcher_OnMatch* envoy_config_common_matcher_v3_Matcher_on_no_match(const envoy_config_common_matcher_v3_Matcher *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(4, 8), const envoy_config_common_matcher_v3_Matcher_OnMatch*); }
...
UPB_INLINE struct envoy_config_common_matcher_v3_Matcher_MatcherList* envoy_config_common_matcher_v3_Matcher_mutable_matcher_list(envoy_config_common_matcher_v3_Matcher *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_Matcher_MatcherList*)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_config_common_matcher_v3_Matcher_MatcherTree* envoy_config_common_matcher_v3_Matcher_mutable_matcher_tree(envoy_config_common_matcher_v3_Matcher *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_Matcher_MatcherTree*)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherTree_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_config_common_matcher_v3_Matcher_OnMatch* envoy_config_common_matcher_v3_Matcher_mutable_on_no_match(envoy_config_common_matcher_v3_Matcher *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_Matcher_OnMatch*)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_OnMatch_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE envoy_config_common_matcher_v3_Matcher_OnMatch *envoy_config_common_matcher_v3_Matcher_OnMatch_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_Matcher_OnMatch *)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_OnMatch_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_OnMatch *envoy_config_common_matcher_v3_Matcher_OnMatch_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_OnMatch_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_OnMatch *envoy_config_common_matcher_v3_Matcher_OnMatch_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_Matcher_OnMatch *ret = envoy_config_common_matcher_v3_Matcher_OnMatch_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_OnMatch_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_Matcher_OnMatch_serialize(const envoy_config_common_matcher_v3_Matcher_OnMatch *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_Matcher_OnMatch_msginit, arena, len);
}
...
UPB_INLINE struct envoy_config_common_matcher_v3_Matcher* envoy_config_common_matcher_v3_Matcher_OnMatch_mutable_matcher(envoy_config_common_matcher_v3_Matcher_OnMatch *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_Matcher*)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList *envoy_config_common_matcher_v3_Matcher_MatcherList_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_Matcher_MatcherList *)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList *envoy_config_common_matcher_v3_Matcher_MatcherList_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherList_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList *envoy_config_common_matcher_v3_Matcher_MatcherList_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_Matcher_MatcherList *ret = envoy_config_common_matcher_v3_Matcher_MatcherList_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherList_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_Matcher_MatcherList_serialize(const envoy_config_common_matcher_v3_Matcher_MatcherList *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_Matcher_MatcherList_msginit, arena, len);
}
...
UPB_INLINE struct envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher* envoy_config_common_matcher_v3_Matcher_MatcherList_add_matchers(envoy_config_common_matcher_v3_Matcher_MatcherList *msg, upb_arena *arena) {
  struct envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher* sub = (struct envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher*)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit, arena);
...
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate *)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate *ret = envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_serialize(const envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_msginit, arena, len);
}
...
UPB_INLINE struct envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate* envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_mutable_single_predicate(envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate*)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList* envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_mutable_or_matcher(envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList*)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate* envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_mutable_not_matcher(envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate*)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *ret = envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_serialize(const envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit, arena, len);
}
...
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *ret = envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_serialize(const envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit, arena, len);
}
...
UPB_INLINE struct envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate* envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_add_predicate(envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *msg, upb_arena *arena) {
  struct envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate* sub = (struct envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate*)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate_msginit, arena);
  bool ok = _upb_array_append_accessor2(
      msg, UPB_SIZE(0, 0), UPB_SIZE(2, 3), &sub, arena);
  if (!ok) return NULL;
  return sub;
...
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher *envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher *)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher *envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher *envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher *ret = envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_serialize(const envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit, arena, len);
}
...
UPB_INLINE const envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate* envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_predicate(const envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(4, 8), const envoy_config_common_matcher_v3_Matcher_MatcherList_Predicate*); }
...
UPB_INLINE const envoy_config_common_matcher_v3_Matcher_OnMatch* envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher_on_match(const envoy_config_common_matcher_v3_Matcher_MatcherList_FieldMatcher *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(8, 16), const envoy_config_common_matcher_v3_Matcher_OnMatch*); }
...
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherTree *envoy_config_common_matcher_v3_Matcher_MatcherTree_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_Matcher_MatcherTree *)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherTree_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherTree *envoy_config_common_matcher_v3_Matcher_MatcherTree_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherTree_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherTree *envoy_config_common_matcher_v3_Matcher_MatcherTree_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_Matcher_MatcherTree *ret = envoy_config_common_matcher_v3_Matcher_MatcherTree_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherTree_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_Matcher_MatcherTree_serialize(const envoy_config_common_matcher_v3_Matcher_MatcherTree *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_Matcher_MatcherTree_msginit, arena, len);
}
...
UPB_INLINE const struct envoy_config_core_v3_TypedExtensionConfig* envoy_config_common_matcher_v3_Matcher_MatcherTree_input(const envoy_config_common_matcher_v3_Matcher_MatcherTree *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(4, 8), const struct envoy_config_core_v3_TypedExtensionConfig*); }
...
UPB_INLINE struct envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap* envoy_config_common_matcher_v3_Matcher_MatcherTree_mutable_exact_match_map(envoy_config_common_matcher_v3_Matcher_MatcherTree *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap*)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap *envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap *)_upb_msg_new(&envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap *envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap *envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap *ret = envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_serialize(const envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_msginit, arena, len);
}
...
UPB_INLINE bool envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_map_get(const envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap *msg, upb_strview key, envoy_config_common_matcher_v3_Matcher_OnMatch* *val) { return _upb_msg_map_get(msg, UPB_SIZE(0, 0), &key, 0, val, sizeof(*val)); }
...
UPB_INLINE bool envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_map_set(envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap *msg, upb_strview key, envoy_config_common_matcher_v3_Matcher_OnMatch* val, upb_arena *a) { return _upb_msg_map_set(msg, UPB_SIZE(0, 0), &key, 0, &val, sizeof(val), a); }
UPB_INLINE bool envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_map_delete(envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap *msg, upb_strview key) { return _upb_msg_map_delete(msg, UPB_SIZE(0, 0), &key, 0); }
...
UPB_INLINE upb_strview envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_MapEntry_key(const envoy_config_common_matcher_v3_Matcher_MatcherTree_MatchMap_MapEntry *msg) {
  upb_strview ret;
...
UPB_INLINE envoy_config_common_matcher_v3_MatchPredicate *envoy_config_common_matcher_v3_MatchPredicate_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_MatchPredicate *)_upb_msg_new(&envoy_config_common_matcher_v3_MatchPredicate_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_MatchPredicate *envoy_config_common_matcher_v3_MatchPredicate_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_MatchPredicate_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_MatchPredicate *envoy_config_common_matcher_v3_MatchPredicate_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_MatchPredicate *ret = envoy_config_common_matcher_v3_MatchPredicate_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_MatchPredicate_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_MatchPredicate_serialize(const envoy_config_common_matcher_v3_MatchPredicate *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_MatchPredicate_msginit, arena, len);
}
...
UPB_INLINE struct envoy_config_common_matcher_v3_MatchPredicate_MatchSet* envoy_config_common_matcher_v3_MatchPredicate_mutable_or_match(envoy_config_common_matcher_v3_MatchPredicate *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_MatchPredicate_MatchSet*)_upb_msg_new(&envoy_config_common_matcher_v3_MatchPredicate_MatchSet_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_config_common_matcher_v3_HttpHeadersMatch* envoy_config_common_matcher_v3_MatchPredicate_mutable_http_request_headers_match(envoy_config_common_matcher_v3_MatchPredicate *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_HttpHeadersMatch*)_upb_msg_new(&envoy_config_common_matcher_v3_HttpHeadersMatch_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_config_common_matcher_v3_HttpGenericBodyMatch* envoy_config_common_matcher_v3_MatchPredicate_mutable_http_request_generic_body_match(envoy_config_common_matcher_v3_MatchPredicate *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_config_common_matcher_v3_HttpGenericBodyMatch*)_upb_msg_new(&envoy_config_common_matcher_v3_HttpGenericBodyMatch_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE envoy_config_common_matcher_v3_MatchPredicate_MatchSet *envoy_config_common_matcher_v3_MatchPredicate_MatchSet_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_MatchPredicate_MatchSet *)_upb_msg_new(&envoy_config_common_matcher_v3_MatchPredicate_MatchSet_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_MatchPredicate_MatchSet *envoy_config_common_matcher_v3_MatchPredicate_MatchSet_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_MatchPredicate_MatchSet_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_MatchPredicate_MatchSet *envoy_config_common_matcher_v3_MatchPredicate_MatchSet_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_MatchPredicate_MatchSet *ret = envoy_config_common_matcher_v3_MatchPredicate_MatchSet_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_MatchPredicate_MatchSet_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_MatchPredicate_MatchSet_serialize(const envoy_config_common_matcher_v3_MatchPredicate_MatchSet *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_MatchPredicate_MatchSet_msginit, arena, len);
}
...
UPB_INLINE struct envoy_config_common_matcher_v3_MatchPredicate* envoy_config_common_matcher_v3_MatchPredicate_MatchSet_add_rules(envoy_config_common_matcher_v3_MatchPredicate_MatchSet *msg, upb_arena *arena) {
  struct envoy_config_common_matcher_v3_MatchPredicate* sub = (struct envoy_config_common_matcher_v3_MatchPredicate*)_upb_msg_new(&envoy_config_common_matcher_v3_MatchPredicate_msginit, arena);
  bool ok = _upb_array_append_accessor2(
      msg, UPB_SIZE(0, 0), UPB_SIZE(2, 3), &sub, arena);
  if (!ok) return NULL;
  return sub;
...
UPB_INLINE envoy_config_common_matcher_v3_HttpHeadersMatch *envoy_config_common_matcher_v3_HttpHeadersMatch_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_HttpHeadersMatch *)_upb_msg_new(&envoy_config_common_matcher_v3_HttpHeadersMatch_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_HttpHeadersMatch *envoy_config_common_matcher_v3_HttpHeadersMatch_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_HttpHeadersMatch_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_HttpHeadersMatch *envoy_config_common_matcher_v3_HttpHeadersMatch_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_HttpHeadersMatch *ret = envoy_config_common_matcher_v3_HttpHeadersMatch_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_HttpHeadersMatch_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_HttpHeadersMatch_serialize(const envoy_config_common_matcher_v3_HttpHeadersMatch *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_HttpHeadersMatch_msginit, arena, len);
}
...
UPB_INLINE envoy_config_common_matcher_v3_HttpGenericBodyMatch *envoy_config_common_matcher_v3_HttpGenericBodyMatch_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_HttpGenericBodyMatch *)_upb_msg_new(&envoy_config_common_matcher_v3_HttpGenericBodyMatch_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_HttpGenericBodyMatch *envoy_config_common_matcher_v3_HttpGenericBodyMatch_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_HttpGenericBodyMatch_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_HttpGenericBodyMatch *envoy_config_common_matcher_v3_HttpGenericBodyMatch_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_HttpGenericBodyMatch *ret = envoy_config_common_matcher_v3_HttpGenericBodyMatch_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_HttpGenericBodyMatch_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_HttpGenericBodyMatch_serialize(const envoy_config_common_matcher_v3_HttpGenericBodyMatch *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_HttpGenericBodyMatch_msginit, arena, len);
}

UPB_INLINE uint32_t envoy_config_common_matcher_v3_HttpGenericBodyMatch_bytes_limit(const envoy_config_common_matcher_v3_HttpGenericBodyMatch *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(0, 0), uint32_t); }
...
UPB_INLINE struct envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch* envoy_config_common_matcher_v3_HttpGenericBodyMatch_add_patterns(envoy_config_common_matcher_v3_HttpGenericBodyMatch *msg, upb_arena *arena) {
  struct envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch* sub = (struct envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch*)_upb_msg_new(&envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_msginit, arena);
  bool ok = _upb_array_append_accessor2(
...
UPB_INLINE envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch *envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_new(upb_arena *arena) {
  return (envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch *)_upb_msg_new(&envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_msginit, arena);
}
UPB_INLINE envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch *envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch *envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_parse_ex(const char *buf, size_t size,
  ...
  envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch *ret = envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_serialize(const envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_msginit, arena, len);
}
...
UPB_INLINE upb_strview envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_string_match(const envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch *msg) { return UPB_READ_ONEOF(msg, upb_strview, UPB_SIZE(0, 0), UPB_SIZE(8, 16), 1, upb_strview_make("", strlen(""))); }
...
UPB_INLINE upb_strview envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_binary_match(const envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch *msg) { return UPB_READ_ONEOF(msg, upb_strview, UPB_SIZE(0, 0), UPB_SIZE(8, 16), 2, upb_strview_make("", strlen(""))); }

UPB_INLINE void envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_set_string_match(envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch *msg, upb_strview value) {
  UPB_WRITE_ONEOF(msg, upb_strview, UPB_SIZE(0, 0), value, UPB_SIZE(8, 16), 1);
}
UPB_INLINE void envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch_set_binary_match(envoy_config_common_matcher_v3_HttpGenericBodyMatch_GenericTextMatch *msg, upb_strview value) {
  UPB_WRITE_ONEOF(msg, upb_strview, UPB_SIZE(0, 0), value, UPB_SIZE(8, 16), 2);
}

extern const upb_msglayout_file envoy_config_common_matcher_v3_matcher_proto_upb_file_layout;
