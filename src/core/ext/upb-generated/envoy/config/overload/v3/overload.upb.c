...
static const upb_msglayout *const envoy_config_overload_v3_OverloadAction_submsgs[1] = {
  &envoy_config_overload_v3_Trigger_msginit,
};

static const upb_msglayout_field envoy_config_overload_v3_OverloadAction__fields[2] = {
  {1, UPB_SIZE(0, 0), 0, 0, 9, 1},
