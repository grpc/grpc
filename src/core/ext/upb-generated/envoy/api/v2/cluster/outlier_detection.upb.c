...
static const upb_msglayout_sub envoy_api_v2_cluster_OutlierDetection_submsgs[2] = {
...
const upb_msglayout envoy_api_v2_cluster_OutlierDetection_msginit = {
  ...
  UPB_SIZE(80, 160), 20, _UPB_MSGEXT_NONE, 20, 255,
};
...
const upb_msglayout_file envoy_api_v2_cluster_outlier_detection_proto_upb_file_layout = {
  messages_layout,
  NULL,
  1,
  0,
