...
UPB_INLINE envoy_api_v2_cluster_OutlierDetection *envoy_api_v2_cluster_OutlierDetection_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_api_v2_cluster_OutlierDetection_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_api_v2_cluster_OutlierDetection *envoy_api_v2_cluster_OutlierDetection_parse_ex(const char *buf, size_t size,
                           const upb_extreg *extreg, int options,
                           upb_arena *arena) {
  envoy_api_v2_cluster_OutlierDetection *ret = envoy_api_v2_cluster_OutlierDetection_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_api_v2_cluster_OutlierDetection_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_consecutive_5xx(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 1); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_interval(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 2); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_base_ejection_time(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 3); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_max_ejection_percent(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 4); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_enforcing_consecutive_5xx(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 5); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_enforcing_success_rate(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 6); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_success_rate_minimum_hosts(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 7); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_success_rate_request_volume(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 8); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_success_rate_stdev_factor(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 9); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_consecutive_gateway_failure(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 10); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_enforcing_consecutive_gateway_failure(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 11); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_split_external_local_origin_errors(const envoy_api_v2_cluster_OutlierDetection *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(3, 3), bool); }
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_consecutive_local_origin_failure(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 12); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_enforcing_consecutive_local_origin_failure(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 13); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_enforcing_local_origin_success_rate(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 14); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_failure_percentage_threshold(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 15); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_enforcing_failure_percentage(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 16); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_enforcing_failure_percentage_local_origin(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 17); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_failure_percentage_minimum_hosts(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 18); }
...
UPB_INLINE bool envoy_api_v2_cluster_OutlierDetection_has_failure_percentage_request_volume(const envoy_api_v2_cluster_OutlierDetection *msg) { return _upb_hasbit(msg, 19); }
...
extern const upb_msglayout_file envoy_api_v2_cluster_outlier_detection_proto_upb_file_layout;
