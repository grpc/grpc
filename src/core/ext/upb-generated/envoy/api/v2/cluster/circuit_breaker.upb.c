...
static const upb_msglayout_sub envoy_api_v2_cluster_CircuitBreakers_submsgs[1] = {
  {.submsg = &envoy_api_v2_cluster_CircuitBreakers_Thresholds_msginit},
};
...
static const upb_msglayout_sub envoy_api_v2_cluster_CircuitBreakers_Thresholds_submsgs[2] = {
  {.submsg = &envoy_api_v2_cluster_CircuitBreakers_Thresholds_RetryBudget_msginit},
...
static const upb_msglayout_sub envoy_api_v2_cluster_CircuitBreakers_Thresholds_RetryBudget_submsgs[2] = {
...
const upb_msglayout_file envoy_api_v2_cluster_circuit_breaker_proto_upb_file_layout = {
  messages_layout,
  NULL,
  3,
  0,
