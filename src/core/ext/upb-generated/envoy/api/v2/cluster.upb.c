...
static const upb_msglayout_field envoy_api_v2_Cluster__fields[45] = {
  ...
  {2, UPB_SIZE(168, 304), UPB_SIZE(-176, -312), 0, 14, 1},
  ...
  {23, UPB_SIZE(180, 320), UPB_SIZE(-184, -328), 8, 11, 1},
  ...
  {34, UPB_SIZE(180, 320), UPB_SIZE(-184, -328), 6, 11, 1},
  {35, UPB_SIZE(152, 272), 0, 3, 11, _UPB_LABEL_MAP},
  {36, UPB_SIZE(156, 280), 0, 10, 11, _UPB_LABEL_MAP},
  {37, UPB_SIZE(180, 320), UPB_SIZE(-184, -328), 5, 11, 1},
  {38, UPB_SIZE(168, 304), UPB_SIZE(-176, -312), 1, 11, 1},
...
static const upb_msglayout_field envoy_api_v2_Cluster_CommonLbConfig__fields[7] = {
  ...
  {2, UPB_SIZE(16, 32), UPB_SIZE(-20, -40), 2, 11, 1},
  {3, UPB_SIZE(16, 32), UPB_SIZE(-20, -40), 1, 11, 1},
