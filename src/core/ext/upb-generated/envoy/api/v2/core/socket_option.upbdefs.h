...
#ifndef ENVOY_API_V2_CORE_SOCKET_OPTION_PROTO_UPBDEFS_H_
...
UPB_INLINE const upb_msgdef *envoy_api_v2_core_SocketOption_getmsgdef(upb_symtab *s) {
  _upb_symtab_loaddefinit(s, &envoy_api_v2_core_socket_option_proto_upbdefinit);
...
#endif  /* ENVOY_API_V2_CORE_SOCKET_OPTION_PROTO_UPBDEFS_H_ */
