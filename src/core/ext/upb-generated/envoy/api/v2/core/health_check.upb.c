...
static const upb_msglayout_field envoy_api_v2_core_HealthCheck__fields[17] = {
  {1, UPB_SIZE(16, 32), 0, 5, 11, 1},
  {2, UPB_SIZE(20, 40), 0, 5, 11, 1},
  {3, UPB_SIZE(24, 48), 0, 5, 11, 1},
  {4, UPB_SIZE(28, 56), 0, 6, 11, 1},
  {5, UPB_SIZE(32, 64), 0, 6, 11, 1},
  {6, UPB_SIZE(36, 72), 0, 6, 11, 1},
  {7, UPB_SIZE(40, 80), 0, 4, 11, 1},
  {8, UPB_SIZE(60, 120), UPB_SIZE(-65, -129), 2, 11, 1},
  {9, UPB_SIZE(60, 120), UPB_SIZE(-65, -129), 3, 11, 1},
  {11, UPB_SIZE(60, 120), UPB_SIZE(-65, -129), 1, 11, 1},
  {12, UPB_SIZE(44, 88), 0, 5, 11, 1},
  {13, UPB_SIZE(60, 120), UPB_SIZE(-65, -129), 0, 11, 1},
  {14, UPB_SIZE(48, 96), 0, 5, 11, 1},
  {15, UPB_SIZE(52, 104), 0, 5, 11, 1},
  {16, UPB_SIZE(56, 112), 0, 5, 11, 1},
  {17, UPB_SIZE(8, 16), 0, 0, 9, 1},
...
static const upb_msglayout_field envoy_api_v2_core_HealthCheck_HttpHealthCheck__fields[8] = {
  ...
  {2, UPB_SIZE(16, 32), 0, 0, 9, 1},
  {3, UPB_SIZE(32, 64), 0, 1, 11, 1},
  {4, UPB_SIZE(36, 72), 0, 1, 11, 1},
