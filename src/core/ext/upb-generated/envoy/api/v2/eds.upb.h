...
UPB_INLINE envoy_api_v2_ClusterLoadAssignment_NamedEndpointsEntry *envoy_api_v2_ClusterLoadAssignment_NamedEndpointsEntry_parsenew(upb_strview buf, upb_arena *arena) {
  ...
  return (ret && upb_decode(buf, ret, &envoy_api_v2_ClusterLoadAssignment_NamedEndpointsEntry_msginit)) ? ret : NULL;
}
