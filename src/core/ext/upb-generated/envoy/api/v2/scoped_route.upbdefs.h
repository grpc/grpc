...
#ifndef ENVOY_API_V2_SCOPED_ROUTE_PROTO_UPBDEFS_H_
#define ENVOY_API_V2_SCOPED_ROUTE_PROTO_UPBDEFS_H_
...
UPB_INLINE const upb_msgdef *envoy_api_v2_ScopedRouteConfiguration_getmsgdef(upb_symtab *s) {
  _upb_symtab_loaddefinit(s, &envoy_api_v2_scoped_route_proto_upbdefinit);
...
#endif  /* ENVOY_API_V2_SCOPED_ROUTE_PROTO_UPBDEFS_H_ */
