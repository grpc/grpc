...
static const upb_msglayout_field envoy_admin_v2alpha_Memory__fields[6] = {
...
const upb_msglayout envoy_admin_v2alpha_Memory_msginit = {
  NULL,
  &envoy_admin_v2alpha_Memory__fields[0],
  UPB_SIZE(48, 48), 6, _UPB_MSGEXT_NONE, 6, 255,
};

static const upb_msglayout *messages_layout[1] = {
  &envoy_admin_v2alpha_Memory_msginit,
};

const upb_msglayout_file envoy_admin_v2alpha_memory_proto_upb_file_layout = {
  messages_layout,
  NULL,
  1,
  0,
