...
UPB_INLINE envoy_type_tracing_v2_CustomTag *envoy_type_tracing_v2_CustomTag_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_type_tracing_v2_CustomTag_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_type_tracing_v2_CustomTag *envoy_type_tracing_v2_CustomTag_parse_ex(const char *buf, size_t size,
                           const upb_extreg *extreg, int options,
                           upb_arena *arena) {
  envoy_type_tracing_v2_CustomTag *ret = envoy_type_tracing_v2_CustomTag_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_type_tracing_v2_CustomTag_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
...
UPB_INLINE envoy_type_tracing_v2_CustomTag_Literal *envoy_type_tracing_v2_CustomTag_Literal_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_type_tracing_v2_CustomTag_Literal_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_type_tracing_v2_CustomTag_Literal *envoy_type_tracing_v2_CustomTag_Literal_parse_ex(const char *buf, size_t size,
                           const upb_extreg *extreg, int options,
                           upb_arena *arena) {
  envoy_type_tracing_v2_CustomTag_Literal *ret = envoy_type_tracing_v2_CustomTag_Literal_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_type_tracing_v2_CustomTag_Literal_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
...
UPB_INLINE upb_strview envoy_type_tracing_v2_CustomTag_Literal_value(const envoy_type_tracing_v2_CustomTag_Literal *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(0, 0), upb_strview); }
...
UPB_INLINE envoy_type_tracing_v2_CustomTag_Environment *envoy_type_tracing_v2_CustomTag_Environment_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_type_tracing_v2_CustomTag_Environment_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_type_tracing_v2_CustomTag_Environment *envoy_type_tracing_v2_CustomTag_Environment_parse_ex(const char *buf, size_t size,
                           const upb_extreg *extreg, int options,
                           upb_arena *arena) {
  envoy_type_tracing_v2_CustomTag_Environment *ret = envoy_type_tracing_v2_CustomTag_Environment_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_type_tracing_v2_CustomTag_Environment_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
...
UPB_INLINE upb_strview envoy_type_tracing_v2_CustomTag_Environment_name(const envoy_type_tracing_v2_CustomTag_Environment *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(0, 0), upb_strview); }
UPB_INLINE upb_strview envoy_type_tracing_v2_CustomTag_Environment_default_value(const envoy_type_tracing_v2_CustomTag_Environment *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(8, 16), upb_strview); }
...
UPB_INLINE envoy_type_tracing_v2_CustomTag_Header *envoy_type_tracing_v2_CustomTag_Header_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_type_tracing_v2_CustomTag_Header_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_type_tracing_v2_CustomTag_Header *envoy_type_tracing_v2_CustomTag_Header_parse_ex(const char *buf, size_t size,
                           const upb_extreg *extreg, int options,
                           upb_arena *arena) {
  envoy_type_tracing_v2_CustomTag_Header *ret = envoy_type_tracing_v2_CustomTag_Header_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_type_tracing_v2_CustomTag_Header_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
...
UPB_INLINE upb_strview envoy_type_tracing_v2_CustomTag_Header_name(const envoy_type_tracing_v2_CustomTag_Header *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(0, 0), upb_strview); }
UPB_INLINE upb_strview envoy_type_tracing_v2_CustomTag_Header_default_value(const envoy_type_tracing_v2_CustomTag_Header *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(8, 16), upb_strview); }
...
UPB_INLINE envoy_type_tracing_v2_CustomTag_Metadata *envoy_type_tracing_v2_CustomTag_Metadata_parse(const char *buf, size_t size,
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &envoy_type_tracing_v2_CustomTag_Metadata_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE envoy_type_tracing_v2_CustomTag_Metadata *envoy_type_tracing_v2_CustomTag_Metadata_parse_ex(const char *buf, size_t size,
                           const upb_extreg *extreg, int options,
                           upb_arena *arena) {
  envoy_type_tracing_v2_CustomTag_Metadata *ret = envoy_type_tracing_v2_CustomTag_Metadata_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &envoy_type_tracing_v2_CustomTag_Metadata_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
...
UPB_INLINE bool envoy_type_tracing_v2_CustomTag_Metadata_has_kind(const envoy_type_tracing_v2_CustomTag_Metadata *msg) { return _upb_hasbit(msg, 1); }
UPB_INLINE const struct envoy_type_metadata_v2_MetadataKind* envoy_type_tracing_v2_CustomTag_Metadata_kind(const envoy_type_tracing_v2_CustomTag_Metadata *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(12, 24), const struct envoy_type_metadata_v2_MetadataKind*); }
UPB_INLINE bool envoy_type_tracing_v2_CustomTag_Metadata_has_metadata_key(const envoy_type_tracing_v2_CustomTag_Metadata *msg) { return _upb_hasbit(msg, 2); }
UPB_INLINE const struct envoy_type_metadata_v2_MetadataKey* envoy_type_tracing_v2_CustomTag_Metadata_metadata_key(const envoy_type_tracing_v2_CustomTag_Metadata *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(16, 32), const struct envoy_type_metadata_v2_MetadataKey*); }
UPB_INLINE upb_strview envoy_type_tracing_v2_CustomTag_Metadata_default_value(const envoy_type_tracing_v2_CustomTag_Metadata *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(4, 8), upb_strview); }
...
UPB_INLINE void envoy_type_tracing_v2_CustomTag_Metadata_set_kind(envoy_type_tracing_v2_CustomTag_Metadata *msg, struct envoy_type_metadata_v2_MetadataKind* value) {
  _upb_sethas(msg, 1);
  *UPB_PTR_AT(msg, UPB_SIZE(12, 24), struct envoy_type_metadata_v2_MetadataKind*) = value;
}
...
UPB_INLINE void envoy_type_tracing_v2_CustomTag_Metadata_set_metadata_key(envoy_type_tracing_v2_CustomTag_Metadata *msg, struct envoy_type_metadata_v2_MetadataKey* value) {
  _upb_sethas(msg, 2);
  *UPB_PTR_AT(msg, UPB_SIZE(16, 32), struct envoy_type_metadata_v2_MetadataKey*) = value;
}
...
extern const upb_msglayout_file envoy_type_tracing_v2_custom_tag_proto_upb_file_layout;
