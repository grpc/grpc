...
static const upb_msglayout_sub envoy_type_metadata_v2_MetadataKey_submsgs[1] = {
  {.submsg = &envoy_type_metadata_v2_MetadataKey_PathSegment_msginit},
};
...
static const upb_msglayout_sub envoy_type_metadata_v2_MetadataKind_submsgs[4] = {
  {.submsg = &envoy_type_metadata_v2_MetadataKind_Cluster_msginit},
  {.submsg = &envoy_type_metadata_v2_MetadataKind_Host_msginit},
  {.submsg = &envoy_type_metadata_v2_MetadataKind_Request_msginit},
  {.submsg = &envoy_type_metadata_v2_MetadataKind_Route_msginit},
};
...
const upb_msglayout_file envoy_type_metadata_v2_metadata_proto_upb_file_layout = {
  messages_layout,
  NULL,
  7,
  0,
