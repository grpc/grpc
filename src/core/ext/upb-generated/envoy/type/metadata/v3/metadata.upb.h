...
UPB_INLINE envoy_type_metadata_v3_MetadataKey *envoy_type_metadata_v3_MetadataKey_new(upb_arena *arena) {
  return (envoy_type_metadata_v3_MetadataKey *)upb_msg_new(&envoy_type_metadata_v3_MetadataKey_msginit, arena);
}
...
UPB_INLINE upb_strview envoy_type_metadata_v3_MetadataKey_key(const envoy_type_metadata_v3_MetadataKey *msg) { return UPB_FIELD_AT(msg, upb_strview, UPB_SIZE(0, 0)); }
...
UPB_INLINE envoy_type_metadata_v3_MetadataKey_PathSegment** envoy_type_metadata_v3_MetadataKey_resize_path(envoy_type_metadata_v3_MetadataKey *msg, size_t len, upb_arena *arena) {
  return (envoy_type_metadata_v3_MetadataKey_PathSegment**)_upb_array_resize_accessor(msg, UPB_SIZE(8, 16), len, UPB_SIZE(4, 8), UPB_TYPE_MESSAGE, arena);
}
UPB_INLINE struct envoy_type_metadata_v3_MetadataKey_PathSegment* envoy_type_metadata_v3_MetadataKey_add_path(envoy_type_metadata_v3_MetadataKey *msg, upb_arena *arena) {
  struct envoy_type_metadata_v3_MetadataKey_PathSegment* sub = (struct envoy_type_metadata_v3_MetadataKey_PathSegment*)upb_msg_new(&envoy_type_metadata_v3_MetadataKey_PathSegment_msginit, arena);
...
UPB_INLINE envoy_type_metadata_v3_MetadataKey_PathSegment *envoy_type_metadata_v3_MetadataKey_PathSegment_new(upb_arena *arena) {
  return (envoy_type_metadata_v3_MetadataKey_PathSegment *)upb_msg_new(&envoy_type_metadata_v3_MetadataKey_PathSegment_msginit, arena);
}
...
UPB_INLINE bool envoy_type_metadata_v3_MetadataKey_PathSegment_has_key(const envoy_type_metadata_v3_MetadataKey_PathSegment *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(8, 16), 1); }
...
UPB_INLINE envoy_type_metadata_v3_MetadataKind *envoy_type_metadata_v3_MetadataKind_new(upb_arena *arena) {
  return (envoy_type_metadata_v3_MetadataKind *)upb_msg_new(&envoy_type_metadata_v3_MetadataKind_msginit, arena);
}
...
UPB_INLINE envoy_type_metadata_v3_MetadataKind_kind_oneofcases envoy_type_metadata_v3_MetadataKind_kind_case(const envoy_type_metadata_v3_MetadataKind* msg) { return (envoy_type_metadata_v3_MetadataKind_kind_oneofcases)UPB_FIELD_AT(msg, int32_t, UPB_SIZE(4, 8)); }

UPB_INLINE bool envoy_type_metadata_v3_MetadataKind_has_request(const envoy_type_metadata_v3_MetadataKind *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 1); }
...
UPB_INLINE bool envoy_type_metadata_v3_MetadataKind_has_route(const envoy_type_metadata_v3_MetadataKind *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 2); }
...
UPB_INLINE bool envoy_type_metadata_v3_MetadataKind_has_cluster(const envoy_type_metadata_v3_MetadataKind *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 3); }
...
UPB_INLINE bool envoy_type_metadata_v3_MetadataKind_has_host(const envoy_type_metadata_v3_MetadataKind *msg) { return _upb_has_oneof_field(msg, UPB_SIZE(4, 8), 4); }
...
UPB_INLINE struct envoy_type_metadata_v3_MetadataKind_Request* envoy_type_metadata_v3_MetadataKind_mutable_request(envoy_type_metadata_v3_MetadataKind *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_type_metadata_v3_MetadataKind_Request*)upb_msg_new(&envoy_type_metadata_v3_MetadataKind_Request_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_type_metadata_v3_MetadataKind_Route* envoy_type_metadata_v3_MetadataKind_mutable_route(envoy_type_metadata_v3_MetadataKind *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_type_metadata_v3_MetadataKind_Route*)upb_msg_new(&envoy_type_metadata_v3_MetadataKind_Route_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_type_metadata_v3_MetadataKind_Cluster* envoy_type_metadata_v3_MetadataKind_mutable_cluster(envoy_type_metadata_v3_MetadataKind *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_type_metadata_v3_MetadataKind_Cluster*)upb_msg_new(&envoy_type_metadata_v3_MetadataKind_Cluster_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct envoy_type_metadata_v3_MetadataKind_Host* envoy_type_metadata_v3_MetadataKind_mutable_host(envoy_type_metadata_v3_MetadataKind *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct envoy_type_metadata_v3_MetadataKind_Host*)upb_msg_new(&envoy_type_metadata_v3_MetadataKind_Host_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE envoy_type_metadata_v3_MetadataKind_Request *envoy_type_metadata_v3_MetadataKind_Request_new(upb_arena *arena) {
  return (envoy_type_metadata_v3_MetadataKind_Request *)upb_msg_new(&envoy_type_metadata_v3_MetadataKind_Request_msginit, arena);
}
...
UPB_INLINE envoy_type_metadata_v3_MetadataKind_Route *envoy_type_metadata_v3_MetadataKind_Route_new(upb_arena *arena) {
  return (envoy_type_metadata_v3_MetadataKind_Route *)upb_msg_new(&envoy_type_metadata_v3_MetadataKind_Route_msginit, arena);
}
...
UPB_INLINE envoy_type_metadata_v3_MetadataKind_Cluster *envoy_type_metadata_v3_MetadataKind_Cluster_new(upb_arena *arena) {
  return (envoy_type_metadata_v3_MetadataKind_Cluster *)upb_msg_new(&envoy_type_metadata_v3_MetadataKind_Cluster_msginit, arena);
}
...
UPB_INLINE envoy_type_metadata_v3_MetadataKind_Host *envoy_type_metadata_v3_MetadataKind_Host_new(upb_arena *arena) {
  return (envoy_type_metadata_v3_MetadataKind_Host *)upb_msg_new(&envoy_type_metadata_v3_MetadataKind_Host_msginit, arena);
}
