...
extern const upb_msglayout envoy_type_matcher_ValueMatcher_NullMatch_msginit;
extern const upb_msglayout envoy_type_matcher_ListMatcher_msginit;

static const upb_msglayout *layouts[3] = {
  &envoy_type_matcher_ValueMatcher_msginit,
  &envoy_type_matcher_ValueMatcher_NullMatch_msginit,
  &envoy_type_matcher_ListMatcher_msginit,
};
