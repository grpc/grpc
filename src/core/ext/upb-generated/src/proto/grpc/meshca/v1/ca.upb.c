...
#include <stddef.h>
#include "upb/msg.h"
#include "src/proto/grpc/meshca/v1/ca.upb.h"
...
static const upb_msglayout_field google_security_meshca_v1_MeshCertificateRequest__fields[4] = {
  {1, UPB_SIZE(0, 0), 0, 0, 9, 1},
  {2, UPB_SIZE(8, 16), 0, 0, 9, 1},
  {3, UPB_SIZE(24, 48), 0, 0, 11, 1},
