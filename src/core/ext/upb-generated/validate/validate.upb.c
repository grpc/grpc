...
static const upb_msglayout_field validate_StringRules__fields[20] = {
  {1, UPB_SIZE(56, 64), 7, 0, 9, 1},
  {2, UPB_SIZE(8, 8), 1, 0, 4, 1},
  {3, UPB_SIZE(16, 16), 2, 0, 4, 1},
  {4, UPB_SIZE(24, 24), 3, 0, 4, 1},
  {5, UPB_SIZE(32, 32), 4, 0, 4, 1},
  {6, UPB_SIZE(64, 80), 8, 0, 9, 1},
  {7, UPB_SIZE(72, 96), 9, 0, 9, 1},
  {8, UPB_SIZE(80, 112), 10, 0, 9, 1},
  {9, UPB_SIZE(88, 128), 11, 0, 9, 1},
  {10, UPB_SIZE(96, 144), 0, 0, 9, 3},
  {11, UPB_SIZE(100, 152), 0, 0, 9, 3},
  {12, UPB_SIZE(104, 160), UPB_SIZE(-109, -165), 0, 8, 1},
  {13, UPB_SIZE(104, 160), UPB_SIZE(-109, -165), 0, 8, 1},
  {14, UPB_SIZE(104, 160), UPB_SIZE(-109, -165), 0, 8, 1},
  {15, UPB_SIZE(104, 160), UPB_SIZE(-109, -165), 0, 8, 1},
  {16, UPB_SIZE(104, 160), UPB_SIZE(-109, -165), 0, 8, 1},
  {17, UPB_SIZE(104, 160), UPB_SIZE(-109, -165), 0, 8, 1},
  {18, UPB_SIZE(104, 160), UPB_SIZE(-109, -165), 0, 8, 1},
