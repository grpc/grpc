...
static const upb_msglayout_field validate_FieldRules__fields[22] = {
  {1, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 8, 11, 1},
  {2, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 3, 11, 1},
  {3, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 9, 11, 1},
  {4, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 10, 11, 1},
  {5, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 20, 11, 1},
  {6, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 21, 11, 1},
  {7, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 16, 11, 1},
  {8, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 17, 11, 1},
  {9, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 6, 11, 1},
  {10, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 7, 11, 1},
  {11, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 14, 11, 1},
  {12, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 15, 11, 1},
  {13, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 1, 11, 1},
  {14, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 18, 11, 1},
  {15, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 2, 11, 1},
  {16, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 5, 11, 1},
  {17, UPB_SIZE(4, 8), 1, 12, 11, 1},
  {18, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 13, 11, 1},
  {19, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 11, 11, 1},
  {20, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 0, 11, 1},
  {21, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 4, 11, 1},
  {22, UPB_SIZE(8, 16), UPB_SIZE(-12, -24), 19, 11, 1},
};
...
static const upb_msglayout_field validate_StringRules__fields[25] = {
  ...
  {12, UPB_SIZE(120, 176), UPB_SIZE(-128, -184), 0, 8, 1},
  {13, UPB_SIZE(120, 176), UPB_SIZE(-128, -184), 0, 8, 1},
  {14, UPB_SIZE(120, 176), UPB_SIZE(-128, -184), 0, 8, 1},
  {15, UPB_SIZE(120, 176), UPB_SIZE(-128, -184), 0, 8, 1},
  {16, UPB_SIZE(120, 176), UPB_SIZE(-128, -184), 0, 8, 1},
  {17, UPB_SIZE(120, 176), UPB_SIZE(-128, -184), 0, 8, 1},
  {18, UPB_SIZE(120, 176), UPB_SIZE(-128, -184), 0, 8, 1},
  {19, UPB_SIZE(40, 40), 5, 0, 4, 1},
  {20, UPB_SIZE(48, 48), 6, 0, 4, 1},
  {21, UPB_SIZE(120, 176), UPB_SIZE(-128, -184), 0, 8, 1},
  {22, UPB_SIZE(120, 176), UPB_SIZE(-128, -184), 0, 8, 1},
  {23, UPB_SIZE(100, 144), 13, 0, 9, 1},
  {24, UPB_SIZE(120, 176), UPB_SIZE(-128, -184), 0, 14, 1},
...
static const upb_msglayout_field validate_BytesRules__fields[13] = {
  ...
  {10, UPB_SIZE(80, 128), UPB_SIZE(-84, -132), 0, 8, 1},
  {11, UPB_SIZE(80, 128), UPB_SIZE(-84, -132), 0, 8, 1},
  {12, UPB_SIZE(80, 128), UPB_SIZE(-84, -132), 0, 8, 1},
