...
static const upb_msglayout_field google_api_HttpRule__fields[10] = {
  ...
  {2, UPB_SIZE(32, 64), UPB_SIZE(-41, -81), 0, 9, 1},
  {3, UPB_SIZE(32, 64), UPB_SIZE(-41, -81), 0, 9, 1},
  {4, UPB_SIZE(32, 64), UPB_SIZE(-41, -81), 0, 9, 1},
  {5, UPB_SIZE(32, 64), UPB_SIZE(-41, -81), 0, 9, 1},
  {6, UPB_SIZE(32, 64), UPB_SIZE(-41, -81), 0, 9, 1},
  {7, UPB_SIZE(8, 16), 0, 0, 9, 1},
  {8, UPB_SIZE(32, 64), UPB_SIZE(-41, -81), 0, 11, 1},
