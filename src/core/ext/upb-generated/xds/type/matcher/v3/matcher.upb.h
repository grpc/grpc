...
extern const upb_msglayout xds_type_matcher_v3_Matcher_msginit;
...
extern const upb_msglayout xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit;
extern const upb_msglayout xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit;
extern const upb_msglayout xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit;
extern const upb_msglayout xds_type_matcher_v3_Matcher_MatcherTree_msginit;
extern const upb_msglayout xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_msginit;
...
extern const upb_msglayout xds_core_v3_TypedExtensionConfig_msginit;
...
UPB_INLINE xds_type_matcher_v3_Matcher *xds_type_matcher_v3_Matcher_new(upb_arena *arena) {
  return (xds_type_matcher_v3_Matcher *)_upb_msg_new(&xds_type_matcher_v3_Matcher_msginit, arena);
}
UPB_INLINE xds_type_matcher_v3_Matcher *xds_type_matcher_v3_Matcher_parse(const char *buf, size_t size,
                        upb_arena *arena) {
  xds_type_matcher_v3_Matcher *ret = xds_type_matcher_v3_Matcher_new(arena);
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE xds_type_matcher_v3_Matcher *xds_type_matcher_v3_Matcher_parse_ex(const char *buf, size_t size,
  ...
  xds_type_matcher_v3_Matcher *ret = xds_type_matcher_v3_Matcher_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *xds_type_matcher_v3_Matcher_serialize(const xds_type_matcher_v3_Matcher *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &xds_type_matcher_v3_Matcher_msginit, arena, len);
}
...
UPB_INLINE const xds_type_matcher_v3_Matcher_OnMatch* xds_type_matcher_v3_Matcher_on_no_match(const xds_type_matcher_v3_Matcher *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(4, 8), const xds_type_matcher_v3_Matcher_OnMatch*); }
...
UPB_INLINE struct xds_type_matcher_v3_Matcher_MatcherList* xds_type_matcher_v3_Matcher_mutable_matcher_list(xds_type_matcher_v3_Matcher *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct xds_type_matcher_v3_Matcher_MatcherList*)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct xds_type_matcher_v3_Matcher_MatcherTree* xds_type_matcher_v3_Matcher_mutable_matcher_tree(xds_type_matcher_v3_Matcher *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct xds_type_matcher_v3_Matcher_MatcherTree*)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherTree_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct xds_type_matcher_v3_Matcher_OnMatch* xds_type_matcher_v3_Matcher_mutable_on_no_match(xds_type_matcher_v3_Matcher *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct xds_type_matcher_v3_Matcher_OnMatch*)_upb_msg_new(&xds_type_matcher_v3_Matcher_OnMatch_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE xds_type_matcher_v3_Matcher_OnMatch *xds_type_matcher_v3_Matcher_OnMatch_new(upb_arena *arena) {
  return (xds_type_matcher_v3_Matcher_OnMatch *)_upb_msg_new(&xds_type_matcher_v3_Matcher_OnMatch_msginit, arena);
}
UPB_INLINE xds_type_matcher_v3_Matcher_OnMatch *xds_type_matcher_v3_Matcher_OnMatch_parse(const char *buf, size_t size,
                        upb_arena *arena) {
  xds_type_matcher_v3_Matcher_OnMatch *ret = xds_type_matcher_v3_Matcher_OnMatch_new(arena);
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_OnMatch_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE xds_type_matcher_v3_Matcher_OnMatch *xds_type_matcher_v3_Matcher_OnMatch_parse_ex(const char *buf, size_t size,
  ...
  xds_type_matcher_v3_Matcher_OnMatch *ret = xds_type_matcher_v3_Matcher_OnMatch_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_OnMatch_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *xds_type_matcher_v3_Matcher_OnMatch_serialize(const xds_type_matcher_v3_Matcher_OnMatch *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &xds_type_matcher_v3_Matcher_OnMatch_msginit, arena, len);
}
...
UPB_INLINE struct xds_type_matcher_v3_Matcher* xds_type_matcher_v3_Matcher_OnMatch_mutable_matcher(xds_type_matcher_v3_Matcher_OnMatch *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct xds_type_matcher_v3_Matcher*)_upb_msg_new(&xds_type_matcher_v3_Matcher_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct xds_core_v3_TypedExtensionConfig* xds_type_matcher_v3_Matcher_OnMatch_mutable_action(xds_type_matcher_v3_Matcher_OnMatch *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct xds_core_v3_TypedExtensionConfig*)_upb_msg_new(&xds_core_v3_TypedExtensionConfig_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList *xds_type_matcher_v3_Matcher_MatcherList_new(upb_arena *arena) {
  return (xds_type_matcher_v3_Matcher_MatcherList *)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_msginit, arena);
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList *xds_type_matcher_v3_Matcher_MatcherList_parse(const char *buf, size_t size,
                        upb_arena *arena) {
  xds_type_matcher_v3_Matcher_MatcherList *ret = xds_type_matcher_v3_Matcher_MatcherList_new(arena);
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherList_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList *xds_type_matcher_v3_Matcher_MatcherList_parse_ex(const char *buf, size_t size,
  ...
  xds_type_matcher_v3_Matcher_MatcherList *ret = xds_type_matcher_v3_Matcher_MatcherList_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherList_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *xds_type_matcher_v3_Matcher_MatcherList_serialize(const xds_type_matcher_v3_Matcher_MatcherList *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &xds_type_matcher_v3_Matcher_MatcherList_msginit, arena, len);
}
...
UPB_INLINE struct xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher* xds_type_matcher_v3_Matcher_MatcherList_add_matchers(xds_type_matcher_v3_Matcher_MatcherList *msg, upb_arena *arena) {
  struct xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher* sub = (struct xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher*)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit, arena);
...
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_Predicate *xds_type_matcher_v3_Matcher_MatcherList_Predicate_new(upb_arena *arena) {
  return (xds_type_matcher_v3_Matcher_MatcherList_Predicate *)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_Predicate_msginit, arena);
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_Predicate *xds_type_matcher_v3_Matcher_MatcherList_Predicate_parse(const char *buf, size_t size,
                        upb_arena *arena) {
  xds_type_matcher_v3_Matcher_MatcherList_Predicate *ret = xds_type_matcher_v3_Matcher_MatcherList_Predicate_new(arena);
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherList_Predicate_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_Predicate *xds_type_matcher_v3_Matcher_MatcherList_Predicate_parse_ex(const char *buf, size_t size,
  ...
  xds_type_matcher_v3_Matcher_MatcherList_Predicate *ret = xds_type_matcher_v3_Matcher_MatcherList_Predicate_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherList_Predicate_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *xds_type_matcher_v3_Matcher_MatcherList_Predicate_serialize(const xds_type_matcher_v3_Matcher_MatcherList_Predicate *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &xds_type_matcher_v3_Matcher_MatcherList_Predicate_msginit, arena, len);
}
...
UPB_INLINE struct xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate* xds_type_matcher_v3_Matcher_MatcherList_Predicate_mutable_single_predicate(xds_type_matcher_v3_Matcher_MatcherList_Predicate *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate*)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList* xds_type_matcher_v3_Matcher_MatcherList_Predicate_mutable_or_matcher(xds_type_matcher_v3_Matcher_MatcherList_Predicate *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList*)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE struct xds_type_matcher_v3_Matcher_MatcherList_Predicate* xds_type_matcher_v3_Matcher_MatcherList_Predicate_mutable_not_matcher(xds_type_matcher_v3_Matcher_MatcherList_Predicate *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct xds_type_matcher_v3_Matcher_MatcherList_Predicate*)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_Predicate_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_new(upb_arena *arena) {
  return (xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit, arena);
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_parse(const char *buf, size_t size,
                        upb_arena *arena) {
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_parse_ex(const char *buf, size_t size,
  ...
  xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *ret = xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_serialize(const xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_msginit, arena, len);
}
...
UPB_INLINE const struct xds_core_v3_TypedExtensionConfig* xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_input(const xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(4, 8), const struct xds_core_v3_TypedExtensionConfig*); }
...
UPB_INLINE struct xds_type_matcher_v3_StringMatcher* xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate_mutable_value_match(xds_type_matcher_v3_Matcher_MatcherList_Predicate_SinglePredicate *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct xds_type_matcher_v3_StringMatcher*)_upb_msg_new(&xds_type_matcher_v3_StringMatcher_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_new(upb_arena *arena) {
  return (xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit, arena);
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_parse(const char *buf, size_t size,
                        upb_arena *arena) {
  ...
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_parse_ex(const char *buf, size_t size,
  ...
  xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *ret = xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_serialize(const xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_msginit, arena, len);
}
...
UPB_INLINE struct xds_type_matcher_v3_Matcher_MatcherList_Predicate* xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList_add_predicate(xds_type_matcher_v3_Matcher_MatcherList_Predicate_PredicateList *msg, upb_arena *arena) {
  struct xds_type_matcher_v3_Matcher_MatcherList_Predicate* sub = (struct xds_type_matcher_v3_Matcher_MatcherList_Predicate*)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_Predicate_msginit, arena);
  bool ok = _upb_array_append_accessor2(
      msg, UPB_SIZE(0, 0), UPB_SIZE(2, 3), &sub, arena);
  if (!ok) return NULL;
  return sub;
...
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher *xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_new(upb_arena *arena) {
  return (xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher *)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit, arena);
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher *xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_parse(const char *buf, size_t size,
                        upb_arena *arena) {
  xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher *ret = xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_new(arena);
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher *xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_parse_ex(const char *buf, size_t size,
  ...
  xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher *ret = xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_serialize(const xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_msginit, arena, len);
}
...
UPB_INLINE const xds_type_matcher_v3_Matcher_MatcherList_Predicate* xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_predicate(const xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(4, 8), const xds_type_matcher_v3_Matcher_MatcherList_Predicate*); }
...
UPB_INLINE const xds_type_matcher_v3_Matcher_OnMatch* xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher_on_match(const xds_type_matcher_v3_Matcher_MatcherList_FieldMatcher *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(8, 16), const xds_type_matcher_v3_Matcher_OnMatch*); }
...
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherTree *xds_type_matcher_v3_Matcher_MatcherTree_new(upb_arena *arena) {
  return (xds_type_matcher_v3_Matcher_MatcherTree *)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherTree_msginit, arena);
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherTree *xds_type_matcher_v3_Matcher_MatcherTree_parse(const char *buf, size_t size,
                        upb_arena *arena) {
  xds_type_matcher_v3_Matcher_MatcherTree *ret = xds_type_matcher_v3_Matcher_MatcherTree_new(arena);
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherTree_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherTree *xds_type_matcher_v3_Matcher_MatcherTree_parse_ex(const char *buf, size_t size,
  ...
  xds_type_matcher_v3_Matcher_MatcherTree *ret = xds_type_matcher_v3_Matcher_MatcherTree_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherTree_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *xds_type_matcher_v3_Matcher_MatcherTree_serialize(const xds_type_matcher_v3_Matcher_MatcherTree *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &xds_type_matcher_v3_Matcher_MatcherTree_msginit, arena, len);
}
...
UPB_INLINE const struct xds_core_v3_TypedExtensionConfig* xds_type_matcher_v3_Matcher_MatcherTree_input(const xds_type_matcher_v3_Matcher_MatcherTree *msg) { return *UPB_PTR_AT(msg, UPB_SIZE(4, 8), const struct xds_core_v3_TypedExtensionConfig*); }
...
UPB_INLINE struct xds_type_matcher_v3_Matcher_MatcherTree_MatchMap* xds_type_matcher_v3_Matcher_MatcherTree_mutable_exact_match_map(xds_type_matcher_v3_Matcher_MatcherTree *msg, upb_arena *arena) {
  ...
  if (sub == NULL) {
    sub = (struct xds_type_matcher_v3_Matcher_MatcherTree_MatchMap*)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_msginit, arena);
    if (!sub) return NULL;
...
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherTree_MatchMap *xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_new(upb_arena *arena) {
  return (xds_type_matcher_v3_Matcher_MatcherTree_MatchMap *)_upb_msg_new(&xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_msginit, arena);
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherTree_MatchMap *xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_parse(const char *buf, size_t size,
                        upb_arena *arena) {
  xds_type_matcher_v3_Matcher_MatcherTree_MatchMap *ret = xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_new(arena);
  if (!ret) return NULL;
  if (!upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_msginit, arena)) return NULL;
  return ret;
}
UPB_INLINE xds_type_matcher_v3_Matcher_MatcherTree_MatchMap *xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_parse_ex(const char *buf, size_t size,
  ...
  xds_type_matcher_v3_Matcher_MatcherTree_MatchMap *ret = xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_new(arena);
  if (!ret) return NULL;
  if (!_upb_decode(buf, size, ret, &xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_msginit, extreg, options, arena)) {
    return NULL;
  }
  return ret;
}
UPB_INLINE char *xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_serialize(const xds_type_matcher_v3_Matcher_MatcherTree_MatchMap *msg, upb_arena *arena, size_t *len) {
  return upb_encode(msg, &xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_msginit, arena, len);
}
...
UPB_INLINE bool xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_map_get(const xds_type_matcher_v3_Matcher_MatcherTree_MatchMap *msg, upb_strview key, xds_type_matcher_v3_Matcher_OnMatch* *val) { return _upb_msg_map_get(msg, UPB_SIZE(0, 0), &key, 0, val, sizeof(*val)); }
...
UPB_INLINE bool xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_map_set(xds_type_matcher_v3_Matcher_MatcherTree_MatchMap *msg, upb_strview key, xds_type_matcher_v3_Matcher_OnMatch* val, upb_arena *a) { return _upb_msg_map_set(msg, UPB_SIZE(0, 0), &key, 0, &val, sizeof(val), a); }
UPB_INLINE bool xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_map_delete(xds_type_matcher_v3_Matcher_MatcherTree_MatchMap *msg, upb_strview key) { return _upb_msg_map_delete(msg, UPB_SIZE(0, 0), &key, 0); }
...
UPB_INLINE upb_strview xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_MapEntry_key(const xds_type_matcher_v3_Matcher_MatcherTree_MatchMap_MapEntry *msg) {
  upb_strview ret;
...
extern const upb_msglayout_file xds_type_matcher_v3_matcher_proto_upb_file_layout;
