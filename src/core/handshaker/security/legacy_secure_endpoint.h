...
#ifndef GRPC_SRC_CORE_HANDSHAKER_SECURITY_LEGACY_SECURE_ENDPOINT_H
#define GRPC_SRC_CORE_HANDSHAKER_SECURITY_LEGACY_SECURE_ENDPOINT_H
...
#endif  // GRPC_SRC_CORE_HANDSHAKER_SECURITY_LEGACY_SECURE_ENDPOINT_H
