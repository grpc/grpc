 ...
 public:
  ...
  struct SelectCertificateResult {
    ...
    struct HandshakeHintsResult {
      // Opaque string generated by BoringSSL.
      std::string handshake_hints;
      // The cipher list (in BoringSSL's mini-language format) to set on the
      // server-side SSL object. See
      // https://github.com/google/boringssl/blob/27c62ff54d72b4a2dd55c3c4ace527550a051626/include/openssl/ssl.h#L1630
      // for details.
      std::string cipher_list;
      // The minimum TLS version to set on the server-side SSL object.
      // See go/boringssl-api/ssl.h.html#Protocol-versions.
      uint16_t min_tls_version;
      // The maximum TLS version to set on the server-side SSL object.
      // See go/boringssl-api/ssl.h.html#Protocol-versions.
