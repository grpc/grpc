...
struct grpc_tls_credentials_options
 ...
 public:
  ...
  grpc_tls_verification_key_purpose verification_key_purpose() const { return verification_key_purpose_; }
  ...
  void set_verification_key_purpose(grpc_tls_verification_key_purpose verification_key_purpose) { verification_key_purpose_ = verification_key_purpose; }
  ...
  bool operator==(const grpc_tls_credentials_options& other) const {
    return cert_request_type_ == other.cert_request_type_ &&
      ...
      verification_key_purpose_ == other.verification_key_purpose_ &&
 ...
 private:
  ...
  grpc_tls_verification_key_purpose verification_key_purpose_ = GRPC_TLS_VERIFICATION_KEY_PURPOSE_DEFAULT;
