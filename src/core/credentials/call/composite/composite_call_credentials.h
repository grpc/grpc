...
#ifndef GRPC_SRC_CORE_CREDENTIALS_CALL_COMPOSITE_COMPOSITE_CREDENTIALS_H
#define GRPC_SRC_CORE_CREDENTIALS_CALL_COMPOSITE_COMPOSITE_CREDENTIALS_H
...
#endif  // GRPC_SRC_CORE_CREDENTIALS_CALL_COMPOSITE_COMPOSITE_CREDENTIALS_H
