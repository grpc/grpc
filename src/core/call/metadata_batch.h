...
using MetadataParseErrorFn =
    absl::FunctionRef<void(absl::string_view, const Slice&)>;
...
struct GrpcTarPit {
  ...
  static absl::string_view key() { return "GrpcTarPit"; }
  static MementoType ParseMemento(Slice value, bool will_keep,
                                  MetadataParseErrorFn on_error) {
    abort();
  }
  static ValueType MementoToValue(MementoType x) { return x; }
  static auto Encode(const ValueType& x) { abort(); }
  static auto DisplayValue(const ValueType& x) { return "tarpit"; }
};
struct GrpcCallWasCancelled {
  ...
  static absl::string_view key() { return "GrpcCallWasCancelled"; }
  static MementoType ParseMemento(Slice value, bool will_keep,
                                  MetadataParseErrorFn on_error) {
    abort();
  }
  static ValueType MementoToValue(MementoType x) { return x; }
  static auto Encode(const ValueType& x) { abort(); }
  static auto DisplayValue(const ValueType& x) { return x ? "true" : "false"; }
};
struct GrpcStatusFromWire {
  ...
  using ValueType = bool;
  using MementoType = bool;
  static absl::string_view key() { return "GrpcStatusFromWire"; }
  static MementoType ParseMemento(Slice value, bool will_keep,
                                  MetadataParseErrorFn on_error) {
    abort();
  }
...
struct GrpcTrailersOnly {
  ...
  using ValueType = bool;
  using MementoType = bool;
  static absl::string_view key() { return "GrpcTrailersOnly"; }
  static MementoType ParseMemento(Slice value, bool will_keep,
                                  MetadataParseErrorFn on_error) {
    abort();
  }
...
struct IsTransparentRetry {
  ...
  using ValueType = bool;
  using MementoType = bool;
  static absl::string_view key() { return "IsTransparentRetry"; }
  static MementoType ParseMemento(Slice value, bool will_keep,
                                  MetadataParseErrorFn on_error) {
    abort();
  }
...
struct EndpointLoadMetricsBinMetadata {
  ...
  static ValueType MementoToValue(MementoType x) { return x; }
  static auto Encode(const ValueType& x) { abort(); }
  static auto DisplayValue(const ValueType& x) { return "<unsupported>"; }
};
...
struct PeerString {
  ...
  using ValueType = Slice;
  using MementoType = Slice;
  static absl::string_view key() { return "PeerString"; }
  static MementoType ParseMemento(Slice value, bool will_keep,
                                  MetadataParseErrorFn on_error) {
    abort();
  }
...
struct GrpcStatusContext {
  ...
  static absl::string_view key() { return "GrpcStatusContext"; }
  static MementoType ParseMemento(Slice value, bool will_keep,
                                  MetadataParseErrorFn on_error) {
    abort();
  }
...
struct GrpcRetryPushbackMsMetadata {
  ...
  static auto DisplayValue(const ValueType& x) { return x.millis(); }
};
struct GrpcTimeoutMetadata {
  ...
  static ValueType MementoToValue(MementoType x) { return x; }
  static auto Encode(const ValueType& x) { abort(); }
  static auto DisplayValue(const ValueType& x) { return x.ToString(); }
};
struct GrpcLbClientStatsMetadata {
  ...
  static ValueType MementoToValue(MementoType x) { return x; }
  static auto Encode(const ValueType& x) { abort(); }
  static auto DisplayValue(const ValueType& x) { return "<internal-lb-stats>"; }
};
struct GrpcRegisteredMethod {
  ...
  static absl::string_view key() { return "GrpcRegisteredMethod"; }
  static MementoType ParseMemento(Slice value, bool will_keep,
                                  MetadataParseErrorFn on_error) {
    abort();
  }
...
struct GrpcAcceptEncodingMetadata {
  ...
  static ValueType MementoToValue(MementoType x) { return x; }
  static auto Encode(const ValueType& x) { return x.ToSlice(); }
  static auto DisplayValue(const ValueType& x) { return x.ToString(); }
};
...
struct GrpcStatusMetadata {
  ...
  static ValueType MementoToValue(MementoType x) { return x; }
  static auto Encode(const ValueType& x) { return Slice::FromInt64(x); }
  ...
  struct GrpcStreamNetworkState {
    ...
    using MementoType = ValueType;
    static absl::string_view key() { return "GrpcStreamNetworkState"; }
    static MementoType ParseMemento(Slice value, bool will_keep,
                                    MetadataParseErrorFn on_error) {
      abort();
    }
  ...
  struct TeMetadata {
    ...
    static MementoType ParseMemento(Slice value, bool will_keep,
                                    MetadataParseErrorFn on_error) {
      if (value == StaticSlice::FromStaticString("trailers")) return kTrailers;
      return kInvalid;
    }
    static ValueType MementoToValue(MementoType x) { return x; }
    static auto Encode(const ValueType& x) {
    ...
    static auto DisplayValue(const ValueType& x) {
      if (x == kTrailers) return "trailers";
      return "invalid";
    }
  };
  struct WaitForReady {
    ...
    using ValueType = uint32_t;
    using MementoType = uint32_t;
    static absl::string_view key() { return "WaitForReady"; }
    static MementoType ParseMemento(Slice value, bool will_keep,
                                    MetadataParseErrorFn on_error) {
      abort();
    }
  ...
  class UnknownMap {
   public:
    ...
    std::optional<absl::string_view> GetStringValue(absl::string_view,
                                                    std::string*) const {
      return std::nullopt;
    }
    void Clear() {}
  ...
  struct grpc_metadata_batch {
   ...
   public:
    ...
    grpc_metadata_batch(grpc_metadata_batch&& other) noexcept {
      ...
      // bool_flags_ optimized out by FlagAllocator unified array
      if ((flags_[0] & (1 << 5)) != 0) {
        EndpointLoadMetricsBinMetadata_ =
            std::move(other.EndpointLoadMetricsBinMetadata_);
      }
      if ((flags_[0] & (1 << 6)) != 0) {
        GrpcMessageMetadata_ = std::move(other.GrpcMessageMetadata_);
      }
      if ((flags_[0] & (1 << 7)) != 0) {
        GrpcServerStatsBinMetadata_ =
            std::move(other.GrpcServerStatsBinMetadata_);
      }
      if ((flags_[1] & (1 << 0)) != 0) {
      ...
      if ((flags_[2] & (1 << 5)) != 0) {
        GrpcRetryPushbackMsMetadata_ =
            std::move(other.GrpcRetryPushbackMsMetadata_);
      }
      if ((flags_[2] & (1 << 6)) != 0) {
        GrpcTimeoutMetadata_ = std::move(other.GrpcTimeoutMetadata_);
      }
      if ((flags_[2] & (1 << 7)) != 0) {
        GrpcLbClientStatsMetadata_ =
            std::move(other.GrpcLbClientStatsMetadata_);
      }
      if ((flags_[3] & (1 << 0)) != 0) {
      ...
      if ((flags_[3] & (1 << 2)) != 0) {
        GrpcAcceptEncodingMetadata_ =
            std::move(other.GrpcAcceptEncodingMetadata_);
      }
      if ((flags_[3] & (1 << 3)) != 0) {
        GrpcEncodingMetadata_ = std::move(other.GrpcEncodingMetadata_);
      }
      if ((flags_[3] & (1 << 4)) != 0) {
        GrpcInternalEncodingRequest_ =
            std::move(other.GrpcInternalEncodingRequest_);
      }
      if ((flags_[3] & (1 << 5)) != 0) {
        GrpcPreviousRpcAttemptsMetadata_ =
            std::move(other.GrpcPreviousRpcAttemptsMetadata_);
      }
      if ((flags_[3] & (1 << 6)) != 0) {
    ...
    auto get(Which) const -> std::optional<typename Which::ValueType> {
      ...
      if constexpr (std::is_same_v<Which, TeMetadata>) {
        if ((flags_[4] & (1 << 4)) != 0)
          return std::optional<decltype(TeMetadata_)>(TeMetadata_);
        return std::optional<decltype(TeMetadata_)>();
      }
      if constexpr (std::is_same_v<Which, WaitForReady>) {
        if ((flags_[4] & (1 << 5)) != 0)
          return std::optional<decltype(WaitForReady_)>(WaitForReady_);
    ...
    void Log(absl::FunctionRef<void(absl::string_view, absl::string_view)>
                 log_fn) const {}
    std::string DebugString() const { return ""; }
    bool empty() const { return count() == 0; }
    template <typename Trait, typename Value>
    void Set(Trait, Value) {}
    void Set(const ParsedMetadata<grpc_metadata_batch>&) {}
    size_t TransportSize() const { return 0; }
    template <typename Trait>
    const typename Trait::ValueType* get_pointer(Trait) const {
      return nullptr;
    }
    struct DummyValue {
      int value = 0;
      bool explicitly_set = false;
      void emplace_back(const std::string&) {}
    };
    template <typename Trait>
    DummyValue* GetOrCreatePointer(Trait) {
      static DummyValue dummy;
      return &dummy;
    }
    template <typename Trait>
    typename Trait::ValueType* get_pointer(Trait) {
      return nullptr;
    }
    const std::vector<std::string>* get_pointer(GrpcStatusContext) const {
      return nullptr;
    }
    template <typename Encoder>
    void Encode(Encoder*) const {}
    static ParsedMetadata<grpc_metadata_batch> Parse(absl::string_view, Slice,
                                                     bool, uint32_t,
    ...
    template <typename Trait>
    std::optional<typename Trait::ValueType> Take(Trait) {
      return std::nullopt;
    }
    template <typename Trait>
    void Remove(Trait) {}
  ...
  template <typename Trait>
  Slice MetadataValueAsSlice(const typename Trait::ValueType& value) {
    return Trait::Encode(value);
  }
}  // namespace grpc_core
