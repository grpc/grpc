...
const char* tsi_security_level_to_string(
...
tsi_result tsi_frame_protector_unprotect(
  ...
  if (self == nullptr || self->vtable == nullptr ||
      ...
      protected_frames_bytes_size == nullptr ||
      unprotected_bytes == nullptr ||
      unprotected_bytes_size == nullptr) {
    return TSI_INVALID_ARGUMENT;
  }
  ...
  return self->vtable->unprotect(
      self, protected_frames_bytes, protected_frames_bytes_size,
...
tsi_result tsi_handshaker_get_bytes_to_send_to_peer(
  ...
  return self->vtable->get_bytes_to_send_to_peer(self, bytes,
                                                 bytes_size);
}

tsi_result tsi_handshaker_process_bytes_from_peer(
...
tsi_result tsi_handshaker_result_extract_peer(
...
void tsi_peer_destruct(tsi_peer* self) {
  ...
  if (self->properties != nullptr) {
    tsi_peer_destroy_list_property(self->properties,
                                   self->property_count);
