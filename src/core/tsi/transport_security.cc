...
tsi_result
tsi_frame_protector_protect (tsi_frame_protector * self,
			     ...
			     size_t * protected_output_frames_size)
{
  ...
  if (self->vtable->protect == nullptr)
    return TSI_UNIMPLEMENTED;
  return self->vtable->protect (self, unprotected_bytes,
...
tsi_result
tsi_frame_protector_protect_flush (tsi_frame_protector * self,
				   unsigned char *protected_output_frames,
				   size_t * protected_output_frames_size,
				   size_t * still_pending_size)
{
  ...
  if (self->vtable->protect_flush == nullptr)
    return TSI_UNIMPLEMENTED;
...
tsi_result
tsi_frame_protector_unprotect (tsi_frame_protector * self,
...
tsi_result
tsi_handshaker_get_bytes_to_send_to_peer (tsi_handshaker * self,
					  unsigned char *bytes,
					  size_t * bytes_size)
{
...
tsi_result
tsi_handshaker_process_bytes_from_peer (tsi_handshaker * self,
...
tsi_handshaker_get_result (tsi_handshaker * self)
{
  ...
  if (self->frame_protector_created)
    return TSI_FAILED_PRECONDITION;
  if (self->vtable->get_result == nullptr)
    return TSI_UNIMPLEMENTED;
...
tsi_handshaker_extract_peer (tsi_handshaker * self, tsi_peer * peer)
{
  ...
  if (self->vtable->extract_peer == nullptr)
    return TSI_UNIMPLEMENTED;
  return self->vtable->extract_peer (self, peer);
}

tsi_result
tsi_handshaker_create_frame_protector (tsi_handshaker * self,
				       ...
				       tsi_frame_protector ** protector)
{
  ...
  if (tsi_handshaker_get_result (self) != TSI_OK)
    return TSI_FAILED_PRECONDITION;
  if (self->vtable->create_frame_protector == nullptr)
    return TSI_UNIMPLEMENTED;
  result =
    self->vtable->create_frame_protector (self, max_protected_frame_size,
					  protector);
  if (result == TSI_OK)
    {
...
tsi_result
tsi_handshaker_next (tsi_handshaker * self,
...
tsi_result
tsi_handshaker_result_extract_peer (const tsi_handshaker_result * self,
				    tsi_peer * peer)
{
  if (self == nullptr || self->vtable == nullptr || peer == nullptr)
    {
...
tsi_result
tsi_handshaker_result_create_frame_protector (const tsi_handshaker_result *
					      self,
					      size_t *
...
tsi_result
tsi_handshaker_result_get_unused_bytes (const tsi_handshaker_result * self,
					const unsigned char **bytes,
					size_t * bytes_size)
{
  if (self == nullptr || self->vtable == nullptr || bytes == nullptr ||
  ...
  if (self->vtable->get_unused_bytes == nullptr)
    return TSI_UNIMPLEMENTED;
  return self->vtable->get_unused_bytes (self, bytes, bytes_size);
}

void
tsi_handshaker_result_destroy (tsi_handshaker_result * self)
{
  if (self == nullptr)
    return;
  self->vtable->destroy (self);
...
static void
tsi_peer_destroy_list_property (tsi_peer_property * children,
				size_t child_count)
{
  size_t i;
...
tsi_result
tsi_construct_allocated_string_peer_property (const char *name,
					      size_t value_length,
					      tsi_peer_property * property)
{
  *property = tsi_init_peer_property ();
  if (name != nullptr)
    property->name = gpr_strdup (name);
  if (value_length > 0)
    {
...
tsi_result
tsi_construct_string_peer_property_from_cstring (const char *name,
						 const char *value,
						 tsi_peer_property * property)
{
...
tsi_result
tsi_construct_string_peer_property (const char *name,
				    const char *value,
				    size_t value_length,
				    tsi_peer_property * property)
{
  tsi_result result =
    tsi_construct_allocated_string_peer_property (name, value_length,
						  property);
  if (result != TSI_OK)
    return result;
  if (value_length > 0)
...
tsi_construct_peer (size_t property_count, tsi_peer * peer)
{
  ...
  if (property_count > 0)
    {
      peer->properties =
	(tsi_peer_property *) gpr_zalloc (property_count *
