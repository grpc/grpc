...
tsi_result
tsi_handshaker_result_create_zero_copy_grpc_protector (const
						       ...
						       ** protector)
{
  ...
  return self->vtable->create_zero_copy_grpc_protector (self,
							max_output_protected_frame_size,
							protector);
}
...
tsi_result
tsi_zero_copy_grpc_protector_protect (tsi_zero_copy_grpc_protector * self,
...
void
tsi_zero_copy_grpc_protector_destroy (tsi_zero_copy_grpc_protector * self)
{
  if (self == nullptr)
    return;
