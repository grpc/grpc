...
static void init_openssl(void) {
  ...
  openssl_mutexes = reinterpret_cast<gpr_mu*>(
...
static tsi_result build_alpn_protocol_name_list(
  ...
  *protocol_name_list =
      reinterpret_cast<unsigned char*>(gpr_malloc(*protocol_name_list_length));
...
static tsi_result ssl_protector_protect(tsi_frame_protector* self,
  ...
  int pending_in_ssl = static_cast<int>(BIO_pending(impl->from_ssl));
  if (pending_in_ssl > 0) {
    *unprotected_bytes_size = 0;
...
static tsi_result ssl_protector_protect_flush(
  ...
  pending = static_cast<int>(BIO_pending(impl->from_ssl));
...
static tsi_result ssl_handshaker_get_bytes_to_send_to_peer(tsi_handshaker* self,
  ...
  bytes_read_from_ssl =
      BIO_read(impl->from_ssl, bytes, static_cast<int>(*bytes_size));
...
static tsi_result ssl_handshaker_process_bytes_from_peer(
  ...
  bytes_written_into_ssl_size =
      BIO_write(impl->into_ssl, bytes, static_cast<int>(*bytes_size));
...
static tsi_result ssl_handshaker_extract_peer(tsi_handshaker* self,
  ...
  if (alpn_selected != nullptr) {
    size_t i;
    tsi_peer_property* new_properties = reinterpret_cast<tsi_peer_property*>(
...
static tsi_result ssl_handshaker_create_frame_protector(
  ...
  tsi_ssl_frame_protector* protector_impl =
      reinterpret_cast<tsi_ssl_frame_protector*>(
  ...
  protector_impl->buffer =
      reinterpret_cast<unsigned char*>(gpr_malloc(protector_impl->buffer_size));
...
static tsi_result create_tsi_ssl_handshaker(SSL_CTX* ctx, int is_client,
  ...
  *handshaker = nullptr;
  ...
  impl = reinterpret_cast<tsi_ssl_handshaker*>(gpr_zalloc(sizeof(*impl)));
  impl->ssl = ssl;
...
static int client_handshaker_factory_npn_callback(SSL* ssl, unsigned char** out,
  ...
  tsi_ssl_client_handshaker_factory* factory =
      reinterpret_cast<tsi_ssl_client_handshaker_factory*>(arg);
...
static int ssl_server_handshaker_factory_servername_callback(SSL* ssl, int* ap,
  ...
  tsi_ssl_server_handshaker_factory* impl =
      reinterpret_cast<tsi_ssl_server_handshaker_factory*>(arg);
  size_t i = 0;
...
tsi_result tsi_create_ssl_client_handshaker_factory(
  ...
  *factory = nullptr;
  ...
  impl = reinterpret_cast<tsi_ssl_client_handshaker_factory*>(
...
tsi_result tsi_create_ssl_server_handshaker_factory_ex(
  ...
  *factory = nullptr;
  ...
  impl = reinterpret_cast<tsi_ssl_server_handshaker_factory*>(
      gpr_zalloc(sizeof(*impl)));
  tsi_ssl_handshaker_factory_init(&impl->base);
  impl->base.vtable = &server_handshaker_factory_vtable;

  impl->ssl_contexts = reinterpret_cast<SSL_CTX**>(
      gpr_zalloc(num_key_cert_pairs * sizeof(SSL_CTX*)));
  impl->ssl_context_x509_subject_names = reinterpret_cast<tsi_peer*>(
