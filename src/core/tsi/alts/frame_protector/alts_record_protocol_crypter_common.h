...
/**
 * This file contains common implementation that will be used in both
 * seal and unseal operations.
 */

/**
 * Main struct for alts_record_protocol_crypter that will be used in
 * both seal and unseal operations.
 */
 ...
 * - data: it represents raw data that needs to be sealed in a seal
 * operation or protected data that needs to be unsealed in an unseal
 * operation.
 * - output_size: size of data written to the data buffer after a seal
 * or unseal operation.
 * - error_details: a buffer containing an error message if any of
 * checked inputs is nullptr. It is legal to pass nullptr into
...
/**
 * This method increments the counter within an
 * alts_record_protocol_crypter instance.
 *
 * - rp_crypter: an alts_record_protocol_crypter instance.
 * - error_details: a buffer containing an error message if the method
 * does not function correctly or the counter is wrapped. It is legal to
 * pass nullptr into error_details and otherwise, the parameter should
...
/**
 * This method creates an alts_crypter instance, and populates the
 * fields that are common to both seal and unseal operations.
 *
 * - crypter: a gsec_aead_crypter instance used to perform AEAD
 * decryption. The function does not take ownership of crypter.
 ...
 * gpr_free.
 *
 * On success of creation, the method returns
 * alts_record_protocol_crypter instance. Otherwise, it returns nullptr
 * with its details specified in error_details (if error_details is not
 * nullptr).
 *
 */
...
/**
 * For the following two methods, please refer to the corresponding API
 * in alts_crypter.h for detailed specifications.
 */
