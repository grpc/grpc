...
/**
 * This method creates an integrity-only alts_grpc_record_protocol
 ...
 *-  enable_extra_copy: a flag indicating if the instance uses one-copy
 *instead of zero-copy in the protect operation.
