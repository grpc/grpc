  ...
  return If(
      ...
      [self = WeakRef(), payload_ptr]() mutable {
        return Seq(
            ...
            [self, payload_ptr](StatusFlag status) mutable {
              return If(
                  !status.ok(),
