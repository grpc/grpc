...
#ifndef GRPC_SRC_CORE_UTIL_PROMISE_DETAIL_JOIN_STATE_H
#define GRPC_SRC_CORE_UTIL_PROMISE_DETAIL_JOIN_STATE_H
...
#endif  // GRPC_SRC_CORE_UTIL_PROMISE_DETAIL_JOIN_STATE_H
