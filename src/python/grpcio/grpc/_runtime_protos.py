...
def protos(
    protobuf_path: str,
) -> types.ModuleType:  # pylint: disable=unused-argument
    ...
    """
    return cast(
        types.ModuleType, _call_with_lazy_import("protos", protobuf_path)
    )
...
def services(
    ...
    """
    return cast(
        types.ModuleType, _call_with_lazy_import("services", protobuf_path)
    )
...
def protos_and_services(
    ...
    return cast(
        Tuple[types.ModuleType, types.ModuleType], protos_and_services_modules
    )
