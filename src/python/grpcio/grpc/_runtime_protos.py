...
def _is_grpc_tools_importable() -> bool:
    try:
        import grpc_tools  # pylint: disable=unused-import # pytype: disable=import-error # type: ignore # noqa: PGH003
...
def _call_with_lazy_import(
    ...
    import grpc_tools.protoc  # pytype: disable=import-error # type: ignore # noqa: PGH003
