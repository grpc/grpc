...
def protos(protobuf_path: str) -> Any:  # pylint: disable=unused-argument
...
def services(protobuf_path: str) -> Any:  # pylint: disable=unused-argument
    """Returns a module generated by the indicated .proto file.
...
def protos_and_services(protobuf_path: str) -> Any:  # pylint: disable=unused-argument
