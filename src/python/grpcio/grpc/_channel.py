...
class _InactiveRpcError(grpc.RpcError, grpc.Call, grpc.Future):
    ...
    ) -> Any:  # pylint: disable=unused-argument,C0326
...
def _determine_deadline(user_deadline: Optional[float]) -> Optional[float]:
    ...
    return min(parent_deadline, user_deadline)  # type: ignore # noqa: PGH003
...
class Channel(grpc.Channel):
    ...
    def _process_python_options(
        self,
        python_options: Sequence[ChannelArgumentType],
    ) -> None:
