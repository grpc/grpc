...
def _unwrap_client_call_details(call_details, default_details):
    ...
    try:
        authority = call_details.authority
    except AttributeError:
        authority = default_details.authority

    return method, timeout, metadata, credentials, authority
...
class _UnaryUnaryMultiCallable(grpc.UnaryUnaryMultiCallable):
    ...
    def future(self,
        ...
        client_call_details = _ClientCallDetails(
            self._method, timeout, metadata, credentials, authority)

        def continuation(new_details, request):
            new_method, new_timeout, new_metadata, new_credentials, new_authority = (
