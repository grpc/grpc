...
INSTALL_REQUIRES = ('coverage>=4.0', 'enum34>=1.0.4',
                    ...
                    'grpcio-tools>={version}'.format(
                        version=grpc_version.VERSION),
                    'grpcio-health-checking>={version}'.format(
                        version=grpc_version.VERSION), 'oauth2client>=1.4.7',
                    'protobuf>=3.6.0', 'six>=1.10', 'google-auth>=1.0.0',
                    'requests>=2.14.2')
