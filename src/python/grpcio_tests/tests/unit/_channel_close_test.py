...
class ChannelCloseTest(unittest.TestCase):
    ...
    def test_close_immediately_after_call_invocation(self):
        ...
        multi_callable = channel.stream_stream(_STREAM_URI, _registered_method=True)
    ...
    def test_exception_in_callback(self):
        with grpc.insecure_channel(
            ...
            stream_multi_callable = channel.stream_stream(_STREAM_URI, _registered_method=True)
            endless_iterator = itertools.repeat(b"abc")
            stream_response_iterator = stream_multi_callable(endless_iterator)
            future = channel.unary_unary(_UNARY_URI, _registered_method=True).future(b"abc")
