...
if __name__ == "__main__":
    ...
    if args.scenario == UNSTARTED_SERVER:
        ...
        if args.scenario == IN_FLIGHT_UNARY_UNARY_CALL:
            multi_callable = channel.unary_unary(method, _registered_method=True)
            ...
            multi_callable = channel.unary_stream(method, _registered_method=True)
            ...
            multi_callable = channel.stream_unary(method, _registered_method=True)
            ...
            multi_callable = channel.stream_stream(method, _registered_method=True)
