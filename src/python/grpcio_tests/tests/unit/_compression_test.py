...
def _unary_stream_client(channel, multicallable_kwargs, message):
    multi_callable = channel.unary_stream(_UNARY_STREAM, _registered_method=True)
...
def _stream_unary_client(channel, multicallable_kwargs, message):
    multi_callable = channel.stream_unary(_STREAM_UNARY, _registered_method=True)
...
def _stream_stream_client(channel, multicallable_kwargs, message):
    multi_callable = channel.stream_stream(_STREAM_STREAM, _registered_method=True)
