...
class OpenCensusExporter(_observability.Exporter):
  ...
  def export_tracing_data(
    ...
    for span_data in tracing_data:
      ...
      span_datas = _get_span_data(span_data, span_context, self.default_labels)
  ...
  def _register_open_census_views(self) -> None:
    ...
    self.view_manager.register_view(
        _views.client_sent_compressed_message_bytes_per_rpc(self.default_labels)
    )
    self.view_manager.register_view(
    ...
    self.view_manager.register_view(
        _views.server_sent_compressed_message_bytes_per_rpc(self.default_labels)
    )
    self.view_manager.register_view(
