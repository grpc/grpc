...
#ifndef GRPC_SRC_PYTHON_GRPCIO_OBSERVABILITY_GRPC_OBSERVABILITY_CONSTANTS_H
#define GRPC_SRC_PYTHON_GRPCIO_OBSERVABILITY_GRPC_OBSERVABILITY_CONSTANTS_H
...
#endif // GRPC_SRC_PYTHON_GRPCIO_OBSERVABILITY_GRPC_OBSERVABILITY_CONSTANTS_H
