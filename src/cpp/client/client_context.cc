...
namespace grpc
{
  ...
  class DefaultGlobalClientCallbacks final:public ClientContext::
    GlobalCallbacks
  {
  public:
...
ClientContext::ClientContext ():initial_metadata_received_ (false),
    ...
    propagate_from_call_ (nullptr), initial_metadata_corked_ (false)
  {
  ...
  std::unique_ptr < ClientContext >
    ClientContext::FromServerContext (const ServerContext & context,
  ...
  void ClientContext::
    set_compression_algorithm (grpc_compression_algorithm algorithm)
  {
