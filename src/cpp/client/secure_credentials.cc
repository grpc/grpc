...
std::shared_ptr<ChannelCredentials> SslCredentials(
  ...
  grpc_channel_credentials* c_creds = grpc_ssl_credentials_create(
      ...
      nullptr);
  grpc_ssl_credentials_set_min_tls_version(c_creds,
                                           options.tls_version.min_tls_version);
  grpc_ssl_credentials_set_max_tls_version(c_creds,
                                           options.tls_version.max_tls_version);
