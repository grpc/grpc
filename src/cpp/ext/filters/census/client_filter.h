...
class CensusClientCallData : public CallData {
 public:
  ...
  static void OnDoneRecvTrailingMetadataCb(void* user_data, grpc_error_handle error);

  static void OnDoneSendInitialMetadataCb(void* user_data, grpc_error_handle error);
