...
class ProtoServerReflection final : public reflection::v1alpha::ServerReflection::Service {
 public:
  ...
  Status ServerReflectionInfo(
      ...
      ServerReaderWriter<reflection::v1alpha::ServerReflectionResponse,
                         reflection::v1alpha::ServerReflectionRequest>* stream) override;
 ...
 private:
  ...
  Status GetFileContainingSymbol(ServerContext* context, const std::string& symbol,
                                 reflection::v1alpha::ServerReflectionResponse* response);
  ...
  Status GetAllExtensionNumbers(ServerContext* context, const std::string& type,
                                reflection::v1alpha::ExtensionNumberResponse* response);

  void FillFileDescriptorResponse(const protobuf::FileDescriptor* file_desc,
                                  reflection::v1alpha::ServerReflectionResponse* response,
