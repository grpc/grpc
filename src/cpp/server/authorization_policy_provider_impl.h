...
#ifndef GRPCPP_SECURITY_AUTHORIZATION_POLICY_PROVIDER_IMPL_H
#define GRPCPP_SECURITY_AUTHORIZATION_POLICY_PROVIDER_IMPL_H
...
#endif  // GRPCPP_SECURITY_AUTHORIZATION_POLICY_PROVIDER_IMPL_H
