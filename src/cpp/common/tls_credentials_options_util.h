...
/** The following 2 functions convert the user-provided schedule or
 * cancel functions into C style schedule or cancel functions. These are
 * internal functions, not meant to be accessed by the user. **/
