...
typedef grpc_channel_credentials*(*grpc_gce_channel_credentials_create_type)(grpc_call_credentials* call_credentials, void* reserved);
extern grpc_gce_channel_credentials_create_type grpc_gce_channel_credentials_create_import;
#define grpc_gce_channel_credentials_create grpc_gce_channel_credentials_create_import
