...
typedef void(*grpc_tls_identity_pairs_release_type)(grpc_tls_identity_pairs* pairs);
extern grpc_tls_identity_pairs_release_type grpc_tls_identity_pairs_release_import;
#define grpc_tls_identity_pairs_release grpc_tls_identity_pairs_release_import
