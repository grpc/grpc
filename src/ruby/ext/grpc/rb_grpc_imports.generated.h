...
typedef GRPC_DLL grpc_byte_buffer*(*grpc_raw_byte_buffer_create_type)(grpc_slice* slices, size_t nslices);
extern grpc_raw_byte_buffer_create_type grpc_raw_byte_buffer_create_import;
#define grpc_raw_byte_buffer_create grpc_raw_byte_buffer_create_import
typedef GRPC_DLL grpc_byte_buffer*(*grpc_raw_compressed_byte_buffer_create_type)(grpc_slice* slices, size_t nslices, grpc_compression_algorithm compression);
...
typedef GRPC_DLL grpc_byte_buffer*(*grpc_byte_buffer_copy_type)(grpc_byte_buffer* bb);
extern grpc_byte_buffer_copy_type grpc_byte_buffer_copy_import;
#define grpc_byte_buffer_copy grpc_byte_buffer_copy_import
typedef GRPC_DLL size_t(*grpc_byte_buffer_length_type)(grpc_byte_buffer* bb);
...
typedef GRPC_DLL void(*grpc_byte_buffer_destroy_type)(grpc_byte_buffer* bb);
...
typedef GRPC_DLL int(*grpc_byte_buffer_reader_init_type)(grpc_byte_buffer_reader* reader, grpc_byte_buffer* buffer);
...
typedef GRPC_DLL void(*grpc_byte_buffer_reader_destroy_type)(grpc_byte_buffer_reader* reader);
...
typedef GRPC_DLL int(*grpc_byte_buffer_reader_next_type)(grpc_byte_buffer_reader* reader, grpc_slice* slice);
...
typedef GRPC_DLL int(*grpc_byte_buffer_reader_peek_type)(grpc_byte_buffer_reader* reader, grpc_slice** slice);
...
typedef GRPC_DLL grpc_slice(*grpc_byte_buffer_reader_readall_type)(grpc_byte_buffer_reader* reader);
...
typedef GRPC_DLL grpc_byte_buffer*(*grpc_raw_byte_buffer_from_reader_type)(grpc_byte_buffer_reader* reader);
...
typedef GRPC_DLL int(*grpc_compression_algorithm_is_message_type)(grpc_compression_algorithm algorithm);
...
typedef GRPC_DLL int(*grpc_compression_algorithm_is_stream_type)(grpc_compression_algorithm algorithm);
...
typedef GRPC_DLL int(*grpc_compression_algorithm_parse_type)(grpc_slice name, grpc_compression_algorithm* algorithm);
extern grpc_compression_algorithm_parse_type grpc_compression_algorithm_parse_import;
#define grpc_compression_algorithm_parse grpc_compression_algorithm_parse_import
typedef GRPC_DLL int(*grpc_compression_algorithm_name_type)(grpc_compression_algorithm algorithm, const char** name);
...
typedef GRPC_DLL grpc_compression_algorithm(*grpc_compression_algorithm_for_level_type)(grpc_compression_level level, uint32_t accepted_encodings);
...
typedef GRPC_DLL void(*grpc_compression_options_init_type)(grpc_compression_options* opts);
...
typedef GRPC_DLL void(*grpc_compression_options_enable_algorithm_type)(grpc_compression_options* opts, grpc_compression_algorithm algorithm);
...
typedef GRPC_DLL void(*grpc_compression_options_disable_algorithm_type)(grpc_compression_options* opts, grpc_compression_algorithm algorithm);
...
typedef GRPC_DLL int(*grpc_compression_options_is_algorithm_enabled_type)(const grpc_compression_options* opts, grpc_compression_algorithm algorithm);
...
typedef GRPC_DLL void(*grpc_metadata_array_init_type)(grpc_metadata_array* array);
...
typedef GRPC_DLL void(*grpc_metadata_array_destroy_type)(grpc_metadata_array* array);
...
typedef GRPC_DLL void(*grpc_call_details_init_type)(grpc_call_details* details);
...
typedef GRPC_DLL void(*grpc_call_details_destroy_type)(grpc_call_details* details);
...
typedef GRPC_DLL GRPC_DLL const char*(*grpc_version_string_type)(void);
extern grpc_version_string_type grpc_version_string_import;
#define grpc_version_string grpc_version_string_import
typedef GRPC_DLL const char*(*grpc_g_stands_for_type)(void);
extern grpc_g_stands_for_type grpc_g_stands_for_import;
#define grpc_g_stands_for grpc_g_stands_for_import
typedef GRPC_DLL const grpc_completion_queue_factory*(*grpc_completion_queue_factory_lookup_type)(const grpc_completion_queue_attributes* attributes);
...
typedef GRPC_DLL grpc_completion_queue*(*grpc_completion_queue_create_for_next_type)(void* reserved);
...
typedef GRPC_DLL grpc_completion_queue*(*grpc_completion_queue_create_for_pluck_type)(void* reserved);
...
typedef GRPC_DLL grpc_completion_queue*(*grpc_completion_queue_create_for_callback_type)(grpc_completion_queue_functor* shutdown_callback, void* reserved);
...
typedef GRPC_DLL grpc_completion_queue*(*grpc_completion_queue_create_type)(const grpc_completion_queue_factory* factory, const grpc_completion_queue_attributes* attributes, void* reserved);
extern grpc_completion_queue_create_type grpc_completion_queue_create_import;
#define grpc_completion_queue_create grpc_completion_queue_create_import
typedef GRPC_DLL grpc_event(*grpc_completion_queue_next_type)(grpc_completion_queue* cq, gpr_timespec deadline, void* reserved);
...
typedef GRPC_DLL grpc_event(*grpc_completion_queue_pluck_type)(grpc_completion_queue* cq, void* tag, gpr_timespec deadline, void* reserved);
...
typedef GRPC_DLL void(*grpc_completion_queue_shutdown_type)(grpc_completion_queue* cq);
...
typedef GRPC_DLL void(*grpc_completion_queue_destroy_type)(grpc_completion_queue* cq);
...
typedef GRPC_DLL void(*grpc_completion_queue_thread_local_cache_init_type)(grpc_completion_queue* cq);
...
typedef GRPC_DLL int(*grpc_completion_queue_thread_local_cache_flush_type)(grpc_completion_queue* cq, void** tag, int* ok);
...
typedef GRPC_DLL grpc_connectivity_state(*grpc_channel_check_connectivity_state_type)(grpc_channel* channel, int try_to_connect);
...
typedef GRPC_DLL int(*grpc_channel_num_external_connectivity_watchers_type)(grpc_channel* channel);
...
typedef GRPC_DLL void(*grpc_channel_watch_connectivity_state_type)(grpc_channel* channel, grpc_connectivity_state last_observed_state, gpr_timespec deadline, grpc_completion_queue* cq, void* tag);
...
typedef GRPC_DLL int(*grpc_channel_support_connectivity_watcher_type)(grpc_channel* channel);
...
typedef GRPC_DLL grpc_call*(*grpc_channel_create_call_type)(grpc_channel* channel, grpc_call* parent_call, uint32_t propagation_mask, grpc_completion_queue* completion_queue, grpc_slice method, const grpc_slice* host, gpr_timespec deadline, void* reserved);
...
typedef GRPC_DLL void*(*grpc_channel_register_call_type)(grpc_channel* channel, const char* method, const char* host, void* reserved);
...
typedef GRPC_DLL grpc_call*(*grpc_channel_create_registered_call_type)(grpc_channel* channel, grpc_call* parent_call, uint32_t propagation_mask, grpc_completion_queue* completion_queue, void* registered_call_handle, gpr_timespec deadline, void* reserved);
...
typedef GRPC_DLL void*(*grpc_call_arena_alloc_type)(grpc_call* call, size_t size);
extern grpc_call_arena_alloc_type grpc_call_arena_alloc_import;
#define grpc_call_arena_alloc grpc_call_arena_alloc_import
typedef GRPC_DLL grpc_call_error(*grpc_call_start_batch_type)(grpc_call* call, const grpc_op* ops, size_t nops, void* tag, void* reserved);
extern grpc_call_start_batch_type grpc_call_start_batch_import;
#define grpc_call_start_batch grpc_call_start_batch_import
typedef GRPC_DLL char*(*grpc_call_get_peer_type)(grpc_call* call);
extern grpc_call_get_peer_type grpc_call_get_peer_import;
#define grpc_call_get_peer grpc_call_get_peer_import
typedef GRPC_DLL void(*grpc_census_call_set_context_type)(grpc_call* call, struct census_context* context);
...
typedef GRPC_DLL struct census_context*(*grpc_census_call_get_context_type)(grpc_call* call);
...
typedef GRPC_DLL char*(*grpc_channel_get_target_type)(grpc_channel* channel);
...
typedef GRPC_DLL void(*grpc_channel_get_info_type)(grpc_channel* channel, const grpc_channel_info* channel_info);
extern grpc_channel_get_info_type grpc_channel_get_info_import;
#define grpc_channel_get_info grpc_channel_get_info_import
typedef GRPC_DLL void(*grpc_channel_reset_connect_backoff_type)(grpc_channel* channel);
...
typedef GRPC_DLL void(*grpc_channel_credentials_release_type)(grpc_channel_credentials* creds);
...
typedef GRPC_DLL void(*grpc_server_credentials_release_type)(grpc_server_credentials* creds);
...
typedef GRPC_DLL grpc_channel*(*grpc_channel_create_type)(const char* target, grpc_channel_credentials* creds, const grpc_channel_args* args);
extern grpc_channel_create_type grpc_channel_create_import;
#define grpc_channel_create grpc_channel_create_import
typedef GRPC_DLL grpc_channel*(*grpc_lame_client_channel_create_type)(const char* target, grpc_status_code error_code, const char* error_message);
...
typedef GRPC_DLL void(*grpc_channel_destroy_type)(grpc_channel* channel);
extern grpc_channel_destroy_type grpc_channel_destroy_import;
#define grpc_channel_destroy grpc_channel_destroy_import
typedef GRPC_DLL grpc_call_error(*grpc_call_cancel_type)(grpc_call* call, void* reserved);
extern grpc_call_cancel_type grpc_call_cancel_import;
#define grpc_call_cancel grpc_call_cancel_import
typedef GRPC_DLL grpc_call_error(*grpc_call_cancel_with_status_type)(grpc_call* call, grpc_status_code status, const char* description, void* reserved);
...
typedef GRPC_DLL int(*grpc_call_failed_before_recv_message_type)(const grpc_call* c);
...
typedef GRPC_DLL void(*grpc_call_ref_type)(grpc_call* call);
extern grpc_call_ref_type grpc_call_ref_import;
#define grpc_call_ref grpc_call_ref_import
typedef GRPC_DLL void(*grpc_call_unref_type)(grpc_call* call);
extern grpc_call_unref_type grpc_call_unref_import;
#define grpc_call_unref grpc_call_unref_import
typedef GRPC_DLL grpc_call_error(*grpc_server_request_call_type)(grpc_server* server, grpc_call** call, grpc_call_details* details, grpc_metadata_array* request_metadata, grpc_completion_queue* cq_bound_to_call, grpc_completion_queue* cq_for_notification, void* tag_new);
...
typedef GRPC_DLL void*(*grpc_server_register_method_type)(grpc_server* server, const char* method, const char* host, grpc_server_register_method_payload_handling payload_handling, uint32_t flags);
...
typedef GRPC_DLL grpc_server*(*grpc_server_create_type)(const grpc_channel_args* args, void* reserved);
extern grpc_server_create_type grpc_server_create_import;
#define grpc_server_create grpc_server_create_import
typedef GRPC_DLL void(*grpc_server_register_completion_queue_type)(grpc_server* server, grpc_completion_queue* cq, void* reserved);
extern grpc_server_register_completion_queue_type grpc_server_register_completion_queue_import;
#define grpc_server_register_completion_queue grpc_server_register_completion_queue_import
typedef GRPC_DLL grpc_server_config_fetcher*(*grpc_server_config_fetcher_xds_create_type)(grpc_server_xds_status_notifier notifier, const grpc_channel_args* args);
...
typedef GRPC_DLL void(*grpc_server_config_fetcher_destroy_type)(grpc_server_config_fetcher* config_fetcher);
...
typedef GRPC_DLL void(*grpc_server_set_config_fetcher_type)(grpc_server* server, grpc_server_config_fetcher* config_fetcher);
...
typedef GRPC_DLL int(*grpc_server_add_http2_port_type)(grpc_server* server, const char* addr, grpc_server_credentials* creds);
...
typedef GRPC_DLL void(*grpc_server_start_type)(grpc_server* server);
extern grpc_server_start_type grpc_server_start_import;
#define grpc_server_start grpc_server_start_import
typedef GRPC_DLL void(*grpc_server_shutdown_and_notify_type)(grpc_server* server, grpc_completion_queue* cq, void* tag);
...
typedef GRPC_DLL void(*grpc_server_cancel_all_calls_type)(grpc_server* server);
...
typedef GRPC_DLL void(*grpc_server_destroy_type)(grpc_server* server);
extern grpc_server_destroy_type grpc_server_destroy_import;
#define grpc_server_destroy grpc_server_destroy_import
typedef GRPC_DLL int(*grpc_tracer_set_enabled_type)(const char* name, int enabled);
...
typedef GRPC_DLL int(*grpc_header_key_is_legal_type)(grpc_slice slice);
...
typedef GRPC_DLL int(*grpc_header_nonbin_value_is_legal_type)(grpc_slice slice);
...
typedef GRPC_DLL int(*grpc_is_binary_header_type)(grpc_slice slice);
extern grpc_is_binary_header_type grpc_is_binary_header_import;
#define grpc_is_binary_header grpc_is_binary_header_import
typedef GRPC_DLL const char*(*grpc_call_error_to_string_type)(grpc_call_error error);
extern grpc_call_error_to_string_type grpc_call_error_to_string_import;
#define grpc_call_error_to_string grpc_call_error_to_string_import
typedef GRPC_DLL grpc_resource_quota*(*grpc_resource_quota_create_type)(const char* trace_name);
...
typedef GRPC_DLL void(*grpc_resource_quota_ref_type)(grpc_resource_quota* resource_quota);
...
typedef GRPC_DLL void(*grpc_resource_quota_unref_type)(grpc_resource_quota* resource_quota);
...
typedef GRPC_DLL void(*grpc_resource_quota_resize_type)(grpc_resource_quota* resource_quota, size_t new_size);
...
typedef GRPC_DLL void(*grpc_resource_quota_set_max_threads_type)(grpc_resource_quota* resource_quota, int new_max_threads);
...
typedef GRPC_DLL grpc_slice(*grpc_dump_xds_configs_type)(void);
extern grpc_dump_xds_configs_type grpc_dump_xds_configs_import;
#define grpc_dump_xds_configs grpc_dump_xds_configs_import
typedef GRPC_DLL const grpc_arg_pointer_vtable*(*grpc_resource_quota_arg_vtable_type)(void);
...
typedef GRPC_DLL char*(*grpc_channelz_get_top_channels_type)(intptr_t start_channel_id);
...
typedef GRPC_DLL char*(*grpc_channelz_get_servers_type)(intptr_t start_server_id);
...
typedef GRPC_DLL char*(*grpc_channelz_get_server_type)(intptr_t server_id);
...
typedef GRPC_DLL char*(*grpc_channelz_get_server_sockets_type)(intptr_t server_id, intptr_t start_socket_id, intptr_t max_results);
...
typedef GRPC_DLL char*(*grpc_channelz_get_channel_type)(intptr_t channel_id);
...
typedef GRPC_DLL char*(*grpc_channelz_get_subchannel_type)(intptr_t subchannel_id);
...
typedef GRPC_DLL char*(*grpc_channelz_get_socket_type)(intptr_t socket_id);
...
typedef GRPC_DLL const grpc_arg_pointer_vtable*(*grpc_authorization_policy_provider_arg_vtable_type)(void);
...
typedef GRPC_DLL grpc_channel*(*grpc_channel_create_from_fd_type)(const char* target, int fd, grpc_channel_credentials* creds, const grpc_channel_args* args);
...
typedef GRPC_DLL void(*grpc_server_add_channel_from_fd_type)(grpc_server* server, int fd, grpc_server_credentials* creds);
...
typedef GRPC_DLL GRPC_DLL const grpc_auth_property*(*grpc_auth_property_iterator_next_type)(grpc_auth_property_iterator* it);
extern grpc_auth_property_iterator_next_type grpc_auth_property_iterator_next_import;
#define grpc_auth_property_iterator_next grpc_auth_property_iterator_next_import
typedef GRPC_DLL GRPC_DLL grpc_auth_property_iterator(*grpc_auth_context_property_iterator_type)(const grpc_auth_context* ctx);
...
typedef GRPC_DLL GRPC_DLL grpc_auth_property_iterator(*grpc_auth_context_peer_identity_type)(const grpc_auth_context* ctx);
...
typedef GRPC_DLL GRPC_DLL grpc_auth_property_iterator(*grpc_auth_context_find_properties_by_name_type)(const grpc_auth_context* ctx, const char* name);
...
typedef GRPC_DLL GRPC_DLL const char*(*grpc_auth_context_peer_identity_property_name_type)(const grpc_auth_context* ctx);
...
typedef GRPC_DLL GRPC_DLL int(*grpc_auth_context_peer_is_authenticated_type)(const grpc_auth_context* ctx);
...
typedef GRPC_DLL GRPC_DLL grpc_auth_context*(*grpc_call_auth_context_type)(grpc_call* call);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_auth_context_release_type)(grpc_auth_context* context);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_auth_context_add_property_type)(grpc_auth_context* ctx, const char* name, const char* value, size_t value_length);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_auth_context_add_cstring_property_type)(grpc_auth_context* ctx, const char* name, const char* value);
...
typedef GRPC_DLL GRPC_DLL int(*grpc_auth_context_set_peer_identity_property_name_type)(grpc_auth_context* ctx, const char* name);
...
typedef GRPC_DLL GRPC_DLL grpc_ssl_session_cache*(*grpc_ssl_session_cache_create_lru_type)(size_t capacity);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_ssl_session_cache_destroy_type)(grpc_ssl_session_cache* cache);
...
typedef GRPC_DLL GRPC_DLL grpc_arg(*grpc_ssl_session_cache_create_channel_arg_type)(grpc_ssl_session_cache* cache);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_call_credentials_release_type)(grpc_call_credentials* creds);
...
typedef GRPC_DLL GRPC_DLL grpc_channel_credentials*(*grpc_google_default_credentials_create_type)(grpc_call_credentials* call_credentials);
extern grpc_google_default_credentials_create_type grpc_google_default_credentials_create_import;
#define grpc_google_default_credentials_create grpc_google_default_credentials_create_import
typedef GRPC_DLL GRPC_DLL void(*grpc_set_ssl_roots_override_callback_type)(grpc_ssl_roots_override_callback cb);
...
typedef GRPC_DLL GRPC_DLL grpc_channel_credentials*(*grpc_ssl_credentials_create_type)(const char* pem_root_certs, grpc_ssl_pem_key_cert_pair* pem_key_cert_pair, const verify_peer_options* verify_options, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_channel_credentials*(*grpc_ssl_credentials_create_ex_type)(const char* pem_root_certs, grpc_ssl_pem_key_cert_pair* pem_key_cert_pair, const grpc_ssl_verify_peer_options* verify_options, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_channel_credentials*(*grpc_composite_channel_credentials_create_type)(grpc_channel_credentials* channel_creds, grpc_call_credentials* call_creds, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_call_credentials*(*grpc_composite_call_credentials_create_type)(grpc_call_credentials* creds1, grpc_call_credentials* creds2, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_call_credentials*(*grpc_google_compute_engine_credentials_create_type)(void* reserved);
...
typedef GRPC_DLL GRPC_DLL gpr_timespec(*grpc_max_auth_token_lifetime_type)(void);
...
typedef GRPC_DLL GRPC_DLL grpc_call_credentials*(*grpc_service_account_jwt_access_credentials_create_type)(const char* json_key, gpr_timespec token_lifetime, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_call_credentials*(*grpc_external_account_credentials_create_type)(const char* json_string, const char* scopes_string);
...
typedef GRPC_DLL GRPC_DLL grpc_call_credentials*(*grpc_google_refresh_token_credentials_create_type)(const char* json_refresh_token, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_call_credentials*(*grpc_access_token_credentials_create_type)(const char* access_token, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_call_credentials*(*grpc_google_iam_credentials_create_type)(const char* authorization_token, const char* authority_selector, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_call_credentials*(*grpc_sts_credentials_create_type)(const grpc_sts_credentials_options* options, void* reserved);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_auth_metadata_context_copy_type)(grpc_auth_metadata_context* from, grpc_auth_metadata_context* to);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_auth_metadata_context_reset_type)(grpc_auth_metadata_context* context);
...
typedef GRPC_DLL GRPC_DLL grpc_call_credentials*(*grpc_metadata_credentials_create_from_plugin_type)(grpc_metadata_credentials_plugin plugin, grpc_security_level min_security_level, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_ssl_server_certificate_config*(*grpc_ssl_server_certificate_config_create_type)(const char* pem_root_certs, const grpc_ssl_pem_key_cert_pair* pem_key_cert_pairs, size_t num_key_cert_pairs);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_ssl_server_certificate_config_destroy_type)(grpc_ssl_server_certificate_config* config);
...
typedef GRPC_DLL GRPC_DLL grpc_server_credentials*(*grpc_ssl_server_credentials_create_type)(const char* pem_root_certs, grpc_ssl_pem_key_cert_pair* pem_key_cert_pairs, size_t num_key_cert_pairs, int force_client_auth, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_server_credentials*(*grpc_ssl_server_credentials_create_ex_type)(const char* pem_root_certs, grpc_ssl_pem_key_cert_pair* pem_key_cert_pairs, size_t num_key_cert_pairs, grpc_ssl_client_certificate_request_type client_certificate_request, void* reserved);
...
typedef GRPC_DLL GRPC_DLL grpc_ssl_server_credentials_options*(*grpc_ssl_server_credentials_create_options_using_config_type)(grpc_ssl_client_certificate_request_type client_certificate_request, grpc_ssl_server_certificate_config* certificate_config);
...
typedef GRPC_DLL GRPC_DLL grpc_ssl_server_credentials_options*(*grpc_ssl_server_credentials_create_options_using_config_fetcher_type)(grpc_ssl_client_certificate_request_type client_certificate_request, grpc_ssl_server_certificate_config_callback cb, void* user_data);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_ssl_server_credentials_options_destroy_type)(grpc_ssl_server_credentials_options* options);
...
typedef GRPC_DLL GRPC_DLL grpc_server_credentials*(*grpc_ssl_server_credentials_create_with_options_type)(grpc_ssl_server_credentials_options* options);
...
typedef GRPC_DLL GRPC_DLL grpc_call_error(*grpc_call_set_credentials_type)(grpc_call* call, grpc_call_credentials* creds);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_server_credentials_set_auth_metadata_processor_type)(grpc_server_credentials* creds, grpc_auth_metadata_processor processor);
...
typedef GRPC_DLL GRPC_DLL grpc_alts_credentials_options*(*grpc_alts_credentials_client_options_create_type)(void);
...
typedef GRPC_DLL GRPC_DLL grpc_alts_credentials_options*(*grpc_alts_credentials_server_options_create_type)(void);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_alts_credentials_client_options_add_target_service_account_type)(grpc_alts_credentials_options* options, const char* service_account);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_alts_credentials_options_destroy_type)(grpc_alts_credentials_options* options);
...
typedef GRPC_DLL GRPC_DLL grpc_channel_credentials*(*grpc_alts_credentials_create_type)(const grpc_alts_credentials_options* options);
...
typedef GRPC_DLL GRPC_DLL grpc_server_credentials*(*grpc_alts_server_credentials_create_type)(const grpc_alts_credentials_options* options);
...
typedef GRPC_DLL GRPC_DLL grpc_channel_credentials*(*grpc_local_credentials_create_type)(grpc_local_connect_type type);
...
typedef GRPC_DLL GRPC_DLL grpc_server_credentials*(*grpc_local_server_credentials_create_type)(grpc_local_connect_type type);
...
typedef GRPC_DLL GRPC_DLL grpc_tls_identity_pairs*(*grpc_tls_identity_pairs_create_type)();
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_identity_pairs_add_pair_type)(grpc_tls_identity_pairs* pairs, const char* private_key, const char* cert_chain);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_identity_pairs_destroy_type)(grpc_tls_identity_pairs* pairs);
...
typedef GRPC_DLL GRPC_DLL grpc_tls_certificate_provider*(*grpc_tls_certificate_provider_static_data_create_type)(const char* root_certificate, grpc_tls_identity_pairs* pem_key_cert_pairs);
...
typedef GRPC_DLL GRPC_DLL grpc_tls_certificate_provider*(*grpc_tls_certificate_provider_file_watcher_create_type)(const char* private_key_path, const char* identity_certificate_path, const char* root_cert_path, unsigned int refresh_interval_sec);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_certificate_provider_release_type)(grpc_tls_certificate_provider* provider);
...
typedef GRPC_DLL GRPC_DLL grpc_tls_credentials_options*(*grpc_tls_credentials_options_create_type)(void);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_min_tls_version_type)(grpc_tls_credentials_options* options, grpc_tls_version min_tls_version);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_set_max_tls_version_type)(grpc_tls_credentials_options* options, grpc_tls_version max_tls_version);
...
typedef GRPC_DLL grpc_tls_credentials_options*(*grpc_tls_credentials_options_copy_type)(grpc_tls_credentials_options* options);
...
typedef GRPC_DLL void(*grpc_tls_credentials_options_destroy_type)(grpc_tls_credentials_options* options);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_set_certificate_provider_type)(grpc_tls_credentials_options* options, grpc_tls_certificate_provider* provider);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_watch_root_certs_type)(grpc_tls_credentials_options* options);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_set_root_cert_name_type)(grpc_tls_credentials_options* options, const char* root_cert_name);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_watch_identity_key_cert_pairs_type)(grpc_tls_credentials_options* options);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_set_identity_cert_name_type)(grpc_tls_credentials_options* options, const char* identity_cert_name);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_set_cert_request_type_type)(grpc_tls_credentials_options* options, grpc_ssl_client_certificate_request_type type);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_set_crl_directory_type)(grpc_tls_credentials_options* options, const char* crl_directory);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_set_verify_server_cert_type)(grpc_tls_credentials_options* options, int verify_server_cert);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_set_send_client_ca_list_type)(grpc_tls_credentials_options* options, bool send_client_ca_list);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_set_check_call_host_type)(grpc_tls_credentials_options* options, int check_call_host);
...
typedef GRPC_DLL GRPC_DLL grpc_channel_credentials*(*grpc_insecure_credentials_create_type)();
...
typedef GRPC_DLL GRPC_DLL grpc_server_credentials*(*grpc_insecure_server_credentials_create_type)();
...
typedef GRPC_DLL GRPC_DLL grpc_channel_credentials*(*grpc_xds_credentials_create_type)(grpc_channel_credentials* fallback_credentials);
...
typedef GRPC_DLL GRPC_DLL grpc_server_credentials*(*grpc_xds_server_credentials_create_type)(grpc_server_credentials* fallback_credentials);
...
typedef GRPC_DLL GRPC_DLL grpc_authorization_policy_provider*(*grpc_authorization_policy_provider_static_data_create_type)(const char* authz_policy, grpc_status_code* code, const char** error_details);
...
typedef GRPC_DLL GRPC_DLL grpc_authorization_policy_provider*(*grpc_authorization_policy_provider_file_watcher_create_type)(const char* authz_policy_path, unsigned int refresh_interval_sec, grpc_status_code* code, const char** error_details);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_authorization_policy_provider_release_type)(grpc_authorization_policy_provider* provider);
...
typedef GRPC_DLL GRPC_DLL void(*grpc_tls_credentials_options_set_tls_session_key_log_file_path_type)(grpc_tls_credentials_options* options, const char* path);
...
typedef GRPC_DLL grpc_slice(*grpc_slice_new_with_len_type)(void* p, size_t len, void (*destroy)(void*, size_t));
...
typedef GRPC_DLL grpc_slice(*grpc_slice_malloc_type)(size_t length);
extern grpc_slice_malloc_type grpc_slice_malloc_import;
#define grpc_slice_malloc grpc_slice_malloc_import
typedef GRPC_DLL grpc_slice(*grpc_slice_malloc_large_type)(size_t length);
...
typedef GRPC_DLL grpc_slice(*grpc_slice_from_copied_string_type)(const char* source);
...
typedef GRPC_DLL grpc_slice(*grpc_slice_from_copied_buffer_type)(const char* source, size_t len);
...
typedef GRPC_DLL grpc_slice(*grpc_slice_from_static_string_type)(const char* source);
...
typedef GRPC_DLL grpc_slice(*grpc_slice_from_static_buffer_type)(const void* source, size_t len);
...
typedef GRPC_DLL grpc_slice(*grpc_slice_sub_type)(grpc_slice s, size_t begin, size_t end);
extern grpc_slice_sub_type grpc_slice_sub_import;
#define grpc_slice_sub grpc_slice_sub_import
typedef GRPC_DLL grpc_slice(*grpc_slice_sub_no_ref_type)(grpc_slice s, size_t begin, size_t end);
extern grpc_slice_sub_no_ref_type grpc_slice_sub_no_ref_import;
#define grpc_slice_sub_no_ref grpc_slice_sub_no_ref_import
typedef GRPC_DLL grpc_slice(*grpc_slice_split_tail_type)(grpc_slice* s, size_t split);
extern grpc_slice_split_tail_type grpc_slice_split_tail_import;
#define grpc_slice_split_tail grpc_slice_split_tail_import
typedef GRPC_DLL grpc_slice(*grpc_slice_split_tail_maybe_ref_type)(grpc_slice* s, size_t split, grpc_slice_ref_whom ref_whom);
...
typedef GRPC_DLL grpc_slice(*grpc_slice_dup_type)(grpc_slice a);
extern grpc_slice_dup_type grpc_slice_dup_import;
#define grpc_slice_dup grpc_slice_dup_import
typedef GRPC_DLL char*(*grpc_slice_to_c_string_type)(grpc_slice s);
...
typedef GRPC_DLL void(*grpc_slice_buffer_init_type)(grpc_slice_buffer* sb);
...
typedef GRPC_DLL void(*grpc_slice_buffer_destroy_type)(grpc_slice_buffer* sb);
...
typedef GRPC_DLL void(*grpc_slice_buffer_add_type)(grpc_slice_buffer* sb, grpc_slice slice);
extern grpc_slice_buffer_add_type grpc_slice_buffer_add_import;
#define grpc_slice_buffer_add grpc_slice_buffer_add_import
typedef GRPC_DLL size_t(*grpc_slice_buffer_add_indexed_type)(grpc_slice_buffer* sb, grpc_slice slice);
...
typedef GRPC_DLL void(*grpc_slice_buffer_addn_type)(grpc_slice_buffer* sb, grpc_slice* slices, size_t n);
...
typedef GRPC_DLL uint8_t*(*grpc_slice_buffer_tiny_add_type)(grpc_slice_buffer* sb, size_t len);
...
typedef GRPC_DLL void(*grpc_slice_buffer_pop_type)(grpc_slice_buffer* sb);
extern grpc_slice_buffer_pop_type grpc_slice_buffer_pop_import;
#define grpc_slice_buffer_pop grpc_slice_buffer_pop_import
typedef GRPC_DLL void(*grpc_slice_buffer_reset_and_unref_type)(grpc_slice_buffer* sb);
...
typedef GRPC_DLL void(*grpc_slice_buffer_swap_type)(grpc_slice_buffer* a, grpc_slice_buffer* b);
...
typedef GRPC_DLL void(*grpc_slice_buffer_move_into_type)(grpc_slice_buffer* src, grpc_slice_buffer* dst);
...
typedef GRPC_DLL void(*grpc_slice_buffer_trim_end_type)(grpc_slice_buffer* sb, size_t n, grpc_slice_buffer* garbage);
...
typedef GRPC_DLL void(*grpc_slice_buffer_move_first_type)(grpc_slice_buffer* src, size_t n, grpc_slice_buffer* dst);
...
typedef GRPC_DLL void(*grpc_slice_buffer_move_first_no_ref_type)(grpc_slice_buffer* src, size_t n, grpc_slice_buffer* dst);
...
typedef GRPC_DLL void(*grpc_slice_buffer_move_first_into_buffer_type)(grpc_slice_buffer* src, size_t n, void* dst);
...
typedef GRPC_DLL grpc_slice(*grpc_slice_buffer_take_first_type)(grpc_slice_buffer* sb);
...
typedef GRPC_DLL void(*grpc_slice_buffer_undo_take_first_type)(grpc_slice_buffer* sb, grpc_slice slice);
