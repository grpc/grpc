...
typedef void(*grpc_ssl_credentials_set_min_tls_version_type)(grpc_channel_credentials* creds, grpc_tls_version min_tls_version);
extern grpc_ssl_credentials_set_min_tls_version_type grpc_ssl_credentials_set_min_tls_version_import;
#define grpc_ssl_credentials_set_min_tls_version grpc_ssl_credentials_set_min_tls_version_import
typedef void(*grpc_ssl_credentials_set_max_tls_version_type)(grpc_channel_credentials* creds, grpc_tls_version max_tls_version);
extern grpc_ssl_credentials_set_max_tls_version_type grpc_ssl_credentials_set_max_tls_version_import;
#define grpc_ssl_credentials_set_max_tls_version grpc_ssl_credentials_set_max_tls_version_import
...
typedef void(*grpc_ssl_server_credentials_set_min_tls_version_type)(grpc_server_credentials* creds, grpc_tls_version min_tls_version);
extern grpc_ssl_server_credentials_set_min_tls_version_type grpc_ssl_server_credentials_set_min_tls_version_import;
#define grpc_ssl_server_credentials_set_min_tls_version grpc_ssl_server_credentials_set_min_tls_version_import
typedef void(*grpc_ssl_server_credentials_set_max_tls_version_type)(grpc_server_credentials* creds, grpc_tls_version max_tls_version);
extern grpc_ssl_server_credentials_set_max_tls_version_type grpc_ssl_server_credentials_set_max_tls_version_import;
#define grpc_ssl_server_credentials_set_max_tls_version grpc_ssl_server_credentials_set_max_tls_version_import
