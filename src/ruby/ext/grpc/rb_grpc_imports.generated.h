...
typedef void(*grpc_completion_queue_set_notify_fd_type)(grpc_completion_queue* cq, int fd);
extern grpc_completion_queue_set_notify_fd_type grpc_completion_queue_set_notify_fd_import;
#define grpc_completion_queue_set_notify_fd grpc_completion_queue_set_notify_fd_import
