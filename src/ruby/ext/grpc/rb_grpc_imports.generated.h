...
typedef void(*grpc_tls_credentials_options_set_tls_key_log_config_type)(grpc_tls_credentials_options* options, grpc_tls_key_log_config* config);
extern grpc_tls_credentials_options_set_tls_key_log_config_type grpc_tls_credentials_options_set_tls_key_log_config_import;
#define grpc_tls_credentials_options_set_tls_key_log_config grpc_tls_credentials_options_set_tls_key_log_config_import
typedef grpc_tls_key_logger*(*grpc_tls_key_logger_create_type)(grpc_tls_credentials_options* options);
extern grpc_tls_key_logger_create_type grpc_tls_key_logger_create_import;
#define grpc_tls_key_logger_create grpc_tls_key_logger_create_import
typedef void(*grpc_tls_key_logger_destroy_type)(grpc_tls_key_logger* key_logger);
extern grpc_tls_key_logger_destroy_type grpc_tls_key_logger_destroy_import;
#define grpc_tls_key_logger_destroy grpc_tls_key_logger_destroy_import
typedef void(*grpc_tls_key_logger_registry_init_type)();
extern grpc_tls_key_logger_registry_init_type grpc_tls_key_logger_registry_init_import;
#define grpc_tls_key_logger_registry_init grpc_tls_key_logger_registry_init_import
typedef void(*grpc_tls_key_logger_registry_destroy_type)();
extern grpc_tls_key_logger_registry_destroy_type grpc_tls_key_logger_registry_destroy_import;
#define grpc_tls_key_logger_registry_destroy grpc_tls_key_logger_registry_destroy_import
