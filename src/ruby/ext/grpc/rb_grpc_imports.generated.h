...
typedef grpc_server_config_fetcher*(*grpc_server_config_fetcher_xds_create_type)(grpc_server_xds_status_notifier notifier, int drain_grace_time_ms, const grpc_channel_args* args);
