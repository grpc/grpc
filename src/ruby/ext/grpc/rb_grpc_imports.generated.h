...
typedef grpc_tls_status(*gprc_tls_certificate_provider_data_watcher_set_root_cert_type)(grpc_tls_certificate_provider* provider, const char* root_certificate);
...
typedef grpc_tls_status(*gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs_type)(grpc_tls_certificate_provider* provider, grpc_tls_identity_pairs* pem_key_cert_pairs);
