...
typedef grpc_server_credentials*(*grpc_ssl_server_credentials_create_ex_type)(const char* pem_root_certs, grpc_ssl_pem_key_cert_pair* pem_key_cert_pairs, size_t num_key_cert_pair, grpc_ssl_client_certificate_request_type client_certificate_request, void* reserved);
...
typedef void(*grpc_ssl_server_credentials_set_send_client_ca_list_type)(grpc_server_credentials* server_credentials, bool send_client_ca_list);
extern grpc_ssl_server_credentials_set_send_client_ca_list_type grpc_ssl_server_credentials_set_send_client_ca_list_import;
#define grpc_ssl_server_credentials_set_send_client_ca_list grpc_ssl_server_credentials_set_send_client_ca_list_import
