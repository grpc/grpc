...
typedef grpc_tls_session_key_log_config*(*grpc_tls_session_key_log_config_create_type)();
extern grpc_tls_session_key_log_config_create_type grpc_tls_session_key_log_config_create_import;
#define grpc_tls_session_key_log_config_create grpc_tls_session_key_log_config_create_import
typedef void(*grpc_tls_session_key_log_config_release_type)(grpc_tls_session_key_log_config* config);
extern grpc_tls_session_key_log_config_release_type grpc_tls_session_key_log_config_release_import;
#define grpc_tls_session_key_log_config_release grpc_tls_session_key_log_config_release_import
typedef void(*grpc_tls_session_key_log_config_set_log_format_type)(grpc_tls_session_key_log_config* config, grpc_tls_session_key_log_format format);
extern grpc_tls_session_key_log_config_set_log_format_type grpc_tls_session_key_log_config_set_log_format_import;
#define grpc_tls_session_key_log_config_set_log_format grpc_tls_session_key_log_config_set_log_format_import
typedef void(*grpc_tls_session_key_log_config_set_log_path_type)(grpc_tls_session_key_log_config* config, const char* path);
extern grpc_tls_session_key_log_config_set_log_path_type grpc_tls_session_key_log_config_set_log_path_import;
#define grpc_tls_session_key_log_config_set_log_path grpc_tls_session_key_log_config_set_log_path_import
typedef void(*grpc_tls_credentials_options_set_tls_session_key_log_config_type)(grpc_tls_credentials_options* options, grpc_tls_session_key_log_config* config);
extern grpc_tls_credentials_options_set_tls_session_key_log_config_type grpc_tls_credentials_options_set_tls_session_key_log_config_import;
#define grpc_tls_credentials_options_set_tls_session_key_log_config grpc_tls_credentials_options_set_tls_session_key_log_config_import
