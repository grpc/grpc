...
typedef void(*grpc_tls_credentials_options_set_key_materials_config_type)(grpc_tls_credentials_options* options, grpc_tls_key_materials_config* config);
...
typedef void(*grpc_tls_credentials_options_set_credential_reload_config_type)(grpc_tls_credentials_options* options, grpc_tls_credential_reload_config* config);
...
typedef void(*grpc_tls_key_materials_config_set_key_materials_type)(grpc_tls_key_materials_config* config, grpc_ssl_pem_key_cert_pair* pem_key_cert_pairs, const char* pem_root_certs, size_t num_key_cert_pairs);
