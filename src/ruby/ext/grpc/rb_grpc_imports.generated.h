...
typedef grpc_status_code(*grpc_tls_certificate_provider_in_memory_set_root_cert_type)(grpc_tls_certificate_provider* provider, const char* root_certificate, const char** error_details);
extern grpc_tls_certificate_provider_in_memory_set_root_cert_type grpc_tls_certificate_provider_in_memory_set_root_cert_import;
#define grpc_tls_certificate_provider_in_memory_set_root_cert grpc_tls_certificate_provider_in_memory_set_root_cert_import
typedef grpc_status_code(*grpc_tls_certificate_provider_in_memory_set_key_cert_pairs_type)(grpc_tls_certificate_provider* provider, grpc_tls_identity_pairs* pem_key_cert_pairs, const char** error_details);
extern grpc_tls_certificate_provider_in_memory_set_key_cert_pairs_type grpc_tls_certificate_provider_in_memory_set_key_cert_pairs_import;
#define grpc_tls_certificate_provider_in_memory_set_key_cert_pairs grpc_tls_certificate_provider_in_memory_set_key_cert_pairs_import
