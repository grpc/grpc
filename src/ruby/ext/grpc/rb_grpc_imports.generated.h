...
typedef void(*grpc_tls_credentials_options_set_exported_keying_material_options_type)(grpc_tls_credentials_options* options, const char* label, size_t length);
extern grpc_tls_credentials_options_set_exported_keying_material_options_type grpc_tls_credentials_options_set_exported_keying_material_options_import;
#define grpc_tls_credentials_options_set_exported_keying_material_options grpc_tls_credentials_options_set_exported_keying_material_options_import
