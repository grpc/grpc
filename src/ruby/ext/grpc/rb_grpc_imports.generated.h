...
typedef void(*gpr_log_verbosity_init_for_path_type)(const char* path);
extern gpr_log_verbosity_init_for_path_type gpr_log_verbosity_init_for_path_import;
#define gpr_log_verbosity_init_for_path gpr_log_verbosity_init_for_path_import
