...
typedef grpc_tls_certificate_provider*(*grpc_tls_certificate_provider_file_watcher_create_type)(const char* identity_key_cert_directory, const char* private_key_file_name, const char* identity_certificate_file_name, const char* root_cert_full_path, unsigned int refresh_interval_sec);
