...
typedef void(*grpc_absl_log_error_type)(const char* file, int line, const char* message_str);
extern grpc_absl_log_error_type grpc_absl_log_error_import;
#define grpc_absl_log_error grpc_absl_log_error_import
typedef void(*grpc_absl_log_info_type)(const char* file, int line, const char* message_str);
extern grpc_absl_log_info_type grpc_absl_log_info_import;
#define grpc_absl_log_info grpc_absl_log_info_import
