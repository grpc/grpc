...
typedef void(*grpc_resolver_factory_register_type)(const char* scheme, grpc_resolver_factory* factory);
extern grpc_resolver_factory_register_type grpc_resolver_factory_register_import;
#define grpc_resolver_factory_register grpc_resolver_factory_register_import
typedef void(*grpc_resolver_observer_ref_type)(grpc_resolver_observer* observer);
extern grpc_resolver_observer_ref_type grpc_resolver_observer_ref_import;
#define grpc_resolver_observer_ref grpc_resolver_observer_ref_import
typedef void(*grpc_resolver_observer_unref_type)(grpc_resolver_observer* observer);
extern grpc_resolver_observer_unref_type grpc_resolver_observer_unref_import;
#define grpc_resolver_observer_unref grpc_resolver_observer_unref_import
typedef void(*grpc_resolver_observer_set_result_type)(grpc_resolver_observer* observer, const grpc_resolver_result* result);
extern grpc_resolver_observer_set_result_type grpc_resolver_observer_set_result_import;
#define grpc_resolver_observer_set_result grpc_resolver_observer_set_result_import
typedef void(*grpc_resolver_observer_set_error_type)(grpc_resolver_observer* observer, const char* error_details);
extern grpc_resolver_observer_set_error_type grpc_resolver_observer_set_error_import;
#define grpc_resolver_observer_set_error grpc_resolver_observer_set_error_import
