...
typedef grpc_tls_certificate_provider*(*grpc_tls_certificate_provider_in_memory_create_type)(const char* root_certificate, grpc_tls_identity_pairs* pem_key_cert_pairs);
