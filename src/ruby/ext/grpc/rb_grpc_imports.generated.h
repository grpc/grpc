...
typedef void(*grpc_tls_certificate_provider_in_memory_set_root_certificate_type)(grpc_tls_certificate_provider* provider, const char* root_cert);
...
typedef void(*grpc_tls_certificate_provider_in_memory_set_identity_certificate_type)(grpc_tls_certificate_provider* provider, grpc_tls_identity_pairs* pem_key_cert_pairs);
...
typedef void(*grpc_tls_identity_pairs_add_pair_with_custom_signer_type)(grpc_tls_identity_pairs* pairs, grpc_core::CustomPrivateKeySigner* private_key, const char* cert_chain);
extern grpc_tls_identity_pairs_add_pair_with_custom_signer_type grpc_tls_identity_pairs_add_pair_with_custom_signer_import;
#define grpc_tls_identity_pairs_add_pair_with_custom_signer grpc_tls_identity_pairs_add_pair_with_custom_signer_import
