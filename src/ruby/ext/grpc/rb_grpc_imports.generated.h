...
typedef grpc_status_code(*gprc_tls_certificate_provider_data_watcher_set_root_cert_type)(grpc_tls_certificate_provider* provider, const char* root_certificate, char** error_details);
extern gprc_tls_certificate_provider_data_watcher_set_root_cert_type gprc_tls_certificate_provider_data_watcher_set_root_cert_import;
#define gprc_tls_certificate_provider_data_watcher_set_root_cert gprc_tls_certificate_provider_data_watcher_set_root_cert_import
typedef grpc_status_code(*gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs_type)(grpc_tls_certificate_provider* provider, grpc_tls_identity_pairs* pem_key_cert_pairs, char** error_details);
extern gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs_type gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs_import;
#define gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs_import
