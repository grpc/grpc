...
typedef int(*grpc_compression_level_parse_type)(const char *name, grpc_compression_level *level);
extern grpc_compression_level_parse_type grpc_compression_level_parse_import;
#define grpc_compression_level_parse grpc_compression_level_parse_import
...
typedef int(*grpc_compression_level_name_type)(grpc_compression_level level, char **name);
extern grpc_compression_level_name_type grpc_compression_level_name_import;
#define grpc_compression_level_name grpc_compression_level_name_import
