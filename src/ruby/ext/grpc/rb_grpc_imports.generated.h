...
typedef grpc_tls_certificate_provider*(*grpc_tls_certificate_provider_data_watcher_create_type)(const char* root_certificate, grpc_tls_identity_pairs* pem_key_cert_pairs);
extern grpc_tls_certificate_provider_data_watcher_create_type grpc_tls_certificate_provider_data_watcher_create_import;
#define grpc_tls_certificate_provider_data_watcher_create grpc_tls_certificate_provider_data_watcher_create_import
...
typedef SetCredentialsStatus*(*grpc_set_data_watcher_root_certificate_type)(grpc_tls_certificate_provider* provider, const char* root_certificate);
extern grpc_set_data_watcher_root_certificate_type grpc_set_data_watcher_root_certificate_import;
#define grpc_set_data_watcher_root_certificate grpc_set_data_watcher_root_certificate_import
typedef SetCredentialsStatus*(*grpc_set_data_watcher_key_certificate_pairs_type)(grpc_tls_certificate_provider* provider, grpc_tls_identity_pairs* pem_key_cert_pairs);
extern grpc_set_data_watcher_key_certificate_pairs_type grpc_set_data_watcher_key_certificate_pairs_import;
#define grpc_set_data_watcher_key_certificate_pairs grpc_set_data_watcher_key_certificate_pairs_import
typedef void(*grpc_set_credentials_status_release_type)(SetCredentialsStatus* status);
extern grpc_set_credentials_status_release_type grpc_set_credentials_status_release_import;
#define grpc_set_credentials_status_release grpc_set_credentials_status_release_import
