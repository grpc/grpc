...
typedef grpc_channel_credentials*(*grpc_google_default_credentials_create_type)(grpc_call_credentials* default_credentials, grpc_call_credentials* alts_credentials = nullptr);
