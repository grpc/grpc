...
typedef void(*grpc_tls_credentials_options_set_cert_request_type_type)(grpc_tls_credentials_options* options, <<<<<<< HEAD grpc_tls_server_authorization_check_config* config);
