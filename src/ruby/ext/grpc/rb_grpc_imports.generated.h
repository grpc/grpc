...
typedef void(*grpc_ssl_server_credentials_options_set_min_tls_version_type)(grpc_ssl_server_credentials_options* options, grpc_tls_version min_tls_version);
extern grpc_ssl_server_credentials_options_set_min_tls_version_type grpc_ssl_server_credentials_options_set_min_tls_version_import;
#define grpc_ssl_server_credentials_options_set_min_tls_version grpc_ssl_server_credentials_options_set_min_tls_version_import
typedef void(*grpc_ssl_server_credentials_options_set_max_tls_version_type)(grpc_ssl_server_credentials_options* options, grpc_tls_version max_tls_version);
extern grpc_ssl_server_credentials_options_set_max_tls_version_type grpc_ssl_server_credentials_options_set_max_tls_version_import;
#define grpc_ssl_server_credentials_options_set_max_tls_version grpc_ssl_server_credentials_options_set_max_tls_version_import
