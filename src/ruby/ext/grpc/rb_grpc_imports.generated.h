...
typedef void(*grpc_authorization_policy_provider_file_watcher_set_error_callback_type)(grpc_authorization_policy_provider* provider, grpc_authorization_policy_provider_file_watcher_on_error_cb cb);
extern grpc_authorization_policy_provider_file_watcher_set_error_callback_type grpc_authorization_policy_provider_file_watcher_set_error_callback_import;
#define grpc_authorization_policy_provider_file_watcher_set_error_callback grpc_authorization_policy_provider_file_watcher_set_error_callback_import
