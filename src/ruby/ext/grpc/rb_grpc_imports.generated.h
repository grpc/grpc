...
typedef void(*grpc_tls_credentials_options_set_exported_keying_material_label_type)(grpc_tls_credentials_options* options, const char* label);
extern grpc_tls_credentials_options_set_exported_keying_material_label_type grpc_tls_credentials_options_set_exported_keying_material_label_import;
#define grpc_tls_credentials_options_set_exported_keying_material_label grpc_tls_credentials_options_set_exported_keying_material_label_import
typedef void(*grpc_tls_credentials_options_set_exported_keying_material_length_type)(grpc_tls_credentials_options* options, size_t length);
extern grpc_tls_credentials_options_set_exported_keying_material_length_type grpc_tls_credentials_options_set_exported_keying_material_length_import;
#define grpc_tls_credentials_options_set_exported_keying_material_length grpc_tls_credentials_options_set_exported_keying_material_length_import
...
typedef const grpc_arg_pointer_vtable*(*grpc_channel_args_arg_vtable_type)(void);
extern grpc_channel_args_arg_vtable_type grpc_channel_args_arg_vtable_import;
#define grpc_channel_args_arg_vtable grpc_channel_args_arg_vtable_import
