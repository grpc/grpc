...
grpc_completion_queue_set_notify_fd_type grpc_completion_queue_set_notify_fd_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_completion_queue_set_notify_fd_import = (grpc_completion_queue_set_notify_fd_type) GetProcAddress(library, "grpc_completion_queue_set_notify_fd");
