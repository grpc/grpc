...
grpc_compression_level_parse_type grpc_compression_level_parse_import;
grpc_compression_algorithm_name_type grpc_compression_algorithm_name_import;
grpc_compression_level_name_type grpc_compression_level_name_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_compression_level_parse_import = (grpc_compression_level_parse_type) GetProcAddress(library, "grpc_compression_level_parse");
  ...
  grpc_compression_level_name_import = (grpc_compression_level_name_type) GetProcAddress(library, "grpc_compression_level_name");
