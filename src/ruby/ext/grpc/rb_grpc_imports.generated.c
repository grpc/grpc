...
gpr_set_absl_verbosity_debug_type gpr_set_absl_verbosity_debug_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  gpr_set_absl_verbosity_debug_import = (gpr_set_absl_verbosity_debug_type) GetProcAddress(library, "gpr_set_absl_verbosity_debug");
