...
grpc_ssl_server_credentials_options_set_min_tls_version_type grpc_ssl_server_credentials_options_set_min_tls_version_import;
grpc_ssl_server_credentials_options_set_max_tls_version_type grpc_ssl_server_credentials_options_set_max_tls_version_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_ssl_server_credentials_options_set_min_tls_version_import = (grpc_ssl_server_credentials_options_set_min_tls_version_type) GetProcAddress(library, "grpc_ssl_server_credentials_options_set_min_tls_version");
  grpc_ssl_server_credentials_options_set_max_tls_version_import = (grpc_ssl_server_credentials_options_set_max_tls_version_type) GetProcAddress(library, "grpc_ssl_server_credentials_options_set_max_tls_version");
