...
grpc_alts_credentials_options_add_transport_protocol_preference_type grpc_alts_credentials_options_add_transport_protocol_preference_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_alts_credentials_options_add_transport_protocol_preference_import = (grpc_alts_credentials_options_add_transport_protocol_preference_type) GetProcAddress(library, "grpc_alts_credentials_options_add_transport_protocol_preference");
