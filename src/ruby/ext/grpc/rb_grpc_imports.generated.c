...
grpc_tls_session_key_log_config_create_type grpc_tls_session_key_log_config_create_import;
grpc_tls_session_key_log_config_release_type grpc_tls_session_key_log_config_release_import;
grpc_tls_session_key_log_config_set_log_format_type grpc_tls_session_key_log_config_set_log_format_import;
grpc_tls_session_key_log_config_set_log_path_type grpc_tls_session_key_log_config_set_log_path_import;
grpc_tls_credentials_options_set_tls_session_key_log_config_type grpc_tls_credentials_options_set_tls_session_key_log_config_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_tls_session_key_log_config_create_import = (grpc_tls_session_key_log_config_create_type) GetProcAddress(library, "grpc_tls_session_key_log_config_create");
  grpc_tls_session_key_log_config_release_import = (grpc_tls_session_key_log_config_release_type) GetProcAddress(library, "grpc_tls_session_key_log_config_release");
  grpc_tls_session_key_log_config_set_log_format_import = (grpc_tls_session_key_log_config_set_log_format_type) GetProcAddress(library, "grpc_tls_session_key_log_config_set_log_format");
  grpc_tls_session_key_log_config_set_log_path_import = (grpc_tls_session_key_log_config_set_log_path_type) GetProcAddress(library, "grpc_tls_session_key_log_config_set_log_path");
  grpc_tls_credentials_options_set_tls_session_key_log_config_import = (grpc_tls_credentials_options_set_tls_session_key_log_config_type) GetProcAddress(library, "grpc_tls_credentials_options_set_tls_session_key_log_config");
