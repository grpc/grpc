...
grpc_tls_identity_pairs_add_pair_with_custom_signer_type grpc_tls_identity_pairs_add_pair_with_custom_signer_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_tls_identity_pairs_add_pair_with_custom_signer_import = (grpc_tls_identity_pairs_add_pair_with_custom_signer_type) GetProcAddress(library, "grpc_tls_identity_pairs_add_pair_with_custom_signer");
