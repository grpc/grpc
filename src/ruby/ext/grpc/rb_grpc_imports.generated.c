...
grpc_ssl_server_certificate_config_release_type grpc_ssl_server_certificate_config_release_import;
...
grpc_ssl_server_credentials_options_release_type grpc_ssl_server_credentials_options_release_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_ssl_server_certificate_config_release_import = (grpc_ssl_server_certificate_config_release_type) GetProcAddress(library, "grpc_ssl_server_certificate_config_release");
  ...
  grpc_ssl_server_credentials_options_release_import = (grpc_ssl_server_credentials_options_release_type) GetProcAddress(library, "grpc_ssl_server_credentials_options_release");
