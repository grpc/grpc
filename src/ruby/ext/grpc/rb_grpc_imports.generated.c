...
grpc_ssl_server_credentials_set_send_client_ca_list_type grpc_ssl_server_credentials_set_send_client_ca_list_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_ssl_server_credentials_set_send_client_ca_list_import = (grpc_ssl_server_credentials_set_send_client_ca_list_type) GetProcAddress(library, "grpc_ssl_server_credentials_set_send_client_ca_list");
