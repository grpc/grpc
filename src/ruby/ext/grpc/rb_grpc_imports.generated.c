...
gprc_tls_certificate_provider_data_watcher_set_root_cert_type gprc_tls_certificate_provider_data_watcher_set_root_cert_import;
gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs_type gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  gprc_tls_certificate_provider_data_watcher_set_root_cert_import = (gprc_tls_certificate_provider_data_watcher_set_root_cert_type) GetProcAddress(library, "gprc_tls_certificate_provider_data_watcher_set_root_cert");
  gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs_import = (gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs_type) GetProcAddress(library, "gprc_tls_certificate_provider_data_watcher_set_key_cert_pairs");
