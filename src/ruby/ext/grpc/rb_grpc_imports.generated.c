...
grpc_tls_credentials_options_set_tls_key_log_config_type grpc_tls_credentials_options_set_tls_key_log_config_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_tls_credentials_options_set_tls_key_log_config_import = (grpc_tls_credentials_options_set_tls_key_log_config_type) GetProcAddress(library, "grpc_tls_credentials_options_set_tls_key_log_config");
