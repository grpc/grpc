...
grpc_tls_identity_pairs_release_type grpc_tls_identity_pairs_release_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_tls_identity_pairs_release_import = (grpc_tls_identity_pairs_release_type) GetProcAddress(library, "grpc_tls_identity_pairs_release");
