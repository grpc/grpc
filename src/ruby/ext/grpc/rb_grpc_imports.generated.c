...
grpc_tls_certificate_provider_in_memory_set_root_cert_type grpc_tls_certificate_provider_in_memory_set_root_cert_import;
grpc_tls_certificate_provider_in_memory_set_key_cert_pairs_type grpc_tls_certificate_provider_in_memory_set_key_cert_pairs_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_tls_certificate_provider_in_memory_set_root_cert_import = (grpc_tls_certificate_provider_in_memory_set_root_cert_type) GetProcAddress(library, "grpc_tls_certificate_provider_in_memory_set_root_cert");
  grpc_tls_certificate_provider_in_memory_set_key_cert_pairs_import = (grpc_tls_certificate_provider_in_memory_set_key_cert_pairs_type) GetProcAddress(library, "grpc_tls_certificate_provider_in_memory_set_key_cert_pairs");
