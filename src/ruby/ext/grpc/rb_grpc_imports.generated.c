...
grpc_tls_certificate_provider_file_watcher_force_update_type grpc_tls_certificate_provider_file_watcher_force_update_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_tls_certificate_provider_file_watcher_force_update_import = (grpc_tls_certificate_provider_file_watcher_force_update_type) GetProcAddress(library, "grpc_tls_certificate_provider_file_watcher_force_update");
