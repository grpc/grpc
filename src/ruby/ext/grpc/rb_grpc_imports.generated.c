...
grpc_authorization_policy_provider_file_watcher_set_error_callback_type grpc_authorization_policy_provider_file_watcher_set_error_callback_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_authorization_policy_provider_file_watcher_set_error_callback_import = (grpc_authorization_policy_provider_file_watcher_set_error_callback_type) GetProcAddress(library, "grpc_authorization_policy_provider_file_watcher_set_error_callback");
