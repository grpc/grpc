...
grpc_ssl_session_cache_arg_vtable_type grpc_ssl_session_cache_arg_vtable_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_ssl_session_cache_arg_vtable_import = (grpc_ssl_session_cache_arg_vtable_type) GetProcAddress(library, "grpc_ssl_session_cache_arg_vtable");
