...
grpc_gce_channel_credentials_create_type grpc_gce_channel_credentials_create_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_gce_channel_credentials_create_import = (grpc_gce_channel_credentials_create_type) GetProcAddress(library, "grpc_gce_channel_credentials_create");
