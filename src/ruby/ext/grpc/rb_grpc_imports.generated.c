...
grpc_tls_credentials_options_set_exported_keying_material_label_type grpc_tls_credentials_options_set_exported_keying_material_label_import;
grpc_tls_credentials_options_set_exported_keying_material_length_type grpc_tls_credentials_options_set_exported_keying_material_length_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_tls_credentials_options_set_exported_keying_material_label_import = (grpc_tls_credentials_options_set_exported_keying_material_label_type) GetProcAddress(library, "grpc_tls_credentials_options_set_exported_keying_material_label");
  grpc_tls_credentials_options_set_exported_keying_material_length_import = (grpc_tls_credentials_options_set_exported_keying_material_length_type) GetProcAddress(library, "grpc_tls_credentials_options_set_exported_keying_material_length");
