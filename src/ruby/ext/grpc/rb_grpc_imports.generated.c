...
grpc_metadata_credentials_create_with_security_level_from_plugin_type grpc_metadata_credentials_create_with_security_level_from_plugin_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_metadata_credentials_create_with_security_level_from_plugin_import = (grpc_metadata_credentials_create_with_security_level_from_plugin_type) GetProcAddress(library, "grpc_metadata_credentials_create_with_security_level_from_plugin");
