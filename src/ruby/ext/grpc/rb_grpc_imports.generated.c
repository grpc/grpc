...
grpc_channel_arg_ssl_session_cache_create_type grpc_channel_arg_ssl_session_cache_create_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_channel_arg_ssl_session_cache_create_import = (grpc_channel_arg_ssl_session_cache_create_type) GetProcAddress(library, "grpc_channel_arg_ssl_session_cache_create");
