...
grpc_tls_certificate_provider_data_watcher_create_type grpc_tls_certificate_provider_data_watcher_create_import;
grpc_tls_certificate_provider_release_type grpc_tls_certificate_provider_release_import;
grpc_set_data_watcher_root_certificate_type grpc_set_data_watcher_root_certificate_import;
grpc_set_data_watcher_key_certificate_pairs_type grpc_set_data_watcher_key_certificate_pairs_import;
grpc_set_credentials_status_release_type grpc_set_credentials_status_release_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_tls_certificate_provider_data_watcher_create_import = (grpc_tls_certificate_provider_data_watcher_create_type) GetProcAddress(library, "grpc_tls_certificate_provider_data_watcher_create");
  ...
  grpc_set_data_watcher_root_certificate_import = (grpc_set_data_watcher_root_certificate_type) GetProcAddress(library, "grpc_set_data_watcher_root_certificate");
  grpc_set_data_watcher_key_certificate_pairs_import = (grpc_set_data_watcher_key_certificate_pairs_type) GetProcAddress(library, "grpc_set_data_watcher_key_certificate_pairs");
  grpc_set_credentials_status_release_import = (grpc_set_credentials_status_release_type) GetProcAddress(library, "grpc_set_credentials_status_release");
