...
grpc_server_add_passive_listener_endpoint_type grpc_server_add_passive_listener_endpoint_import;
grpc_server_add_passive_listener_connected_fd_type grpc_server_add_passive_listener_connected_fd_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_server_add_passive_listener_endpoint_import = (grpc_server_add_passive_listener_endpoint_type) GetProcAddress(library, "grpc_server_add_passive_listener_endpoint");
  grpc_server_add_passive_listener_connected_fd_import = (grpc_server_add_passive_listener_connected_fd_type) GetProcAddress(library, "grpc_server_add_passive_listener_connected_fd");
