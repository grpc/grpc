...
def main
  ...
  Process.spawn(RbConfig.ruby, echo_server_path, "--secure", :in => to_child_r, :out => to_parent_w)
  to_child_r.close
  to_parent_w.close
  ...
  stub = Echo::EchoServer::Stub.new("localhost:#{child_port}", channel_creds, channel_args: {
