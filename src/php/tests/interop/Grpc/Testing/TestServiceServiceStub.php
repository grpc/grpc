...
class TestServiceServiceStub {
     ...
     * @param \Grpc\ServerContext $context server request context
     * @return array with [
     *     \Grpc\Testing\SimpleResponse, // response data
     *     optional array = [], // initial metadata
     *     optional \Grpc\Status = \Grpc\Status::ok // Grpc status
     * ]
     */
     ...
     * @param \Grpc\ServerCallWriter $writter write response data of \Grpc\Testing\StreamingOutputCallResponse
     * @param \Grpc\ServerContext $context server request context
     * @return void
     */
     ...
     * @param \Grpc\ServerContext $context server request context
     * @return array with [
     *     \Grpc\Testing\StreamingInputCallResponse, // response data
     *     optional array = [], // initial metadata
     *     optional \Grpc\Status = \Grpc\Status::ok // Grpc status
     * ]
     */
