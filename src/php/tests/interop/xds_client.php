...
class XdsUpdateClientConfigureService extends \Grpc\Testing\XdsUpdateClientConfigureServiceStub
{
    public function configure(
        ...
        $client_thread->rpc_config->update(
            $rpcs_to_send,
            $metadata_to_send,
...
class LoadBalancerStatsService extends \Grpc\Testing\LoadBalancerStatsServiceStub
{
