...
class Call
{
   ...
   *
   * @return object{message?: string, send_metadata?: bool, send_message?: bool, send_close?: bool, send_status?: bool, metadata?: array<string, string[]>, status?: object{code: int, metadata: array<string, string[]>, details: string}, cancelled?: bool} Object with results of all actions
   */
