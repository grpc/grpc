...
def main():
    ...
    with _reserve_port() as port:
        ...
        for _ in range(_PROCESS_COUNT):
            ...
            # BEFORE the parent process loads the gRPC library. See
            # https://github.com/grpc/grpc/issues/16001 for more details.
            #
            # In this example, the parent process never creates a gRPC server or
            # loads the gRPC library for its own use - it only forks worker processes.
            # Each forked child then independently loads gRPC and starts its server.
            ...
            # The crucial point is that THIS (parent) process hasn't loaded gRPC yet.
