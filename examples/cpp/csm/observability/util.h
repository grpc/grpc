...
#ifndef GRPCPP_EXAMPLES_CPP_CSM_OBSERVABILITY_UTIL_H
#define GRPCPP_EXAMPLES_CPP_CSM_OBSERVABILITY_UTIL_H
...
#endif  // GRPCPP_EXAMPLES_CPP_CSM_OBSERVABILITY_UTIL_H
