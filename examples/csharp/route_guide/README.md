...
able to generate the server and client interface code and run the examples. Follow the instructions for [Linux](../../../src/csharp#usage-linux-mono) or [MacOS](../../../src/csharp#usage-macos-mono).

## Defining the service

Our first step (as you'll know from [Getting started](../..) is to define the gRPC *service* and the method *request* and *response* types using [protocol buffers] (https://developers.google.com/protocol-buffers/docs/overview). You can see the complete .proto file in [`RouteGuide/protos/route_guide.proto`](RouteGuide/protos/route_guide.proto).
...
- For Linux, make sure you've [installed gRPC C Core using Linuxbrew](../../../src/csharp#usage-linux-mono)
- For MacOS, make sure you've [installed gRPC C Core using Homebrew](../../../src/csharp#usage-macos-mono)
