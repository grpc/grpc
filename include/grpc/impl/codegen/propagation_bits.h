...
/** Propagation bits: this can be bitwise or-ed to form propagation_mask
 * for grpc_call */
/** Propagate deadline */
...
/** Default propagation mask: clients of the core API are encouraged to
   encode deltas from this in their implementations... ie write:
   GRPC_PROPAGATE_DEFAULTS & ~GRPC_PROPAGATE_DEADLINE to disable
   deadline propagation. Doing so gives flexibility in the future to
   define new propagation types that are default inherited or not. */
#define GRPC_PROPAGATE_DEFAULTS                        \
  ((uint32_t)((0xffff | GRPC_PROPAGATE_DEADLINE |      \
