...
/** InterlockedCompareExchangePointerNoFence() not available on vista or
   windows7 */
#ifdef GPR_ARCH_64
  return o == (gpr_atm)InterlockedCompareExchangeAcquire64((volatile LONGLONG*)p, (LONGLONG)n,
                                                           (LONGLONG)o);
#else
...
#ifdef GPR_ARCH_64
  return o == (gpr_atm)InterlockedCompareExchangeRelease64((volatile LONGLONG*)p, (LONGLONG)n,
                                                           (LONGLONG)o);
#else
...
#ifdef GPR_ARCH_64
  return o ==
         (gpr_atm)InterlockedCompareExchange64((volatile LONGLONG*)p, (LONGLONG)n, (LONGLONG)o);
#else
...
static __inline gpr_atm gpr_atm_full_fetch_add(gpr_atm* p, gpr_atm delta) {
  ...
  do {
    old = *p;
                                                        ...
                                                        (LONGLONG)old + delta, (LONGLONG)old));
#else
  do {
    old = *p;
  } while (old !=
           (gpr_atm)InterlockedCompareExchange((volatile LONG*)p, (LONG)old + delta, (LONG)old));
#endif
  return old;
}
