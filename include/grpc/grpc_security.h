...
/** Gets the name of the property that indicates the peer identity. Will return
   NULL if the peer is not authenticated. */
  GRPCAPI const char *grpc_auth_context_peer_identity_property_name (const
								     grpc_auth_context
								     * ctx);

/** Returns 1 if the peer is authenticated, 0 otherwise. */
  GRPCAPI int grpc_auth_context_peer_is_authenticated (const grpc_auth_context
						       * ctx);
...
/** Sets the property name. Returns 1 if successful or 0 in case of failure
  ...
  GRPCAPI int
    grpc_auth_context_set_peer_identity_property_name (grpc_auth_context *
						       ctx, const char *name);
...
/** Callback for getting the SSL roots override from the application.
  ...
  typedef
    grpc_ssl_roots_override_result (*grpc_ssl_roots_override_callback) (char
									**pem_root_certs);
...
/** Setup a callback to override the default TLS/SSL roots.
  ...
  GRPCAPI void
    grpc_set_ssl_roots_override_callback (grpc_ssl_roots_override_callback
					  cb);
...
/** Creates an SSL credentials object.
  ...
  GRPCAPI grpc_channel_credentials *grpc_ssl_credentials_create (const char
								 *pem_root_certs,
								 grpc_ssl_pem_key_cert_pair
								 *
								 pem_key_cert_pair,
...
/** Creates a composite channel credentials object. */
  GRPCAPI grpc_channel_credentials
    *grpc_composite_channel_credentials_create (grpc_channel_credentials *
						channel_creds,
						grpc_call_credentials *
						call_creds, void *reserved);

/** Creates a composite call credentials object. */
  GRPCAPI grpc_call_credentials
    *grpc_composite_call_credentials_create (grpc_call_credentials * creds1,
...
/** Creates an Oauth2 Refresh Token credentials object for connecting to Google.
  ...
  GRPCAPI grpc_call_credentials
    *grpc_google_refresh_token_credentials_create (const char
						   *json_refresh_token,
						   void *reserved);

/** Creates an Oauth2 Access Token credentials with an access token that was
   aquired by an out of band mechanism. */
  GRPCAPI grpc_call_credentials *grpc_access_token_credentials_create (const
								       char
								       *access_token,
								       void
								       *reserved);
...
/** Creates an IAM credentials object for connecting to Google. */
  GRPCAPI grpc_call_credentials *grpc_google_iam_credentials_create (const
								     char
								     *authorization_token,
								     const
								     char
...
/** Callback function to be called by the metadata credentials plugin
  ...
  typedef void (*grpc_credentials_plugin_metadata_cb) (void *user_data,
						       const grpc_metadata *
						       creds_md,
						       size_t num_creds_md,
						       grpc_status_code
...
/** Creates a secure channel using the passed-in credentials. */
  GRPCAPI grpc_channel *grpc_secure_channel_create (grpc_channel_credentials *
...
/** Callback to retrieve updated SSL server certificates, private keys, and
  ...
  typedef
    ...
    (*grpc_ssl_server_certificate_config_callback) (void *user_data,
						    grpc_ssl_server_certificate_config
						    ** config);
...
/** Deprecated in favor of grpc_ssl_server_credentials_create_ex.
   ...
   - force_client_auth, if set to non-zero will force the client to authenticate
     ...
     NULL. */
  GRPCAPI grpc_server_credentials *grpc_ssl_server_credentials_create (const
								       char
								       *pem_root_certs,
								       grpc_ssl_pem_key_cert_pair
								       *
...
/** Deprecated in favor of grpc_ssl_server_credentials_create_with_options.
  ...
  GRPCAPI grpc_server_credentials
    *grpc_ssl_server_credentials_create_ex (const char *pem_root_certs,
					    grpc_ssl_pem_key_cert_pair *
					    pem_key_cert_pairs,
					    size_t num_key_cert_pairs,
