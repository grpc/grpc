 ...
 public:
  ...
  class Endpoint {
   public:
    ...
    ///   public:
    ///     bool SupportsExtension(absl::string_view id) override {
    ...
    /// }
    ///
    /// if (endpoint_->SupportsExtension(CustomrEndpointExtension::Name())) {
    ///   auto ext_ = static_cast<CustomEndpointExtension*>(endpoint);
    ///   ...
    /// }
    ///
    ///
    virtual bool SupportsExtension(absl::string_view /*id*/) { return false; }
  };
