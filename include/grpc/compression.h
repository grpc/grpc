...
GRPCAPI int grpc_compression_algorithm_parse(grpc_slice name,
...
grpc_compression_algorithm_for_level(grpc_compression_level level, uint32_t accepted_encodings);
