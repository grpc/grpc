...
void UnaryRunHandlerHelper(const MethodHandler::HandlerParameter& param, ResponseType* rsp,
                           ::grpc::Status& status) {
...
class RpcMethodHandler : public ::grpc::internal::MethodHandler {
 public:
  RpcMethodHandler(std::function<::grpc::Status(ServiceType*, ::grpc::ServerContext*,
  ...
  void RunHandler(const HandlerParameter& param) final {
    ...
    if (status.ok()) {
      status = CatchingFunctionHandler([this, &param, &rsp] {
        return func_(service_, static_cast<::grpc::ServerContext*>(param.server_context),
  ...
  void* Deserialize(grpc_call* call, grpc_byte_buffer* req, ::grpc::Status* status,
                    void** /*handler_data*/) final {
    auto* request =
        new (::grpc::g_core_codegen_interface->grpc_call_arena_alloc(call, sizeof(RequestType)))
            RequestType;
 ...
 private:
  ...
  std::function<::grpc::Status(ServiceType*, ::grpc::ServerContext*, const RequestType*,
                               ResponseType*)>
      func_;
...
class ClientStreamingHandler : public ::grpc::internal::MethodHandler {
 public:
  ClientStreamingHandler(std::function<::grpc::Status(ServiceType*, ::grpc::ServerContext*,
  ...
  void RunHandler(const HandlerParameter& param) final {
    ...
    ResponseType rsp;
    ::grpc::Status status = CatchingFunctionHandler([this, &param, &reader, &rsp] {
      return func_(service_, static_cast<::grpc::ServerContext*>(param.server_context), &reader,
                   &rsp);
    });
 ...
 private:
  std::function<::grpc::Status(ServiceType*, ::grpc::ServerContext*, ServerReader<RequestType>*,
                               ResponseType*)>
      func_;
  ServiceType* service_;
};
 ...
 public:
  ...
  void* Deserialize(grpc_call* call, grpc_byte_buffer* req, ::grpc::Status* status,
    ...
    auto* request =
        new (::grpc::g_core_codegen_interface->grpc_call_arena_alloc(call, sizeof(RequestType)))
            RequestType();
    *status = ::grpc::SerializationTraits<RequestType>::Deserialize(&buf, request);
    buf.Release();
    if (status->ok()) {
      return request;
    }
...
class BidiStreamingHandler
 ...
 public:
  BidiStreamingHandler(std::function<::grpc::Status(ServiceType*, ::grpc::ServerContext*,
