...
class DelegatingChannel : public ::grpc::ChannelInterface {
 public:
  ...
  explicit DelegatingChannel(std::shared_ptr<::grpc::ChannelInterface> delegate_channel)
  ...
  std::shared_ptr<::grpc::ChannelInterface> delegate_channel() { return delegate_channel_; }
 ...
 private:
  ...
  ::grpc::CompletionQueue* CallbackCQ() final { return delegate_channel()->CallbackCQ(); }
