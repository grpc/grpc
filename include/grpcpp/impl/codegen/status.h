...
class Status {
 public:
  ...
  Status() : code_(StatusCode::OK) {
    ...
    static_assert(
        StatusCode::OK == static_cast<StatusCode>(GRPC_STATUS_OK),
        "Mismatched status code");
    static_assert(StatusCode::CANCELLED ==
                      static_cast<StatusCode>(GRPC_STATUS_CANCELLED),
                  "Mismatched status code");
    static_assert(StatusCode::UNKNOWN ==
                      static_cast<StatusCode>(GRPC_STATUS_UNKNOWN),
                  "Mismatched status code");
    static_assert(
    ...
    static_assert(
        ...
        "Mismatched status code");
    static_assert(StatusCode::NOT_FOUND ==
                      static_cast<StatusCode>(GRPC_STATUS_NOT_FOUND),
                  "Mismatched status code");
    static_assert(
    ...
    static_assert(
        ...
        "Mismatched status code");
    static_assert(StatusCode::ABORTED ==
                      static_cast<StatusCode>(GRPC_STATUS_ABORTED),
                  "Mismatched status code");
    ...
    static_assert(
        ...
        "Mismatched status code");
    static_assert(StatusCode::INTERNAL ==
                      static_cast<StatusCode>(GRPC_STATUS_INTERNAL),
                  "Mismatched status code");
    static_assert(StatusCode::UNAVAILABLE ==
                      static_cast<StatusCode>(GRPC_STATUS_UNAVAILABLE),
                  "Mismatched status code");
    static_assert(StatusCode::DATA_LOSS ==
                      static_cast<StatusCode>(GRPC_STATUS_DATA_LOSS),
                  "Mismatched status code");
  }

  /// Construct an instance with associated \a code and \a
  /// error_message. It is an error to construct an OK status with
  /// non-empty \a error_message.
  Status(StatusCode code, const std::string& error_message)
      : code_(code), error_message_(error_message) {}

  /// Construct an instance with \a code,  \a error_message and
  /// \a error_details. It is an error to construct an OK status with
  /// non-empty \a error_message and/or \a error_details.
  Status(StatusCode code, const std::string& error_message,
  ...
  // Ignores any errors. This method does nothing except potentially
  // suppress complaints from any tools that are checking that errors
