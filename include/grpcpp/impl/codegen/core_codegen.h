...
class CoreCodegen final : public CoreCodegenInterface {
 private:
  ...
  grpc_byte_buffer* grpc_byte_buffer_copy(
      grpc_byte_buffer* bb) override;
  ...
  grpc_byte_buffer* grpc_raw_byte_buffer_create(
      grpc_slice* slice, size_t nslices) override;
  ...
  grpc_slice grpc_slice_split_head(grpc_slice* s,
                                   size_t split) override;
  grpc_slice grpc_slice_sub(grpc_slice s, size_t begin,
                            size_t end) override;
