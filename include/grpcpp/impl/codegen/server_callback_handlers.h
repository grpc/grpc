...
class CallbackUnaryHandler : public ::grpc::internal::MethodHandler {
 public:
  explicit CallbackUnaryHandler(
      std::function<ServerUnaryReactor*(::grpc::CallbackServerContext*, const RequestType*,
                                        ResponseType*)>
          get_reactor)
  ...
  void RunHandler(const HandlerParameter& param) final {
    ...
    auto* allocator_state =
        static_cast<MessageHolder<RequestType, ResponseType>*>(param.internal_data);

    auto* call = new (::grpc::g_core_codegen_interface->grpc_call_arena_alloc(
        param.call->call(), sizeof(ServerCallbackUnaryImpl)))
        ServerCallbackUnaryImpl(static_cast<::grpc::CallbackServerContext*>(param.server_context),
    ...
    if (param.status.ok()) {
      reactor = ::grpc::internal::CatchingReactorGetter<ServerUnaryReactor>(
          get_reactor_, static_cast<::grpc::CallbackServerContext*>(param.server_context),
    ...
    if (reactor == nullptr) {
      ...
      reactor = new (::grpc::g_core_codegen_interface->grpc_call_arena_alloc(
          ...
          UnimplementedUnaryReactor(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, ""));
    }
  ...
  void* Deserialize(grpc_call* call, grpc_byte_buffer* req, ::grpc::Status* status,
    ...
    if (allocator_ != nullptr) {
      ...
      allocator_state = new (::grpc::g_core_codegen_interface->grpc_call_arena_alloc(
 ...
 private:
  ...
  class ServerCallbackUnaryImpl : public ServerCallbackUnary {
   public:
    void Finish(::grpc::Status s) override {
      ...
      finish_tag_.Set(
          call_.call(),
          [this](bool) {
            this->MaybeDone(reactor_.load(std::memory_order_relaxed)->InternalInlineable());
          },
    ...
    void SendInitialMetadata() override {
      ...
      meta_tag_.Set(
          call_.call(),
          [this](bool ok) {
            ServerUnaryReactor* reactor = reactor_.load(std::memory_order_relaxed);
   ...
   private:
    ...
    ServerCallbackUnaryImpl(::grpc::CallbackServerContext* ctx, ::grpc::internal::Call* call,
    ...
    ServerReactor* reactor() override { return reactor_.load(std::memory_order_relaxed); }
    ...
    std::atomic<intptr_t> callbacks_outstanding_{3};  // reserve for start, Finish, and CompletionOp
  };
};
 ...
 public:
  ...
  void RunHandler(const HandlerParameter& param) final {
    ...
    auto* reader = new (::grpc::g_core_codegen_interface->grpc_call_arena_alloc(
        ...
        ServerCallbackReaderImpl(static_cast<::grpc::CallbackServerContext*>(param.server_context),
    ...
    param.server_context->BeginCompletionOp(
        param.call, [reader](bool) { reader->MaybeDone(/*inlineable_ondone=*/false); }, reader);

    ServerReadReactor<RequestType>* reactor = nullptr;
    if (param.status.ok()) {
      reactor = ::grpc::internal::CatchingReactorGetter<ServerReadReactor<RequestType>>(
          get_reactor_, static_cast<::grpc::CallbackServerContext*>(param.server_context),
          reader->response());
    }
 ...
 private:
  ...
  class ServerCallbackReaderImpl : public ServerCallbackReader<RequestType> {
   public:
    ...
    void SendInitialMetadata() override {
      ...
      meta_tag_.Set(
          call_.call(),
          [this](bool ok) {
            ServerReadReactor<RequestType>* reactor = reactor_.load(std::memory_order_relaxed);
            reactor->OnSendInitialMetadataDone(ok);
            this->MaybeDone(/*inlineable_ondone=*/true);
          },
          &meta_ops_, /*can_inline=*/false);
   ...
   private:
    ...
    ServerCallbackReaderImpl(::grpc::CallbackServerContext* ctx, ::grpc::internal::Call* call,
                             std::function<void()> call_requester)
...
class CallbackServerStreamingHandler : public ::grpc::internal::MethodHandler {
 public:
  explicit CallbackServerStreamingHandler(std::function<ServerWriteReactor<ResponseType>*(
  ...
  void RunHandler(const HandlerParameter& param) final {
    ...
    auto* writer = new (::grpc::g_core_codegen_interface->grpc_call_arena_alloc(
        ...
        ServerCallbackWriterImpl(static_cast<::grpc::CallbackServerContext*>(param.server_context),
    ...
    // the DefaultReactor (which is unary).
    param.server_context->BeginCompletionOp(
        param.call, [writer](bool) { writer->MaybeDone(/*inlineable_ondone=*/false); }, writer);

    ServerWriteReactor<ResponseType>* reactor = nullptr;
    if (param.status.ok()) {
      reactor = ::grpc::internal::CatchingReactorGetter<ServerWriteReactor<ResponseType>>(
          get_reactor_, static_cast<::grpc::CallbackServerContext*>(param.server_context),
          writer->request());
    }
    if (reactor == nullptr) {
 ...
 private:
  ...
  class ServerCallbackWriterImpl : public ServerCallbackWriter<ResponseType> {
   public:
    ...
    void SendInitialMetadata() override {
      ...
      meta_tag_.Set(
          call_.call(),
          [this](bool ok) {
            ServerWriteReactor<ResponseType>* reactor = reactor_.load(std::memory_order_relaxed);
            reactor->OnSendInitialMetadataDone(ok);
            this->MaybeDone(/*inlineable_ondone=*/true);
          },
          &meta_ops_, /*can_inline=*/false);
   ...
   private:
    ...
    ServerCallbackWriterImpl(::grpc::CallbackServerContext* ctx, ::grpc::internal::Call* call,
                             const RequestType* req, std::function<void()> call_requester)
        : ctx_(ctx), call_(*call), req_(req), call_requester_(std::move(call_requester)) {}
...
class CallbackBidiHandler : public ::grpc::internal::MethodHandler {
 public:
  explicit CallbackBidiHandler(
      std::function<ServerBidiReactor<RequestType, ResponseType>*(::grpc::CallbackServerContext*)>
          get_reactor)
      : get_reactor_(std::move(get_reactor)) {}
  void RunHandler(const HandlerParameter& param) final {
    ::grpc::g_core_codegen_interface->grpc_call_ref(param.call->call());
    ...
    auto* stream = new (::grpc::g_core_codegen_interface->grpc_call_arena_alloc(
        ...
        ServerCallbackReaderWriterImpl(
            static_cast<::grpc::CallbackServerContext*>(param.server_context), param.call,
            param.call_requester);
    // Inlineable OnDone can be false in the CompletionOp callback because there
    // is no bidi reactor that has an inlineable OnDone; this only applies to
    // the DefaultReactor (which is unary).
    param.server_context->BeginCompletionOp(
        param.call, [stream](bool) { stream->MaybeDone(/*inlineable_ondone=*/false); }, stream);

    ServerBidiReactor<RequestType, ResponseType>* reactor = nullptr;
    if (param.status.ok()) {
      reactor =
          ::grpc::internal::CatchingReactorGetter<ServerBidiReactor<RequestType, ResponseType>>(
              get_reactor_, static_cast<::grpc::CallbackServerContext*>(param.server_context));
    }
    ...
    if (reactor == nullptr) {
      // if deserialization or reactor creator failed, we need to fail the call
      reactor = new (::grpc::g_core_codegen_interface->grpc_call_arena_alloc(
          param.call->call(), sizeof(UnimplementedBidiReactor<RequestType, ResponseType>)))
 ...
 private:
  ...
  class ServerCallbackReaderWriterImpl
   ...
   private:
    ...
    ServerCallbackReaderWriterImpl(::grpc::CallbackServerContext* ctx, ::grpc::internal::Call* call,
                                   std::function<void()> call_requester)
        : ctx_(ctx), call_(*call), call_requester_(std::move(call_requester)) {}
