...
// Wrapper around C-core grpc_authorization_policy_provider. Internally,
// it handles creating and updating authorization engine objects, using
// SDK authorization policy.
...
// Implementation obtains authorization policy from static string. This
// provider will always return the same authorization engines.
