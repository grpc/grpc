...
/// one request message to a server and receive one response message).
  ...
  namespace internal
  {
    ...
    public:
      ...
      template < class W >
	static ClientAsyncResponseReader < R >
	*Create (ChannelInterface * channel, CompletionQueue * cq,
		 const::grpc::internal::RpcMethod & method,
		 ClientContext * context, const W & request, bool start)
      {
	::grpc::internal::Call call =
	  channel->CreateCall (method, context, cq);
	return new (g_core_codegen_interface->
		    grpc_call_arena_alloc (call.call (),
					   sizeof (ClientAsyncResponseReader <
						   R >)))
...
template < class R > class ClientAsyncResponseReader final:public ClientAsyncResponseReaderInterface <
    R >
  {
  public:
  ...
  private:
    ...
    template < class W >
      ClientAsyncResponseReader (::grpc::internal::Call call,
				 ...
				 bool start):context_ (context), call_ (call),
      started_ (start)
    {
    ...
    ::grpc::internal::SneakyCallOpSet <::grpc::internal::
      CallOpSendInitialMetadata,::grpc::internal::CallOpSendMessage,::grpc::
      internal::CallOpClientSendClose > init_buf;
    ::grpc::internal::CallOpSet <::grpc::internal::CallOpRecvInitialMetadata >
      meta_buf;
    ::grpc::internal::CallOpSet <::grpc::internal::
      CallOpRecvInitialMetadata,::grpc::internal::CallOpRecvMessage <
      R >,::grpc::internal::CallOpClientRecvStatus > finish_buf;
  };

/// Async server-side API for handling unary calls, where the single
/// response message sent to the client is of type \a W.
template < class W > class ServerAsyncResponseWriter final:public internal::
    ServerAsyncStreamingInterface
  {
  public:
  explicit ServerAsyncResponseWriter (ServerContext * ctx):call_ (nullptr, nullptr, nullptr),
      ctx_ (ctx)
    {
    }
  ...
  private:
    ...
    ::grpc::internal::CallOpSet <::grpc::internal::
      CallOpSendInitialMetadata,::grpc::internal::CallOpSendMessage,::grpc::
      internal::CallOpServerSendStatus > finish_buf_;
  };
