...
/// An interface that yields a sequence of messages of type \a R.
    template < class R > class ReaderInterface
    {
    public:
...
/// An interface that can be fed a sequence of messages of type \a W.
    template < class W > class WriterInterface
    {
    public:
...
template < class R > class ClientReaderInterface:public internal::ClientStreamingInterface,
    public internal::ReaderInterface <
    R >
  {
  public:
  ...
  namespace internal
  {
    template < class R > class ClientReaderFactory
    {
    public:
      template < class W >
...
/// of type \a R.
template < class R > class ClientReader final:public ClientReaderInterface <
    R >
  {
  public:
  ...
  template < class W > ClientReader (::grpc::ChannelInterface * channel, const::grpc::internal::RpcMethod & method, ClientContext * context, const W & request):context_ (context),
      cq_
      (grpc_completion_queue_attributes
       {
       GRPC_CQ_CURRENT_VERSION, GRPC_CQ_PLUCK, GRPC_CQ_DEFAULT_POLLING}),	// Pluckable cq
      call_ (channel->CreateCall (method, context, &cq_))
    {
      ::grpc::internal::CallOpSet <::grpc::internal::
	CallOpSendInitialMetadata,::grpc::internal::CallOpSendMessage,::grpc::
	internal::CallOpClientSendClose > ops;
...
template < class W > class ClientWriterInterface:public internal::ClientStreamingInterface,
    public internal::WriterInterface <
    W >
  {
  public:
  ...
  namespace internal
  {
    template < class W > class ClientWriterFactory
    {
    public:
      template < class R >
...
template < class W > class ClientWriter:public ClientWriterInterface < W >
  ...
  template < class R > ClientWriter (ChannelInterface * channel, const::grpc::internal::RpcMethod & method, ClientContext * context, R * response):context_ (context),
      cq_
      (grpc_completion_queue_attributes
       {
       GRPC_CQ_CURRENT_VERSION, GRPC_CQ_PLUCK, GRPC_CQ_DEFAULT_POLLING}),	// Pluckable cq
...
template < class W, class R > class ClientReaderWriterInterface:public internal::ClientStreamingInterface,
  ...
  namespace internal
  {
    template < class W, class R > class ClientReaderWriterFactory
    {
    public:
      static ClientReaderWriter < W,
	R > *Create (::grpc::ChannelInterface * channel,
...
template < class W, class R > class ClientReaderWriter final:public ClientReaderWriterInterface < W,
    R >
  {
  public:
  ...
  ClientReaderWriter (::grpc::ChannelInterface * channel, const::grpc::internal::RpcMethod & method, ClientContext * context):context_ (context),
      cq_
      (grpc_completion_queue_attributes
       {
       GRPC_CQ_CURRENT_VERSION, GRPC_CQ_PLUCK, GRPC_CQ_DEFAULT_POLLING}),	// Pluckable cq
...
template < class R > class ServerReaderInterface:public internal::ServerStreamingInterface,
    public internal::ReaderInterface <
    R >
  {
  };
...
/// type \a R.
template < class R > class ServerReader final:public ServerReaderInterface <
    R >
  {
  public:
  ...
  ServerReader (internal::Call * call, ServerContext * ctx):call_ (call),
      ctx_ (ctx)
    {
    }
  };
...
template < class W > class ServerWriterInterface:public internal::ServerStreamingInterface,
    public internal::WriterInterface <
    W >
  {
  };
...
template < class W > class ServerWriter final:public ServerWriterInterface <
    W >
  {
  public:
    /// See the \a ServerStreamingInterface.SendInitialMetadata method
      ...
      if (!ctx_->sent_initial_metadata_)
	{
	  ...
	  if (ctx_->compression_level_set ())
	    {
	      ctx_->pending_ops_.set_compression_level (ctx_->
							compression_level ());
	    }
	  ctx_->sent_initial_metadata_ = true;
	}
  ...
  ServerWriter (internal::Call * call, ServerContext * ctx):call_ (call),
      ctx_ (ctx)
    {
    }
  };
...
template < class W, class R > class ServerReaderWriterInterface:public internal::ServerStreamingInterface,
    public internal::WriterInterface < W >,
    public internal::ReaderInterface < R >
  {
  };
...
/// Actual implementation of bi-directional streaming
  namespace internal
  {
    template < class W, class R > class ServerReaderWriterBody final
    {
    public:
    ServerReaderWriterBody (Call * call, ServerContext * ctx):call_ (call),
	ctx_
	(ctx)
      {
      }
...
template < class W, class R > class ServerReaderWriter final:public ServerReaderWriterInterface < W,
    R >
  {
  public:
    /// See the \a ServerStreamingInterface.SendInitialMetadata method
  ...
  ServerReaderWriter (internal::Call * call, ServerContext * ctx):body_ (call,
	   ctx)
    {
    }
  };
...
template < class RequestType, class ResponseType > class ServerUnaryStreamer final:public ServerReaderWriterInterface < ResponseType,
    RequestType
    >
  {
  public:
  ...
  ServerUnaryStreamer (internal::Call * call, ServerContext * ctx):body_ (call, ctx), read_done_ (false),
      write_done_
      (false)
    {
    }
...
template < class RequestType, class ResponseType > class ServerSplitStreamer final:public ServerReaderWriterInterface < ResponseType,
    RequestType
    >
  {
  public:
  ...
  ServerSplitStreamer (internal::Call * call, ServerContext * ctx):body_ (call, ctx),
      read_done_
      (false)
    {
    }
