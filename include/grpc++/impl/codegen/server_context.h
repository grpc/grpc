...
/// \warning ServerContext instances should \em not be reused across rpcs.
  ...
  public:
    ...
    /// must end in "-bin".
    void AddInitialMetadata (const grpc::string & key,
    ...
    /// \param meta_value The metadata value. If its value is binary, the key name
    /// must end in "-bin".
    void AddTrailingMetadata (const grpc::string & key,
			      const grpc::string & value);
    ...
    const std::multimap < grpc::string_ref,
      grpc::string_ref > &client_metadata () const
    {
    ...
    void SetLoadReportingCosts (const std::vector < grpc::string >
				&cost_data);
  ...
  private:
    ...
    template < class W, class R > friend class::grpc::ServerAsyncReader;
    template < class W > friend class::grpc::ServerAsyncWriter;
    template < class W > friend class::grpc::ServerAsyncResponseWriter;
    template < class W, class R > friend class::grpc::ServerAsyncReaderWriter;
    ...
    internal::CallOpSet < internal::CallOpSendInitialMetadata,
      internal::CallOpSendMessage > pending_ops_;
