...
namespace grpc
{
  ...
  namespace internal
  {
    ...
    class RpcMethod;
      ...
      template < class R > class ClientAsyncResponseReaderFactory;
  }				// namespace internal
...
/// Codegen interface for \a grpc::Channel.
  ...
  public:
    ...
    /// deadline expires. \a GetState needs to called to get the current state.
      ...
      void NotifyOnStateChange (grpc_connectivity_state last_observed,
				T deadline, CompletionQueue * cq, void *tag)
    {
  ...
  private:
    ...
    virtual void NotifyOnStateChangeImpl (grpc_connectivity_state
					  last_observed,
					  gpr_timespec deadline,
					  CompletionQueue * cq, void *tag) =
      0;
    virtual bool WaitForStateChangeImpl (grpc_connectivity_state
					 last_observed,
