  ...
  public:
    ...
    virtual const grpc_completion_queue_factory
      *grpc_completion_queue_factory_lookup (const
					     ...
					     * attributes) = 0;
    virtual grpc_completion_queue *grpc_completion_queue_create (const
								 ...
								 *reserved) =
      0;
    virtual grpc_completion_queue *grpc_completion_queue_create_for_next (void
									  *reserved)
      = 0;
    virtual grpc_completion_queue
      *grpc_completion_queue_create_for_pluck (void *reserved) = 0;
    virtual void grpc_completion_queue_destroy (grpc_completion_queue * cq) =
      0;
    virtual grpc_event grpc_completion_queue_pluck (grpc_completion_queue *
						    cq, void *tag,
    ...
    virtual grpc_byte_buffer *grpc_byte_buffer_copy (grpc_byte_buffer * bb) =
      0;
    virtual void grpc_byte_buffer_destroy (grpc_byte_buffer * bb) = 0;

    virtual int grpc_byte_buffer_reader_init (grpc_byte_buffer_reader *
					      reader,
					      grpc_byte_buffer *
					      buffer) GRPC_MUST_USE_RESULT =
      0;
    virtual void grpc_byte_buffer_reader_destroy (grpc_byte_buffer_reader *
						  reader) = 0;
    virtual int grpc_byte_buffer_reader_next (grpc_byte_buffer_reader *
					      reader, grpc_slice * slice) = 0;
    ...
    virtual grpc_slice grpc_slice_split_tail (grpc_slice * s, size_t split) =
      0;
    virtual grpc_slice grpc_slice_split_head (grpc_slice * s, size_t split) =
      0;
    ...
    virtual void grpc_metadata_array_destroy (grpc_metadata_array * array) =
      0;
