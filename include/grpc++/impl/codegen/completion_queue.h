...
namespace grpc
{
  ...
  namespace internal
  {
    template < class W, class R > class ServerReaderWriterBody;
  }				// namespace internal
...
/// performance servers.
  ...
  public:
    ...
    /// instance.
    CompletionQueue ():CompletionQueue (grpc_completion_queue_attributes
					{
					GRPC_CQ_CURRENT_VERSION, GRPC_CQ_NEXT,
  ...
  protected:
    ...
    CompletionQueue (const grpc_completion_queue_attributes & attributes)
    {
      cq_ =
	g_core_codegen_interface->
	grpc_completion_queue_create (g_core_codegen_interface->
  ...
  private:
    ...
    NextStatus AsyncNextInternal (void **tag, bool * ok,
	...
	g_core_codegen_interface->gpr_inf_future (GPR_CLOCK_REALTIME);
      auto ev =
	g_core_codegen_interface->grpc_completion_queue_pluck (cq_, tag,
							       deadline,
							       nullptr);
    ...
    {
      auto deadline =
	g_core_codegen_interface->gpr_time_0 (GPR_CLOCK_REALTIME);
      auto ev =
	g_core_codegen_interface->grpc_completion_queue_pluck (cq_, tag,
							       deadline,
							       nullptr);
...
/// by servers. Instantiated by \a ServerBuilder.
  ...
  private:
    ...
    /// frequently polled.
  ServerCompletionQueue (grpc_cq_polling_type polling_type):CompletionQueue
