...
/// \see https://grpc.io/docs/guides/auth.html
  ...
  protected:
    friend std::shared_ptr < ChannelCredentials >
      CompositeChannelCredentials (const std::shared_ptr <
				   ChannelCredentials > &channel_creds,
  ...
  private:
      ...
      CreateCustomChannel (const grpc::string & target,
			   ...
			   &creds, const ChannelArguments & args);

    virtual std::shared_ptr < Channel >
      CreateChannel (const grpc::string & target,
...
/// \see https://grpc.io/docs/guides/auth.html
  ...
  protected:
    ...
    friend std::shared_ptr < CallCredentials >
...
/// User defined metadata credentials.
  ...
  public:
    ...
    /// the server.
    virtual Status GetMetadata (grpc::string_ref service_url,
				grpc::string_ref method_name,
				const AuthContext & channel_auth_context,
				std::multimap < grpc::string,
				grpc::string > *metadata) = 0;
  };
