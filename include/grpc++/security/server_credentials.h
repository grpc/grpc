...
/// Wrapper around \a grpc_server_credentials, a way to authenticate a server.
  ...
  public:
    ...
    virtual void SetAuthMetadataProcessor (const std::shared_ptr <
...
/// Options to create ServerCredentials with SSL
  struct SslServerCredentialsOptions
  {
    ...
    SslServerCredentialsOptions (grpc_ssl_client_certificate_request_type
				 request_type):force_client_auth (false),
