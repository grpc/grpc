...
/// by name.
  ...
  {
  public:
    explicit GenericStub (std::shared_ptr < ChannelInterface >
    ...
    std::unique_ptr < GenericClientAsyncReaderWriter >
      Call (ClientContext * context, const grpc::string & method,
    ...
    /// The return value only indicates whether or not registration of the call
    /// succeeded (i.e. the call won't proceed if the return value is nullptr).
      std::unique_ptr < GenericClientAsyncResponseReader >
      PrepareUnaryCall (ClientContext * context, const grpc::string & method,
