...
namespace grpc
{
  ...
  template < class W, class R > class MockClientReaderWriter:public ClientReaderWriterInterface < W,
      R >
    {
    public:
...
/// TODO: We do not support mocking an async RPC for now.
  ...
  template < class R > class MockClientAsyncResponseReader:public ClientAsyncResponseReaderInterface <
      R >
    {
    public:
  ...
  template < class R > class MockClientAsyncReader:public ClientAsyncReaderInterface <
      R >
    {
    public:
  ...
  template < class W > class MockClientAsyncWriter:public ClientAsyncWriterInterface <
      W >
    {
    public:
  ...
  template < class W, class R > class MockClientAsyncReaderWriter:public ClientAsyncReaderWriterInterface < W,
      R >
    {
    public:
