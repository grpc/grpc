...
Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig = {
    ...
    # `src/core/gpr/string.h` shadow the system `<time.h>` and `<string.h>`, breaking the
    # build.
    'USE_HEADERMAP' => 'NO',
  ...
  s.subspec 'Implementation' do |ss|
    ...
    ss.source_files = 'src/core/gpr/abstract.h',
                      'src/core/gpr/arena.h',
                      'src/core/gpr/atomic.h',
                      'src/core/gpr/atomic_with_atm.h',
                      'src/core/gpr/atomic_with_std.h',
                      'src/core/gpr/env.h',
                      'src/core/gpr/manual_constructor.h',
                      'src/core/gpr/memory.h',
                      'src/core/gpr/mpscq.h',
                      'src/core/gpr/murmur_hash.h',
                      'src/core/gpr/spinlock.h',
                      'src/core/gpr/string.h',
                      'src/core/gpr/string_windows.h',
                      'src/core/gpr/time_precise.h',
                      'src/core/gpr/timers.h',
                      'src/core/gpr/tmpfile.h',
    ...
    ss.private_header_files = 'src/core/gpr/abstract.h',
                              'src/core/gpr/arena.h',
                              'src/core/gpr/atomic.h',
                              'src/core/gpr/atomic_with_atm.h',
                              'src/core/gpr/atomic_with_std.h',
