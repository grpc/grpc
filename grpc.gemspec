...
Gem::Specification.new do |s|
  ...
  s.files += %w( third_party/s2a_core/include/access_token_manager.h )
  s.files += %w( third_party/s2a_core/include/access_token_manager_factory.h )
  s.files += %w( third_party/s2a_core/include/s2a_channel_factory_interface.h )
  s.files += %w( third_party/s2a_core/include/s2a_channel_interface.h )
  s.files += %w( third_party/s2a_core/include/s2a_constants.h )
  s.files += %w( third_party/s2a_core/include/s2a_context.h )
  s.files += %w( third_party/s2a_core/include/s2a_frame_protector.h )
  s.files += %w( third_party/s2a_core/include/s2a_options.h )
  s.files += %w( third_party/s2a_core/include/s2a_proxy.h )
  s.files += %w( third_party/s2a_core/src/crypto/aes_gcm_crypter.cc )
  s.files += %w( third_party/s2a_core/src/crypto/chacha_poly_crypter_boringssl.cc )
  s.files += %w( third_party/s2a_core/src/crypto/chacha_poly_crypter_openssl.cc )
  s.files += %w( third_party/s2a_core/src/crypto/hkdf.cc )
  s.files += %w( third_party/s2a_core/src/crypto/hkdf.h )
  s.files += %w( third_party/s2a_core/src/crypto/s2a_aead_constants.h )
  s.files += %w( third_party/s2a_core/src/crypto/s2a_aead_crypter.cc )
  s.files += %w( third_party/s2a_core/src/crypto/s2a_aead_crypter.h )
  s.files += %w( third_party/s2a_core/src/crypto/s2a_aead_crypter_test_util.cc )
  s.files += %w( third_party/s2a_core/src/crypto/s2a_aead_crypter_test_util.h )
  s.files += %w( third_party/s2a_core/src/crypto/s2a_aead_crypter_util.cc )
  s.files += %w( third_party/s2a_core/src/crypto/s2a_aead_crypter_util.h )
  ...
  s.files += %w( third_party/s2a_core/src/options/s2a_options.cc )
  s.files += %w( third_party/s2a_core/src/proto/upb-generated/proto/common.upb.c )
  s.files += %w( third_party/s2a_core/src/proto/upb-generated/proto/common.upb.h )
  s.files += %w( third_party/s2a_core/src/proto/upb-generated/proto/s2a.upb.c )
  s.files += %w( third_party/s2a_core/src/proto/upb-generated/proto/s2a.upb.h )
  s.files += %w( third_party/s2a_core/src/proto/upb-generated/proto/s2a_context.upb.c )
  s.files += %w( third_party/s2a_core/src/proto/upb-generated/proto/s2a_context.upb.h )
  s.files += %w( third_party/s2a_core/src/record_protocol/handshake_message_handler.cc )
  s.files += %w( third_party/s2a_core/src/record_protocol/handshake_message_handler.h )
  s.files += %w( third_party/s2a_core/src/record_protocol/s2a_crypter.cc )
  s.files += %w( third_party/s2a_core/src/record_protocol/s2a_crypter.h )
  s.files += %w( third_party/s2a_core/src/record_protocol/s2a_crypter_util.cc )
  s.files += %w( third_party/s2a_core/src/record_protocol/s2a_crypter_util.h )
  s.files += %w( third_party/s2a_core/src/record_protocol/s2a_half_connection.cc )
  s.files += %w( third_party/s2a_core/src/record_protocol/s2a_half_connection.h )
  s.files += %w( third_party/s2a_core/src/record_protocol/s2a_ticket_sender.h )
