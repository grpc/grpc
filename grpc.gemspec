...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/ext/filters/client_channel/lb_policy/xds/xds_locality_attribute.cc )
  s.files += %w( src/core/ext/filters/client_channel/lb_policy/xds/xds_locality_attribute.h )
