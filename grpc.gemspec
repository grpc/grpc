...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/ext/filters/stateful_session_affinity/stateful_session_affinity_filter.cc )
  s.files += %w( src/core/ext/filters/stateful_session_affinity/stateful_session_affinity_filter.h )
  s.files += %w( src/core/ext/filters/stateful_session_affinity/stateful_session_affinity_service_config_parser.cc )
  s.files += %w( src/core/ext/filters/stateful_session_affinity/stateful_session_affinity_service_config_parser.h )
  ...
  s.files += %w( src/core/ext/xds/xds_http_stateful_session_affinity_filter.cc )
  s.files += %w( src/core/ext/xds/xds_http_stateful_session_affinity_filter.h )
