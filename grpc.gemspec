...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/tsi/fake/fake_transport_security.h )
  s.files += %w( src/core/tsi/local/local_transport_security.h )
  s.files += %w( src/core/tsi/ssl/load_system_roots.h )
  s.files += %w( src/core/tsi/ssl/load_system_roots_linux.h )
  s.files += %w( src/core/tsi/ssl/session_cache/ssl_session.h )
  s.files += %w( src/core/tsi/ssl/session_cache/ssl_session_cache.h )
  s.files += %w( src/core/tsi/ssl/ssl_transport_security.h )
  s.files += %w( src/core/tsi/ssl/ssl_transport_security_util.h )
  ...
  s.files += %w( src/core/tsi/fake/fake_transport_security.cc )
  s.files += %w( src/core/tsi/local/local_transport_security.cc )
  s.files += %w( src/core/tsi/ssl/load_system_roots_fallback.cc )
  s.files += %w( src/core/tsi/ssl/load_system_roots_linux.cc )
  ...
  s.files += %w( src/core/tsi/ssl/ssl_transport_security.cc )
  s.files += %w( src/core/tsi/ssl/ssl_transport_security_util.cc )
