...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/ext/filters/client_channel/resolver/plugin/plugin_resolver.h )
  ...
  s.files += %w( src/core/ext/filters/client_channel/resolver/plugin/plugin_resolver.cc )
