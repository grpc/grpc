...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/lib/iomgr/vsock_sockets_posix.cc )
  s.files += %w( src/core/lib/iomgr/vsock_sockets_posix.h )
  ...
  s.files += %w( third_party/boringssl/crypto/err_data.c )
