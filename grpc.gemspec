...
Gem::Specification.new do |s|
  ...
  s.files += %w( include/grpc/impl/codegen/codegen_atm.h )
  s.files += %w( include/grpc/impl/codegen/codegen_atm_gcc_atomic.h )
  s.files += %w( include/grpc/impl/codegen/codegen_atm_gcc_sync.h )
  s.files += %w( include/grpc/impl/codegen/codegen_atm_windows.h )
  s.files += %w( include/grpc/impl/codegen/codegen_gpr_slice.h )
  s.files += %w( include/grpc/impl/codegen/codegen_gpr_types.h )
  s.files += %w( include/grpc/impl/codegen/codegen_port_platform.h )
  s.files += %w( include/grpc/impl/codegen/codegen_sync.h )
  s.files += %w( include/grpc/impl/codegen/codegen_sync_custom.h )
  s.files += %w( include/grpc/impl/codegen/codegen_sync_generic.h )
  s.files += %w( include/grpc/impl/codegen/codegen_sync_posix.h )
  s.files += %w( include/grpc/impl/codegen/codegen_sync_windows.h )
  ...
  s.files += %w( include/grpc/impl/codegen/codegen_byte_buffer.h )
  s.files += %w( include/grpc/impl/codegen/codegen_byte_buffer_reader.h )
  s.files += %w( include/grpc/impl/codegen/codegen_compression_types.h )
  s.files += %w( include/grpc/impl/codegen/codegen_connectivity_state.h )
  s.files += %w( include/grpc/impl/codegen/codegen_exec_ctx_fwd.h )
  s.files += %w( include/grpc/impl/codegen/codegen_grpc_types.h )
  s.files += %w( include/grpc/impl/codegen/codegen_propagation_bits.h )
  s.files += %w( include/grpc/impl/codegen/codegen_slice.h )
  s.files += %w( include/grpc/impl/codegen/codegen_status.h )
  s.files += %w( include/grpc/impl/codegen/codegen_atm.h )
  s.files += %w( include/grpc/impl/codegen/codegen_atm_gcc_atomic.h )
  s.files += %w( include/grpc/impl/codegen/codegen_atm_gcc_sync.h )
  s.files += %w( include/grpc/impl/codegen/codegen_atm_windows.h )
