...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/ext/filters/client_channel/parse_address_novsock.cc )
  s.files += %w( src/core/ext/filters/client_channel/parse_address_vsock.cc )
  ...
  s.files += %w( src/core/lib/iomgr/novsock.cc )
