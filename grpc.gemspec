...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/handshaker/security/event_engine/secure_endpoint.cc )
  s.files += %w( src/core/handshaker/security/event_engine/secure_endpoint.h )
  ...
  s.files += %w( src/core/lib/iomgr/event_engine_shims/endpoint_pair.h )
  s.files += %w( src/core/lib/iomgr/event_engine_shims/endpoint_pair_posix.cc )
  s.files += %w( src/core/lib/iomgr/event_engine_shims/endpoint_pair_windows.cc )
