...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/lib/event_engine/channel_args.h )
  s.files += %w( src/core/lib/event_engine/event_engine.h )
  s.files += %w( src/core/lib/event_engine/port.h )
  s.files += %w( src/core/lib/event_engine/slice_allocator.cc )
  s.files += %w( src/core/lib/event_engine/slice_allocator.h )
