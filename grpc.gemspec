...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/lib/gpr/alloc_fallback.cc )
  s.files += %w( src/core/lib/gpr/alloc_linux.cc )
  s.files += %w( src/core/lib/gpr/alloc_posix.cc )
  s.files += %w( src/core/lib/gpr/alloc_windows.cc )
