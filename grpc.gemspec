...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/libuv/include/uv.h )
  s.files += %w( src/libuv/include/uv/android-ifaddrs.h )
  s.files += %w( src/libuv/include/uv/darwin.h )
  s.files += %w( src/libuv/include/uv/errno.h )
  s.files += %w( src/libuv/include/uv/linux.h )
  s.files += %w( src/libuv/include/uv/threadpool.h )
  s.files += %w( src/libuv/include/uv/tree.h )
  s.files += %w( src/libuv/include/uv/unix.h )
  s.files += %w( src/libuv/include/uv/version.h )
  s.files += %w( src/libuv/include/uv/win.h )
  s.files += %w( src/libuv/src/fs-poll.c )
  s.files += %w( src/libuv/src/heap-inl.h )
  s.files += %w( src/libuv/src/idna.c )
  s.files += %w( src/libuv/src/idna.h )
  s.files += %w( src/libuv/src/inet.c )
  s.files += %w( src/libuv/src/queue.h )
  s.files += %w( src/libuv/src/random.c )
  s.files += %w( src/libuv/src/strscpy.c )
  s.files += %w( src/libuv/src/strscpy.h )
  s.files += %w( src/libuv/src/threadpool.c )
  s.files += %w( src/libuv/src/timer.c )
  s.files += %w( src/libuv/src/unix/android-ifaddrs.c )
  s.files += %w( src/libuv/src/unix/async.c )
  s.files += %w( src/libuv/src/unix/atomic-ops.h )
  s.files += %w( src/libuv/src/unix/bsd-ifaddrs.c )
  s.files += %w( src/libuv/src/unix/core.c )
  s.files += %w( src/libuv/src/unix/darwin-proctitle.c )
  s.files += %w( src/libuv/src/unix/darwin-stub.h )
  s.files += %w( src/libuv/src/unix/darwin.c )
  s.files += %w( src/libuv/src/unix/dl.c )
  s.files += %w( src/libuv/src/unix/epoll.c )
  s.files += %w( src/libuv/src/unix/fs.c )
  s.files += %w( src/libuv/src/unix/fsevents.c )
  s.files += %w( src/libuv/src/unix/getaddrinfo.c )
  s.files += %w( src/libuv/src/unix/getnameinfo.c )
  s.files += %w( src/libuv/src/unix/internal.h )
  s.files += %w( src/libuv/src/unix/kqueue.c )
  s.files += %w( src/libuv/src/unix/linux-core.c )
  s.files += %w( src/libuv/src/unix/linux-inotify.c )
  s.files += %w( src/libuv/src/unix/linux-syscalls.c )
  s.files += %w( src/libuv/src/unix/linux-syscalls.h )
  s.files += %w( src/libuv/src/unix/loop-watcher.c )
  s.files += %w( src/libuv/src/unix/loop.c )
  s.files += %w( src/libuv/src/unix/pipe.c )
  s.files += %w( src/libuv/src/unix/poll.c )
  s.files += %w( src/libuv/src/unix/process.c )
  s.files += %w( src/libuv/src/unix/procfs-exepath.c )
  s.files += %w( src/libuv/src/unix/proctitle.c )
  s.files += %w( src/libuv/src/unix/pthread-fixes.c )
  s.files += %w( src/libuv/src/unix/random-devurandom.c )
  s.files += %w( src/libuv/src/unix/random-getentropy.c )
  s.files += %w( src/libuv/src/unix/random-getrandom.c )
  s.files += %w( src/libuv/src/unix/random-sysctl-linux.c )
  ...
  s.files += %w( src/libuv/src/unix/udp.c )
  s.files += %w( src/libuv/src/uv-common.c )
  s.files += %w( src/libuv/src/uv-common.h )
  s.files += %w( src/libuv/src/uv-data-getter-setters.c )
  s.files += %w( src/libuv/src/version.c )
  s.files += %w( src/libuv/src/win/async.c )
  s.files += %w( src/libuv/src/win/atomicops-inl.h )
  s.files += %w( src/libuv/src/win/core.c )
  s.files += %w( src/libuv/src/win/detect-wakeup.c )
  s.files += %w( src/libuv/src/win/dl.c )
  s.files += %w( src/libuv/src/win/error.c )
  s.files += %w( src/libuv/src/win/fs-event.c )
  s.files += %w( src/libuv/src/win/fs-fd-hash-inl.h )
  s.files += %w( src/libuv/src/win/fs.c )
  s.files += %w( src/libuv/src/win/getaddrinfo.c )
  s.files += %w( src/libuv/src/win/getnameinfo.c )
  s.files += %w( src/libuv/src/win/handle-inl.h )
  s.files += %w( src/libuv/src/win/handle.c )
  s.files += %w( src/libuv/src/win/internal.h )
  s.files += %w( src/libuv/src/win/loop-watcher.c )
  s.files += %w( src/libuv/src/win/pipe.c )
  s.files += %w( src/libuv/src/win/poll.c )
  s.files += %w( src/libuv/src/win/process-stdio.c )
  s.files += %w( src/libuv/src/win/process.c )
  s.files += %w( src/libuv/src/win/req-inl.h )
  s.files += %w( src/libuv/src/win/signal.c )
  s.files += %w( src/libuv/src/win/stream-inl.h )
  s.files += %w( src/libuv/src/win/stream.c )
  s.files += %w( src/libuv/src/win/tcp.c )
  s.files += %w( src/libuv/src/win/thread.c )
  s.files += %w( src/libuv/src/win/tty.c )
  s.files += %w( src/libuv/src/win/udp.c )
  s.files += %w( src/libuv/src/win/util.c )
  s.files += %w( src/libuv/src/win/winapi.c )
  s.files += %w( src/libuv/src/win/winapi.h )
  s.files += %w( src/libuv/src/win/winsock.c )
  s.files += %w( src/libuv/src/win/winsock.h )
  ...
  s.files += %w( third_party/libuv/docs/code/cgi/main.c )
  s.files += %w( third_party/libuv/docs/code/cgi/tick.c )
  s.files += %w( third_party/libuv/docs/code/detach/main.c )
  s.files += %w( third_party/libuv/docs/code/dns/main.c )
  s.files += %w( third_party/libuv/docs/code/helloworld/main.c )
  s.files += %w( third_party/libuv/docs/code/idle-basic/main.c )
  s.files += %w( third_party/libuv/docs/code/idle-compute/main.c )
  s.files += %w( third_party/libuv/docs/code/interfaces/main.c )
  s.files += %w( third_party/libuv/docs/code/locks/main.c )
  s.files += %w( third_party/libuv/docs/code/multi-echo-server/main.c )
  s.files += %w( third_party/libuv/docs/code/multi-echo-server/worker.c )
  s.files += %w( third_party/libuv/docs/code/onchange/main.c )
  s.files += %w( third_party/libuv/docs/code/pipe-echo-server/main.c )
  s.files += %w( third_party/libuv/docs/code/plugin/hello.c )
  s.files += %w( third_party/libuv/docs/code/plugin/main.c )
  s.files += %w( third_party/libuv/docs/code/plugin/plugin.h )
  s.files += %w( third_party/libuv/docs/code/proc-streams/main.c )
  s.files += %w( third_party/libuv/docs/code/proc-streams/test.c )
  s.files += %w( third_party/libuv/docs/code/progress/main.c )
  s.files += %w( third_party/libuv/docs/code/queue-cancel/main.c )
  s.files += %w( third_party/libuv/docs/code/queue-work/main.c )
  s.files += %w( third_party/libuv/docs/code/ref-timer/main.c )
  s.files += %w( third_party/libuv/docs/code/signal/main.c )
  s.files += %w( third_party/libuv/docs/code/spawn/main.c )
  s.files += %w( third_party/libuv/docs/code/tcp-echo-server/main.c )
  s.files += %w( third_party/libuv/docs/code/thread-create/main.c )
  s.files += %w( third_party/libuv/docs/code/tty-gravity/main.c )
  s.files += %w( third_party/libuv/docs/code/tty/main.c )
  s.files += %w( third_party/libuv/docs/code/udp-dhcp/main.c )
  s.files += %w( third_party/libuv/docs/code/uvcat/main.c )
  s.files += %w( third_party/libuv/docs/code/uvstop/main.c )
  s.files += %w( third_party/libuv/docs/code/uvtee/main.c )
  s.files += %w( third_party/libuv/docs/code/uvwget/main.c )
  s.files += %w( third_party/libuv/include/uv.h )
  s.files += %w( third_party/libuv/include/uv/aix.h )
  s.files += %w( third_party/libuv/include/uv/android-ifaddrs.h )
  s.files += %w( third_party/libuv/include/uv/bsd.h )
  ...
  s.files += %w( third_party/libuv/include/uv/os390.h )
  s.files += %w( third_party/libuv/include/uv/posix.h )
  s.files += %w( third_party/libuv/include/uv/stdint-msvc2008.h )
  s.files += %w( third_party/libuv/include/uv/sunos.h )
  ...
  s.files += %w( third_party/libuv/src/unix/aix-common.c )
  s.files += %w( third_party/libuv/src/unix/aix.c )
  s.files += %w( third_party/libuv/src/unix/android-ifaddrs.c )
  ...
  s.files += %w( third_party/libuv/src/unix/bsd-proctitle.c )
  s.files += %w( third_party/libuv/src/unix/core.c )
  s.files += %w( third_party/libuv/src/unix/cygwin.c )
  s.files += %w( third_party/libuv/src/unix/darwin-proctitle.c )
  s.files += %w( third_party/libuv/src/unix/darwin-stub.h )
  s.files += %w( third_party/libuv/src/unix/darwin.c )
  s.files += %w( third_party/libuv/src/unix/dl.c )
  s.files += %w( third_party/libuv/src/unix/epoll.c )
  s.files += %w( third_party/libuv/src/unix/freebsd.c )
  ...
  s.files += %w( third_party/libuv/src/unix/haiku.c )
  s.files += %w( third_party/libuv/src/unix/ibmi.c )
  ...
  s.files += %w( third_party/libuv/src/unix/netbsd.c )
  s.files += %w( third_party/libuv/src/unix/no-fsevents.c )
  s.files += %w( third_party/libuv/src/unix/no-proctitle.c )
  s.files += %w( third_party/libuv/src/unix/openbsd.c )
  s.files += %w( third_party/libuv/src/unix/os390-proctitle.c )
  s.files += %w( third_party/libuv/src/unix/os390-syscalls.c )
  s.files += %w( third_party/libuv/src/unix/os390-syscalls.h )
  s.files += %w( third_party/libuv/src/unix/os390.c )
  s.files += %w( third_party/libuv/src/unix/pipe.c )
  s.files += %w( third_party/libuv/src/unix/poll.c )
  s.files += %w( third_party/libuv/src/unix/posix-hrtime.c )
  s.files += %w( third_party/libuv/src/unix/posix-poll.c )
  ...
  s.files += %w( third_party/libuv/src/unix/pthread-fixes.c )
  s.files += %w( third_party/libuv/src/unix/qnx.c )
  ...
  s.files += %w( third_party/libuv/src/unix/sunos.c )
  s.files += %w( third_party/libuv/src/unix/sysinfo-loadavg.c )
  s.files += %w( third_party/libuv/src/unix/sysinfo-memory.c )
  ...
  s.files += %w( third_party/libuv/test/benchmark-async-pummel.c )
  s.files += %w( third_party/libuv/test/benchmark-async.c )
  s.files += %w( third_party/libuv/test/benchmark-fs-stat.c )
  s.files += %w( third_party/libuv/test/benchmark-getaddrinfo.c )
  s.files += %w( third_party/libuv/test/benchmark-list.h )
  s.files += %w( third_party/libuv/test/benchmark-loop-count.c )
  s.files += %w( third_party/libuv/test/benchmark-million-async.c )
  s.files += %w( third_party/libuv/test/benchmark-million-timers.c )
  s.files += %w( third_party/libuv/test/benchmark-multi-accept.c )
  s.files += %w( third_party/libuv/test/benchmark-ping-pongs.c )
  s.files += %w( third_party/libuv/test/benchmark-ping-udp.c )
  s.files += %w( third_party/libuv/test/benchmark-pound.c )
  s.files += %w( third_party/libuv/test/benchmark-pump.c )
  s.files += %w( third_party/libuv/test/benchmark-sizes.c )
  s.files += %w( third_party/libuv/test/benchmark-spawn.c )
  s.files += %w( third_party/libuv/test/benchmark-tcp-write-batch.c )
  s.files += %w( third_party/libuv/test/benchmark-thread.c )
  s.files += %w( third_party/libuv/test/benchmark-udp-pummel.c )
  s.files += %w( third_party/libuv/test/blackhole-server.c )
  s.files += %w( third_party/libuv/test/dns-server.c )
  s.files += %w( third_party/libuv/test/echo-server.c )
  s.files += %w( third_party/libuv/test/run-benchmarks.c )
  s.files += %w( third_party/libuv/test/run-tests.c )
  s.files += %w( third_party/libuv/test/runner-unix.c )
  s.files += %w( third_party/libuv/test/runner-unix.h )
  s.files += %w( third_party/libuv/test/runner-win.c )
  s.files += %w( third_party/libuv/test/runner-win.h )
  s.files += %w( third_party/libuv/test/runner.c )
  s.files += %w( third_party/libuv/test/runner.h )
  s.files += %w( third_party/libuv/test/task.h )
  s.files += %w( third_party/libuv/test/test-active.c )
  s.files += %w( third_party/libuv/test/test-async-null-cb.c )
  s.files += %w( third_party/libuv/test/test-async.c )
  s.files += %w( third_party/libuv/test/test-barrier.c )
  s.files += %w( third_party/libuv/test/test-callback-order.c )
  s.files += %w( third_party/libuv/test/test-callback-stack.c )
  s.files += %w( third_party/libuv/test/test-close-fd.c )
  s.files += %w( third_party/libuv/test/test-close-order.c )
  s.files += %w( third_party/libuv/test/test-condvar.c )
  s.files += %w( third_party/libuv/test/test-connect-unspecified.c )
  s.files += %w( third_party/libuv/test/test-connection-fail.c )
  s.files += %w( third_party/libuv/test/test-cwd-and-chdir.c )
  s.files += %w( third_party/libuv/test/test-default-loop-close.c )
  s.files += %w( third_party/libuv/test/test-delayed-accept.c )
  s.files += %w( third_party/libuv/test/test-dlerror.c )
  s.files += %w( third_party/libuv/test/test-eintr-handling.c )
  s.files += %w( third_party/libuv/test/test-embed.c )
  s.files += %w( third_party/libuv/test/test-emfile.c )
  s.files += %w( third_party/libuv/test/test-env-vars.c )
  s.files += %w( third_party/libuv/test/test-error.c )
  s.files += %w( third_party/libuv/test/test-fail-always.c )
  s.files += %w( third_party/libuv/test/test-fork.c )
  s.files += %w( third_party/libuv/test/test-fs-copyfile.c )
  s.files += %w( third_party/libuv/test/test-fs-event.c )
  s.files += %w( third_party/libuv/test/test-fs-fd-hash.c )
  s.files += %w( third_party/libuv/test/test-fs-open-flags.c )
  s.files += %w( third_party/libuv/test/test-fs-poll.c )
  s.files += %w( third_party/libuv/test/test-fs-readdir.c )
  s.files += %w( third_party/libuv/test/test-fs.c )
  s.files += %w( third_party/libuv/test/test-get-currentexe.c )
  s.files += %w( third_party/libuv/test/test-get-loadavg.c )
  s.files += %w( third_party/libuv/test/test-get-memory.c )
  s.files += %w( third_party/libuv/test/test-get-passwd.c )
  s.files += %w( third_party/libuv/test/test-getaddrinfo.c )
  s.files += %w( third_party/libuv/test/test-gethostname.c )
  s.files += %w( third_party/libuv/test/test-getnameinfo.c )
  s.files += %w( third_party/libuv/test/test-getsockname.c )
  s.files += %w( third_party/libuv/test/test-getters-setters.c )
  s.files += %w( third_party/libuv/test/test-gettimeofday.c )
  s.files += %w( third_party/libuv/test/test-handle-fileno.c )
  s.files += %w( third_party/libuv/test/test-homedir.c )
  s.files += %w( third_party/libuv/test/test-hrtime.c )
  s.files += %w( third_party/libuv/test/test-idle.c )
  s.files += %w( third_party/libuv/test/test-idna.c )
  s.files += %w( third_party/libuv/test/test-ip4-addr.c )
  s.files += %w( third_party/libuv/test/test-ip6-addr.c )
  s.files += %w( third_party/libuv/test/test-ipc-heavy-traffic-deadlock-bug.c )
  s.files += %w( third_party/libuv/test/test-ipc-send-recv.c )
  s.files += %w( third_party/libuv/test/test-ipc.c )
  s.files += %w( third_party/libuv/test/test-list.h )
  s.files += %w( third_party/libuv/test/test-loop-alive.c )
  s.files += %w( third_party/libuv/test/test-loop-close.c )
  s.files += %w( third_party/libuv/test/test-loop-configure.c )
  s.files += %w( third_party/libuv/test/test-loop-handles.c )
  s.files += %w( third_party/libuv/test/test-loop-stop.c )
  s.files += %w( third_party/libuv/test/test-loop-time.c )
  s.files += %w( third_party/libuv/test/test-metrics.c )
  s.files += %w( third_party/libuv/test/test-multiple-listen.c )
  s.files += %w( third_party/libuv/test/test-mutexes.c )
  s.files += %w( third_party/libuv/test/test-not-readable-nor-writable-on-read-error.c )
  s.files += %w( third_party/libuv/test/test-not-readable-on-eof.c )
  s.files += %w( third_party/libuv/test/test-not-writable-after-shutdown.c )
  s.files += %w( third_party/libuv/test/test-osx-select.c )
  s.files += %w( third_party/libuv/test/test-pass-always.c )
  s.files += %w( third_party/libuv/test/test-ping-pong.c )
  s.files += %w( third_party/libuv/test/test-pipe-bind-error.c )
  s.files += %w( third_party/libuv/test/test-pipe-close-stdout-read-stdin.c )
  s.files += %w( third_party/libuv/test/test-pipe-connect-error.c )
  s.files += %w( third_party/libuv/test/test-pipe-connect-multiple.c )
  s.files += %w( third_party/libuv/test/test-pipe-connect-prepare.c )
  s.files += %w( third_party/libuv/test/test-pipe-getsockname.c )
  s.files += %w( third_party/libuv/test/test-pipe-pending-instances.c )
  s.files += %w( third_party/libuv/test/test-pipe-sendmsg.c )
  s.files += %w( third_party/libuv/test/test-pipe-server-close.c )
  s.files += %w( third_party/libuv/test/test-pipe-set-fchmod.c )
  s.files += %w( third_party/libuv/test/test-pipe-set-non-blocking.c )
  s.files += %w( third_party/libuv/test/test-platform-output.c )
  s.files += %w( third_party/libuv/test/test-poll-close-doesnt-corrupt-stack.c )
  s.files += %w( third_party/libuv/test/test-poll-close.c )
  s.files += %w( third_party/libuv/test/test-poll-closesocket.c )
  s.files += %w( third_party/libuv/test/test-poll-multiple-handles.c )
  s.files += %w( third_party/libuv/test/test-poll-oob.c )
  s.files += %w( third_party/libuv/test/test-poll.c )
  s.files += %w( third_party/libuv/test/test-process-priority.c )
  s.files += %w( third_party/libuv/test/test-process-title-threadsafe.c )
  s.files += %w( third_party/libuv/test/test-process-title.c )
  s.files += %w( third_party/libuv/test/test-queue-foreach-delete.c )
  s.files += %w( third_party/libuv/test/test-random.c )
  s.files += %w( third_party/libuv/test/test-ref.c )
  s.files += %w( third_party/libuv/test/test-run-nowait.c )
  s.files += %w( third_party/libuv/test/test-run-once.c )
  s.files += %w( third_party/libuv/test/test-semaphore.c )
  s.files += %w( third_party/libuv/test/test-shutdown-close.c )
  s.files += %w( third_party/libuv/test/test-shutdown-eof.c )
  s.files += %w( third_party/libuv/test/test-shutdown-simultaneous.c )
  s.files += %w( third_party/libuv/test/test-shutdown-twice.c )
  s.files += %w( third_party/libuv/test/test-signal-multiple-loops.c )
  s.files += %w( third_party/libuv/test/test-signal-pending-on-close.c )
  s.files += %w( third_party/libuv/test/test-signal.c )
  s.files += %w( third_party/libuv/test/test-socket-buffer-size.c )
  s.files += %w( third_party/libuv/test/test-spawn.c )
  s.files += %w( third_party/libuv/test/test-stdio-over-pipes.c )
  s.files += %w( third_party/libuv/test/test-strscpy.c )
  s.files += %w( third_party/libuv/test/test-tcp-alloc-cb-fail.c )
  s.files += %w( third_party/libuv/test/test-tcp-bind-error.c )
  s.files += %w( third_party/libuv/test/test-tcp-bind6-error.c )
  s.files += %w( third_party/libuv/test/test-tcp-close-accept.c )
  s.files += %w( third_party/libuv/test/test-tcp-close-reset.c )
  s.files += %w( third_party/libuv/test/test-tcp-close-while-connecting.c )
  s.files += %w( third_party/libuv/test/test-tcp-close.c )
  s.files += %w( third_party/libuv/test/test-tcp-connect-error-after-write.c )
  s.files += %w( third_party/libuv/test/test-tcp-connect-error.c )
  s.files += %w( third_party/libuv/test/test-tcp-connect-timeout.c )
  s.files += %w( third_party/libuv/test/test-tcp-connect6-error.c )
  s.files += %w( third_party/libuv/test/test-tcp-create-socket-early.c )
  s.files += %w( third_party/libuv/test/test-tcp-flags.c )
  s.files += %w( third_party/libuv/test/test-tcp-oob.c )
  s.files += %w( third_party/libuv/test/test-tcp-open.c )
  s.files += %w( third_party/libuv/test/test-tcp-read-stop-start.c )
  s.files += %w( third_party/libuv/test/test-tcp-read-stop.c )
  s.files += %w( third_party/libuv/test/test-tcp-shutdown-after-write.c )
  s.files += %w( third_party/libuv/test/test-tcp-try-write-error.c )
  s.files += %w( third_party/libuv/test/test-tcp-try-write.c )
  s.files += %w( third_party/libuv/test/test-tcp-unexpected-read.c )
  s.files += %w( third_party/libuv/test/test-tcp-write-after-connect.c )
  s.files += %w( third_party/libuv/test/test-tcp-write-fail.c )
  s.files += %w( third_party/libuv/test/test-tcp-write-queue-order.c )
  s.files += %w( third_party/libuv/test/test-tcp-write-to-half-open-connection.c )
  s.files += %w( third_party/libuv/test/test-tcp-writealot.c )
  s.files += %w( third_party/libuv/test/test-test-macros.c )
  s.files += %w( third_party/libuv/test/test-thread-equal.c )
  s.files += %w( third_party/libuv/test/test-thread.c )
  s.files += %w( third_party/libuv/test/test-threadpool-cancel.c )
  s.files += %w( third_party/libuv/test/test-threadpool.c )
  s.files += %w( third_party/libuv/test/test-timer-again.c )
  s.files += %w( third_party/libuv/test/test-timer-from-check.c )
  s.files += %w( third_party/libuv/test/test-timer.c )
  s.files += %w( third_party/libuv/test/test-tmpdir.c )
  s.files += %w( third_party/libuv/test/test-tty-duplicate-key.c )
  s.files += %w( third_party/libuv/test/test-tty-escape-sequence-processing.c )
  s.files += %w( third_party/libuv/test/test-tty.c )
  s.files += %w( third_party/libuv/test/test-udp-alloc-cb-fail.c )
  s.files += %w( third_party/libuv/test/test-udp-bind.c )
  s.files += %w( third_party/libuv/test/test-udp-connect.c )
  s.files += %w( third_party/libuv/test/test-udp-create-socket-early.c )
  s.files += %w( third_party/libuv/test/test-udp-dgram-too-big.c )
  s.files += %w( third_party/libuv/test/test-udp-ipv6.c )
  s.files += %w( third_party/libuv/test/test-udp-mmsg.c )
  s.files += %w( third_party/libuv/test/test-udp-multicast-interface.c )
  s.files += %w( third_party/libuv/test/test-udp-multicast-interface6.c )
  s.files += %w( third_party/libuv/test/test-udp-multicast-join.c )
  s.files += %w( third_party/libuv/test/test-udp-multicast-join6.c )
  s.files += %w( third_party/libuv/test/test-udp-multicast-ttl.c )
  s.files += %w( third_party/libuv/test/test-udp-open.c )
  s.files += %w( third_party/libuv/test/test-udp-options.c )
  s.files += %w( third_party/libuv/test/test-udp-send-and-recv.c )
  s.files += %w( third_party/libuv/test/test-udp-send-hang-loop.c )
  s.files += %w( third_party/libuv/test/test-udp-send-immediate.c )
  s.files += %w( third_party/libuv/test/test-udp-send-unreachable.c )
  s.files += %w( third_party/libuv/test/test-udp-sendmmsg-error.c )
  s.files += %w( third_party/libuv/test/test-udp-try-send.c )
  s.files += %w( third_party/libuv/test/test-uname.c )
  s.files += %w( third_party/libuv/test/test-walk-handles.c )
  s.files += %w( third_party/libuv/test/test-watcher-cross-stop.c )
