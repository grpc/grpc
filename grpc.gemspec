...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/gpr/abstract.h )
  s.files += %w( src/core/gpr/arena.h )
  s.files += %w( src/core/gpr/atomic.h )
  s.files += %w( src/core/gpr/atomic_with_atm.h )
  s.files += %w( src/core/gpr/atomic_with_std.h )
  s.files += %w( src/core/gpr/env.h )
  s.files += %w( src/core/gpr/manual_constructor.h )
  s.files += %w( src/core/gpr/memory.h )
  s.files += %w( src/core/gpr/mpscq.h )
  s.files += %w( src/core/gpr/murmur_hash.h )
  s.files += %w( src/core/gpr/spinlock.h )
  s.files += %w( src/core/gpr/string.h )
  s.files += %w( src/core/gpr/string_windows.h )
  s.files += %w( src/core/gpr/time_precise.h )
  s.files += %w( src/core/gpr/timers.h )
  s.files += %w( src/core/gpr/tmpfile.h )
  s.files += %w( src/core/gpr/alloc.cc )
  s.files += %w( src/core/gpr/arena.cc )
  s.files += %w( src/core/gpr/atm.cc )
  s.files += %w( src/core/gpr/avl.cc )
  s.files += %w( src/core/gpr/basic_timers.cc )
  s.files += %w( src/core/gpr/cmdline.cc )
  s.files += %w( src/core/gpr/cpu_iphone.cc )
  s.files += %w( src/core/gpr/cpu_linux.cc )
  s.files += %w( src/core/gpr/cpu_posix.cc )
  s.files += %w( src/core/gpr/cpu_windows.cc )
  s.files += %w( src/core/gpr/env_linux.cc )
  s.files += %w( src/core/gpr/env_posix.cc )
  s.files += %w( src/core/gpr/env_windows.cc )
  s.files += %w( src/core/gpr/histogram.cc )
  s.files += %w( src/core/gpr/host_port.cc )
  s.files += %w( src/core/gpr/log.cc )
  s.files += %w( src/core/gpr/log_android.cc )
  s.files += %w( src/core/gpr/log_linux.cc )
  s.files += %w( src/core/gpr/log_posix.cc )
  s.files += %w( src/core/gpr/log_windows.cc )
  s.files += %w( src/core/gpr/mpscq.cc )
  s.files += %w( src/core/gpr/murmur_hash.cc )
  s.files += %w( src/core/gpr/stap_timers.cc )
  s.files += %w( src/core/gpr/string.cc )
  s.files += %w( src/core/gpr/string_posix.cc )
  s.files += %w( src/core/gpr/string_util_windows.cc )
  s.files += %w( src/core/gpr/string_windows.cc )
  s.files += %w( src/core/gpr/subprocess_posix.cc )
  s.files += %w( src/core/gpr/subprocess_windows.cc )
  s.files += %w( src/core/gpr/sync.cc )
  s.files += %w( src/core/gpr/sync_posix.cc )
  s.files += %w( src/core/gpr/sync_windows.cc )
  s.files += %w( src/core/gpr/thd.cc )
  s.files += %w( src/core/gpr/thd_posix.cc )
  s.files += %w( src/core/gpr/thd_windows.cc )
  s.files += %w( src/core/gpr/time.cc )
  s.files += %w( src/core/gpr/time_posix.cc )
  s.files += %w( src/core/gpr/time_precise.cc )
  s.files += %w( src/core/gpr/time_windows.cc )
  s.files += %w( src/core/gpr/tls_pthread.cc )
  s.files += %w( src/core/gpr/tmpfile_msys.cc )
  s.files += %w( src/core/gpr/tmpfile_posix.cc )
  s.files += %w( src/core/gpr/tmpfile_windows.cc )
  s.files += %w( src/core/gpr/wrap_memcpy.cc )
  ...
  s.files += %w( src/core/gpr/vector.h )
