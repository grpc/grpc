...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/ext/upb-generated/src/proto/grpc/lookup/rls.upb.c )
  s.files += %w( src/core/ext/upb-generated/src/proto/grpc/lookup/rls.upb.h )
  ...
  s.files += %w( src/core/lib/gpr/random.cc )
  s.files += %w( src/core/lib/gpr/random.h )
