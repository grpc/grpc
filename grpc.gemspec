...
Gem::Specification.new do |s|
  ...
  s.files += %w( third_party/xxhash/cli/xsum_arch.h )
  s.files += %w( third_party/xxhash/cli/xsum_config.h )
  s.files += %w( third_party/xxhash/cli/xsum_os_specific.c )
  s.files += %w( third_party/xxhash/cli/xsum_os_specific.h )
  s.files += %w( third_party/xxhash/cli/xsum_output.c )
  s.files += %w( third_party/xxhash/cli/xsum_output.h )
  s.files += %w( third_party/xxhash/cli/xsum_sanity_check.c )
  s.files += %w( third_party/xxhash/cli/xsum_sanity_check.h )
  s.files += %w( third_party/xxhash/xxh3.h )
  s.files += %w( third_party/xxhash/xxh_x86dispatch.c )
  s.files += %w( third_party/xxhash/xxh_x86dispatch.h )
  s.files += %w( third_party/xxhash/xxhash.c )
  s.files += %w( third_party/xxhash/xxhash.h )
  s.files += %w( third_party/xxhash/xxhsum.c )
