...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/ext/http/format_request.h )
  s.files += %w( src/core/ext/http/httpcli.h )
  s.files += %w( src/core/ext/http/parser.h )
  s.files += %w( src/core/ext/transport/chttp2/alpn/alpn.h )
  s.files += %w( src/core/ext/security/context/security_context.h )
  s.files += %w( src/core/ext/security/credentials/credentials.h )
  s.files += %w( src/core/ext/security/credentials/fake/fake_credentials.h )
  s.files += %w( src/core/ext/security/credentials/composite/composite_credentials.h )
  s.files += %w( src/core/ext/security/credentials/iam/iam_credentials.h )
  s.files += %w( src/core/ext/security/credentials/jwt/json_token.h )
  s.files += %w( src/core/ext/security/credentials/jwt/jwt_credentials.h )
  s.files += %w( src/core/ext/security/credentials/jwt/jwt_verifier.h )
  s.files += %w( src/core/ext/security/util/b64.h )
  s.files += %w( src/core/ext/security/util/json_util.h )
  s.files += %w( src/core/ext/json/json.h )
  s.files += %w( src/core/ext/json/json_common.h )
  s.files += %w( src/core/ext/json/json_reader.h )
  s.files += %w( src/core/ext/json/json_writer.h )
  s.files += %w( src/core/ext/security/credentials/ssl/ssl_credentials.h )
  s.files += %w( src/core/ext/security/credentials/oauth2/oauth2_credentials.h )
  s.files += %w( src/core/ext/https/httpscli.h )
  s.files += %w( src/core/ext/security/credentials/plugin/plugin_credentials.h )
  s.files += %w( src/core/ext/security/credentials/google_default/google_default_credentials.h )
  s.files += %w( src/core/ext/security/transport/auth_filters.h )
  s.files += %w( src/core/ext/security/transport/handshake.h )
  s.files += %w( src/core/ext/security/transport/secure_endpoint.h )
  s.files += %w( src/core/ext/security/transport/security_connector.h )
  s.files += %w( src/core/ext/security/transport/tsi_error.h )
  s.files += %w( src/core/ext/tsi/fake_transport_security.h )
  s.files += %w( src/core/ext/tsi/ssl_transport_security.h )
  s.files += %w( src/core/ext/tsi/ssl_types.h )
  s.files += %w( src/core/ext/tsi/transport_security.h )
  s.files += %w( src/core/ext/tsi/transport_security_interface.h )
  ...
  s.files += %w( src/core/ext/http/format_request.c )
  s.files += %w( src/core/ext/http/httpcli.c )
  s.files += %w( src/core/ext/http/parser.c )
  s.files += %w( src/core/ext/transport/chttp2/alpn/alpn.c )
  s.files += %w( src/core/lib/surface/init_secure.c )
  s.files += %w( src/core/ext/security/context/security_context.c )
  s.files += %w( src/core/ext/security/credentials/credentials.c )
  s.files += %w( src/core/ext/security/credentials/credentials_metadata.c )
  s.files += %w( src/core/ext/security/credentials/fake/fake_credentials.c )
  s.files += %w( src/core/ext/security/credentials/composite/composite_credentials.c )
  s.files += %w( src/core/ext/security/credentials/iam/iam_credentials.c )
  s.files += %w( src/core/ext/security/credentials/jwt/json_token.c )
  s.files += %w( src/core/ext/security/credentials/jwt/jwt_credentials.c )
  s.files += %w( src/core/ext/security/credentials/jwt/jwt_verifier.c )
  s.files += %w( src/core/ext/security/util/b64.c )
  s.files += %w( src/core/ext/security/util/json_util.c )
  s.files += %w( src/core/ext/json/json.c )
  s.files += %w( src/core/ext/json/json_reader.c )
  s.files += %w( src/core/ext/json/json_string.c )
  s.files += %w( src/core/ext/json/json_writer.c )
  s.files += %w( src/core/ext/security/credentials/ssl/ssl_credentials.c )
  s.files += %w( src/core/ext/security/credentials/oauth2/oauth2_credentials.c )
  s.files += %w( src/core/ext/https/httpcli_security_connector.c )
  s.files += %w( src/core/ext/security/credentials/plugin/plugin_credentials.c )
  s.files += %w( src/core/ext/security/credentials/google_default/credentials_posix.c )
  s.files += %w( src/core/ext/security/credentials/google_default/credentials_windows.c )
  s.files += %w( src/core/ext/security/credentials/google_default/google_default_credentials.c )
  s.files += %w( src/core/ext/security/transport/client_auth_filter.c )
  s.files += %w( src/core/ext/security/transport/handshake.c )
  s.files += %w( src/core/ext/security/transport/secure_endpoint.c )
  s.files += %w( src/core/ext/security/transport/security_connector.c )
  s.files += %w( src/core/ext/security/transport/server_auth_filter.c )
  s.files += %w( src/core/ext/security/transport/tsi_error.c )
  s.files += %w( src/core/ext/tsi/fake_transport_security.c )
  s.files += %w( src/core/ext/tsi/ssl_transport_security.c )
  s.files += %w( src/core/ext/tsi/transport_security.c )
