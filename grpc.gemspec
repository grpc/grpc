...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/ext/filters/client_channel/status_string.h )
  ...
  s.files += %w( src/core/lib/transport/status_metadata.c )
  ...
  s.files += %w( src/core/ext/filters/client_channel/status_string.c )
