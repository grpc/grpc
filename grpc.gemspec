...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/channelz/zviz/data.cc )
  s.files += %w( src/core/channelz/zviz/data.h )
  s.files += %w( src/core/channelz/zviz/entity.cc )
  s.files += %w( src/core/channelz/zviz/entity.h )
  s.files += %w( src/core/channelz/zviz/environment.cc )
  s.files += %w( src/core/channelz/zviz/environment.h )
  s.files += %w( src/core/channelz/zviz/layout.cc )
  s.files += %w( src/core/channelz/zviz/layout.h )
  s.files += %w( src/core/channelz/zviz/layout_text.cc )
  s.files += %w( src/core/channelz/zviz/layout_text.h )
  s.files += %w( src/core/channelz/zviz/strings.cc )
  s.files += %w( src/core/channelz/zviz/strings.h )
  s.files += %w( src/core/channelz/zviz/style.cc )
  s.files += %w( src/core/channelz/zviz/style.h )
  s.files += %w( src/core/channelz/zviz/trace.cc )
  s.files += %w( src/core/channelz/zviz/trace.h )
  ...
  s.files += %w( src/proto/grpc/channelz/v2/channelz.proto )
  s.files += %w( src/proto/grpc/channelz/v2/promise.proto )
  s.files += %w( src/proto/grpc/channelz/v2/property_list.proto )
