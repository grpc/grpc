...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/proto/grpc/gcp/altscontext.proto )
  s.files += %w( src/proto/grpc/gcp/handshaker.proto )
  s.files += %w( src/proto/grpc/gcp/transport_security_common.proto )
  s.files += %w( src/proto/grpc/lb/v1/load_balancer.proto )
