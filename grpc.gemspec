...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/ext/upb-generated/third_party/istio/security/proto/providers/google/meshca.upb.c )
  s.files += %w( src/core/ext/upb-generated/third_party/istio/security/proto/providers/google/meshca.upb.h )
  ...
  s.files += %w( src/core/lib/security/certificate_provider/config.h )
  s.files += %w( src/core/lib/security/certificate_provider/factory.h )
  s.files += %w( src/core/lib/security/certificate_provider/google_mesh_ca.cc )
  s.files += %w( src/core/lib/security/certificate_provider/google_mesh_ca.h )
  s.files += %w( src/core/lib/security/certificate_provider/provider.h )
  s.files += %w( src/core/lib/security/certificate_provider/registry.cc )
  s.files += %w( src/core/lib/security/certificate_provider/registry.h )
  s.files += %w( src/core/lib/security/certificate_provider/store.cc )
  s.files += %w( src/core/lib/security/certificate_provider/store.h )
