...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/ext/filters/client_channel/grpc_if_nametoindex.h )
  ...
  s.files += %w( src/core/ext/filters/client_channel/grpc_if_nametoindex_posix.cc )
  s.files += %w( src/core/ext/filters/client_channel/grpc_if_nametoindex_unsupported.cc )
