...
Gem::Specification.new do |s|
  ...
  s.files += %w( include/grpc/grpc_tunnel.h )
  ...
  s.files += %w( src/core/ext/tunnel/tunnel_endpoint.h )
  ...
  s.files += %w( src/core/ext/tunnel/tunnel_client.cc )
  s.files += %w( src/core/ext/tunnel/tunnel_endpoint.cc )
  s.files += %w( src/core/ext/tunnel/tunnel_server.cc )
