...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/lib/event_engine/windows/event_poller.h )
  s.files += %w( src/core/lib/event_engine/windows/iocp.cc )
  s.files += %w( src/core/lib/event_engine/windows/iocp.h )
  s.files += %w( src/core/lib/event_engine/windows/socket.cc )
  s.files += %w( src/core/lib/event_engine/windows/socket.h )
