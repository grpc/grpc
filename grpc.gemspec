...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/util/promise/activity.cc )
  s.files += %w( src/core/util/promise/activity.h )
  s.files += %w( src/core/util/promise/all_ok.h )
  s.files += %w( src/core/util/promise/arena_promise.h )
  s.files += %w( src/core/util/promise/cancel_callback.h )
  s.files += %w( src/core/util/promise/context.h )
  s.files += %w( src/core/util/promise/detail/basic_seq.h )
  s.files += %w( src/core/util/promise/detail/join_state.h )
  s.files += %w( src/core/util/promise/detail/promise_factory.h )
  s.files += %w( src/core/util/promise/detail/promise_like.h )
  s.files += %w( src/core/util/promise/detail/seq_state.h )
  s.files += %w( src/core/util/promise/detail/status.h )
  s.files += %w( src/core/util/promise/exec_ctx_wakeup_scheduler.h )
  s.files += %w( src/core/util/promise/for_each.h )
  s.files += %w( src/core/util/promise/if.h )
  s.files += %w( src/core/util/promise/interceptor_list.h )
  s.files += %w( src/core/util/promise/latch.h )
  s.files += %w( src/core/util/promise/loop.h )
  s.files += %w( src/core/util/promise/map.h )
  s.files += %w( src/core/util/promise/observable.h )
  s.files += %w( src/core/util/promise/party.cc )
  s.files += %w( src/core/util/promise/party.h )
  s.files += %w( src/core/util/promise/pipe.h )
  s.files += %w( src/core/util/promise/poll.h )
  s.files += %w( src/core/util/promise/prioritized_race.h )
  s.files += %w( src/core/util/promise/promise.h )
  s.files += %w( src/core/util/promise/race.h )
  s.files += %w( src/core/util/promise/seq.h )
  s.files += %w( src/core/util/promise/sleep.cc )
  s.files += %w( src/core/util/promise/sleep.h )
  s.files += %w( src/core/util/promise/status_flag.h )
  s.files += %w( src/core/util/promise/try_join.h )
  s.files += %w( src/core/util/promise/try_seq.h )
