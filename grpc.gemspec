...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/tsi/ssl_session.h )
  s.files += %w( src/core/tsi/ssl_session_cache.h )
  ...
  s.files += %w( src/core/tsi/ssl_session_boringssl.cc )
  s.files += %w( src/core/tsi/ssl_session_cache.cc )
  s.files += %w( src/core/tsi/ssl_session_openssl.cc )
