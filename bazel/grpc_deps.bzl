...
def grpc_deps():
    ...
    if "s2a_core" not in native.existing_rules():
        http_archive(
            name = "s2a_core",
            strip_prefix = "s2a_core-afde66f1b96524d67b06e2544e795dd60b768b8f",
            urls = [
                "https://github.com/google/s2a-core/archive/afde66f1b96524d67b06e2544e795dd60b768b8f.tar.gz",
            ],
        )
