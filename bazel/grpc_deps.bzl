...
def grpc_deps():
    ...
    if "com_google_protobuf" not in native.existing_rules():
        http_archive(
            ...
            sha256 = "d8c3df086ce23806e06338eb6a1963ff86a1d2e0af7e2aec05f1d8ae4b23e951",
            strip_prefix = "protobuf-09ef9a29b80017d1967060aa96b79e24baddc23e",
            urls = [
                # https://github.com/protocolbuffers/protobuf/commits/23.x
                "https://storage.googleapis.com/grpc-bazel-mirror/github.com/protocolbuffers/protobuf/archive/09ef9a29b80017d1967060aa96b79e24baddc23e.tar.gz",
                "https://github.com/protocolbuffers/protobuf/archive/09ef9a29b80017d1967060aa96b79e24baddc23e.tar.gz",
            ],
            patches = [
    ...
    if "upb" not in native.existing_rules():
        http_archive(
            name = "upb",
            sha256 = "c0648a5433881a6ae30651c75534085ac7cf4696abbeddaa688cbe2977ec2c3f",
            strip_prefix = "upb-c50109929e015b5c180787385212aa32ca9a0daa",
            urls = [
                # https://github.com/protocolbuffers/upb/commits/23.x
                "https://storage.googleapis.com/grpc-bazel-mirror/github.com/protocolbuffers/upb/archive/c50109929e015b5c180787385212aa32ca9a0daa.tar.gz",
                "https://github.com/protocolbuffers/upb/archive/c50109929e015b5c180787385212aa32ca9a0daa.tar.gz",
            ],
        )
