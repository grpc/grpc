...
def grpc_deps():
    ...
    if "boringssl" not in native.existing_rules():
        http_archive(
            ...
            urls = [
                "https://storage.googleapis.com/grpc-bazel-mirror/github.com/google/boringssl/archive/0e2e48f9baa351c58fb68540332dc1382773699a.tar.gz",
                "https://github.com/google/boringssl/archive/0e2e48f9baa351c58fb68540332dc1382773699a.tar.gz",
            ],
        )
