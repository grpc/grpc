...
def grpc_deps():
    ...
    if "com_google_protobuf" not in native.existing_rules():
        http_archive(
            ...
            strip_prefix = "protobuf-6a6cd88c262ffdb1738167a47d5fcc7a3eb4edac",
            urls = [
                # https://github.com/protocolbuffers/protobuf/commits/v31.1
                "https://storage.googleapis.com/grpc-bazel-mirror/github.com/protocolbuffers/protobuf/archive/6a6cd88c262ffdb1738167a47d5fcc7a3eb4edac.tar.gz",
                "https://github.com/protocolbuffers/protobuf/archive/6a6cd88c262ffdb1738167a47d5fcc7a3eb4edac.tar.gz",
            ],
            patches = [
