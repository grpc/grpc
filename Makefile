...
test_cxx: buildtests_cxx
	...
	$(E) "[RUN]     Testing interop_server"
	$(Q) ./bins/interop_server || ( echo test interop_server failed ; exit 1 )
	$(E) "[RUN]     Testing interop_client"
	$(Q) ./bins/interop_client || ( echo test interop_client failed ; exit 1 )
...
bins/cpp_plugin: $(CPP_PLUGIN_OBJS)
	$(E) "[LD]      Linking $@"
	$(Q) mkdir -p `dirname $@`
	$(Q) $(LD) $(LDFLAGS) $(CPP_PLUGIN_OBJS) -Llibs $(LDLIBS) $(LDLIBS_SECURE) -o bins/cpp_plugin
...
bins/ruby_plugin: $(RUBY_PLUGIN_OBJS)
	$(E) "[LD]      Linking $@"
	$(Q) mkdir -p `dirname $@`
	$(Q) $(LD) $(LDFLAGS) $(RUBY_PLUGIN_OBJS) -Llibs $(LDLIBS) $(LDLIBS_SECURE) -o bins/ruby_plugin
...
bins/interop_server: $(INTEROP_SERVER_OBJS) libs/libgrpc_test_util.a libs/libgrpc++.a libs/libgrpc.a libs/libgpr.a
	$(E) "[LD]      Linking $@"
	$(Q) mkdir -p `dirname $@`
	$(Q) $(LDXX) $(LDFLAGS) $(INTEROP_SERVER_OBJS) $(GTEST_LIB) -Llibs -lgrpc_test_util -lgrpc++ -lgrpc -lgpr $(LDLIBSXX) $(LDLIBS) $(LDLIBS_SECURE) -o bins/interop_server
...
bins/interop_client: $(INTEROP_CLIENT_OBJS) libs/libgrpc_test_util.a libs/libgrpc++.a libs/libgrpc.a libs/libgpr.a
	$(E) "[LD]      Linking $@"
	$(Q) mkdir -p `dirname $@`
	$(Q) $(LDXX) $(LDFLAGS) $(INTEROP_CLIENT_OBJS) $(GTEST_LIB) -Llibs -lgrpc_test_util -lgrpc++ -lgrpc -lgpr $(LDLIBSXX) $(LDLIBS) $(LDLIBS_SECURE) -o bins/interop_client
